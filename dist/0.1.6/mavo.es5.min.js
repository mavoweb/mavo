...
var o=this;this.treeBuilt=Mavo.defer(), this.dataLoaded=Mavo.defer(), this.element=n, this.inProgress=!1, this.index=Object.keys(a.all).length+1, Object.defineProperty(a.all, this.index-1, {value:this});var r=a.attributes.map(function(e) {
return "[data-"+e+"]";
}).join(", ");if ([this.element].concat(_toConsumableArray(t(r, this.element))).forEach(function(e) {
a.attributes.forEach(function(t) {
...
for (var s=2;this.id+s in a.all;s++) {
;
} this.id+=s;
...
var o=Mavo.Primitive.getConfig(t), r=Mavo.is("multiple", t);!r&&(o.attribute||o.hasChildren)||t.setAttribute("typeof", "");
}
...
o.dataLoaded.resolve(), e.fire(o.element, "mv-load");
...
var t=new Mavo.Observer(o.element, "id", e, {subtree:!0});
}
}requestAnimationFrame(function() {
...
var r=n.getCousin(38==e.keyCode?-1:1, {wrap:!0});r&&(r.editing?r.edit({immediately:!0}).then(function() {
return r.editor.focus();
}):r.element.focus(), e.preventDefault());
}
}
...
var o;(o=console).log.apply(o, ["%c"+this.id+": "+e, "color: red; font-weight: bold"].concat(a));
}
}, render:function(e) {
var t=this;this.expressions.active=!1;var n={context:this, data:e};a.hooks.run("render-start", n), n.data&&this.root.render(n.data), this.unsavedChanges=!1, this.expressions.active=!0, requestAnimationFrame(function() {
return t.expressions.update();
}), a.hooks.run("render-end", n);
}, edit:function() {
...
return !e&&(e=!t.modes&&"Group"!=t.nodeType, !t.modes);
...
var e=0<arguments.length&&arguments[0]!==void 0?arguments[0]:document, n=Array.isArray(arguments[0])?arguments[0]:t(a.selectors.init, e), o=n.filter(function(e) {
return !a.get(e);
}).map(function(e) {
return new a(e);
});return o;
}, UI:{}, hooks:new e.Hooks, attributes:["mv-app", "mv-storage", "mv-source", "mv-init", "mv-path", "mv-multiple-path", "mv-format", "mv-attribute", "mv-default", "mv-mode", "mv-edit", "mv-permisssions", "mv-rel", "mv-value"], lazy:{locale:function() {
...
}}); {var n=a.selectors={init:".mv-app, [mv-app], [data-mv-app]", property:"[property], [itemprop]", specificProperty:function(e) {
return "[property="+e+"], [itemprop="+e+"]";
}, group:"[typeof], [itemscope], [itemtype], [mv-group]", multiple:"[mv-multiple]", formControl:"input, select, option, textarea", textInput:["text", "email", "url", "tel", "search"].map(function(e) {
return "input[type="+e+"]";
}).join(", ")+", input:not([type]), textarea", ui:".mv-ui", container:{tr:"table", option:"select"}}, o=n.arr=function(e) {
return e.split(/\s*,\s*/g);
}, r=n.not=function(e) {
...
return e+", "+t;
}, s=n.and=function(e, t) {
var a=[], n=o(t);return o(e).forEach(function(e) {
return a.push.apply(a, _toConsumableArray(n.map(function(t) {
return e+t;
})));
}), a.join(", ");
}, l=n.andNot=function(e, t) {
return s(e, r(t));
};e.extend(a.selectors, {primitive:l(n.property, n.group), rootGroup:l(n.group, n.property), item:i(n.multiple, n.group), output:i(n.specificProperty("output"), ".mv-output")});}requestAnimationFrame(function() {
var n=[];e.each({blissfuljs:Array.from&&document.documentElement.closest&&self.URL&&"searchParams"in URL.prototype, "Intl.~locale.en":self.Intl, IntersectionObserver:self.IntersectionObserver, Symbol:self.Symbol, "Element.prototype.remove":Element.prototype.remove}, function(e, t) {
t||n.push(e);
});var o="https://cdn.polyfill.io/v2/polyfill.min.js?unknown=polyfill&features="+n.map(function(e) {
return e+"|gated";
}).join(",");a.dependencies.push(e.ready().then(function() {
return a.Plugins.load();
}), e.include(!n.length, o)), a.inited=e.ready().then(function() {
return e.attributes(t(a.selectors.init), {"mv-progress":"Loading"}), a.ready;
}).catch(console.error).then(function() {
return Mavo.init();
}), a.ready=a.thenAll(a.dependencies);
...
var a=1<arguments.length&&void 0!==arguments[1]?arguments[1]:document.currentScript?document.currentScript.src:location;if (n.loaded=n.loaded||new Set, !n.loaded.has(t+"")) {
...
if ("object"===("undefined"==typeof a?"undefined":_typeof(a))&&null!==a) {
if (t.has(a)) {
return;
}t.add(a);
} return a;
...
var n=Mavo.value(t);if ("object"!==("undefined"==typeof t?"undefined":_typeof(t))||null===t) {
if (null===t) {
var o;t=(o={}, _defineProperty(o, Symbol.toStringTag, "Null"), _defineProperty(o, "toJSON", function() {
return null;
}), o);
}
else {
var r=t.constructor;t=new r(n), t[Symbol.toStringTag]=r.name;
}t.valueOf=t[Symbol.toPrimitive]=function() {
return n;
};
} return e.extend(t, a);
}, value:function(e) {
...
return new Set([].concat(_toConsumableArray(e||[]), _toConsumableArray(t||[])));
}, filter:function(e, t) {
for (var a=0;a<e.length;a++) {
t(e[a])||(e.splice(a, 1), a--);
}
}, is:function(e) {
for (var t=arguments.length, a=Array(1<t?t-1:0), o=1;o<t;o++) {
a[o-1]=arguments[o];
} for (var r, s=0;s<a.length;s++) {
if (r=a[s], r&&r.matches&&r.matches(n.selectors[e])) {
return !0;
}
} return !1;
...
var r, e=n.elementData.get(t)||{};return 2==arguments.length?r=e[a]:void 0===o?delete e[a]:r=e[a]=o, n.elementData.set(t, e), r;
...
a[n-1]=arguments[n];
} for (var o, r, s=0;o=a[s];s++) {
if (r=e.getAttribute(o), r) {
return r;
}
} return null;
}, getTarget:function() {
...
if (e) {
return "object"===("undefined"==typeof e?"undefined":_typeof(e))&&t in e||void 0!==e[t];
}
...
} return "object"==("undefined"==typeof t?"undefined":_typeof(t))&&a&&a.length?a.reduce(function(e, t, n) {
...
e.apply(o, r), removeEventListener("beforeunload", a);
...
}, Observer:e.Class({constructor:function(t, a, n) {
var r=3<arguments.length&&arguments[3]!==void 0?arguments[3]:{};n instanceof MutationObserver&&(this.observer=n), this.observer=this.observer||new MutationObserver(n), this.element=t, this.callback=n, this.attribute=a, this.options=e.extend({}, r), a&&e.extend(this.options, {attributes:!0, attributeFilter:"all"==this.attribute?void 0:Mavo.toArray(this.attribute), attributeOldValue:!!r.oldValue}), this.attribute&&"all"!=this.attribute||e.extend(this.options, {characterData:!0, childList:!0, subtree:!0, characterDataOldValue:!!r.oldValue}), this.run();
}, stop:function() {
...
var t, n, o=new Promise(function(a, o) {
e&&e(a, o), t=a, n=o;
...
return a.length==e.length?e:n.thenAll(a);
});
}, rr:function(e) {
return e(), e;
}, wrap:function(e, t) {
...
}});e.add("toggleAttribute", function(e, t) {
var a=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null!==t;a?this.setAttribute(e, t):this.removeAttribute(e);
...
Mavo.toArray(t).forEach(function(t) {
...
var e=0<arguments.length&&arguments[0]!==void 0?arguments[0]:"";return a.all[e]||a.all[a.getBaseLang(e)];
}, get:function(e) {
...
var o="https://raw.githubusercontent.com/"+t.repo+"/master/"+n;return a.loaded[t.id]?Promise.resolve():e.fetch(o).then(function(t) {
...
var n=this;if (this.mavo=t, this.element=e(".mv-bar", this.mavo.element), this.template=this.mavo.element.getAttribute("mv-bar")||"", this.element) {
for (var o in this.custom=!0, this.template+=" "+(this.element.getAttribute("mv-bar")||""), this.template=this.template.trim(), a.controls) {
this[o]=e(".mv-"+o, this.element), this[o]&&(this.template=this.template||"with", this.template+=" "+o);
}
}
else {
...
var r=a.controls[t];for (var o in n[t]&&n[t].remove(), r.create?n[t]=r.create.call(n.mavo, n[t]):!n[t]&&(n[t]=e.create("button", {className:"mv-"+t, textContent:n.mavo._(t)})), n.add(t), r.permission?n.permissions.can(r.permission, function() {
n.toggle(t, !r.condition||r.condition.call(n.mavo));
}, function() {
n.remove(t);
}):r.condition&&!r.condition.call(n.mavo)&&n.remove(t), r.events) {
e.bind(n[t], o, r.events[o].bind(n.mavo));
}
});var r=function(t) {
var r=a.controls[t];r.action&&e.delegate(n.mavo.element, "click", ".mv-"+t, function(e) {
(!r.permission||n.permissions.is(r.permission))&&(r.action.call(n.mavo), e.preventDefault());
});
};for (var i in a.controls) {
r(i);
...
var t=this, n=a.controls[e];n.prepare&&n.prepare.call(this.mavo), Mavo.revocably.add(this[e], this.element), this.resizeObserver||this.noResize||requestAnimationFrame(function() {
return t.resize();
});
}, remove:function(e) {
var t=this, n=a.controls[e];Mavo.revocably.remove(this[e], "mv-"+e), n.cleanup&&n.cleanup.call(this.mavo), this.resizeObserver||this.noResize||requestAnimationFrame(function() {
return t.resize();
});
}, toggle:function(e, t) {
...
if ("none"==e) {
return [];
} var o=/^with\s|\b(yes|no)-\w+\b/.test(e);e=e.replace(/\byes-|^with\s+/g, "");var r=e.split(/\s+/);return r=Mavo.Functions.unique(r.reverse()).reverse(), o?n.filter(function(e) {
var n=r.lastIndexOf(e), o=r.lastIndexOf("no-"+e), i=n>t(-1, o), s=o>t(-1, n);return i||!a.controls[e].optional&&!s;
}):r;
} return n.filter(function(e) {
return !a.controls[e].optional;
});
...
var o=this;if (this.mavo=t, this.message=a, this.closed=Mavo.defer(), this.element=e.create(_defineProperty({className:"mv-ui mv-message"+(n.type?" mv-"+n.type:""), innerHTML:this.message, events:{click:function() {
return Mavo.scrollIntoViewIfNeeded(o.mavo.element);
}}}, this.mavo.bar?"after":"start", (this.mavo.bar||this.mavo).element)), n.classes&&this.element.classList.add(n.classes), "error"==n.type?this.element.setAttribute("role", "alert"):this.element.setAttribute("aria-live", "polite"), n.dismiss=n.dismiss||{}, "string"==typeof n.dismiss||Array.isArray(n.dismiss)) {
var r={};Mavo.toArray(n.dismiss).forEach(function(e) {
r[e]=!0;
}), n.dismiss=r;
} if (n.dismiss.button&&e.create("button", {className:"mv-close mv-ui", textContent:"\xD7", events:{click:function() {
return o.close();
}}, start:this.element}), n.dismiss.timeout) {
var i, s="number"==typeof n.dismiss.timeout?n.dismiss.timeout:5e3;e.bind(this.element, {mouseenter:function() {
...
}n.dismiss.submit&&this.element.addEventListener("submit", function(e) {
e.preventDefault(), o.close(e.target);
});
}, close:function(t) {
var a=this;e.transition(this.element, {opacity:0}).then(function() {
...
var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:new URL(this.url);return t.searchParams.set("timestamp", Date.now()), e.fetch(t.href).then(function(e) {
...
var n=this, o=2<arguments.length&&void 0!==arguments[2]?arguments[2]:"GET", r=3<arguments.length&&void 0!==arguments[3]?arguments[3]:{};return r=e.extend({}, r), r.method=r.method||o, r.responseType=r.responseType||"json", r.headers=e.extend({"Content-Type":"application/json; charset=utf-8"}, r.headers||{}), r.data=a, this.isAuthenticated()&&(r.headers.Authorization=r.headers.Authorization||"Bearer "+this.accessToken), "object"===e.type(r.data)&&("GET"==r.method?r.data=Object.keys(r.data).map(function(e) {
return e+"="+encodeURIComponent(r.data[e]);
}).join("&"):r.data=JSON.stringify(r.data)), t=new URL(t, this.constructor.apiDomain), "GET"==r.method&&t.searchParams.set("timestamp", Date.now()), e.fetch(t, r).catch(function(e) {
...
a.accessToken=localStorage["mavo:"+r+"token"], a.accessToken&&n(a.accessToken);
}
else {
...
for (var t in e.data.backend==a.id&&(a.accessToken=localStorage["mavo:"+r+"token"]=e.data.token), a.accessToken||o(Error("Authentication error")), n(a.accessToken), Mavo.all) {
...
var a=Mavo.Node=e.Class({abstract:!0, constructor:function(t, n) {
var o=this, r=2<arguments.length&&void 0!==arguments[2]?arguments[2]:{};if (!t||!n) {
throw new Error("Mavo.Node constructor requires an element argument and a mavo object");
} var i={context:this, options:r};this.uid=++a.maxId, this.nodeType=this.nodeType, this.property=null, this.element=t, e.extend(this, i.options), a.all.set(t, [].concat(_toConsumableArray(a.all.get(this.element)||[]), [this])), this.mavo=n, this.group=this.parentGroup=i.options.group, this.template=i.options.template, this.alias=this.element.getAttribute("mv-alias"), this.template?this.template.copies.push(this):this.copies=[], this.fromTemplate("property", "type")||(this.property=a.getProperty(t), this.type=Mavo.Group.normalize(t), this.storage=this.element.getAttribute("mv-storage")), this.modes=this.element.getAttribute("mv-mode"), Mavo.hooks.run("node-init-start", i), this.mode=Mavo.getStyle(this.element, "--mv-mode")||"read", this.collection=i.options.collection, this.collection&&(this.group=this.parentGroup=this.collection.parentGroup);var s=this.template;if (s&&s.expressions&&(this.expressions=s.expressions.map(function(e) {
return new Mavo.DOMExpression({template:e, item:o, mavo:o.mavo});
})), this instanceof Mavo.Group||this.collection) {
var l=Mavo.DOMExpression.search(this.element).filter(function(e) {
return "mv-value"==e.originalAttribute;
})[0];l&&(l.mavoNode=this, this.expressionText=l, this.storage=this.storage||"none", this.modes="read", this.collection&&(this.collection.expressions=[].concat(_toConsumableArray(this.collection.expressions||[]), [l]), l.mavoNode=this.collection, this.collection.storage=this.collection.storage||"none", this.collection.modes="read"));
...
var e=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{};if (this.isDataNull(e)) {
...
var t=1<arguments.length&&arguments[1]!==void 0?arguments[1]:[], a=2<arguments.length&&arguments[2]!==void 0?arguments[2]:{};return function t(n, o) {
var r=e(n, o);if (!1!==r) {
...
var a;this.isRoot&&1===(a=this.getNames("Collection")).length?t.data=_defineProperty({}, a[0], t.data):(this.inPath.push("0"), t.data=t.data[0]);
...
var a=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{};e.fire(a.element||this.element, "mv-change", e.extend({property:this.property, action:t, mavo:this.mavo, node:this}, a));
}, toString:function() {
...
var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{}, a=this.find(e, t);return void 0===a&&(a=this.walkUp(function(t) {
return t.property==e?t:e in t.children?t.children[e]:void 0;
})), void 0===a&&(a=this.mavo.root.find(e, t)), a;
}, relativizeData:self.Proxy?function(e) {
var t=this, a=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{live:!0};return new Proxy(e, {get:function(e, a, n) {
return a in e?e[a]:a in n&&a in t.proxyCache?t.proxyCache[a]:void 0;
}, has:function(e, n) {
if (n in e||n in t.proxyCache) {
return !0;
} switch (n) {
case "$index":return t.proxyCache[n]=t.index||0, !0;case "$next":case "$previous":return t.closestCollection?(t.proxyCache[n]=t.closestCollection.getData(a)[t.index+("$next"==n?1:-1)], !0):(t.proxyCache[n]=null, !1);
} var o=t.resolve(n);return void 0===o?!!(n in Mavo.all&&isNaN(n)&&Mavo.all[n].root)&&(t.proxyCache[n]=Mavo.all[n].root.getData(a)):(Array.isArray(o)?o=o.map(function(e) {
return e.getData(a);
}).filter(function(e) {
return null!==e;
}):o instanceof Mavo.Node&&(o=o.getData(a)), t.proxyCache[n]=o, !0);
}, set:function() {
var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"", t=arguments[2];return console.warn("You cannot set data via expressions. Attempt to set "+e.toString()+" to "+t+" ignored."), t;
}});
}:function(e) {
return e;
}, createLiveData:function() {
var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};return this.liveData=e, this.liveData[Mavo.toNode]=this, this.liveData[Mavo.toProxy]=this.relativizeData(this.liveData), this.liveData;
}, pathFrom:function(e) {
...
}, getCousin:function(e) {
var t=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{};if (!this.closestCollection) {
return null;
...
var e="Collection"==this.nodeType?"mv-multiple-path":"mv-path";return (this.element.getAttribute(e)||"").split("/").filter(function(e) {
return e.length;
});
}, properties:function() {
if (this.template) {
...
var n=this;this.element.classList.toggle("mv-deleted", a), a?(this.elementContents=document.createDocumentFragment(), t(this.element.childNodes).forEach(function(e) {
n.elementContents.appendChild(e);
...
}}}, static:{maxId:0, all:new WeakMap, create:function(e, t) {
var a=2<arguments.length&&arguments[2]!==void 0?arguments[2]:{};return Mavo.is("multiple", e)&&!a.collection?new Mavo.Collection(e, t, a):new Mavo[Mavo.is("group", e)?"Group":"Primitive"](e, t, a);
...
var n=(a.all.get(e)||[]).filter(function(e) {
return !(e instanceof Mavo.Collection);
});return 2>n.length||!t?n[0]:n[0]instanceof Mavo.Group?node[1]:void 0;
}, getClosest:function(e, t) {
var n;do {
n=a.get(e, t);
} while (!n&&(e=e.parentNode));return n;
}, children:function(a) {
var e=Mavo.Node.get(a);return e?[e]:(e=t(Mavo.selectors.property, a).map(function(t) {
return Mavo.Node.get(t);
}).filter(function(t) {
return !a.contains(t.parentGroup.element);
}).map(function(t) {
return t.collection||t;
}), Mavo.Functions.unique(e));
}}});
}(Bliss, Bliss.$), function(e, t) {
var a=Mavo.Group=e.Class({extends:Mavo.Node, nodeType:"Group", constructor:function() {
var e=this;if (this.children={}, this.group=this, Mavo.hooks.run("group-init-start", this), Mavo.Primitive.getValueAttribute(this.element)) {
this.children[this.property]=new Mavo.Primitive(this.element, this.mavo, {group:this});
} var a=t(Mavo.selectors.property+", "+Mavo.selectors.multiple, this.element).filter(function(t) {
return e.element===t.parentNode.closest(Mavo.selectors.group);
}), n=a.map(function(e) {
return Mavo.Node.getProperty(e);
});a.forEach(function(t, a) {
var o=n[a], r=e.template?e.template.children[o]:null, i={template:r, group:e};if (e.children[o]) {
var s=e.children[o];s.add(t), s.mutable=s.mutable||Mavo.is("multiple", t);
}
else {
e.children[o]=n.indexOf(o)==n.lastIndexOf(o)?Mavo.Node.create(t, e.mavo, i):new Mavo.Collection(t, e.mavo, i);
}
}), this.childrenNames=Object.keys(this.children);var o=(this.isRoot?this.element.closest("[vocab]"):null)||this.element;this.vocab=o.getAttribute("vocab"), this.postInit(), Mavo.hooks.run("group-init-end", this);
}, get isRoot() {
return !this.property;
}, getNames:function() {
var e=this, t=0<arguments.length&&arguments[0]!==void 0?arguments[0]:"Node";return Object.keys(this.children).filter(function(a) {
return e.children[a]instanceof Mavo[t];
});
}, getData:function() {
var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{}, n={context:this, options:t, data:this.super.getData.call(this, t)};if (void 0!==n.data) {
return n.data;
...
var i=this.children[r];if (i.saved||n.options.live) {
var s=i.getData(n.options);
}n.options.live||i.saved&&null!==Mavo.value(s)?n.data[i.property]=s:delete n.data[i.property];
}
} return n.options.live?this.proxyCache={}:(n.data=Mavo.subset(this.data, this.inPath, n.data), this.childrenNames.length||this.isRoot?n.data&&"object"===_typeof(n.data)&&(this.type&&this.type!=a.DEFAULT_TYPE&&(n.data["@type"]=this.type), this.vocab&&(n.data["@context"]=this.vocab)):n.data=null), Mavo.hooks.run("node-getdata-end", n), (n.options.live?n.data[Mavo.toProxy]:n.data)||n.data;
}, find:function(e) {
var t=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{};if (t.exclude!==this) {
if (this.property==e) {
return this;
} if (e in this.children) {
return this.children[e].find(e, t);
} if (this.properties.has(e)) {
var a, n, o=[];for (var r in this.children) {
n=this.children[r].find(e, t), void 0!==n&&(Array.isArray(n)?(o.push.apply(o, _toConsumableArray(n)), a=!0):o.push(n));
} return a||1<o.length?o:o[0];
}
}
}, edit:function() {
var e=this, t=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{};return !1!==this.super.edit.call(this)&&Promise.all(Object.keys(this.children).map(function(a) {
...
var o=e.type(t), r=function(e) {
return (a.children[e]instanceof Mavo.Primitive)+(a.children[e].datatype==o);
}, n=Object.keys(this.children).filter(function(e) {
return !a.children[e].expressionText;
}).sort(function(e, t) {
return r(e)-r(t);
}).reverse()[0];
}t=_defineProperty({}, n, t), this.data=Mavo.subset(this.data, this.inPath, t);
} var i;this.propagate(function(a) {
var n=t[a.property];a.alias&&void 0!==t[a.alias]&&(i=i||e.extend({}, t), n=t[a.alias]), a.render(n);
}), i&&this.propagate(function(e) {
e.alias&&(t[e.property]=i[e.alias], !(e.alias in a.children)&&delete t[e.alias]);
});var n;this.createLiveData(t);
}
...
var o=this;this.fromTemplate("config", "attribute", "templateValue", "originalEditor")||(this.config=a.getConfig(n), this.attribute=this.config.attribute), this.datatype=this.config.datatype, "modes"in this.config&&(this.modes=this.config.modes, this.element.setAttribute("mv-mode", this.config.modes)), Mavo.hooks.run("primitive-init-start", this), this.expressionText=this.expressionText||Mavo.DOMExpression.search(this.element, this.attribute), this.expressionText&&!this.expressionText.mavoNode&&(this.expressionText.primitive=this, this.storage=this.storage||"none", this.modes="read", this.element.setAttribute("aria-live", "polite")), !this.editor&&this.element.hasAttribute("mv-edit")&&(!this.originalEditor&&(this.originalEditor=e(this.element.getAttribute("mv-edit"))), this.originalEditor&&!this.template&&(this.originalEditorObserver=new Mavo.Observer(this.originalEditor, "all", function() {
o.copies.concat(o).forEach(function(e) {
...
})[0], this.editor&&e.remove(this.editor));var r=this.editorValue;this.datatype||"number"!=typeof r&&"boolean"!=typeof r||(this.datatype="undefined"==typeof r?"undefined":_typeof(r)), this.config.init&&this.config.init.call(this, this.element), this.config.changeEvents&&e.bind(this.element, this.config.changeEvents, function(e) {
e.target===o.element&&(o.value=o.getValue());
}), this.templateValue=this.getValue(), this._default=this.element.getAttribute("mv-default"), null===this.default?(this._default=this.modes?this.templateValue:r, this.defaultSource=this.modes?"template":"editor"):""===this.default?(this._default=this.templateValue, this.defaultSource="template"):(this.defaultObserver=new Mavo.Observer(this.element, "mv-default", function() {
...
o.observer.running&&(o.attribute||!o.editing||o.config.subtree)&&(o.value=o.getValue());
...
var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{}, t={context:this, options:e, data:this.super.getData.call(this, e)};if (void 0===t.data&&(t.data=this.value, ""===t.data&&(t.data=null)), !t.options.live) {
this.inPath.length&&(t.data=Mavo.subset(this.data, this.inPath, t.data));
}
else if (this.collection||e.forceObjects) {
return t.data=Mavo.objectify(t.data, _defineProperty({}, Mavo.toNode, this)), t.data[Mavo.toProxy]=this.relativizeData(t.data), this.collection&&(t.data[this.property]=t.data), Mavo.hooks.run("node-getdata-end", t), this.proxyCache={}, t.data[Mavo.toProxy];
...
var a=this;if (!this.editor&&this.originalEditor&&(this.editor=this.originalEditor.cloneNode(!0)), !this.editor) {
var n=this.config.editor;n&&"boolean"!=this.datatype||(n=Mavo.Elements.defaultConfig[this.datatype||"string"].editor), this.editor=e.create("function"===e.type(n)?n.call(this):n), this.editorValue=this.value;
}e.bind(this.editor, {"input change":function() {
a.value=a.editorValue;
}, "mv-change":function(t) {
"output"===t.property&&(t.stopPropagation(), e.fire(a.editor, "input"));
}});var o=this.editor.matches("textarea");o||this.editor.addEventListener("focus", function() {
a.editor.select&&a.editor.select();
}), !this.popup&&this.closestCollection&&this.editor.matches(Mavo.selectors.textInput)&&this.editor.addEventListener("keydown", function(e) {
if (13==e.keyCode&&a.closestCollection.editing&&(e.shiftKey||!o)) {
var t=a.getCousin(1);if (!t) {
if (a.bottomUp) {
return;
} var n=a.closestCollection.add();a.closestCollection.editItem(n, {immediately:!0});
}t=a.getCousin(1), t.edit({immediately:!0}).then(function() {
return t.editor.focus();
}), o&&e.preventDefault();
}
else if (8==e.keyCode&&(a.empty&&a.collection||e[Mavo.superKey])) {
a.closestCollection.delete(a.closestItem);var r=a.getCousin(1)||a.getCousin(-1);r&&r.edit({immediately:!0}).then(function() {
return r.editor.focus();
});
}
}), "placeholder"in this.editor&&(this.editor.placeholder="("+this.label+")");var r=/^mv-edit-/i;t(this.element.attributes).forEach(function(e) {
r.test(e.name)&&this.editor.setAttribute(e.name.replace(r, ""), e.value);
...
var t=this, a=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};return !1!==this.super.edit.call(this)&&(-1===this.element.tabIndex&&Mavo.revocably.setAttribute(this.element, "tabindex", "0"), this.modes||e.bind(this.element, "click.mavo:edit", function(e) {
return e.preventDefault();
}), this.preEdit=Mavo.defer(function(n) {
if (a.immediately) {
return n();
} var o=["click", "focus", "dragover", "dragenter"].map(function(t) {
return t+".mavo:preedit";
}).join(" ");e.bind(t.element, o, n);
}).then(function() {
return e.unbind(t.element, ".mavo:preedit");
}), this.config.edit?void this.config.edit.call(this):this.preEdit.then(function() {
t.sneak(function() {
t.initEdit&&t.initEdit(), t.popup&&(t.popup.prepare(), t.popup.show()), t.attribute||t.popup||(t.editor.parentNode!=t.element&&(t.editorValue=t.value, t.element.textContent="", t.element.appendChild(t.editor)), !t.collection&&(document.activeElement===t.element&&t.editor.focus(), Mavo.revocably.restoreAttribute(t.element, "tabindex")));
});
}));
}, done:function() {
var t=this;return !1!==this.super.done.call(this)&&void("preEdit"in this&&e.unbind(this.element, ".mavo:preedit .mavo:edit"), this.sneak(function() {
return t.config.done?void t.config.done.call(t):void(t.popup?t.popup.close():!t.attribute&&t.editor&&(e.remove(t.editor), a.setValue(t.element, t.editorValue, {config:t.config, attribute:t.attribute, datatype:t.datatype, map:t.originalEditor||t.editor})));
...
for (var n, o=[this.property, "value", "content"], r=0;r<o.length;r++) {
if (n=o[r], n in e) {
t=n;break;
}
}
...
var t=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{};if (this.property==e&&t.exclude!==this) {
return this;
}
}, getValue:function() {
...
}}, static:{all:new WeakMap, getValueAttribute:function(e) {
...
var n="undefined"==typeof e?"undefined":_typeof(e), o=a.cast(e, t);return null===e||void 0===e?e:"boolean"==t?"false"!==e&&0!==e&&""!==e&&(!!("true"===e||0<e)||e):"number"==t?/^[-+]?[0-9.e]+$/i.test(e+"")?o:e:o;
}, cast:function(e, t) {
...
return n.getValue(e);
} var i;return i=o in e&&a.useProperty(e, o)?e[o]:o?e.getAttribute(o):e.getAttribute("content")||e.textContent||null, a.safeCast(i, r);
...
var r=2<arguments.length&&arguments[2]!==void 0?arguments[2]:{};if (1===t.nodeType&&(r.config||(r.config=a.getConfig(t, r.attribute)), r.attribute=void 0===r.attribute?r.config.attribute:r.attribute, r.datatype=void 0===r.datatype?r.config.datatype:r.datatype, r.config.setValue&&r.attribute==r.config.attribute)) {
...
var s=a.format(n, r);s===n?t.textContent=n:(t.textContent=s, t.setAttribute&&t.setAttribute("content", n));
}
}, useProperty:function(e, t) {
return !(-1<["href", "src"].indexOf(t))&&"http://www.w3.org/2000/svg"!=e.namespaceURI;
}, format:function(t) {
var n=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{};if (n.map&&/^select$/i.test(n.map.nodeName)) {
...
}a.element.classList.toggle("mv-point-down", r), e.style(a.element, {top:o+"px", left:n+"px"});
...
var t=this;e.unbind([this.primitive.element, this.element], ".mavo:showpopup"), this.shown=!0, this.hideCallback=function(e) {
t.element.contains(e.target)||t.primitive.element.contains(e.target)||t.hide();
...
var r=n.matches(t, a, o), i=r[r.length-1];if (i) {
return i;
...
var t=this, a=e.create("input", {type:"url", placeholder:"http://example.com/image.png", className:"mv-output", "aria-label":"URL to image"});if (this.mavo.uploadBackend&&self.FileReader) {
var n, o=this.element.nodeName.toLowerCase();o="img"==o?"image":o;var r=this.element.getAttribute("mv-uploads")||o+"s", i=function(e) {
var n=1<arguments.length&&void 0!==arguments[1]?arguments[1]:e.name;if (e&&0===e.type.indexOf(o+"/")) {
var i=URL.createObjectURL(e);t.sneak(function() {
return t.element.src=i;
}), t.mavo.upload(e, r+"/"+n).then(function(e) {
var n=0, o=Mavo.rr(function() {
return Mavo.timeout(1e3+500*n).then(function() {
n++, t.element.src=e;
});
}), r=function() {
URL.revokeObjectURL(i), t.element.removeEventListener("load", s), t.element.removeEventListener("error", s);
}, s=function() {
t.element.src!=i&&(t.element.src=e, r());
}, l=function() {
10>=n?(t.sneak(function() {
return t.element.src=i;
}), o()):(t.mavo.error(t.mavo._("cannot-load-uploaded-file")+" "+e), r());
};a.value=e, t.element.addEventListener("load", s), t.element.addEventListener("error", l);
});
}
}, s={paste:function(e) {
var a=e.clipboardData.items[0];if ("file"==a.kind&&0===a.type.indexOf(o+"/")) {
var n="pasted-"+o+"-"+Date.now()+"."+a.type.slice(6), r=prompt(t.mavo._("filename"), n);""===r&&(r=n), null!==r&&(i(a.getAsFile(), r), e.preventDefault());
}
}, "drag dragstart dragend dragover dragenter dragleave drop":function(e) {
e.preventDefault(), e.stopPropagation();
}, "dragover dragenter":function() {
n.classList.add("mv-dragover"), t.element.classList.add("mv-dragover");
}, "dragleave dragend drop":function() {
n.classList.remove("mv-dragover"), t.element.classList.remove("mv-dragover");
}, drop:function(e) {
i(e.dataTransfer.files[0]);
}};return e.bind(this.element, s), n=e.create({className:"mv-upload-popup", contents:[a, {tag:"input", type:"file", "aria-label":"Upload image", accept:o+"/*", events:{change:function(e) {
var t=e.target.files[0];t&&i(t);
}}}, {className:"mv-tip", innerHTML:"<strong>Tip:</strong> You can also drag & drop or paste!"}], events:s});
} return a;
...
var l=n.element.getBoundingClientRect().left, d=a(0, (e.clientX-l)/n.element.offsetWidth), m=o+i*d, p=m%s;m+=p>s/2?s-p:-p, m=a(o, t(m, r)), n.sneak(function() {
return n.element.setAttribute("value", m);
});
...
return "[day("+e+")] [month("+e+").shortname] [year("+e+")]";
}, month:function(e) {
return "[month("+e+").name] [year("+e+")]";
}, time:function(e) {
return "[hour("+e+").twodigit]:[minute("+e+").twodigit]";
...
var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{}, t={context:this, options:e, data:this.liveData};t.options.live&&(this.proxyCache={});for (var a=0, n=0;item=this.children[a];a++) {
...
if (Mavo.filter(t.data, function(e) {
return null!==Mavo.value(e);
}), t.options.live&&1===t.data.length) {
t.data=t.data[0];
}
else if (this.data&&!t.options.live) {
var r=Mavo.subset(this.data, this.inPath);t.data=t.data.concat(r.slice(t.data.length));
}
...
var n=this, r=2<arguments.length&&void 0!==arguments[2]?arguments[2]:{};if (t=t instanceof Node?Mavo.Node.get(t)||this.createItem(t):t||this.createItem(), t.collection!=this&&this.adopt(t), this.mutable) {
...
a=this.length;
} var s={context:this, item:t};return s.previousIndex=t.index, s.changed=this.splice({remove:s.item}, {index:a, add:s.item}), s.item.itembar&&s.item.itembar.reposition(), this.mavo.expressions.active&&!r.silent&&requestAnimationFrame(function() {
...
t.index===void 0&&t.remove&&isNaN(t.remove)&&(t.index=e.children.indexOf(t.remove), t.remove=1);
}), a.sort(function(e, t) {
return t.index-e.index;
}), a.forEach(function(t) {
if (-1<t.index&&(t.remove||t.add)) {
var a;t.remove=t.remove||0, t.add=Mavo.toArray(t.add), (a=e.children).splice.apply(a, [t.index, +t.remove].concat(_toConsumableArray(t.add)));
}
});for (var o, r=[], s=0;s<this.length;s++) {
o=this.children[s], o&&o.index!==s&&(o.index=s, r.push(o));
} return r;
}, adopt:function(e) {
var t=this;e.collection&&(e.collection.splice({remove:e}), e.collection.dataChanged("delete")), this.walk(function(a) {
a.closestCollection===e.collection&&(a.closestCollection=t), e.mavo!=t.mavo&&(e.mavo=t.mavo);
}), e.collection=this, e.template&&(Mavo.delete(e.template.copies, e), e.template=this.itemTemplate);
}, delete:function(t, a) {
var n=this;return a?(e.remove(t.element), this.splice({remove:t}), void t.destroy()):e.transition(t.element, {opacity:0}).then(function() {
t.deleted=!0, t.element.style.opacity="", t.dataChanged("delete"), n.unsavedChanges=t.unsavedChanges=n.mavo.unsavedChanges=!0;
});
}, move:function(e, t) {
...
var t=this, a=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{}, n=a.immediately?Promise.resolve():Mavo.inView.when(e.element);return n.then(function() {
return t.mutable&&(!e.itembar&&(e.itembar=new Mavo.UI.Itembar(e)), e.itembar.add()), e.edit(a);
});
}, edit:function() {
var t=this, n=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{};if (!1===this.super.edit.call(this)) {
return !1;
} if (this.mutable) {
if (!this.addButton.parentNode) {
var o=this.element.tagName.toLowerCase(), r=Mavo.selectors.container[o], i=r?this.marker.parentNode.closest(r):this.marker;e[this.bottomUp?"before":"after"](this.addButton, i);
}a.dragula.then(function() {
t.getDragula();
});
} return Promise.all(this.children.map(function(e) {
return t.editItem(e, n);
}));
}, done:function() {
return !1!==this.super.done.call(this)&&void(this.mutable&&(this.addButton.parentNode&&this.addButton.remove(), this.propagate(function(e) {
e.itembar&&e.itembar.remove();
})));
}, dataChanged:function(e) {
var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{};return t.element=t.element||this.marker, this.super.dataChanged.call(this, e, t);
}, save:function() {
var e=this;this.children.forEach(function(t) {
t.deleted?e.delete(t, !0):t.unsavedChanges=!1;
});
}, propagated:["save"], dataRender:function(t) {
var a=this;if (void 0!==t) {
if (t=null===t?[]:Mavo.toArray(t).filter(function(e) {
return null!==e;
}), !this.mutable) {
this.children.forEach(function(e, a) {
return e.render(t&&t[a]);
});
}
else {
for (var n, o=0;o<this.children.length;o++) {
n=this.children[o], o<t.length?n.render(t[o]):(n.dataChanged("delete"), this.delete(n, !0), o--);
} if (t.length>o) {
for (var n, r=document.createDocumentFragment(), i=o;i<t.length;i++) {
n=this.createItem(), n.render(t[i]), this.children.push(n), n.index=i, r.appendChild(n.element);var s={context:this, item:n};Mavo.hooks.run("collection-add-end", s);
} this.bottomUp?e.after(r, 0<o?this.children[o-1].element:this.marker):e.before(r, this.marker);for (var i=o;i<this.children.length;i++) {
this.children[i].dataChanged("add"), this.mavo.expressions.active&&requestAnimationFrame(function() {
return a.mavo.expressions.update(a.children[i]);
});
}
}
...
var t=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{};if (t.exclude!==this) {
var a=this.children.filter(function(e) {
return !e.deleted&&!e.hidden;
});if (this.property==e) {
return t.collections?this:a;
} if (this.properties.has(e)) {
var n=a.map(function(a) {
return a.find(e, t);
});return Mavo.flatten(n);
}
}
...
return !!e.accepts.length&&-1<Mavo.flatten(e.accepts.map(function(t) {
return e.mavo.root.find(t, {collections:!0});
})).filter(function(e) {
return e&&e instanceof a;
}).map(function(e) {
return e.marker.parentNode;
}).indexOf(t);
...
var a=this, n="button.mv-add-"+this.property, o=this.closestCollection||this.marker.parentNode.closest(Mavo.selectors.group);if (o) {
var r=t(n, o).filter(function(e) {
return !a.templateElement.contains(e)&&!Mavo.data(e, "collection");
})[0];
} return r||(r=e.create("button", {className:"mv-add", textContent:this.mavo._("add-item", this)})), r.classList.add("mv-ui", "mv-add"), Mavo.data(r, "collection", this), this.property&&r.classList.add("mv-add-"+this.property), r.addEventListener("click", function(e) {
e.preventDefault(), a.editItem(a.add());
}), r;
}, liveData:function() {
return this.createLiveData([]);
}}, static:{dragulas:[], get:function(e) {
var t=Mavo.data(e, "collection");if (t) {
return t;
} var a=Mavo.Node.get(e);return a&&a.collection||null;
}, lazy:{dragula:function() {
return e.include(self.dragula, "https://cdnjs.cloudflare.com/ajax/libs/dragula/3.7.2/dragula.min.js");
}}}});
}(Bliss, Bliss.$), function(e, t) {
var a=Mavo.UI.Itembar=e.Class({constructor:function(a) {
var n=this;if (this.item=a, this.element=t(".mv-item-bar:not([mv-rel]), .mv-item-bar[mv-rel=\""+this.item.property+"\"]", this.item.element).filter(function(e) {
...
});var r={add:this.buttonSelector("add"), delete:this.buttonSelector("delete"), drag:this.buttonSelector("drag")};this.element.addEventListener("click", function(e) {
if (n.item.collection.editing) {
if (e.target.matches(r.add)) {
var t=n.collection.add(null, n.item.index);return e[Mavo.superKey]&&t.render(n.item.getData()), Mavo.scrollIntoViewIfNeeded(t.element), n.collection.editItem(t);
}e.target.matches(r.delete)?n.item.collection.delete(a):e.target.matches(r["drag-handle"])&&function(e) {
...
return a=a.trim(), /\s/.test(a)?new(Function.prototype.bind.apply(t.Syntax, [null].concat(_toConsumableArray(a.split(/\s+/))))):t.Syntax.ESCAPE;
}
}
}, ESCAPE:-1}}), t.Syntax.default=new t.Syntax("[", "]");
}(Bliss, Bliss.$), function(e) {
var t=Mavo.DOMExpression=e.Class({constructor:function() {
var a=this, n=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};this.mavo=n.mavo, this.template=n.template&&n.template.template||n.template;for (var o, r=["item", "path", "syntax", "fallback", "attribute", "originalAttribute", "expression", "parsed"], i=0;i<r.length;i++) {
o=r[i], this[o]=void 0===n[o]&&this.template?this.template[o]:n[o];
} if (this.node=n.node, this.node||(this.node=Mavo.elementPath(this.item.element, this.path)), this.element=this.node, this.attribute=this.attribute||null, Mavo.hooks.run("domexpression-init-start", this), "mv-value"==this.attribute) {
this.originalAttribute="mv-value", this.attribute=Mavo.Primitive.getValueAttribute(this.element), this.fallback=this.fallback||Mavo.Primitive.getValue(this.element, {attribute:this.attribute});var s=this.element.getAttribute("mv-value");this.element.removeAttribute("mv-value"), this.parsed=[new Mavo.Expression(s)], this.expression=this.syntax.start+s+this.syntax.end;
...
if (this.attribute) {
var l=Element.prototype.getAttribute.call(this.node, this.attribute);this.expression=(l||"").trim();
}
else {
if (this.node.normalize(), this.node.firstChild&&1===this.node.childNodes.length&&3===this.node.firstChild.nodeType) {
var d=this.node.firstChild.textContent.match(/^\s*|\s*$/g);d[1]&&(this.node.firstChild.splitText(this.node.firstChild.textContent.length-d[1].length), e.after(this.node.lastChild, this.node)), d[0]&&(this.node.firstChild.splitText(d[0].length), this.node.parentNode.insertBefore(this.node.firstChild, this.node));
} this.expression=this.node.textContent;
} this.parsed=n.template?n.template.parsed:this.syntax.tokenize(this.expression);
...
a.template||a.item||(a.item=Mavo.Node.getClosest(a.element), "Primitive"===a.item.nodeType&&!a.item.collection&&(a.item=a.item.parent)), "mv-value"==a.originalAttribute&&a.mavoNode&&a.mavoNode==a.item.collection&&Mavo.delete(a.item.expressions, a), Mavo.hooks.run("domexpression-init-treebuilt", a);
...
return "mv-value"==this.originalAttribute&&this.mavoNode&&!(this.mavoNode instanceof Mavo.Primitive)?!e||!this.mavoNode.contains(e.node):(this.identifiers||(this.identifiers=Mavo.flatten(this.parsed.map(function(e) {
return e.identifiers||[];
})), t.special.add(this)), Mavo.Expression.changedBy(this.identifiers, e));
}, update:function() {
var e=this, t=0<arguments.length&&arguments[0]!==void 0?arguments[0]:this.data, a=arguments[1], n={context:this, event:a}, o=n;this.data=t, Mavo.hooks.run("domexpression-update-start", n), this.oldValue=this.value;var r=!1;n.value=this.value=this.parsed.map(function(a, n) {
if (a instanceof Mavo.Expression) {
if (a.changedBy(o.event)) {
var i={context:e, expr:a, parentEnv:o};return Mavo.hooks.run("domexpression-update-beforeeval", i), i.value=Mavo.value(i.expr.eval(t)), Mavo.hooks.run("domexpression-update-aftereval", i), r=!0, i.value instanceof Error?void 0===e.fallback?e.syntax.start+i.expr.expression+e.syntax.end:e.fallback:void 0===i.value||null===i.value?"":i.value;
} return e.oldValue[n];
} return a;
});r&&(n.value=1===n.value.length?n.value[0]:n.value.map(function(t) {
return Mavo.Primitive.format(t, {attribute:e.attribute, element:e.element});
}).join(""), this.output(n.value), Mavo.hooks.run("domexpression-update-end", n));
}, output:function(e) {
...
if (null===e) {
return e;
} var n=t.elements.get(e)||[];return 1<arguments.length?n.length?n.filter(function(e) {
...
var a=1<arguments.length&&arguments[1]!==void 0?arguments[1]:{}, n=a.type, o=a.update, r=a.target, i=r===void 0?document:r;this.vars[e]={observe:function() {
...
var t=this;this.mavo=e, this.active=!0, this.expressions=[];var n=Mavo.Expression.Syntax.create(this.mavo.element.closest("[mv-expressions]"))||Mavo.Expression.Syntax.default;this.traverse(this.mavo.element, void 0, n), this.scheduled={}, this.mavo.treeBuilt.then(function() {
t.expressions=[], document.documentElement.addEventListener("mv-change", function(e) {
if (t.active) {
var n=t.scheduled[e.action]=t.scheduled[e.action]||new Set;e.node.template?!n.has(e.node.template)&&(setTimeout(function() {
...
if (this.active) {
var a, n;t instanceof Mavo.Node?(n=t, t=null):t instanceof Element?(a=t.closest(Mavo.selectors.item), n=Mavo.Node.get(a), t=null):n=this.mavo.root;var o=n.getData({live:!0});n.walk(function(a, n) {
if (a.expressions&&a.expressions.length&&!a.isDeleted()) {
var r=e.value.apply(e, [o].concat(_toConsumableArray(n)));a.expressions.forEach(function(e) {
e.changedBy(t)&&e.update(r, t);
});
}
});
}
}, extract:function(e, t, n) {
var o=3<arguments.length&&arguments[3]!==void 0?arguments[3]:Mavo.Expression.Syntax.default;t&&"mv-expressions"==t.name||(t&&-1<a.directives.indexOf(t.name)||o!==Mavo.Expression.Syntax.ESCAPE&&o.test(t?t.value:e.textContent))&&(n===void 0&&(n=Mavo.elementPath(e.closest(Mavo.selectors.item), e)), this.expressions.push(new Mavo.DOMExpression({node:e, syntax:o, path:n, attribute:t&&t.name, mavo:this.mavo})));
}, traverse:function(e) {
var a=this, n=1<arguments.length&&arguments[1]!==void 0?arguments[1]:[], o=arguments[2];if (8!==e.nodeType) {
if (3===e.nodeType) {
this.extract(e, null, n, o);
}
else {
e.normalize(), o=Mavo.Expression.Syntax.create(e)||o, Mavo.is("item", e)&&(n=[]), t(e.attributes).forEach(function(t) {
return a.extract(e, t, n, o);
});var r=-1, i=0;e.matches("script:not([mv-expressions])")||t(e.childNodes).forEach(function(e) {
if (1==e.nodeType?(i=0, r++):i++, 1==e.nodeType||3==e.nodeType) {
var t=0<i?r+"."+i:r;a.traverse(e, [].concat(_toConsumableArray(n||[]), [t]), o);
}
});
}
}
...
if (t=p.date(t), !t) {
return "";
} var a=c[e](t);return a=new self["year"==e?"String":"Number"](a), ("month"==e||"weekday"==e)&&(a.name=r(t, _defineProperty({}, e, "long")), a.shortname=r(t, _defineProperty({}, e, "short"))), "weekday"!=e&&(a.twodigit=(10>a%100?"0":"")+a%100), a;
};
} var s=Math.floor, l=Math.abs, d=Math.min, m=Mavo.Functions={operators:{"=":"eq"}, get:function(e, a) {
var n=2<arguments.length&&void 0!==arguments[2]?arguments[2]:{};a=n.property=t(a);var o=Mavo.getCanonicalProperty(e, a);if (void 0!==o) {
...
var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:location;if (void 0===e) {
...
return Array.isArray(e)?[].concat(_toConsumableArray(new Set(e.map(t)))):e;
}, intersects:function(e, a) {
if (e&&a) {
var n=new Set(a.map?a.map(t):a);return e=e.map?e.map(t):[].concat(_toConsumableArray(e)), !e.every(function(e) {
return !n.has(e);
});
}
}, sum:function(e) {
return p.numbers(e, arguments).reduce(function(e, t) {
return +e+(+t||0);
}, 0);
}, average:function(e) {
return e=p.numbers(e, arguments), e.length&&m.sum(e)/e.length;
}, min:function(e) {
return d.apply(Math, _toConsumableArray(p.numbers(e, arguments)));
}, max:function(e) {
return Math.max.apply(Math, _toConsumableArray(p.numbers(e, arguments)));
}, count:function(e) {
...
var a=1<arguments.length&&void 0!==arguments[1]?arguments[1]:e, n=2<arguments.length&&void 0!==arguments[2]?arguments[2]:"";return Array.isArray(e)?e.map(function(e, o) {
var r=t(e)?a:n;return Array.isArray(r)?r[d(o, r.length-1)]:r;
}):t(e)?a:n;
}, replace:function(e, t) {
var a=2<arguments.length&&void 0!==arguments[2]?arguments[2]:"", n=3<arguments.length&&void 0!==arguments[3]?arguments[3]:1;if (Array.isArray(e)) {
return e.map(function(e) {
return m.replace(e, t, a);
});
} for (var o, r=RegExp(Mavo.escapeRegExp(t), "g"), i=e, s=0;i!=o&&s++<n;) {
o=i, i=i.replace(r, a);
} return i;
}, len:function(e) {
return a(e).length;
}, search:function(e, t) {
return e&&t?a(e).toLowerCase().indexOf((t+"").toLowerCase()):-1;
}, starts:function(e, t) {
return 0===m.search(a(e), a(t));
}, ends:function(e, t) {
var n=[a(e), a(t)];e=n[0], t=n[1];var o=m.search(e, t);return -1<o&&o===e.length-t.length;
}, join:function(e, t) {
...
return m.between(e, t);
}, fromlast:function(e, t) {
return m.between(e, t, "", !0);
}, to:function(e, t) {
return m.between(e, "", t);
}, tofirst:function(e, t) {
return m.between(e, "", t, !0);
}, between:function(e, t, n, o) {
...
}, year:i("year"), month:i("month"), day:i("day"), weekday:i("weekday"), hour:i("hour"), minute:i("minute"), second:i("second"), ms:i("ms"), date:function(e) {
return e=p.date(e), e?m.year(e)+"-"+m.month(e).twodigit+"-"+m.day(e).twodigit:"";
}, time:function(e) {
return e=p.date(e), e?m.hour(e).twodigit+":"+m.minute(e).twodigit+":"+m.second(e).twodigit:"";
}, minutes:function(e) {
return s(l(e)/60)||0;
}, hours:function(e) {
return s(l(e)/3600)||0;
}, days:function(e) {
return s(l(e)/86400)||0;
}, weeks:function(e) {
return s(l(e)/604800)||0;
}, months:function(e) {
return s(l(e)/(30.4368*86400))||0;
}, years:function(e) {
return s(l(e)/(12*(30.4368*86400)))||0;
}, localTimezone:-new Date().getTimezoneOffset(), log:function() {
for (var e, a=arguments.length, n=Array(a), o=0;o<a;o++) {
n[o]=arguments[o];
} return (e=console).log.apply(e, _toConsumableArray(n.map(t))), n[0];
...
}}}, p=m.util;m._Trap=self.Proxy?new Proxy(m, {get:function(e, t) {
var a, n=Mavo.getCanonicalProperty(e, t)||Mavo.getCanonicalProperty(Math, t);return n&&(a=e[n], void 0===a&&(a=Math[n])), void 0===a?t in self?self[t]:t:("function"==typeof a&&(a.toString=function() {
return t;
}), a);
}, has:function(e, t) {
return "data"!=t;
}}):m;var c={year:function(e) {
...
}), Mavo.Functions[e]=function(e) {
return Array.isArray(e)?e.map(t).map(a.scalar):a.scalar(t(e));
};
...
}), r.identity=void 0===r.identity?0:r.identity, Mavo.Functions[e]=r.code||function() {
for (var e=arguments.length, o=Array(e), a=0;a<e;a++) {
o[a]=arguments[a];
}1===o.length&&Array.isArray(o[0])&&(o=[].concat(_toConsumableArray(o[0]))), r.raw||(o=o.map(t));for (var s, l=r.logical?r.identity:o[0], d=function(e) {
var t=r.logical?o[e-1]:l, a=o[e];Array.isArray(a)?("number"==typeof r.identity&&(a=n.numbers(a)), s=Array.isArray(t)?[].concat(_toConsumableArray(a.map(function(e, a) {
return r.scalar(void 0===t[a]?r.identity:t[a], e);
})), _toConsumableArray(t.slice(a.length))):a.map(function(e) {
return r.scalar(t, e);
})):Array.isArray(t)?s=t.map(function(e) {
return r.scalar(e, a);
}):s=r.scalar(t, a), l=r.reduce?r.reduce(l, s, t, a):r.logical?l&&s:s;
}, m=1;m<o.length;m++) {
d(m);
} return l;
};
}, symbols:{}, unarySymbols:{}, getOperatorName:function(e, t) {
return Mavo.Script[t?"unarySymbols":"symbols"][e]||e;
}, operators:{not:{symbol:"!", scalar:function(e) {
return !e;
}}, multiply:{scalar:function(e, t) {
return e*t;
}, identity:1, symbol:"*"}, divide:{scalar:function(e, t) {
return e/t;
}, identity:1, symbol:"/"}, add:{scalar:function(e, t) {
return +e+ +t;
...
}, symbol:"mod", precedence:6}, lte:{logical:!0, scalar:function(e, t) {
var a=Mavo.Script.getNumericalOperands(e, t), n=_slicedToArray(a, 2);return e=n[0], t=n[1], e<=t;
}, identity:!0, symbol:"<="}, lt:{logical:!0, scalar:function(e, t) {
var a=Mavo.Script.getNumericalOperands(e, t), n=_slicedToArray(a, 2);return e=n[0], t=n[1], e<t;
}, identity:!0, symbol:"<"}, gte:{logical:!0, scalar:function(e, t) {
var a=Mavo.Script.getNumericalOperands(e, t), n=_slicedToArray(a, 2);return e=n[0], t=n[1], e>=t;
}, identity:!0, symbol:">="}, gt:{logical:!0, scalar:function(e, t) {
var a=Mavo.Script.getNumericalOperands(e, t), n=_slicedToArray(a, 2);return e=n[0], t=n[1], e>t;
}, identity:!0, symbol:">"}, eq:{logical:!0, scalar:function(e, t) {
return e==t;
}, symbol:["=", "=="], identity:!0, precedence:6}, neq:{logical:!0, scalar:function(e, t) {
return e!=t;
}, symbol:["!="], identity:!0}, and:{logical:!0, scalar:function(e, t) {
return !!e&&!!t;
}, identity:!0, symbol:["&&", "and"], precedence:2}, or:{logical:!0, scalar:function(e, t) {
return e||t;
}, reduce:function(e, t) {
return e||t;
}, identity:!1, symbol:["||", "or"], precedence:2}, concatenate:{symbol:"&", identity:"", scalar:function(e, t) {
return ""+(e||"")+(t||"");
}, precedence:10}, filter:{scalar:function(e, a) {
return t(a)?e:null;
}, raw:!0}}, getNumericalOperands:function(e, t) {
if (isNaN(e)||isNaN(t)) {
var a=n.date(e), o=n.date(t);if (a&&o) {
return [a, o];
}
...
return a.serialize(e.left)+" "+e.operator+" "+a.serialize(e.right);
}, UnaryExpression:function(e) {
return ""+e.operator+a.serialize(e.argument);
}, CallExpression:function(e) {
return a.serialize(e.callee)+"("+e.arguments.map(a.serialize).join(", ")+")";
}, ConditionalExpression:function(e) {
return a.serialize(e.test)+"? "+a.serialize(e.consequent)+" : "+a.serialize(e.alternate);
...
return "["+e.elements.map(a.serialize).join(", ")+"]";
}, Literal:function(e) {
return e.raw;
...
return e.body.map(a.serialize).join(" ");
}}, transformations:{BinaryExpression:function(e) {
var t=Mavo.Script.getOperatorName(e.operator), n=e, o=[];do {
...
}, parse:self.jsep};for (var o in a.serializers.LogicalExpression=a.serializers.BinaryExpression, a.transformations.LogicalExpression=a.transformations.BinaryExpression, Mavo.Script.operators) {
var r=Mavo.Script.operators[o];2>r.scalar.length?Mavo.Script.addUnaryOperator(o, r):Mavo.Script.addBinaryOperator(o, r);
} var i={average:"avg", iff:"iff IF", multiply:"mult product", divide:"div", lt:"smaller", gt:"larger bigger", eq:"equal equality", ordinal:"th"}, s=function(e) {
i[e].split(/\s+/g).forEach(function(t) {
return Mavo.Functions[t]=Mavo.Functions[e];
});
};for (var l in i) {
s(l);
}
...
} return a=new URL("https://raw.githubusercontent.com/"+this.username+"/"+this.repo+"/"+(this.branch||"master")+"/"+this.path), a.searchParams.set("timestamp", Date.now()), e.fetch(a.href).then(function(e) {
return Promise.resolve(e.responseText);
}, function() {
return Promise.resolve(null);
});
...
var n=e.slice(5), o=n.match(/^\w+\/[\w+]+/)[0];return n=n.replace(RegExp("^"+o+"(;base64)?,"), ""), a=t.path.replace(/[^/]+$/, "")+a, t.put(n, a, {isEncoded:!0});
}).then(function(e) {
...
var o="repos/"+this.username+"/"+this.repo, i=o+"/contents/"+n, s=this.mavo.element.getAttribute("mv-github-commit-prefix")||"", l=this.repoInfo||this.request("user/repos", {name:this.repo}, "POST").then(function(e) {
return a.repoInfo=e;
});return e=r.isEncoded?e:t.btoa(e), Promise.resolve(l).then(function(e) {
return a.canPush()?e:a.request(o+"/forks", {name:a.repo}, "POST").then(function(e) {
return i="repos/"+e.full_name+"/contents/"+n, a.forkInfo=e;
}).then(function(e) {
var t, n=function n(o) {
clearTimeout(t), a.request("repos/"+e.full_name+"/commits", {until:"1970-01-01T00:00:00Z"}, "HEAD").then(function() {
o(e);
}).catch(function() {
t=setTimeout(n, 1e3);
});
...
return a.forkInfo&&a.request("repos/"+a.username+"/"+a.repo+"/pulls", {head:a.user.username+":"+a.branch, base:a.branch}).then(function(e) {
a.pullRequest(e[0]);
}), e;
});
}
}, pullRequest:function(e) {
var t=this, a=new URL(location);a.searchParams.set(this.mavo.id+"-storage", "https://github.com/"+this.forkInfo.full_name+"/"+this.path);var n=this.mavo._("gh-edit-suggestion-saved-in-profile", {previewURL:a});this.notice&&this.notice.close(), e?(this.notice=this.mavo.message(n+"\n\t\t\t\t"+this.mavo._("gh-edit-suggestion-notreviewed")+"\n\t\t\t\t<form onsubmit=\"return false\">\n\t\t\t\t\t<button class=\"mv-danger\">"+this.mavo._("gh-edit-suggestion-revoke")+"</button>\n\t\t\t\t</form>", {classes:"mv-inline", dismiss:["button", "submit"]}), this.notice.closed.then(function(a) {
a&&t.request("repos/"+t.username+"/"+t.repo+"/pulls/"+e.number, {state:"closed"}, "POST").then(function(e) {
new Mavo.UI.Message(t.mavo, "<a href=\""+e.html_url+"\">"+t.mavo._("gh-edit-suggestion-cancelled")+"</a>", {dismiss:["button", "timeout"]}), t.pullRequest();
});
})):(this.notice=this.mavo.message(n+"\n\t\t\t\t"+this.mavo._("gh-edit-suggestion-instructions")+"\n\t\t\t\t<form onsubmit=\"return false\">\n\t\t\t\t\t<textarea name=\"edits\" class=\"mv-autosize\" placeholder=\""+this.mavo._("gh-edit-suggestion-reason-placeholder")+"\"></textarea>\n\t\t\t\t\t<button>"+this.mavo._("gh-edit-suggestion-send")+"</button>\n\t\t\t\t</form>", {classes:"mv-inline", dismiss:["button", "submit"]}), this.notice.closed.then(function(e) {
e&&t.request("repos/"+t.username+"/"+t.repo+"/pulls", {title:t.mavo._("gh-edit-suggestion-title"), body:t.mavo._("gh-edit-suggestion-body", {description:e.elements.edits.value, previewURL:a}), head:t.user.username+":"+t.branch, base:t.branch}, "POST").then(function(e) {
new Mavo.UI.Message(t.mavo, "<a href=\""+e.html_url+"\">"+t.mavo._("gh-edit-suggestion-sent")+"</a>", {dismiss:["button", "timeout"]}), t.pullRequest(e);
});
}));
}, login:function(e) {
var t=this;return this.oAuthenticate(e).then(function() {
...
return t.request("repos/"+t.username+"/"+t.repo).then(function(e) {
return void 0===t.branch&&(t.branch=e.default_branch), t.repoInfo=e;
});
}
});
}, canPush:function() {
...
var e=this, t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:this.path, a=arguments[1], n=this.forkInfo||this.repoInfo, o=n.full_name;return t=t.replace(/ /g, "%20"), n.pagesInfo=n.pagesInfo||this.request("repos/"+o+"/pages", {}, "GET", {headers:{Accept:"application/vnd.github.mister-fantastic-preview+json"}}), n.pagesInfo.then(function(e) {
return e.html_url+t;
}).catch(function() {
return a?"https://cdn.rawgit.com/"+o+"/"+a+"/"+t:"https://rawgit.com/"+o+"/"+e.branch+"/"+t;
});
