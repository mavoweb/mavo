...
console.log(t.stack))}).then(function(){e.inProgress=!1}))},save:function(){this.root.save(),this.store(),this.unsavedChanges=!1},revert:function(){this.root.revert()},walk:function(t){this.root.walk(t)},live:{inProgress:function(t){this.wrapper[(t?"set":"remove")+"Attribute"]("data-mv-progress",t)},editing:{set:function(t){this.wrapper.classList.toggle("editing",t),t?this.wrapper.setAttribute("data-editing",""):this.wrapper.removeAttribute("data-editing")}},unsavedChanges:function(t){this.wrapper.classList.toggle("unsaved-changes",t),this.ui&&this.ui.save&&(this.ui.save.disabled=!t,this.ui.revert.disabled=!t)},needsEdit:function(t){this.ui.bar[(t?"remove":"set")+"Attribute"]("hidden","")}},"static":{all:[],superKey:0===navigator.platform.indexOf("Mac")?"metaKey":"ctrlKey",init:function(t){return e(r.selectors.init,t||document).map(function(t){return new r(t)})},hooks:new t.Hooks}});!function(){var e=r.selectors={init:".mavo, [mavo], [data-mavo], [data-store]",property:"[property], [itemprop]",
specificProperty:function(t){return"[property="+t+"], [itemprop="+t+"]"},group:"[typeof], [itemscope], [itemtype], .mv-group",multiple:"[multiple], [data-multiple], .multiple",required:"[required], [data-required], .required",formControl:"input, select, option, textarea",computed:".computed",item:".mv-item",ui:".mv-ui",option:function(t){return"["+t+"], [data-"+t+"], ."+t},container:{li:"ul, ol",tr:"table",option:"select",dt:"dl",dd:"dl"}},i=e.arr=function(t){return t.split(/\s*,\s*/g)},s=e.not=function(t){return i(t).map(function(t){return":not("+t+")"}).join("")},n=e.or=function(t,e){return t+", "+e},o=e.and=function(t,e){var r=[],s=i(e);return i(t).forEach(function(t){return r.push.apply(r,_toConsumableArray(s.map(function(e){return t+e})))}),r.join(", ")},a=e.andNot=function(t,e){return o(t,s(e))};t.extend(r.selectors,{primitive:a(e.property,e.group),rootGroup:a(e.group,e.property),output:n(e.specificProperty("output"),".output, .value"),autoMultiple:o("li, tr, option",":only-of-type")
...
"use strict";!function(t,r){function e(t,e){for(t+="-within",r("."+t).forEach(function(r){return r.classList.remove(t)});e&&(e=e.parentNode)&&e.classList;)e.classList.add(t)}var n=t.extend(Mavo,{toJSON:function(t){return null===t?"":"string"==typeof t?t:JSON.stringify(t,null,"\t")},readable:function(t){return t&&t.replace(/([a-z])([A-Z])(?=[a-z])/g,function(t,r,e){return r+" "+e.toLowerCase()}).replace(/([a-z])[_\/-](?=[a-z])/g,"$1 ").replace(/^[a-z]/,function(t){return t.toUpperCase()})},queryJSON:function(r,e){return e&&r?t.value.apply(t,[r].concat(e.split("/"))):r},observe:function(r,e,n,a){n instanceof MutationObserver||(n=new MutationObserver(n));var o={};return e&&t.extend(o,{attributes:!0,attributeFilter:"all"==e?void 0:[e],attributeOldValue:!!a}),e&&"all"!=e||t.extend(o,{characterData:!0,childList:!0,subtree:!0,characterDataOldValue:!!a}),n.observe(r,o),n},toArray:function(t){return void 0===t?[]:Array.isArray(t)?t:[t]},flatten:function(t){return Array.isArray(t)?t.reduce(function(t,r){
return n.toArray(t).concat(n.flatten(r))},[]):[t]},is:function(t,r){return r.matches&&r.matches(n.selectors[t])},has:function(t,r){return r.matches&&r.matches(n.selectors.option(t))},urlParam:function(){for(var t=("searchParams"in URL.prototype?new URL(location).searchParams:null),r=null,e=arguments.length,n=Array(e),a=0;a<e;a++)n[a]=arguments[a];var o=!0,i=!1,c=void 0;try{for(var u,s=n[Symbol.iterator]();!(o=(u=s.next()).done);o=!0){var l=u.value;if(t)r=t.get(l);else{var f=location.search.match(RegExp("[?&]"+l+"(?:=([^&]+))?(?=&|$)","i"));r=f&&(f[1]||"")}if(null!==r)return r}}catch(h){i=!0,c=h}finally{try{!o&&s["return"]&&s["return"]()}finally{if(i)throw c}}return null},escapeRegExp:function(t){return t.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}});t.proxy=t.classProps.proxy=t.overload(function(t,r,e){return Object.defineProperty(t,r,{get:function(){return this[e][r]},set:function(t){this[e][r]=t},configurable:!0,enumerable:!0}),t}),t.classProps.propagated=function(t,r){Mavo.toArray(r).forEach(function(r){
var e=t[r];t[r]=function(){var t=e&&e.apply(this,arguments);this.propagate&&t!==!1&&this.propagate(r)}})},document.addEventListener("focus",function(t){e("focus",t.target)},!0),addEventListener("hashchange",function(r){e("target",t(location.hash))},!0),e("target",t(location.hash)),e("focus",document.activeElement)}(Bliss,Bliss.$);
...
"use strict";!function(t,e){Mavo.Unit=t.Class({"abstract":!0,"extends":Mavo.Node,constructor:function(t,e){var n=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];this.constructor.all.set(this.element,this),this.collection=n.collection,this.dirty=n.dirty,this.collection&&(this.group=this.parentGroup=this.collection.parentGroup),this.fromTemplate("computed","required")||(this.computed=Mavo.is("computed",this.element),this.required=Mavo.is("required",this.element)),Mavo.hooks.run("unit-init-end",this)},isDeleted:function(){this.deleted;return!!this.deleted||!!this.parentGroup&&this.parentGroup.isDeleted()},getData:function(t){t=t||{};var e=function(e){return e.dirty&&!t.dirty||e.deleted&&t.dirty||e.computed&&!t.computed};return e(this)?null:void this.walkUp(function(t){if(e(t))return null})},lazy:{closestCollection:function(){return this.collection||this.group.collection||(this.parentGroup?this.parentGroup.closestCollection:null)}},live:{deleted:function(n){var i=this;this.element.classList.toggle("deleted",n),
n?(this.elementContents=document.createDocumentFragment(),e(this.element.childNodes).forEach(function(t){i.elementContents.appendChild(t)}),t.contents(this.element,[{tag:"button",className:"close mv-ui",textContent:"×",events:{click:function(e){t.remove(this.parentNode)}}},"Deleted "+this.name,{tag:"button",className:"undo mv-ui",textContent:"Undo",events:{click:function(t){return i.deleted=!1}}}]),this.element.classList.remove("delete-hover")):this.deleted&&(this.element.textContent="",this.element.appendChild(this.elementContents),this._deleted=!1,t.fire(this.element,"mavo:datachange",{unit:this.collection,mavo:this.mavo,action:"undelete",item:this}))},unsavedChanges:function(t){return!t||!this.computed&&this.editing||(t=!1),this.element.classList.toggle("unsaved-changes",t),t}},"static":{get:function(t,e){var n=Mavo.Group.all.get(t);return e||!n?Mavo.Primitive.all.get(t):n},create:function(t,e){var n=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];if(!t||!e)throw new TypeError("Mavo.Unit.create() requires an element argument and a mavo object");
...
return n<t.length&&i.push(t.substring(n)),i},"static":{create:function(t){if(t){var i=t.getAttribute("data-expressions");if(i)return i=i.trim(),/\s/.test(i)?new(Function.prototype.bind.apply(e,[null].concat(_toConsumableArray(i.split(/\s+/))))):e.ESCAPE}},ESCAPE:-1}});e["default"]=new e("[","]")}(),function(){var e=Mavo.Expression.Text=t.Class({constructor:function(t){this.all=t.all,this.node=t.node,this.path=t.path,this.syntax=t.syntax,this.fallback=t.fallback,this.node||(this.node=this.path.reduce(function(t,e){return t.childNodes[e]},this.all.group.element)),this.element=this.node,this.attribute=t.attribute||null,"data-content"==this.attribute?(this.attribute=Mavo.Primitive.getValueAttribute(this.element),this.fallback=this.fallback||Mavo.Primitive.getValue(this.element,this.attribute,null,{raw:!0}),this.expression=this.element.getAttribute("data-content"),this.template=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end):(3===this.node.nodeType&&(this.element=this.node.parentNode,
this.node.parentNode.children.length&&!this.attribute||(this.node=this.element,this.element.normalize())),this.expression=(this.attribute?this.node.getAttribute(this.attribute):this.node.textContent).trim(),this.template=t.template?t.template.template:this.syntax.tokenize(this.expression)),Mavo.hooks.run("expressiontext-init-end",this),e.elements.set(this.element,[].concat(_toConsumableArray(e.elements.get(this.element)||[]),[this]))},update:function(t){var e=this;this.data=t;var i={};i.value=this.value=this.template.map(function(i){if(i instanceof Mavo.Expression){var n={context:e,expr:i};return Mavo.hooks.run("expressiontext-update-beforeeval",n),n.value=n.expr.eval(t),Mavo.hooks.run("expressiontext-update-aftereval",n),n.value instanceof Error?void 0!==e.fallback?e.fallback:n.expr.expression:void 0===n.value||null===n.value?"":n.value}return i}),this.attribute||(i.presentational=this.value.map(function(t){return Array.isArray(t)?t.join(", "):"number"==typeof t?Mavo.Primitive.formatNumber(t):t;
}),i.presentational=1===i.presentational.length?i.presentational[0]:i.presentational.join("")),i.value=1===i.value.length?i.value[0]:i.value.join(""),this.primitive&&1===this.template.length&&("number"==typeof i.value?this.primitive.datatype="number":"boolean"==typeof i.value&&(this.primitive.datatype="boolean")),i.presentational===i.value&&(i=i.value),this.primitive?this.primitive.value=i:Mavo.Primitive.setValue(this.node,i,this.attribute,{presentational:i.presentational})},proxy:{group:"all"},"static":{elements:new WeakMap,search:function(t,i){var n=e.elements.get(t)||[];return arguments.length>1?n.length?n.filter(function(t){return t.attribute===i})[0]||null:null:n}}})}(),function(){Mavo.Expressions=t.Class({constructor:function(t){var e=this;if(t&&(this.group=t,this.group.expressions=this),this.all=[],Mavo.hooks.run("expressions-init-start",this),this.group){var i=this.group.template;if(i&&i.expressions){var n=!0,r=!1,s=void 0;try{for(var a,o=i.expressions.all[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){
var u=a.value;this.all.push(new Mavo.Expression.Text({path:u.path,syntax:u.syntax,attribute:u.attribute,all:this,template:u}))}}catch(l){r=!0,s=l}finally{try{!n&&o["return"]&&o["return"]()}finally{if(r)throw s}}}else{var p=Mavo.Expression.Syntax.create(this.group.element.closest("[data-expressions]"))||Mavo.Expression.Syntax["default"];this.traverse(this.group.element,void 0,p)}}this.dependents=new Set,this.active=!0,this.group.element.addEventListener("mavo:datachange",function(t){return e.update()}),this.update()},update:function(){if(this.active&&!this.group.isDeleted()&&this.all.length+this.dependents.size!==0){var t={context:this,data:this.group.getRelativeData()};Mavo.hooks.run("expressions-update-start",t);var e=!0,i=!1,n=void 0;try{for(var r,s=this.all[Symbol.iterator]();!(e=(r=s.next()).done);e=!0){var a=r.value;a.update(t.data)}}catch(o){i=!0,n=o}finally{try{!e&&s["return"]&&s["return"]()}finally{if(i)throw n}}var u=!0,l=!1,p=void 0;try{for(var h,c=this.dependents[Symbol.iterator]();!(u=(h=c.next()).done);u=!0){
var f=h.value;f.update()}}catch(o){l=!0,p=o}finally{try{!u&&c["return"]&&c["return"]()}finally{if(l)throw p}}}},extract:function(t,e,i,n){(e&&"data-content"==e.name||n.test(e?e.value:t.textContent))&&this.all.push(new Mavo.Expression.Text({node:t,syntax:n,path:(i||"").slice(1).split("/").map(function(t){return+t}),attribute:e&&e.name,all:this}))},traverse:function(t){var i=this,n=arguments.length<=1||void 0===arguments[1]?"":arguments[1],r=arguments[2];if(3===t.nodeType||8===t.nodeType)this.extract(t,null,n,r);else if(t==this.group.element||!Mavo.is("group",t)){if(r=Mavo.Expression.Syntax.create(t)||r,r===Mavo.Expression.Syntax.ESCAPE)return;e(t.attributes).forEach(function(e){return i.extract(t,e,n,r)}),e(t.childNodes).forEach(function(t,e){return i.traverse(t,n+"/"+e,r)})}},"static":{}})}(),Mavo.Node.prototype.getRelativeData=function(){var t=this,e=arguments.length<=0||void 0===arguments[0]?{dirty:!0,computed:!0,"null":!0}:arguments[0];e.unhandled=this.mavo.unhandled;var i=this.getData(e);
return self.Proxy&&i&&"object"===("undefined"==typeof i?"undefined":_typeof(i))&&(i=new Proxy(i,{get:function(i,n){if(n in i)return i[n];if("$index"==n)return t.index+1;var r=t.walkUp(function(i){if(n in i.properties)return i.expressions.dependents.add(t.expressions),i.properties[n].getRelativeData(e)});return void 0!==r?r:void 0},has:function(i,n){if(n in i)return!0;if("$index"==n)return!0;var r=t.walkUp(function(t){if(n in t.properties)return!0});return void 0!==r?r:(r=t.find(n),void 0!==r?(r=Array.isArray(r)?r.map(function(t){return t.getData(e)}).filter(function(t){return null!==t}):r.getData(e),i[n]=r,!0):void 0)},set:function(t,e,i){throw Error("You can’t set data via expressions.")}})),i},Mavo.hooks.add("group-init-start",function(){new Mavo.Expressions(this)}),Mavo.hooks.add("primitive-init-start",function(){this.expressionText=Mavo.Expression.Text.search(this.element,this.attribute),this.computed=!!this.expressionText,this.expressionText&&(this.expressionText.primitive=this)}),
Mavo.hooks.add("group-init-end",function(){this.expressions.update()}),Mavo.hooks.add("group-render-start",function(){this.expressions.active=!1}),Mavo.hooks.add("group-render-end",function(){var t=this;requestAnimationFrame(function(){t.expressions.active=!0,t.expressions.update()})})}(Bliss,Bliss.$);
...
"use strict";!function(t,e){var i=Mavo.Group=t.Class({"extends":Mavo.Unit,constructor:function(t,i,r){var o=this;if(this.properties={},this.group=this,Mavo.hooks.run("group-init-start",this),Mavo.Primitive.getValueAttribute(this.element)){this.properties[this.property]=new Mavo.Primitive(this.element,this.mavo,{group:this})}e(Mavo.selectors.property,this.element).forEach(function(t){var e=Mavo.Node.getProperty(t);if(o.contains(t)){var i=o.properties[e],r=o.template?o.template.properties[e]:null,n={template:r,group:o};if(i){var s=i;i instanceof Mavo.Collection||(s=new Mavo.Collection(i.element,o.mavo,n),o.properties[e]=i.collection=s,s.add(i)),!s.mutable&&Mavo.is("multiple",t)&&(s.mutable=!0),s.add(t)}else{var a=Mavo.Node.create(t,o.mavo,n);o.properties[e]=a}}});var n=(this.isRoot?this.element.closest("[vocab]"):null)||this.element;this.vocab=n.getAttribute("vocab"),Mavo.hooks.run("group-init-end",this)},get isRoot(){return!this.property},getData:function(e){e=e||{};var r=this["super"].getData.call(this,e);
return void 0!==r?r:(r={},this.propagate(function(t){if((!t.computed||e.computed)&&!(t.property in r)){var i=t.getData(e);(null!==i||e["null"])&&(r[t.property]=i)}}),e.dirty&&!e.unhandled||t.extend(r,this.unhandled),this.type&&this.type!=i.DEFAULT_TYPE&&(r["@type"]=this.type),this.vocab&&(r["@context"]=this.vocab),r)},find:function(t){if(this.property==t)return this;if(t in this.properties)return this.properties[t].find(t);for(var e in this.properties){var i=this.properties[e].find(t);if(void 0!==i)return i}},propagate:function(e){var i=arguments;t.each(this.properties,function(t,e){e.call.apply(e,i)})},save:function(){this.unsavedChanges=!1},done:function(){t.unbind(this.element,".mavo:edit")},propagated:["save","done","import","clear"],render:function(e){var i=this;e&&(Mavo.hooks.run("group-render-start",this),e=Array.isArray(e)?e[0]:e,this.unhandled=t.extend({},e,function(t){return!(t in i.properties)}),this.propagate(function(t){t.render(e[t.property])}),this.save(),Mavo.hooks.run("group-render-end",this));
},contains:function(t){return t instanceof Mavo.Unit?t.parentGroup===this:t.parentNode&&this.element===t.parentNode.closest(Mavo.selectors.group)},"static":{all:new WeakMap,DEFAULT_TYPE:"Item",normalize:function(t){if(Mavo.is("group",t)){var e=t.getAttribute("typeof")||t.getAttribute("itemtype")||i.DEFAULT_TYPE;return t.setAttribute("typeof",e),e}return null}}})}(Bliss,Bliss.$);
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){var i=Mavo.Primitive=t.Class({"extends":Mavo.Unit,constructor:function(n,a,s){var o=this;if(this.fromTemplate("attribute","datatype","humanReadable","templateValue")||(this.attribute=i.getValueAttribute(this.element),this.attribute&&(this.humanReadable=this.attribute.humanReadable),this.datatype=i.getDatatype(this.element,this.attribute)),this.view="read",this.computed=!1,Mavo.hooks.run("primitive-init-start",this),Mavo.is("formControl",this.element)?(this.editor=this.element,this.editorType="exposed",this.edit()):this.needsEdit&&(this.mavo.needsEdit=!0),this.editor||this.attribute||(this.editor=e(this.element.children).filter(function(t){return t.matches(Mavo.selectors.formControl)&&!t.matches(Mavo.selectors.property)})[0],this.editor&&(this.editorType="nested",this.element.textContent=this.editorValue,
t.remove(this.editor))),!this.editor&&this.element.hasAttribute("data-edit")){this.editorType="linked";var r=t(this.element.getAttribute("data-edit"));r&&Mavo.is("formControl",r)&&(this.editor=r.cloneNode(!0),this.template||Mavo.observe(r,"all",function(t){var e=!0,i=!1,n=void 0;try{for(var a,s=o.copies[Symbol.iterator]();!(e=(a=s.next()).done);e=!0){var u=a.value;u.editor=r.cloneNode(!0),u.setValue(u.value,{force:!0,silent:!0})}}catch(h){i=!0,n=h}finally{try{!e&&s["return"]&&s["return"]()}finally{if(i)throw n}}}))}if(this.templateValue=this.getValue(),this["default"]=this.element.getAttribute("data-default"),this.computed||this.constant||""===this["default"]?this["default"]=this.templateValue:null===this["default"]?this["default"]=this.editor?this.editorValue:this.emptyValue:Mavo.observe(this.element,"data-default",function(t){o["default"]=o.element.getAttribute("data-default")}),this.collection){var u=function(e){o.unobserve();var i=t.remove(t(".mv-item-controls",o.element)),n=e();return t.inside(i,o.element),
o.observe(),n};["textContent","innerHTML"].forEach(function(t){var e=Object.getOwnPropertyDescriptor(Node.prototype,t);Object.defineProperty(o.element,t,{get:function(){var t=this;return u(function(){return e.get.call(t)})},set:function(t){var i=this;u(function(){return e.set.call(i,t)})}})})}this.needsEdit&&this.setValue(this.templateValue,{silent:!0}),this.setValue(this.template?this["default"]:this.templateValue,{silent:!0}),this.observe()},get editing(){return"edit"==this.view},get editorValue(){if(this.getEditorValue){var e=this.getEditorValue();if(void 0!==e)return e}if(this.editor){if(this.editor.matches(Mavo.selectors.formControl))return i.getValue(this.editor,void 0,this.datatype);var n=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);if(n)return i.all.has(n)?i.all.get(n).value:i.getValue(n)}},set editorValue(e){if((!this.setEditorValue||void 0===this.setEditorValue(e))&&this.editor)if(this.editor.matches(Mavo.selectors.formControl))i.setValue(this.editor,e);else{
var n=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);n&&(i.all.has(n)?i.all.get(n).value=e:i.setValue(n,e))}},get exposed(){return this.editor===this.element},get constant(){return this.element.classList.contains("mv-constant")},get needsEdit(){return!(this.exposed||this.constant||this.computed)},getData:function(t){t=t||{};var e=this["super"].getData.call(this,t);if(void 0!==e)return e;var e=t.dirty||this.exposed?this.value:this.savedValue;return t.dirty||""!==e?e:null},save:function(){this.savedValue=this.value,this.unsavedChanges=!1},done:function(){this.unobserve(),this.popup?this.popup.close():this.attribute||this.exposed||!this.editing||(t.remove(this.editor),this.element.textContent=this.editorValue),this.exposed||(this.view="read"),null!==this.element._.data.prevTabindex?this.element.tabIndex=this.element._.data.prevTabindex:this.element.removeAttribute("tabindex"),this.observe()},revert:function(){this.unsavedChanges&&void 0!==this.savedValue&&(this.value=this.savedValue,
this.unsavedChanges=!1)},preEdit:function(){var t=this;if(!this.computed&&!this.constant){if(this.empty&&!this.attribute)return void this.edit();if("preEdit"!=this.view){this.view="preEdit";var e;this.element._.events({"click.mavo:preedit":function(e){return t.edit()},"focus.mavo:preedit":function(e){t.edit(),t.popup||t.editor.focus()},"click.mavo:edit":function(e){t.exposed||e.preventDefault()}}),this.attribute||this.element._.events({"mouseenter.mavo:preedit":function(i){clearTimeout(e),e=setTimeout(function(){return t.edit()},150)},"mouseleave.mavo:preedit":function(t){clearTimeout(e)}}),this.element._.data.prevTabindex=this.element.getAttribute("tabindex"),this.element.tabIndex=0}}},initEdit:function(){var n=this;if(!this.editor){var a=i.getMatch(this.element,i.editors);a.create&&t.extend(this,a,function(t){return"create"!=t});var s=a.create||a;this.editor=t.create("function"===t.type(s)?s.call(this):s),this.editorValue=this.value,this.editorType="created"}if(this.editor._.events({"input change":function(t){
var e=n.mavo.unsavedChanges;n.value=n.editorValue,n.exposed&&!n.mavo.editing&&n.mavo.permissions.save&&(n.unsavedChanges=!1,n.mavo.unsavedChanges=e,"change"==t.type&&(n.save(),n.mavo.store(),n.mavo.setUnsavedChanges()))},focus:function(t){n.editor.select&&n.editor.select()},"mavo:datachange":function(e){"output"===e.property&&(e.stopPropagation(),t.fire(n.editor,"input"))}}),"placeholder"in this.editor&&(this.editor.placeholder="("+this.label+")"),!this.exposed){var o=/^data-input-/i;e(this.element.attributes).forEach(function(t){o.test(t.name)&&this.editor.setAttribute(t.name.replace(o,""),t.value)},this),this.attribute&&(this.popup=new i.Popup(this))}this.popup||this.editor.classList.add("mv-editor"),this.initEdit=null},edit:function(){this.computed||this.constant||this.editing||(this.element._.unbind(".mavo:preedit"),this.initEdit&&this.initEdit(),this.popup&&this.popup.show(),this.attribute||this.editor.parentNode==this.element||this.exposed||(this.editorValue=this.value,this.element.textContent="",
this.exposed||this.element.appendChild(this.editor)),this.view="edit")},clear:function(){this.value=this.emptyValue},render:function(t){Array.isArray(t)&&(t=t[0]),"object"===("undefined"==typeof t?"undefined":_typeof(t))&&(t=t[this.property]),void 0===t?this.value=this.closestCollection?this["default"]:this.templateValue:this.value=t,this.save()},find:function(t){if(this.property==t)return this},observe:function(){var t=this;this.computed||this.constant||(this.observer=Mavo.observe(this.element,this.attribute,this.observer||function(e){!t.attribute&&t.mavo.editing||(t.value=t.getValue())}))},unobserve:function(){this.observer&&this.observer.disconnect()},getValue:function(t){return i.getValue(this.element,this.attribute,this.datatype,t)},lazy:{label:function(){return Mavo.readable(this.property)},emptyValue:function(){switch(this.datatype){case"boolean":return!1;case"number":return 0}return""}},setValue:function(e){var n=this,a=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];if(this.unobserve(),
"object"==t.type(e)&&"value"in e){var s=e.presentational;e=e.value}return e=e||0===e?e:"",e=i.safeCast(e,this.datatype),e!=this._value||a.force?(this.editor&&document.activeElement!=this.editor&&(this.editorValue=e),this.humanReadable&&this.attribute&&(s=this.humanReadable(e)),this.editing&&!this.attribute||(this.editor&&this.editor.matches("select")&&!this.exposed&&this.editor.selectedOptions[0]&&(s=this.editor.selectedOptions[0].textContent),i.setValue(this.element,{value:e,presentational:s},this.attribute,this.datatype)),this.empty=""===e,this._value=e,a.silent||(this.computed||(this.unsavedChanges=this.mavo.unsavedChanges=!0),requestAnimationFrame(function(){t.fire(n.element,"mavo:datachange",{property:n.property,value:e,mavo:n.mavo,node:n,dirty:n.editing,action:"propertychange"})})),"preEdit"==this.view&&this.preEdit(),this.observe(),e):e},live:{value:function(t){return this.setValue(t)},empty:function(e){var i=e&&!this.exposed&&!(this.attribute&&t(Mavo.selectors.property,this.element));
this.element.classList.toggle("empty",i)},view:function(t){this.element.classList.toggle("editing","edit"==t)},computed:function(t){this.element.classList.toggle("computed",t)}},"static":{all:new WeakMap,getMatch:function(t,e){var i=null;for(var n in e)t.matches(n)&&(i=e[n]);return i},getValueAttribute:function(e){var n=e.getAttribute("data-attribute")||i.getMatch(e,i.attributes);return n&&n.value&&(n=t.extend(new String(n.value),n)),n&&"null"!==n||(n=null),n},getDatatype:function(t,e){var n=t.getAttribute("datatype");if(!n)for(var a in i.datatypes)t.matches(a)&&(n=i.datatypes[a][e]);return n=n||"string"},safeCast:function(t,e){var n=("undefined"==typeof t?"undefined":_typeof(t),i.cast(t,e));return null===t||void 0===t?t:"boolean"==e?"false"!==t&&0!==t&&""!==t&&("true"===t||t>0||t):"number"==e?/^[-+]?[0-9.e]+$/i.test(t+"")?n:t:n},cast:function(t,e){switch(e){case"number":return+t;case"boolean":return!!t;case"string":return t+""}return t},getValue:function(t,e,n){arguments.length<=3||void 0===arguments[3]?{}:arguments[3];
e=e||null===e?e:i.getValueAttribute(t),n=n||i.getDatatype(t,e);var a;return a=e in t&&i.useProperty(t,e)?t[e]:e?t.getAttribute(e):t.getAttribute("content")||t.textContent||null,i.safeCast(a,n)},setValue:function(e,n,a,s){if("object"==t.type(n)&&"value"in n){var o=n.presentational;n=n.value}if(null!==a&&(a=a||i.getValueAttribute(e)),a in e&&i.useProperty(e,a)&&e[a]!=n)try{e[a]=n}catch(r){}a?e.getAttribute(a)!=n&&(e.setAttribute(a,n),o&&(e.textContent=o)):("number"!==s||o||(o=i.formatNumber(n)),e.textContent=o||n,o&&e.setAttribute&&e.setAttribute("content",n))},useProperty:function(t,e){return!(["href","src"].indexOf(e)>-1)&&"http://www.w3.org/2000/svg"!=t.namespaceURI},register:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];e.attribute&&(Mavo.Primitive.attributes[t]=e.attribute),e.datatype&&(Mavo.Primitive.datatypes[t]=e.datatype),e.editor&&(Mavo.Primitive.editors[t]=e.editor),e.init&&Mavo.hooks.add("primitive-init-start",function(){this.element.matches(t)&&e.init.call(this,this.element);
});var i=!0,n=!1,a=void 0;try{for(var s,o=Mavo.toArray(e.is)[Symbol.iterator]();!(i=(s=o.next()).done);i=!0){var r=s.value;Mavo.selectors[r]+=", "+t}}catch(u){n=!0,a=u}finally{try{!i&&o["return"]&&o["return"]()}finally{if(n)throw a}}},lazy:{formatNumber:function(){var t=new Intl.NumberFormat("en-US",{maximumFractionDigits:2});return function(e){return e===1/0||e===-(1/0)?e<0?"-∞":"∞":t.format(e)}}}}});i.attributes={"img, video, audio":"src","a, link":"href","select, input, textarea, meter, progress":"value","input[type=checkbox]":"checked",time:{value:"datetime",humanReadable:function(t){var e=new Date(t);if(!t||isNaN(e))return"(No "+this.label+")";var i={date:{day:"numeric",month:"short",year:"numeric"},month:{month:"long"},time:{hour:"numeric",minute:"numeric"},"datetime-local":{day:"numeric",month:"short",year:"numeric",hour:"numeric",minute:"numeric"}},n=i[this.editor&&this.editor.type]||i.date;return n.timeZone="UTC",e.toLocaleString("en-GB",n)}},meta:"content"},i.datatypes={"input[type=checkbox]":{
checked:"boolean"},"input[type=range], input[type=number], meter, progress":{value:"number"}},i.editors={"*":{tag:"input"},".number":{tag:"input",type:"number"},".boolean":{tag:"input",type:"checkbox"},"a, img, video, audio, .url":{tag:"input",type:"url",placeholder:"http://"},"p, div, li, dt, dd, h1, h2, h3, h4, h5, h6, article, section, address, .multiline":{create:function(){var e=getComputedStyle(this.element).display,i=0===e.indexOf("inline")?"input":"textarea",n=t.create(i);if("textarea"==i){var a=this.element.offsetWidth;a&&(n.width=a)}return n},setEditorValue:function(t){if("string"==this.datatype){var e=getComputedStyle(this.element);return t=t||"",["normal","nowrap"].indexOf(e.whiteSpace)>-1&&(t=t.replace(/\r?\n/g," ")),["normal","nowrap","pre-line"].indexOf(e.whiteSpace)>-1&&(t=t.replace(/^[ \t]+|[ \t]+$/gm,"").replace(/[ \t]+/g," ")),this.editor.value=t,!0}}},"meter, progress":function(){return t.create({tag:"input",type:"range",min:this.element.getAttribute("min")||0,max:this.element.getAttribute("max")||100
})},"time, .date":function(){var e={date:/^[Y\d]{4}-[M\d]{2}-[D\d]{2}$/i,month:/^[Y\d]{4}-[M\d]{2}$/i,time:/^[H\d]{2}:[M\d]{2}/i,week:/[Y\d]{4}-W[W\d]{2}$/i,"datetime-local":/^[Y\d]{4}-[M\d]{2}-[D\d]{2} [H\d]{2}:[M\d]{2}/i},i=this.element.getAttribute("datetime")||"YYYY-MM-DD";for(var n in e)if(e[n].test(i))break;return t.create("input",{type:n})}},i.Popup=t.Class({constructor:function(e){var i=this;this.primitive=e,this.popup=t.create("div",{className:"mv-popup",hidden:!0,contents:[this.primitive.label+":",this.editor],events:{keyup:function(t){13!=t.keyCode&&27!=t.keyCode||(i.popup.contains(document.activeElement)&&i.element.focus(),t.stopPropagation(),i.hide())}}}),this.editor.matches("select")&&(this.editor.size=Math.min(10,this.editor.children.length))},show:function(){var e=this;t.unbind([this.element,this.popup],".mavo:showpopup"),this.shown=!0,this.hideCallback=function(t){e.popup.contains(t.target)||e.element.contains(t.target)||e.hide()},this.position=function(i){var n=e.element.getBoundingClientRect(),a=n.left,s=n.bottom;
t.style(e.popup,{top:s+"px",left:a+"px"})},this.position(),document.body.appendChild(this.popup),requestAnimationFrame(function(t){return e.popup.removeAttribute("hidden")}),t.events(document,"focus click",this.hideCallback,!0),window.addEventListener("scroll",this.position)},hide:function(){var e=this;t.unbind(document,"focus click",this.hideCallback,!0),window.removeEventListener("scroll",this.position),this.popup.setAttribute("hidden",""),this.shown=!1,setTimeout(function(){t.remove(e.popup)},1e3*parseFloat(getComputedStyle(this.popup).transitionDuration)||400),t.events(this.element,{"click.mavo:showpopup":function(t){e.show()},"keyup.mavo:showpopup":function(t){[13,113].indexOf(t.keyCode)>-1&&(e.show(),e.editor.focus())}})},close:function(){this.hide(),t.unbind(this.element,".mavo:edit .mavo:preedit .mavo:showpopup")},proxy:{editor:"primitive",element:"primitive"}})}(Bliss,Bliss.$),Mavo.Primitive.register("button, .counter",{attribute:"data-clicked",datatype:"number",is:"formControl",
init:function(t){"data-clicked"===this.attribute&&(t.setAttribute("data-clicked","0"),t.addEventListener("click",function(e){var i=+t.getAttribute("data-clicked")||0;t.setAttribute("data-clicked",i+1)}))}});
