...
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}!function(e,t){Mavo.attributes.push("mv-multiple","mv-order","mv-accepts");var n=Mavo.Collection=e.Class({"extends":Mavo.Node,nodeType:"Collection",constructor:function(e,n,i){if(this.templateElement=this.element,this.children=[],this.fromTemplate("properties","mutable","templateElement","accepts")||(this.properties=t(Mavo.selectors.property,this.templateElement).map(Mavo.Node.getProperty),this.mutable=this.templateElement.matches(Mavo.selectors.multiple),this.accepts=(this.templateElement.getAttribute("mv-accepts")||"").split(/\s+/),this.templateElement=this.templateElement.cloneNode(!0)),this.mutable){var a=this.createItem(this.element);this.add(a),this.itemTemplate=a.template||a}Mavo.hooks.run("collection-init-end",this)},get length(){return this.children.length},getData:function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],t={
context:this,options:e,data:[]},n=!0,i=!1,a=void 0;try{for(var o,r=this.children[Symbol.iterator]();!(n=(o=r.next()).done);n=!0)if(item=o.value,!item.deleted){var l=item.getData(t.options);l&&t.data.push(l)}}catch(s){i=!0,a=s}finally{try{!n&&r["return"]&&r["return"]()}finally{if(i)throw a}}return this.unhandled&&t.options.unhandled&&(t.data=this.unhandled.before.concat(t.data,this.unhandled.after)),this.mutable||1!=t.data.length||(t.data=t.data[0]),Mavo.hooks.run("node-getdata-end",t),t.data},createItem:function(e){e||(e=this.templateElement.cloneNode(!0));var t=Mavo.Node.create(e,this.mavo,{collection:this,template:this.itemTemplate||(this.template?this.template.itemTemplate:null),property:this.property,type:this.type});return t},add:function(e,t){var n=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];if(e=e instanceof Node?Mavo.Node.get(e)||this.createItem(e):e||this.createItem(),e.collection!=this&&this.adopt(e),void 0===t&&(t=this.bottomUp?0:this.length),this.mutable){var i=this.children[t];
e.element._.before(i&&i.element||this.marker)}var a=this.splice({remove:e},{index:t,add:e});return a.forEach(function(e){n.silent||(e.dataChanged("move"),e.unsavedChanges=!0)}),n.silent||(this.unsavedChanges=this.mavo.unsavedChanges=!0),e},splice:function(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];var i=!0,a=!1,o=void 0;try{for(var r,l=t[Symbol.iterator]();!(i=(r=l.next()).done);i=!0){var s=r.value;void 0===s.index&&s.remove&&isNaN(s.remove)&&(s.index=this.children.indexOf(s.remove),s.remove=1)}}catch(d){a=!0,o=d}finally{try{!i&&l["return"]&&l["return"]()}finally{if(a)throw o}}t.sort(function(e,t){return t.index-e.index});var c=!0,h=!1,m=void 0;try{for(var u,v=t[Symbol.iterator]();!(c=(u=v.next()).done);c=!0){var p=u.value;if(p.index>-1&&(p.remove||p.add)){var f;p.remove=p.remove||0,p.add=Mavo.toArray(p.add),(f=this.children).splice.apply(f,[p.index,+p.remove].concat(_toConsumableArray(p.add)))}}}catch(d){h=!0,m=d}finally{try{!c&&v["return"]&&v["return"]()}finally{
if(h)throw m}}for(var g=[],y=0;y<this.length;y++){var C=this.children[y];C&&C.index!==y&&(C.index=y,g.push(C))}return g},adopt:function(e){var t=this;e.collection&&(e.collection.splice({remove:e}),e.collection.dataChanged("delete")),this.walk(function(n){n.closestCollection===e.collection&&(n.closestCollection=t),e.mavo!=t.mavo&&(e.mavo=t.mavo)}),e.collection=this,e.template&&(Mavo["delete"](e.template.copies,e),e.template=this.itemTemplate)},"delete":function(t,n){var i=this;return n?(e.remove(t.element),void this.splice({remove:t})):e.transition(t.element,{opacity:0}).then(function(){t.deleted=!0,t.element.style.opacity="",t.dataChanged("delete"),i.unsavedChanges=t.unsavedChanges=i.mavo.unsavedChanges=!0})},edit:function(){var t=this;if(this["super"].edit.call(this),this.mutable){if(!this.addButton.parentNode)if(this.bottomUp)this.addButton._.before(e.value(this.children[0],"element")||this.marker);else{var i=this.element.tagName.toLowerCase(),a=Mavo.selectors.container[i];if(a)var o=this.marker.parentNode.closest(a);
this.addButton._.after(o&&o.parentNode?o:this.marker)}n.dragula.then(function(){t.getDragula()})}},done:function(){this["super"].done.call(this),this.mutable&&this.addButton.parentNode&&this.addButton.remove()},clear:function(){this.mutable&&(this.propagate(function(e){if(e.element.remove)e.element.remove();else{var t=!0,n=!1,i=void 0;try{for(var a,o=e.element.childNodes[Symbol.iterator]();!(t=(a=o.next()).done);t=!0){a.value}}catch(r){n=!0,i=r}finally{try{!t&&o["return"]&&o["return"]()}finally{if(n)throw i}}}}),this.children=[],this.dataChanged("clear"))},dataChanged:function(e){var t=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return t.element=t.element||this.marker,this["super"].dataChanged.call(this,e,t)},save:function(){var e=!0,t=!1,n=void 0;try{for(var i,a=this.children[Symbol.iterator]();!(e=(i=a.next()).done);e=!0){var o=i.value;o.deleted?this["delete"](o,!0):o.unsavedChanges=!1}}catch(r){t=!0,n=r}finally{try{!e&&a["return"]&&a["return"]()}finally{if(t)throw n}}},
propagated:["save"],revert:function(){var e=!0,t=!1,n=void 0;try{for(var i,a=this.children[Symbol.iterator]();!(e=(i=a.next()).done);e=!0){var o=i.value;o.unsavedChanges?this["delete"](o,!0):(o.deleted&&(o.deleted=!1),o.revert())}}catch(r){t=!0,n=r}finally{try{!e&&a["return"]&&a["return"]()}finally{if(t)throw n}}},render:function(e){var t=this;if(this.unhandled={before:[],after:[]},e){if(e=Mavo.toArray(e),this.mutable){this.clear();var n=document.createDocumentFragment();e.forEach(function(e,i){var a=t.createItem();a.render(e),t.children.push(a),a.index=i,n.appendChild(a.element)}),this.marker.parentNode.insertBefore(n,this.marker)}else this.children.forEach(function(t,n){return t.render(e&&e[n])}),e&&(this.unhandled.after=e.slice(this.length));this.save()}},find:function(e){var t=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],n=this.children.filter(function(e){return!e.deleted});if(this.property==e)return t.collections?this:n;if(this.properties.indexOf(e)>-1){var i=n.map(function(n){
return n.find(e,t)});return Mavo.flatten(i)}},isCompatible:function(e){return e&&this.itemTemplate.nodeType==e.itemTemplate.nodeType&&(e===this||e.template==this||this.template==e||this.template&&this.template==e.template||this.accepts.indexOf(e.property)>-1)},live:{mutable:function(t){t&&t!==this.mutable&&(this._mutable=t,this.mavo.needsEdit=!0,this.marker=document.createComment("mv-marker"),Mavo.data(this.marker,"collection",this),e.after(this.marker,this.templateElement),this.templateElement.classList.add("mv-item"))}},getDragula:function(){var e=this;if(this.dragula)return this.dragula;if(this.template)return Mavo.pushUnique(this.template.getDragula().containers,this.marker.parentNode),this.dragula=this.template.dragula||this.template.getDragula();return this.dragula=dragula({containers:[this.marker.parentNode],isContainer:function(t){return!!e.accepts.length&&Mavo.flatten(e.accepts.map(function(t){return e.mavo.root.find(t,{collections:!0})})).filter(function(e){return e&&e instanceof n;
}).map(function(e){return e.marker.parentNode}).indexOf(t)>-1},moves:function(e,t,n){return n.classList.contains("mv-drag-handle")&&n.closest(Mavo.selectors.item)==e},accepts:function(e,t,i,a){if(e.contains(t))return!1;var o=a?a.previousElementSibling:t.lastElementChild,r=n.get(o)||n.get(a);if(!r)return!1;var l=Mavo.Node.get(e);return l&&l.collection.isCompatible(r)}}),this.dragula.on("drop",function(t,i,a){var o=Mavo.Node.get(t),r=(o&&o.index,t.nextElementSibling),l=t.previousElementSibling,s=n.get(l)||n.get(r),d=Mavo.Node.get(l)||Mavo.Node.get(r);if(d&&d.collection!=s&&(d=null),!o.collection.isCompatible(s))return e.dragula.cancel(!0);var c=d?d.index+(d.element===l):s.length;s.add(o,c)}),n.dragulas.push(this.dragula),this.dragula},lazy:{bottomUp:function(){if(!this.mutable)return!1;var e=this.templateElement.getAttribute("mv-order");return null!==e?/^desc\b/i.test(e):!!this.addButton.parentNode&&!!(this.addButton.compareDocumentPosition(this.templateElement)&Node.DOCUMENT_POSITION_FOLLOWING);
},closestCollection:function(){var e=this.marker?this.marker.parentNode:this.templateElement.parentNode;return e.closest(Mavo.selectors.item)},addButton:function(){var n=this,i="button.mv-add-"+this.property,a=this.closestCollection||this.marker.parentNode.closest(Mavo.selectors.group);if(a)var o=t(i,a).filter(function(e){return!n.templateElement.contains(e)})[0];return o||(o=e.create("button",{className:"mv-add",textContent:"Add "+this.name})),o.classList.add("mv-ui","mv-add"),Mavo.data(o,"collection",this),this.property&&o.classList.add("mv-add-"+this.property),o.addEventListener("click",function(e){e.preventDefault(),n.add().edit()}),o}},"static":{dragulas:[],get:function(e){var t=Mavo.data(e,"collection");if(t)return t;var n=Mavo.Node.get(e);return n&&n.collection||null},lazy:{dragula:function(){return e.include(self.dragula,"https://cdnjs.cloudflare.com/ajax/libs/dragula/3.7.2/dragula.min.js")}}}});Mavo.hooks.add("primitive-init-end",function(){var t=this;if(this.collection&&!this.attribute){
var n=function(n){var i;return t.sneak(function(){var a=e.remove(e(".mv-item-controls",t.element));i=n(),e.inside(a,t.element)}),i};["textContent","innerHTML"].forEach(function(e){var i=Object.getOwnPropertyDescriptor(Node.prototype,e);Object.defineProperty(t.element,e,{get:function(){var e=this;return n(function(){return i.get.call(e)})},set:function(e){var t=this;n(function(){return i.set.call(t,e)})}})})}}),Mavo.hooks.add("node-edit-end",function(){var n=this;this.collection&&(this.itemControls||(this.itemControls=t(".mv-item-controls",this.element).filter(function(e){return e.closest(Mavo.selectors.item)==n.element})[0],this.itemControls=this.itemControls||e.create({className:"mv-item-controls mv-ui"}),e.set(this.itemControls,{contents:[{tag:"button",title:"Delete this "+this.name,className:"mv-delete",events:{click:function(e){return n.collection["delete"](n)}}},{tag:"button",title:"Add new "+this.name.replace(/s$/i,"")+" "+(this.bottomUp?"after":"before"),className:"mv-add",events:{
click:function(e){var t=n.collection.add(null,n.collection.children.indexOf(n));return e[Mavo.superKey]&&t.render(n.data),t.edit()}}},{tag:"button",title:"Drag to reorder "+this.name,className:"mv-drag-handle"}]})),this.itemControls.parentNode||this.element.appendChild(this.itemControls))}),Mavo.hooks.add("node-done-end",function(){this.collection&&this.itemControls&&this.itemControls.remove()}),Mavo.Node.prototype.getClosestCollection=function(){return this.collection||this.group.collection||(this.parentGroup?this.parentGroup.closestCollection:null)},e.lazy(Mavo.Node.prototype,"closestCollection",function(){return this.getClosestCollection()}),e.live(Mavo.Node.prototype,"deleted",function(n){var i=this;this.element.classList.toggle("mv-deleted",n),n?(this.elementContents=document.createDocumentFragment(),t(this.element.childNodes).forEach(function(e){i.elementContents.appendChild(e)}),e.contents(this.element,[{tag:"button",className:"mv-close mv-ui",textContent:"×",events:{click:function(t){
e.remove(this.parentNode)}}},"Deleted "+this.name,{tag:"button",className:"mv-undo mv-ui",textContent:"Undo",events:{click:function(e){return i.deleted=!1}}}]),this.element.classList.remove("mv-delete-hover")):this.deleted&&(this.element.textContent="",this.element.appendChild(this.elementContents),this._deleted=!1,this.dataChanged("undelete"))}),Mavo.Node.prototype.isDeleted=function(){this.deleted;return!!this.deleted||!!this.parentGroup&&this.parentGroup.isDeleted()},Mavo.hooks.add("node-init-end",function(e){this.collection=e.options.collection,this.collection&&(this.group=this.parentGroup=this.collection.parentGroup)})}(Bliss,Bliss.$);
