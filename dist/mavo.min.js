...
void console.log(t.stack))}).then(function(t){return Promise.resolve(t.response)})},put:function(){var t=this,n=arguments.length<=0||void 0===arguments[0]?this.getFile():arguments[0],o="repos/"+this.username+"/"+this.repo+"/contents/"+n.path;return Promise.resolve(this.repoInfo||this.req("user/repos",{name:this.repo},"POST")).then(function(e){return t.repoInfo=e,t.req(o,{ref:t.branch})}).then(function(s){return t.req(o,{message:"Updated "+(n.name||"file"),content:e.btoa(n.dataString),branch:t.branch,sha:s.sha},"PUT")},function(s){if(404==s.status)return t.req(o,{message:"Created file",content:e.btoa(n.dataString),branch:t.branch},"PUT")}).then(function(t){return console.log("success"),n})},login:function(t){var e=this;return this.ready.then(function(){return e.authenticated?Promise.resolve():new Promise(function(n,o){if(t)e.accessToken=localStorage["mavo:githubtoken"],e.accessToken&&n(e.accessToken);else{var s={width:Math.min(1e3,innerWidth-100),height:Math.min(800,innerHeight-100)};s.top=(innerHeight-s.height)/2+(screen.top||screenTop),
