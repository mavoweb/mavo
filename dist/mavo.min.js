...
var l=s.value;if(l&&l.matches&&l.matches(n.selectors[t]))return!0}}catch(f){o=!0,u=f}finally{try{!a&&c["return"]&&c["return"]()}finally{if(o)throw u}}return!1},data:function(e,r,n){return void 0===n?t.value(e,"_","data","mavo",r):(e._.data.mavo=e._.mavo||{},void(e._.data.mavo[r]=n))},inViewport:function(t){var e=t.getBoundingClientRect();return(0<=e.bottom&&e.bottom<=innerHeight||0<=e.top&&e.top<=innerHeight)&&(0<=e.right&&e.right<=innerWidth||0<=e.left&&e.left<=innerWidth)},pushUnique:function(t,e){t.indexOf(e)===-1&&t.push(e)},getAttribute:function(t){for(var e=arguments.length,r=Array(e>1?e-1:0),n=1;n<e;n++)r[n-1]=arguments[n];for(var i,a=0;i=r[a];a++){var o=t.getAttribute(i);if(o)return o}return null},urlParam:function(){for(var t=("searchParams"in URL.prototype?new URL(location).searchParams:null),e=null,r=arguments.length,n=Array(r),i=0;i<r;i++)n[i]=arguments[i];var a=!0,o=!1,u=void 0;try{for(var s,c=n[Symbol.iterator]();!(a=(s=c.next()).done);a=!0){var l=s.value;if(t)e=t.get(l);else{
var f=location.search.match(RegExp("[?&]"+l+"(?:=([^&]+))?(?=&|$)","i"));e=f&&(f[1]||"")}if(null!==e)return e}}catch(h){o=!0,u=h}finally{try{!a&&c["return"]&&c["return"]()}finally{if(o)throw u}}return null},debounce:function(t,e){var r=null;return function(){var n=this,i=arguments;clearTimeout(r),r=setTimeout(function(){t.apply(n,i)},e)}},escapeRegExp:function(t){return t.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")},Observer:t.Class({constructor:function(e,r,n,i){n instanceof MutationObserver&&(this.observer=n),this.observer=this.observer||new MutationObserver(n),this.element=e,this.callback=n,this.attribute=r,this.oldValue=i,this.options={},r&&t.extend(this.options,{attributes:!0,attributeFilter:"all"==this.attribute?void 0:[this.attribute],attributeOldValue:!!this.oldValue}),this.attribute&&"all"!=this.attribute||t.extend(this.options,{characterData:!0,childList:!0,subtree:!0,characterDataOldValue:!!this.oldValue}),this.run()},stop:function(){return this.running&&(this.observer.disconnect(),
this.running=!1),this},run:function(){return this.running||(this.observer.observe(this.element,this.options),this.running=!0),this},sneak:function(t){var e=this;if(this.running){this.stop();var r=t();requestAnimationFrame(function(){return e.run()})}else var r=t();return r}}),defer:function(t){var e,r,n=new Promise(function(n,i){t&&t(n,i),e=n,r=i});return n.resolve=function(t){return e(t),n},n.reject=function(t){return r(t),n},n},rr:function(t){return t(),t}});t.add("toggleAttribute",function(t,e){var r=arguments.length<=2||void 0===arguments[2]?null!==e:arguments[2];r?this.setAttribute(t,e):this.removeAttribute(t)}),t.proxy=t.classProps.proxy=t.overload(function(t,e,r){return Object.defineProperty(t,e,{get:function(){return this[r][e]},set:function(t){this[r][e]=t},configurable:!0,enumerable:!0}),t}),t.classProps.propagated=function(t,e){Mavo.toArray(e).forEach(function(e){var r=t[e];t[e]=function(){var t=r&&r.apply(this,arguments);this.propagate&&t!==!1&&this.propagate(e)}})},document.addEventListener("focus",function(t){
r("focus",t.target)},!0),document.addEventListener("blur",function(t){r("focus",null)},!0),addEventListener("hashchange",function(e){r("target",t(location.hash))}),document.documentElement.addEventListener("mavo:datachange",function(e){r("target",t(location.hash))}),r("focus",document.activeElement!==document.body?document.activeElement:null)}(Bliss,Bliss.$);
...
e.element._.before(i&&i.element||this.marker)}var o=this.splice({remove:e},{index:t,add:e});return o.forEach(function(e){n.silent||(e.dataChanged("move"),e.unsavedChanges=!0)}),n.silent||(this.unsavedChanges=this.mavo.unsavedChanges=!0),e},splice:function(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n];var i=!0,o=!1,a=void 0;try{for(var r,l=t[Symbol.iterator]();!(i=(r=l.next()).done);i=!0){var s=r.value;void 0===s.index&&s.remove&&isNaN(s.remove)&&(s.index=this.children.indexOf(s.remove),s.remove=1)}}catch(d){o=!0,a=d}finally{try{!i&&l["return"]&&l["return"]()}finally{if(o)throw a}}t.sort(function(e,t){return t.index-e.index});var c=!0,h=!1,m=void 0;try{for(var u,v=t[Symbol.iterator]();!(c=(u=v.next()).done);c=!0){var p=u.value;if(p.index>-1&&(p.remove||p.add)){var f;p.remove=p.remove||0,p.add=Mavo.toArray(p.add),(f=this.children).splice.apply(f,[p.index,+p.remove].concat(_toConsumableArray(p.add)))}}}catch(d){h=!0,m=d}finally{try{!c&&v["return"]&&v["return"]()}finally{
if(h)throw m}}for(var g=[],y=0;y<this.length;y++){var C=this.children[y];C&&C.index!==y&&(C.index=y,g.push(C))}return g},adopt:function(e){var t=this;e.collection&&(e.collection.splice({remove:e}),e.collection.dataChanged("delete")),this.walk(function(n){n.closestCollection===e.collection&&(n.closestCollection=t),e.mavo!=t.mavo&&(e.mavo=t.mavo)}),e.collection=this,e.template&&(Mavo["delete"](e.template.copies,e),e.template=this.itemTemplate)},"delete":function(t,n){var i=this;return n?(e.remove(t.element),void this.splice({remove:t})):e.transition(t.element,{opacity:0}).then(function(){t.deleted=!0,t.element.style.opacity="",t.dataChanged("delete"),i.unsavedChanges=t.unsavedChanges=i.mavo.unsavedChanges=!0})},edit:function(){var t=this;if(this["super"].edit.call(this),this.mutable){if(!this.addButton.parentNode)if(this.bottomUp)this.addButton._.before(e.value(this.children[0],"element")||this.marker);else{var i=this.element.tagName.toLowerCase(),o=Mavo.selectors.container[i];if(o)var a=this.marker.parentNode.closest(o);
this.addButton._.after(a&&a.parentNode?a:this.marker)}n.dragula.then(function(){t.getDragula()})}},done:function(){this["super"].done.call(this),this.mutable&&this.addButton.parentNode&&this.addButton.remove()},clear:function(){this.mutable&&(this.propagate(function(e){if(e.element.remove)e.element.remove();else{var t=!0,n=!1,i=void 0;try{for(var o,a=e.element.childNodes[Symbol.iterator]();!(t=(o=a.next()).done);t=!0){o.value}}catch(r){n=!0,i=r}finally{try{!t&&a["return"]&&a["return"]()}finally{if(n)throw i}}}}),this.children=[],this.dataChanged("clear"))},dataChanged:function(e){var t=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return t.element=t.element||this.marker,this["super"].dataChanged.call(this,e,t)},save:function(){var e=!0,t=!1,n=void 0;try{for(var i,o=this.children[Symbol.iterator]();!(e=(i=o.next()).done);e=!0){var a=i.value;a.deleted?this["delete"](a,!0):a.unsavedChanges=!1}}catch(r){t=!0,n=r}finally{try{!e&&o["return"]&&o["return"]()}finally{if(t)throw n}}},
propagated:["save"],revert:function(){var e=!0,t=!1,n=void 0;try{for(var i,o=this.children[Symbol.iterator]();!(e=(i=o.next()).done);e=!0){var a=i.value;a.unsavedChanges?this["delete"](a,!0):(a.deleted&&(a.deleted=!1),a.revert())}}catch(r){t=!0,n=r}finally{try{!e&&o["return"]&&o["return"]()}finally{if(t)throw n}}},render:function(e){var t=this;if(this.unhandled={before:[],after:[]},e){if(e=Mavo.toArray(e),this.mutable){this.clear();var n=document.createDocumentFragment();e.forEach(function(e,i){var o=t.createItem();o.render(e),t.children.push(o),o.index=i,n.appendChild(o.element)}),this.marker.parentNode.insertBefore(n,this.marker)}else this.children.forEach(function(t,n){return t.render(e&&e[n])}),e&&(this.unhandled.after=e.slice(this.length));this.save()}},find:function(e){var t=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],n=this.children.filter(function(e){return!e.deleted});if(this.property==e)return t.collections?this:n;if(this.properties.indexOf(e)>-1){var i=n.map(function(n){
