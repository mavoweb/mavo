...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,n=Array(t.length);e<t.length;e++)n[e]=t[e];return n}return Array.from(t)}!function(t,e){var n=self.Mavo=t.Class({constructor:function(i){var s=this;this.treeBuilt=Mavo.defer(),this.element=i;var r=n.attributes.map(function(t){return"[data-"+t+"]"}),o=!0,a=!1,u=void 0;try{for(var l,c=e(r.join(", "),this.element).concat(this.element)[Symbol.iterator]();!(o=(l=c.next()).done);o=!0){var h=l.value,v=!0,m=!1,d=void 0;try{for(var f,g=n.attributes[Symbol.iterator]();!(v=(f=g.next()).done);v=!0){var p=f.value,b=h.getAttribute("data-"+p);null!==b&&h.setAttribute(p,b)}}catch(y){m=!0,d=y}finally{try{!v&&g["return"]&&g["return"]()}finally{if(m)throw d}}}}catch(y){a=!0,u=y}finally{try{!o&&c["return"]&&c["return"]()}finally{if(a)throw u}}this.index=n.all.push(this),this.id=Mavo.getAttribute(this.element,"mv-app","id")||"mavo"+this.index,this.element.setAttribute("mv-app",this.id),this.unhandled=this.element.classList.contains("mv-keep-unhandled"),
...
},{tag:"button",textContent:"Logout",className:"mv-logout",events:{click:function(t){return e.backend.logout()}}}])}}),this.element.addEventListener("mavo:logout.mavo",function(e){t(".mv-status",s.ui.bar).textContent=""})),this.needsEdit=!1,Mavo.hooks.run("init-tree-before",this),this.root=new Mavo.Group(this.element,this),this.treeBuilt.resolve(),Mavo.hooks.run("init-tree-after",this),this.setUnsavedChanges(!1),this.permissions.onchange(function(t){var e=t.action,n=t.value;s.element.classList.toggle("mv-can-"+e,!!n)}),this.permissions.can(["edit","add","delete"],function(){s.ui.edit=t.create("button",{className:"mv-edit",textContent:"Edit",onclick:function(t){return s.editing?s.done():s.edit()},inside:s.ui.bar}),s.autoEdit&&s.element.addEventListener("mavo:load",function(t){return s.ui.edit.click()})},function(){t.remove(s.ui.edit),s.editing&&s.done()}),this.needsEdit&&this.permissions.can("save",function(){s.ui.save=t.create("button",{className:"mv-save",textContent:"Save",events:{click:function(t){
return s.save()},"mouseenter focus":function(t){s.element.classList.add("mv-save-hovered"),s.setUnsavedChanges()},"mouseleave blur":function(t){return s.element.classList.remove("mv-save-hovered")}},inside:s.ui.bar}),s.ui.revert=t.create("button",{className:"mv-revert",textContent:"Revert",disabled:!0,events:{click:function(t){return s.revert()},"mouseenter focus":function(t){s.unsavedChanges||(s.element.classList.add("mv-revert-hovered"),s.setUnsavedChanges())},"mouseleave blur":function(t){return s.element.classList.remove("mv-revert-hovered")}},inside:s.ui.bar})},function(){t.remove([s.ui.save,s.ui.revert]),s.ui.save=s.ui.revert=null}),this.permissions.can("delete",function(){s.ui.clear=t.create("button",{className:"mv-clear",textContent:"Clear",onclick:function(t){return s.clear()}}),s.ui.bar.appendChild(s.ui.clear)}),this.permissions.cannot(["delete","edit"],function(){t.remove(s.ui.clear)}),this.storage||this.source?(this.storage||this.source.permissions.can("read",function(){return s.permissions.read=!0;
}),this.permissions.can("read",function(){return s.load()})):(this.permissions.on(["read","edit"]),t.fire(this.element,"mavo:load")),this.needsEdit||(this.permissions.off(["edit","add","delete"]),this.element.addEventListener("mavo:load",function(t){var e=n.debounce(function(){s.save()},1e3),i=function(t){t.node.saved&&e()};requestAnimationFrame(function(){s.permissions.can("save",function(){s.element.addEventListener("mavo:datachange",i)},function(){s.element.removeEventListener("mavo:datachange",i)})})})),Mavo.hooks.run("init-end",this)},get editing(){return this.root.editing},get data(){return this.getData()},getData:function(t){return this.root.getData(t)},toJSON:function(){var t=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0];return n.toJSON(t)},render:function(t){n.hooks.run("render-start",{context:this,data:t}),t&&(this.editing?(this.done(),this.root.render(t),this.edit()):this.root.render(t)),this.unsavedChanges=!1},clear:function(){confirm("This will delete all your data. Are you sure?")&&(this.store(null),
this.root.clear())},edit:function(){this.root.edit(),t.events(this.element,"mouseenter.mavo:edit mouseleave.mavo:edit",function(t){if(t.target.matches(".mv-item-controls .mv-delete")){var e=t.target.closest(n.selectors.item);e.classList.toggle("mv-delete-hover","mouseenter"==t.type)}if(t.target.matches(n.selectors.item)){t.target.classList.remove("mv-has-hovered-item");var i=t.target.parentNode.closest(n.selectors.item);i&&i.classList.toggle("mv-has-hovered-item","mouseenter"==t.type)}},!0),this.setUnsavedChanges()},setUnsavedChanges:function(t){var e=!!t;return t||this.walk(function(n){if(n.unsavedChanges)return e=!0,t===!1&&(n.unsavedChanges=!1),!1}),this.unsavedChanges=e},done:function(){this.root.done(),t.unbind(this.element,".mavo:edit"),this.unsavedChanges=!1},load:function(){var e=this;this.inProgress="Loading";var n=this.storage||this.source;return n.ready.then(function(){return n.get()})["catch"](function(t){return e.source&&n!==e.source?e.source.ready.then(function(){return e.source.get();
}):Promise.reject(t)}).then(function(n){n&&"string"==t.type(n)&&(n=JSON.parse(n)),e.render(n)})["catch"](function(t){t&&(t.xhr&&404==t.xhr.status?e.render(""):(console.error(t),console.log(t.stack)))}).then(function(){e.inProgress=!1,t.fire(e.element,"mavo:load")})},store:function(){var e=this;this.storage&&(this.inProgress="Saving",this.storage.login().then(function(){return e.storage.put()}).then(function(n){t.fire(e.element,"mavo:save",{data:n.data,dataString:n.dataString}),e.lastSaved=Date.now()})["catch"](function(t){t&&(console.error(t),console.log(t.stack))}).then(function(){e.inProgress=!1}))},save:function(){this.root.save(),this.store(),this.unsavedChanges=!1},revert:function(){this.root.revert()},walk:function(t){this.root.walk(t)},live:{inProgress:function(e){t.toggleAttribute(this.element,"mv-progress",e,e)},unsavedChanges:function(t){this.element.classList.toggle("mv-unsaved-changes",t),this.ui&&this.ui.save&&(this.ui.save.disabled=!t,this.ui.revert.disabled=!t)},needsEdit:function(e){
t.toggleAttribute(this.ui.bar,"hidden","",!e)}},"static":{all:[],superKey:0===navigator.platform.indexOf("Mac")?"metaKey":"ctrlKey",init:function(t){return e(n.selectors.init,t||document).filter(function(t){return!t.parentNode.closest(n.selectors.init)}).map(function(t){return new n(t)})},hooks:new t.Hooks,attributes:["mv-app","mv-storage","mv-init","mv-attribute","mv-default","mv-mode","mv-edit","mv-permisssions"]}});!function(){var e=n.selectors={init:".mv-app, [mv-app], [data-mv-app], [mv-storage], [data-mv-storage]",property:"[property], [itemprop]",specificProperty:function(t){return"[property="+t+"], [itemprop="+t+"]"},group:"[typeof], [itemscope], [itemtype], .mv-group",multiple:"[mv-multiple], .mv-multiple",formControl:"input, select, option, textarea",item:".mv-item",ui:".mv-ui",container:{li:"ul, ol",tr:"table",option:"select",dt:"dl",dd:"dl"}},i=e.arr=function(t){return t.split(/\s*,\s*/g)},s=e.not=function(t){return i(t).map(function(t){return":not("+t+")"}).join("")},r=e.or=function(t,e){
return t+", "+e},o=e.and=function(t,e){var n=[],s=i(e);return i(t).forEach(function(t){return n.push.apply(n,_toConsumableArray(s.map(function(e){return t+e})))}),n.join(", ")},a=e.andNot=function(t,e){return o(t,s(e))};t.extend(n.selectors,{primitive:a(e.property,e.group),rootGroup:a(e.group,e.property),output:r(e.specificProperty("output"),".mv-output, .mv-value")})}(),Promise.all([t.ready(),t.include(Array.from&&window.Intl&&document.documentElement.closest,"https://cdn.polyfill.io/v2/polyfill.min.js?features=blissfuljs,Intl.~locale.en")])["catch"](function(t){return console.error(t)}).then(function(){return Mavo.init()}),Stretchy.selectors.filter=".mv-editor:not([property])"}(Bliss,Bliss.$);
"use strict";!function(t,r){function e(t,e){for(t="mv-"+t+"-within",r("."+t).forEach(function(r){return r.classList.remove(t)});e&&(e=e.parentNode)&&e.classList;)e.classList.add(t)}var n=t.extend(Mavo,{toJSON:function(t){return null===t?"":"string"==typeof t?t:JSON.stringify(t,null,"\t")},readable:function(t){return t&&t.replace(/([a-z])([A-Z])(?=[a-z])/g,function(t,r,e){return r+" "+e.toLowerCase()}).replace(/([a-z])[_\/-](?=[a-z])/g,"$1 ").replace(/^[a-z]/,function(t){return t.toUpperCase()})},queryJSON:function(r,e){return e&&r?t.value.apply(t,[r].concat(e.split("/"))):r},toArray:function(t){return void 0===t?[]:Array.isArray(t)?t:[t]},flatten:function(t){return Array.isArray(t)?t.reduce(function(t,r){return n.toArray(t).concat(n.flatten(r))},[]):[t]},is:function(t,r){return r.matches&&r.matches(n.selectors[t])},getAttribute:function(t){for(var r=arguments.length,e=Array(r>1?r-1:0),n=1;n<r;n++)e[n-1]=arguments[n];for(var i,a=0;i=e[a];a++){var o=t.getAttribute(i);if(o)return o}return null;
},urlParam:function(){for(var t=("searchParams"in URL.prototype?new URL(location).searchParams:null),r=null,e=arguments.length,n=Array(e),i=0;i<e;i++)n[i]=arguments[i];var a=!0,o=!1,u=void 0;try{for(var s,c=n[Symbol.iterator]();!(a=(s=c.next()).done);a=!0){var l=s.value;if(t)r=t.get(l);else{var f=location.search.match(RegExp("[?&]"+l+"(?:=([^&]+))?(?=&|$)","i"));r=f&&(f[1]||"")}if(null!==r)return r}}catch(h){o=!0,u=h}finally{try{!a&&c["return"]&&c["return"]()}finally{if(o)throw u}}return null},debounce:function(t,r){var e=null;return function(){var n=this,i=arguments;clearTimeout(e),e=setTimeout(function(){t.apply(n,i)},r)}},escapeRegExp:function(t){return t.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")},Observer:t.Class({constructor:function(r,e,n,i){n instanceof MutationObserver&&(this.observer=n),this.observer=this.observer||new MutationObserver(n),this.element=r,this.callback=n,this.attribute=e,this.oldValue=i,this.options={},e&&t.extend(this.options,{attributes:!0,attributeFilter:"all"==this.attribute?void 0:[this.attribute],
attributeOldValue:!!this.oldValue}),this.attribute&&"all"!=this.attribute||t.extend(this.options,{characterData:!0,childList:!0,subtree:!0,characterDataOldValue:!!this.oldValue}),this.run()},stop:function(){return this.running&&(this.observer.disconnect(),this.running=!1),this},run:function(){return this.running||(this.observer.observe(this.element,this.options),this.running=!0),this},sneak:function(t){var r=this;if(this.running){this.stop();var e=t();requestAnimationFrame(function(){return r.run()})}else var e=t();return e}}),defer:function(t){var r,e,n=new Promise(function(n,i){t&&t(n,i),r=n,e=i});return n.resolve=function(t){return r(t),n},n.reject=function(t){return e(t),n},n}});t.add("toggleAttribute",function(t,r){var e=arguments.length<=2||void 0===arguments[2]?null!==r:arguments[2];e?this.setAttribute(t,r):this.removeAttribute(t)}),t.proxy=t.classProps.proxy=t.overload(function(t,r,e){return Object.defineProperty(t,r,{get:function(){return this[e][r]},set:function(t){this[e][r]=t;
},configurable:!0,enumerable:!0}),t}),t.classProps.propagated=function(t,r){Mavo.toArray(r).forEach(function(r){var e=t[r];t[r]=function(){var t=e&&e.apply(this,arguments);this.propagate&&t!==!1&&this.propagate(r)}})},document.addEventListener("focus",function(t){e("focus",t.target)},!0),document.addEventListener("blur",function(t){e("focus",null)},!0),addEventListener("hashchange",function(r){e("target",t(location.hash))},!0),e("target",t(location.hash)),e("focus",document.activeElement!==document.body?document.activeElement:null)}(Bliss,Bliss.$);
...
"use strict";!function(t,e){var i=Mavo.Group=t.Class({"extends":Mavo.Node,nodeType:"Group",constructor:function(t,i,n){var r=this;if(this.children={},this.group=this,Mavo.hooks.run("group-init-start",this),Mavo.Primitive.getValueAttribute(this.element)){this.children[this.property]=new Mavo.Primitive(this.element,this.mavo,{group:this})}e(Mavo.selectors.property,this.element).forEach(function(t){var e=Mavo.Node.getProperty(t);if(r.contains(t)){var i=r.children[e],n=r.template?r.template.children[e]:null,o={template:n,group:r};if(i){var a=i;i instanceof Mavo.Collection||(a=new Mavo.Collection(i.element,r.mavo,o),r.children[e]=i.collection=a,a.add(i)),!a.mutable&&Mavo.is("multiple",t)&&(a.mutable=!0),a.add(t)}else{var s=Mavo.Node.create(t,r.mavo,o);r.children[e]=s}}});var o=(this.isRoot?this.element.closest("[vocab]"):null)||this.element;this.vocab=o.getAttribute("vocab"),Mavo.hooks.run("group-init-end",this)},get isRoot(){return!this.property},getData:function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],n={
...
t.render(e[t.property])}),this.save(),Mavo.hooks.run("group-render-end",this))},contains:function(t){return t instanceof Mavo.Node?t.parentGroup===this:t.parentNode&&this.element===t.parentNode.closest(Mavo.selectors.group)},"static":{all:new WeakMap,DEFAULT_TYPE:"Item",normalize:function(t){if(Mavo.is("group",t)){var e=Mavo.getAttribute(t,"typeof","itemtype")||i.DEFAULT_TYPE;return t.setAttribute("typeof",e),e}return null}}})}(Bliss,Bliss.$);
