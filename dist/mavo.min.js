...
return r.clear()}}),r.ui.bar.appendChild(r.ui.clear)}),this.permissions.cannot(["delete","edit"],function(){t.remove(r.ui.clear)}),this.storage||this.source?(this.storage||this.source.permissions.can("read",function(){return r.permissions.read=!0}),this.permissions.can("read",function(){return r.load()})):(this.permissions.on(["read","edit"]),t.fire(this.element,"mavo:load")),this.needsEdit||(this.permissions.off(["edit","add","delete"]),this.element.addEventListener("mavo:load",function(t){var e=n.debounce(function(){r.save()},3e3),i=function(t){t.node.saved&&e()};requestAnimationFrame(function(){r.permissions.can("save",function(){r.element.addEventListener("mavo:datachange",i)},function(){r.element.removeEventListener("mavo:datachange",i)})})})),Mavo.hooks.run("init-end",this)},get editing(){return this.root.editing},get data(){return this.getData()},getData:function(t){return this.root.getData(t)},toJSON:function(){var t=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0];
return n.toJSON(t)},error:function i(e){for(var r,s=function(){return t.transition(i,{opacity:0}).then(t.remove)},i=t.create("p",{className:"mv-error mv-ui",contents:[e,{tag:"button",className:"mv-close mv-ui",textContent:"×",events:{click:s}}],events:{mouseenter:function(t){return clearTimeout(r)},mouseleave:n.rr(function(t){return r=setTimeout(s,5e3)})},start:this.element}),o=arguments.length,a=Array(o>1?o-1:0),u=1;u<o;u++)a[u-1]=arguments[u];if(a.length>0){var c;(c=console).log.apply(c,["%c"+e,"color: red; font-weight: bold"].concat(a))}},render:function(t){n.hooks.run("render-start",{context:this,data:t}),t&&this.root.render(t),this.unsavedChanges=!1,n.hooks.run("render-end",{context:this,data:t})},clear:function(){var t=this;confirm("This will delete all your data. Are you sure?")&&this.store(null).then(function(){return t.root.clear()})},edit:function(){this.root.edit(),t.events(this.element,"mouseenter.mavo:edit mouseleave.mavo:edit",function(t){if(t.target.matches(".mv-item-controls *")){
var e=t.target.closest(n.selectors.item);e.classList.toggle("mv-highlight","mouseenter"==t.type)}if(t.target.matches(n.selectors.item)){t.target.classList.remove("mv-has-hovered-item");var i=t.target.parentNode.closest(n.selectors.item);i&&i.classList.toggle("mv-has-hovered-item","mouseenter"==t.type)}},!0),this.setUnsavedChanges()},setUnsavedChanges:function(t){var e=!!t;return t||this.walk(function(n){if(n.unsavedChanges)return e=!0,t===!1&&(n.unsavedChanges=!1),!1}),this.unsavedChanges=e},done:function(){this.root.done(),t.unbind(this.element,".mavo:edit"),this.unsavedChanges=!1},load:function(){var e=this;this.inProgress="Loading";var n=this.storage||this.source;return n.ready.then(function(){return n.get()})["catch"](function(t){return e.source&&n!==e.source?e.source.ready.then(function(){return e.source.get()}):Promise.reject(t)}).then(function(n){if(n&&"string"==t.type(n))try{n=JSON.parse(n)}catch(i){e.error("The data is corrupted.",i,n),n=""}e.render(n)})["catch"](function(t){t&&(t.xhr&&404==t.xhr.status?e.render(""):e.error("The data could not be loaded.",t));
...
}finally{if(e)throw n}}},propagated:["save"],revert:function(){var t=!0,e=!1,n=void 0;try{for(var i,o=this.children[Symbol.iterator]();!(t=(i=o.next()).done);t=!0){var a=i.value;a.unsavedChanges?this["delete"](a,!0):(a.deleted&&(a.deleted=!1),a.revert())}}catch(r){e=!0,n=r}finally{try{!t&&o["return"]&&o["return"]()}finally{if(e)throw n}}},dataRender:function(t){var e=this;if(this.unhandled={before:[],after:[]},t)if(t=Mavo.toArray(t),this.mutable){this.clear();var n=document.createDocumentFragment();t.forEach(function(t,i){var o=e.createItem();o.render(t),e.children.push(o),o.index=i,n.appendChild(o.element);var a={context:e,item:o};Mavo.hooks.run("collection-add-end",a)}),this.marker.parentNode.insertBefore(n,this.marker)}else this.children.forEach(function(e,n){return e.render(t&&t[n])}),t&&(this.unhandled.after=t.slice(this.length))},find:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],n=this.children.filter(function(t){return!t.deleted});if(this.property==t)return e.collections?this:n;
...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,i=Array(t.length);e<t.length;e++)i[e]=t[e];return i}return Array.from(t)}!function(t){var e=Mavo.Expression.Text=t.Class({constructor:function(){var i=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];this.template=i.template&&i.template.template||i.template;for(var s=["group","path","syntax","fallback","attribute"],n=0;n<s.length;n++){var a=s[n];this[a]=void 0===i[a]&&this.template?this.template[a]:i[a]}if(this.node=i.node,this.node||(this.node=this.path.reduce(function(t,e){return t.childNodes[e]},this.group.element)),this.element=this.node,this.attribute=this.attribute||null,Mavo.hooks.run("expressiontext-init-start",this),!this.expression){if(3===this.node.nodeType&&(this.element=this.node.parentNode,this.node.parentNode.children.length&&!this.attribute||(this.node=this.element,this.element.normalize())),this.attribute)null===this.node.getAttribute(this.attribute)&&console.log(this.node,this.attribute,i),
this.expression=this.node.getAttribute(this.attribute).trim();else{if(this.node.normalize(),this.node.firstChild&&1===this.node.childNodes.length&&3===this.node.firstChild.nodeType){var o=this.node.firstChild.textContent.match(/^\s*|\s*$/g);o[1]&&(this.node.firstChild.splitText(this.node.firstChild.textContent.length-o[1].length),t.after(this.node.lastChild,this.node)),o[0]&&(this.node.firstChild.splitText(o[0].length),this.node.parentNode.insertBefore(this.node.firstChild,this.node))}this.expression=this.node.textContent}this.parsed=i.template?i.template.parsed:this.syntax.tokenize(this.expression)}this.oldValue=this.value=this.parsed.map(function(t){return t instanceof Mavo.Expression?t.expression:t});var r=Mavo.Node.get(this.element);r&&r instanceof Mavo.Primitive&&r.attribute==this.attribute&&(this.primitive=r,r.store=r.store||"none",r.modes="read"),Mavo.hooks.run("expressiontext-init-end",this),e.elements.set(this.element,[].concat(_toConsumableArray(e.elements.get(this.element)||[]),[this]));
},changedBy:function(t){return!this.parsed.every(function(e){return!(e instanceof Mavo.Expression&&e.changedBy(t))})},update:function(){var t=this,e=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0],i=arguments[1];this.data=e;var s={};Mavo.hooks.run("expressiontext-update-start",this),this.oldValue=this.value,s.value=this.value=this.parsed.map(function(s,n){if(s instanceof Mavo.Expression){if(s.changedBy(i)){var a={context:t,expr:s};return Mavo.hooks.run("expressiontext-update-beforeeval",a),a.value=a.expr.eval(e),Mavo.hooks.run("expressiontext-update-aftereval",a),a.value instanceof Error?void 0!==t.fallback?t.fallback:a.expr.expression:void 0===a.value||null===a.value?"":a.value}return t.oldValue[n]}return s}),this.attribute||(s.presentational=this.value.map(function(t){return Array.isArray(t)?t.join(", "):"number"==typeof t?Mavo.Primitive.formatNumber(t):t}),s.presentational=1===s.presentational.length?s.presentational[0]:s.presentational.join("")),s.value=1===s.value.length?s.value[0]:s.value.join(""),
this.primitive&&1===this.parsed.length&&("number"==typeof s.value?this.primitive.datatype="number":"boolean"==typeof s.value&&(this.primitive.datatype="boolean")),s.presentational===s.value&&(s=s.value),this.primitive?this.primitive.value=s:Mavo.Primitive.setValue(this.node,s,{attribute:this.attribute}),Mavo.hooks.run("expressiontext-update-end",this)},"static":{elements:new WeakMap,search:function(t,i){var s=e.elements.get(t)||[];return arguments.length>1?s.length?s.filter(function(t){return t.attribute===i})[0]||null:null:s}}});Mavo.hooks.add("primitive-init-start",function(){this.expressionText=Mavo.Expression.Text.search(this.element,this.attribute),this.expressionText&&(this.expressionText.primitive=this,this.store=this.store||"none",this.modes="read")}),Mavo.hooks.add("collection-add-end",function(t){if(t.item instanceof Mavo.Primitive&&this.itemTemplate){var e=Mavo.Expression.Text.search(this.itemTemplate.element)[0];e&&e.group.expressions.push(new Mavo.Expression.Text({node:t.item.element,
template:e}))}})}(Bliss);
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,n=Array(t.length);e<t.length;e++)n[e]=t[e];return n}return Array.from(t)}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){Mavo.attributes.push("mv-value","mv-if");var n=Mavo.Expressions=t.Class({constructor:function(t){var e=this;this.mavo=t,this.all=[],Mavo.hooks.run("expressions-init-start",this);var s=Mavo.Expression.Syntax.create(this.mavo.element.closest("[mv-expressions]"))||Mavo.Expression.Syntax["default"];this.traverse(this.mavo.element,void 0,s,this.mavo.root),this.active=!0,this.scheduled=new Set,this.mavo.element.addEventListener("mavo:datachange",function(t){"propertychange"==t.action?e.scheduled.has(t.property)||(setTimeout(function(){e.scheduled["delete"](t.property),e.update(t)},n.PROPERTYCHANGE_THROTTLE),e.scheduled.add(t.property)):e.update(t);
})},update:function(e){var n=this,s=this.mavo.root.getData({relative:!0,store:"*","null":!0,unhandled:this.mavo.unhandled});this.mavo.walk(function(i,o){if(i instanceof Mavo.Group&&i.expressions&&i.expressions.length&&!i.isDeleted()){var r={context:n,data:t.value.apply(t,[s].concat(_toConsumableArray(o)))};Mavo.hooks.run("expressions-update-start",r);var a=!0,u=!1,v=void 0;try{for(var d,p=i.expressions[Symbol.iterator]();!(a=(d=p.next()).done);a=!0){var h=d.value;h.changedBy(e)&&h.update(r.data,e)}}catch(l){u=!0,v=l}finally{try{!a&&p["return"]&&p["return"]()}finally{if(u)throw v}}}})},extract:function(t,e,s,i,o){e&&"mv-expressions"==e.name||(e&&n.directives.indexOf(e.name)>-1||i.test(e?e.value:t.textContent))&&(o.expressions=o.expressions||[],o.expressions.push(new Mavo.Expression.Text({node:t,syntax:i,group:o,path:s?s.slice(1).split("/").map(function(t){return+t}):[],attribute:e&&e.name})))},traverse:function(t){var n=arguments.length<=1||void 0===arguments[1]?"":arguments[1],s=this,i=arguments[2],o=arguments[3];
if(8!==t.nodeType)if(3===t.nodeType)this.extract(t,null,n,i,o);else{if(i=Mavo.Expression.Syntax.create(t)||i,i===Mavo.Expression.Syntax.ESCAPE)return;t!=o.element&&Mavo.is("group",t)&&(o=Mavo.Node.get(t),n=""),e(t.attributes).forEach(function(e){return s.extract(t,e,n,i,o)}),e(t.childNodes).forEach(function(t,e){return s.traverse(t,n+"/"+e,i,o)})}},"static":{directives:[],PROPERTYCHANGE_THROTTLE:50}});self.Proxy&&Mavo.hooks.add("node-getdata-end",function(t){var e=this;t.options.relative&&t.data&&"object"===_typeof(t.data)&&(t.data=new Proxy(t.data,{get:function(t,n,s){return n in t||n in s&&n in t?t[n]:"$index"==n?e.index+1:n==e.mavo.id?t:void 0},has:function(n,s){if(s in n)return!0;if("$index"==s||s==e.mavo.id)return!0;var i=e.walkUp(function(t){if(s in t.children)return t.children[s]});return void 0===i&&(i=e.find(s)),void 0!==i&&(Array.isArray(i)?i=i.map(function(e){return e.getData(t.options)}).filter(function(t){return null!==t}):i instanceof Mavo.Node&&(i=i.getData(t.options)),n[s]=i,
!0)},set:function(t,e,n){throw Error("You can’t set data via expressions.")}}))}),Mavo.hooks.add("init-tree-after",function(){this.expressions=new Mavo.Expressions(this),this.expressions.update()}),Mavo.hooks.add("group-init-end",function(){var t=this,e=this.template;e&&e.expressions&&(this.expressions=e.expressions.map(function(e){return new Mavo.Expression.Text({template:e,group:t})}))}),Mavo.hooks.add("render-end",function(){this.expressions.update()})}(Bliss,Bliss.$),Mavo.Expressions.directives.push("mv-value"),Mavo.hooks.add("expressiontext-init-start",function(){"mv-value"==this.attribute&&(this.attribute=Mavo.Primitive.getValueAttribute(this.element),this.fallback=this.fallback||Mavo.Primitive.getValue(this.element,{attribute:this.attribute}),this.expression=this.element.getAttribute("mv-value"),this.parsed=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end)});
