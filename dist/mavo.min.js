...
this.setValue(this.initialValue,{silent:!0}),this.observer=new Mavo.Observer(this.element,this.attribute,function(t){!o.attribute&&o.editing||(o.value=o.getValue())}),this.postInit(),Mavo.hooks.run("primitive-init-end",this)},get editorValue(){if(this.defaults.getEditorValue)return this.defaults.getEditorValue.call(this);if(this.editor){if(this.editor.matches(Mavo.selectors.formControl))return i.getValue(this.editor,{datatype:this.datatype});var e=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);if(e)return i.getValue(e)}},set editorValue(e){if(this.defaults.setEditorValue)return this.defaults.setEditorValue.call(this,e);if(this.editor)if(this.editor.matches(Mavo.selectors.formControl))i.setValue(this.editor,e,{defaults:this.editorDefaults});else{var a=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);a&&i.setValue(a,e)}},getData:function(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],e={context:this,options:t,data:this["super"].getData.call(this,t)
