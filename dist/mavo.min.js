...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,n=Array(t.length);e<t.length;e++)n[e]=t[e];return n}return Array.from(t)}!function(t,e){var n=self.Mavo=t.Class({constructor:function(i){var r=this;this.treeBuilt=Mavo.defer(),this.element=i,this.index=n.all.push(this);var s=n.attributes.map(function(t){return"[data-"+t+"]"}),o=!0,a=!1,u=void 0;try{for(var l,c=e(s.join(", "),this.element).concat(this.element)[Symbol.iterator]();!(o=(l=c.next()).done);o=!0){var v=l.value,m=!0,h=!1,d=void 0;try{for(var f,g=n.attributes[Symbol.iterator]();!(m=(f=g.next()).done);m=!0){var p=f.value,b=v.getAttribute("data-"+p);null!==b&&v.setAttribute(p,b)}}catch(y){h=!0,d=y}finally{try{!m&&g["return"]&&g["return"]()}finally{if(h)throw d}}}}catch(y){a=!0,u=y}finally{try{!o&&c["return"]&&c["return"]()}finally{if(a)throw u}}n.allIds.push(this.id=Mavo.getAttribute(this.element,"mv-app","id")||"mavo"+this.index),this.element.setAttribute("mv-app",this.id),this.unhandled=this.element.classList.contains("mv-keep-unhandled"),
this.autoEdit=this.element.classList.contains("mv-autoedit"),this.autoSave=this.element.classList.contains("mv-autosave"),1==this.index&&(this.storage=n.Functions.urlOption("store"),this.source=n.Functions.urlOption("source")),this.storage=this.storage||n.Functions.urlOption(this.id+"_store")||this.element.getAttribute("mv-storage")||null,this.source=this.source||n.Functions.urlOption(this.id+"_source")||this.element.getAttribute("mv-init")||null,this.storage&&(this.storage=this.storage.trim(),this.storage="none"==this.storage?null:n.Backend.create(this.storage,this)),this.source&&(this.source=n.Backend.create(this.source,this)),this.permissions=this.storage?this.storage.permissions:new Mavo.Permissions,this.element.addEventListener("keydown",function(t){83==t.keyCode&&t[n.superKey]&&(t.preventDefault(),r.save())}),this.element.setAttribute("typeof",""),e(n.selectors.primitive,i).forEach(function(e){var i=t(n.selectors.not(n.selectors.formControl)+", "+n.selectors.property,e);if(i){var r=Mavo.Primitive.getDefaults(e),s=Mavo.is("multiple",e);
(s||!Mavo.Primitive.getValueAttribute(e,r)&&!r.hasChildren)&&e.setAttribute("typeof","")}}),this.ui={bar:t(".mv-bar",this.element)||t.create({className:"mv-bar mv-ui",start:this.element})},this.ui.status=t(".mv-status",this.ui.bar)||t.create("span",{className:"mv-status",inside:this.ui.bar}),this.storage&&(this.authControls={},this.permissions.can("login",function(){r.loginHash="#login"+(Mavo.all[0]===r?"":"-"+r.id),r.authControls.login=t.create({tag:"a",href:r.loginHash,textContent:"Login",className:"mv-login mv-button",events:{click:function(t){t.preventDefault(),r.storage.login()}},after:t(".mv-status",r.ui.bar)});var e;(e=function(){location.hash===r.loginHash&&(history.replaceState(null,document.title,new URL("",location)+""),r.storage.login())})(),window.addEventListener("hashchange.mavo",e)},function(){t.remove(r.authControls.login),r.element._.unbind("hashchange.mavo")}),this.element.addEventListener("mavo:login.mavo",function(e){if(e.backend==r.storage){var n=t(".mv-status",r.ui.bar);
n.innerHTML="",n._.contents(["Logged in to "+e.backend.id+" as ",{tag:"strong",innerHTML:e.name},{tag:"button",textContent:"Logout",className:"mv-logout",events:{click:function(t){return e.backend.logout()}}}])}}),this.element.addEventListener("mavo:logout.mavo",function(e){t(".mv-status",r.ui.bar).textContent=""})),t("summary [property]:not([typeof])")&&this.element.addEventListener("click",function(t){t.target!=document.activeElement&&t.preventDefault()}),Mavo.hooks.run("init-tree-before",this),this.root=new Mavo.Group(this.element,this),this.treeBuilt.resolve(),Mavo.hooks.run("init-tree-after",this),this.needsEdit=this.some(function(t){return"read edit"==t.modes||void 0===t.modes}),this.setUnsavedChanges(!1),this.permissions.onchange(function(t){var e=t.action,n=t.value,i=r.element.getAttribute("mv-permissions")||"";i=i.trim().split(/\s+/).filter(function(t){return t!=e}),n&&i.push(e),r.element.setAttribute("mv-permissions",i.join(" "))}),this.permissions.can(["edit","add","delete"],function(){
r.ui.edit=t.create("button",{className:"mv-edit",textContent:"Edit",onclick:function(t){return r.editing?r.done():r.edit()},inside:r.ui.bar}),r.needsEdit=r.needsEdit,r.autoEdit&&r.ui.edit.click()},function(){t.remove(r.ui.edit),r.editing&&r.done()}),this.permissions.can("delete",function(){r.ui.clear=t.create("button",{className:"mv-clear",textContent:"Clear",onclick:function(t){return r.clear()}}),r.ui.bar.appendChild(r.ui.clear)}),this.permissions.cannot(["delete","edit"],function(){t.remove(r.ui.clear)}),this.storage||this.source?(this.storage||this.source.permissions.can("read",function(){return r.permissions.read=!0}),this.permissions.can("read",function(){return r.load()})):(this.permissions.on(["read","edit"]),t.fire(this.element,"mavo:load")),this.permissions.can("save",function(){r.ui.save=t.create("button",{className:"mv-save",textContent:"Save",events:{click:function(t){return r.save()},"mouseenter focus":function(t){r.element.classList.add("mv-highlight-unsaved")},"mouseleave blur":function(t){
return r.element.classList.remove("mv-highlight-unsaved")}},inside:r.ui.bar}),r.autoSave?r.element.addEventListener("mavo:load.mavo:autosave",function(t){var e=n.debounce(function(){r.save()},3e3),i=function(t){t.node.saved&&e()};requestAnimationFrame(function(){r.permissions.can("save",function(){r.element.addEventListener("mavo:datachange.mavo:autosave",i)},function(){r.element.removeEventListener("mavo:datachange.mavo:autosave",i)})})}):r.ui.revert=t.create("button",{className:"mv-revert",textContent:"Revert",disabled:!0,events:{click:function(t){return r.revert()},"mouseenter focus":function(t){r.element.classList.add("mv-highlight-unsaved")},"mouseleave blur":function(t){return r.element.classList.remove("mv-highlight-unsaved")}},inside:r.ui.bar})},function(){t.remove([r.ui.save,r.ui.revert]),r.ui.save=r.ui.revert=null,r.element.removeEventListener(".mavo:autosave")}),Mavo.hooks.run("init-end",this)},get editing(){return this.root.editing},get data(){return this.getData()},getData:function(t){
return this.root.getData(t)},toJSON:function(){var t=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0];return n.toJSON(t)},error:function i(e){for(var r,s=function(){return t.transition(i,{opacity:0}).then(t.remove)},i=t.create("p",{className:"mv-error mv-ui",contents:[e,{tag:"button",className:"mv-close mv-ui",textContent:"×",events:{click:s}}],events:{mouseenter:function(t){return clearTimeout(r)},mouseleave:n.rr(function(t){return r=setTimeout(s,5e3)})},start:this.element}),o=arguments.length,a=Array(o>1?o-1:0),u=1;u<o;u++)a[u-1]=arguments[u];if(a.length>0){var l;(l=console).log.apply(l,["%c"+e,"color: red; font-weight: bold"].concat(a))}},render:function(t){n.hooks.run("render-start",{context:this,data:t}),t&&this.root.render(t),this.unsavedChanges=!1,n.hooks.run("render-end",{context:this,data:t})},clear:function(){var t=this;confirm("This will delete all your data. Are you sure?")&&this.store(null).then(function(){return t.root.clear()})},edit:function(){this.root.edit(),
t.events(this.element,"mouseenter.mavo:edit mouseleave.mavo:edit",function(t){if(t.target.matches(".mv-item-controls *")){var e=t.target.closest(n.selectors.multiple);e.classList.toggle("mv-highlight","mouseenter"==t.type)}if(t.target.matches(n.selectors.multiple)){t.target.classList.remove("mv-has-hovered-item");var i=t.target.parentNode.closest(n.selectors.multiple);i&&i.classList.toggle("mv-has-hovered-item","mouseenter"==t.type)}},!0),this.setUnsavedChanges()},setUnsavedChanges:function(t){var e=!!t;return t||this.walk(function(n){if(n.unsavedChanges)return e=!0,t===!1&&(n.unsavedChanges=!1),!1}),this.unsavedChanges=e},done:function(){this.root.done(),t.unbind(this.element,".mavo:edit"),this.unsavedChanges=!1},load:function(){var e=this;this.inProgress="Loading";var n=this.storage||this.source;return n.ready.then(function(){return n.get()})["catch"](function(t){return e.source&&n!==e.source?e.source.ready.then(function(){return e.source.get()}):Promise.reject(t)}).then(function(n){if(n&&"string"==t.type(n))try{
n=JSON.parse(n)}catch(i){e.error("The data is corrupted.",i,n),n=""}e.render(n)})["catch"](function(t){t&&(t.xhr&&404==t.xhr.status?e.render(""):e.error("The data could not be loaded.",t))}).then(function(){e.inProgress=!1,t.fire(e.element,"mavo:load")})},store:function(){var t=this;if(this.storage)return this.inProgress="Saving",this.storage.login().then(function(){return t.storage.put()}).then(function(e){return t.inProgress=!1,e})["catch"](function(e){if(e){var n="Problem saving data";e.status&&e.statusText&&(n+=" (HTTP "+e.status+": "+e.statusText+")"),t.error(n,e)}return t.inProgress=!1,Promise.reject(e)})},save:function(){var e=this;return this.store().then(function(n){n&&(t.fire(e.element,"mavo:save",{data:n.data,dataString:n.dataString}),e.lastSaved=Date.now(),e.root.save(),e.unsavedChanges=!1)})},revert:function(){this.root.revert()},walk:function(t){return this.root.walk(t)},some:function(t){return!this.walk(function(e,n){var i=t(e,n);if(i===!0)return!1})},live:{inProgress:function(e){
t.toggleAttribute(this.element,"mv-progress",e,e)},unsavedChanges:function(t){this.element.classList.toggle("mv-unsaved-changes",t),this.ui&&(this.ui.save&&this.ui.save.classList.toggle("mv-unsaved-changes",t),this.ui.revert&&(this.ui.revert.disabled=!t))},needsEdit:function(e){t.toggleAttribute(this.ui.edit,"hidden","",!e)}},"static":{all:[],allIds:[],get:function(t){var e=!0,i=!1,r=void 0;try{for(var s,o=n.all[Symbol.iterator]();!(e=(s=o.next()).done);e=!0){var a=s.value;if(a.id===t)return a}}catch(u){i=!0,r=u}finally{try{!e&&o["return"]&&o["return"]()}finally{if(i)throw r}}return null},superKey:0===navigator.platform.indexOf("Mac")?"metaKey":"ctrlKey",init:function(t){return e(n.selectors.init,t||document).filter(function(t){return t==document.documentElement||!t.parentNode.closest(n.selectors.init)}).map(function(t){return new n(t)})},plugin:function(e){for(var i in e.hooks)n.hooks.add(i,e.hooks[i]);for(var r in e.extend)t.Class(Mavo[r],e.extend[r])},hooks:new t.Hooks,attributes:["mv-app","mv-storage","mv-init","mv-attribute","mv-default","mv-mode","mv-edit","mv-permisssions"]
}});!function(){var e=n.selectors={init:".mv-app, [mv-app], [data-mv-app], [mv-storage], [data-mv-storage]",property:"[property], [itemprop]",specificProperty:function(t){return"[property="+t+"], [itemprop="+t+"]"},group:"[typeof], [itemscope], [itemtype], .mv-group",multiple:"[mv-multiple], .mv-multiple",formControl:"input, select, option, textarea",ui:".mv-ui",container:{tr:"table",option:"select"}},i=e.arr=function(t){return t.split(/\s*,\s*/g)},r=e.not=function(t){return i(t).map(function(t){return":not("+t+")"}).join("")},s=e.or=function(t,e){return t+", "+e},o=e.and=function(t,e){var n=[],r=i(e);return i(t).forEach(function(t){return n.push.apply(n,_toConsumableArray(r.map(function(e){return t+e})))}),n.join(", ")},a=e.andNot=function(t,e){return o(t,r(e))};t.extend(n.selectors,{primitive:a(e.property,e.group),rootGroup:a(e.group,e.property),output:s(e.specificProperty("output"),".mv-output, .mv-value")})}(),Promise.all([t.ready(),t.include(Array.from&&window.Intl&&document.documentElement.closest,"https://cdn.polyfill.io/v2/polyfill.min.js?features=blissfuljs,Intl.~locale.en")])["catch"](function(t){
return console.error(t)}).then(function(){return Mavo.init()}),Stretchy.selectors.filter=".mv-editor:not([property])"}(Bliss,Bliss.$);
...
this.postInit(),Mavo.hooks.run("group-init-end",this)},get isRoot(){return!this.property},getData:function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],a={context:this,options:e,data:this["super"].getData.call(this,e)};return void 0!==a.data?a.data:(a.data={},this.propagate(function(t){if((t.saved||"*"==e.store)&&!(t.property in a.data)){var r=t.getData(e);(null!==r||a.options["null"])&&(a.data[t.property]=r)}}),a.options.unhandled&&t.extend(a.data,this.unhandled),this.type&&this.type!=r.DEFAULT_TYPE&&(a.data["@type"]=this.type),this.vocab&&(a.data["@context"]=this.vocab),a.data.summary&&(a.data.toString=function(){return this.summary}),Mavo.hooks.run("node-getdata-end",a),a.data)},find:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];if(this.property==t)return this;if(t in this.children)return this.children[t].find(t,e);var r=[];for(var a in this.children){var i=this.children[a].find(t,e);if(void 0!==i){if(!Array.isArray(i))return i;r.push.apply(r,_toConsumableArray(i));
...
t[this.bottomUp?"after":"before"](e.element,o),void 0===n&&(n=this.bottomUp?0:this.length)}var a={context:this,item:e};return a.previousIndex=e.index,a.changed=this.splice({remove:a.item},{index:n,add:a.item}),i.silent||(a.changed.forEach(function(t){t.dataChanged(t==a.item&&void 0===a.previousIndex?"add":"move"),t.unsavedChanges=!0}),this.unsavedChanges=this.mavo.unsavedChanges=!0),Mavo.hooks.run("collection-add-end",a),a.item},splice:function(){for(var t=arguments.length,e=Array(t),n=0;n<t;n++)e[n]=arguments[n];var i=!0,o=!1,a=void 0;try{for(var r,l=e[Symbol.iterator]();!(i=(r=l.next()).done);i=!0){var s=r.value;void 0===s.index&&s.remove&&isNaN(s.remove)&&(s.index=this.children.indexOf(s.remove),s.remove=1)}}catch(d){o=!0,a=d}finally{try{!i&&l["return"]&&l["return"]()}finally{if(o)throw a}}e.sort(function(t,e){return e.index-t.index});var c=!0,h=!1,m=void 0;try{for(var u,v=e[Symbol.iterator]();!(c=(u=v.next()).done);c=!0){var p=u.value;if(p.index>-1&&(p.remove||p.add)){var f;p.remove=p.remove||0,
p.add=Mavo.toArray(p.add),(f=this.children).splice.apply(f,[p.index,+p.remove].concat(_toConsumableArray(p.add)))}}}catch(d){h=!0,m=d}finally{try{!c&&v["return"]&&v["return"]()}finally{if(h)throw m}}for(var g=[],C=0;C<this.length;C++){var y=this.children[C];y&&y.index!==C&&(y.index=C,g.push(y))}return g},adopt:function(t){var e=this;t.collection&&(t.collection.splice({remove:t}),t.collection.dataChanged("delete")),this.walk(function(n){n.closestCollection===t.collection&&(n.closestCollection=e),t.mavo!=e.mavo&&(t.mavo=e.mavo)}),t.collection=this,t.template&&(Mavo["delete"](t.template.copies,t),t.template=this.itemTemplate)},"delete":function(e,n){var i=this;return n?(t.remove(e.element),this.splice({remove:e}),void e.destroy()):t.transition(e.element,{opacity:0}).then(function(){e.deleted=!0,e.element.style.opacity="",e.dataChanged("delete"),i.unsavedChanges=e.unsavedChanges=i.mavo.unsavedChanges=!0})},edit:function(){var e=this;if(this["super"].edit.call(this),this.mutable){if(!this.addButton.parentNode){
var i=this.element.tagName.toLowerCase(),o=Mavo.selectors.container[i],a=o?this.marker.parentNode.closest(o):this.marker;t[this.bottomUp?"before":"after"](this.addButton,a)}n.dragula.then(function(){e.getDragula()})}},done:function(){this["super"].done.call(this),this.mutable&&this.addButton.parentNode&&this.addButton.remove()},clear:function(){this.mutable&&(this.propagate(function(t){t.element.remove(),t.destroy()}),this.children=[],this.dataChanged("clear"))},dataChanged:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return e.element=e.element||this.marker,this["super"].dataChanged.call(this,t,e)},save:function(){var t=!0,e=!1,n=void 0;try{for(var i,o=this.children[Symbol.iterator]();!(t=(i=o.next()).done);t=!0){var a=i.value;a.deleted?this["delete"](a,!0):a.unsavedChanges=!1}}catch(r){e=!0,n=r}finally{try{!t&&o["return"]&&o["return"]()}finally{if(e)throw n}}},propagated:["save"],revert:function(){var t=!0,e=!1,n=void 0;try{for(var i,o=this.children[Symbol.iterator]();!(t=(i=o.next()).done);t=!0){
var a=i.value;a.unsavedChanges?this["delete"](a,!0):(a.deleted&&(a.deleted=!1),a.revert())}}catch(r){e=!0,n=r}finally{try{!t&&o["return"]&&o["return"]()}finally{if(e)throw n}}},dataRender:function(e){var n=this;if(this.unhandled={before:[],after:[]},e)if(e=Mavo.toArray(e),this.mutable){this.clear();var i=document.createDocumentFragment();e.forEach(function(t,e){var o=n.createItem();o.render(t),n.children.push(o),o.index=e,i.appendChild(o.element);var a={context:n,item:o};Mavo.hooks.run("collection-add-end",a)}),t[this.bottomUp?"after":"before"](i,this.marker)}else this.children.forEach(function(t,n){return t.render(e&&e[n])}),e&&(this.unhandled.after=e.slice(this.length))},find:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],n=this.children.filter(function(t){return!t.deleted});if(this.property==t)return e.collections?this:n;if(this.properties.indexOf(t)>-1){var i=n.map(function(n){return n.find(t,e)});return Mavo.flatten(i)}},isCompatible:function(t){return t&&this.itemTemplate.nodeType==t.itemTemplate.nodeType&&(t===this||t.template==this||this.template==t||this.template&&this.template==t.template||this.accepts.indexOf(t.property)>-1);
},live:{mutable:function(e){e&&e!==this.mutable&&(this._mutable=e,this.marker=document.createComment("mv-marker"),Mavo.data(this.marker,"collection",this),t.after(this.marker,this.templateElement))}},getDragula:function(){var t=this;if(this.dragula)return this.dragula;if(this.template)return Mavo.pushUnique(this.template.getDragula().containers,this.marker.parentNode),this.dragula=this.template.dragula||this.template.getDragula();return this.dragula=dragula({containers:[this.marker.parentNode],isContainer:function(e){return!!t.accepts.length&&Mavo.flatten(t.accepts.map(function(e){return t.mavo.root.find(e,{collections:!0})})).filter(function(t){return t&&t instanceof n}).map(function(t){return t.marker.parentNode}).indexOf(e)>-1},moves:function(t,e,n){return n.classList.contains("mv-drag-handle")&&n.closest(Mavo.selectors.multiple)==t},accepts:function(t,e,i,o){if(t.contains(e))return!1;var a=o?o.previousElementSibling:e.lastElementChild,r=n.get(a)||n.get(o);if(!r)return!1;var l=Mavo.Node.get(t);
return l&&l.collection.isCompatible(r)}}),this.dragula.on("drop",function(e,i,o){var a=Mavo.Node.get(e),r=(a&&a.index,e.nextElementSibling),l=e.previousElementSibling,s=n.get(l)||n.get(r),d=Mavo.Node.get(l)||Mavo.Node.get(r);if(d&&d.collection!=s&&(d=null),!a.collection.isCompatible(s))return t.dragula.cancel(!0);var c=d?d.index+(d.element===l):s.length;s.add(a,c)}),n.dragulas.push(this.dragula),this.dragula},lazy:{bottomUp:function(){if(!this.mutable)return!1;var t=this.templateElement.getAttribute("mv-order");return null!==t?/^desc\b/i.test(t):!!this.addButton.parentNode&&!!(this.addButton.compareDocumentPosition(this.templateElement)&Node.DOCUMENT_POSITION_FOLLOWING)},closestCollection:function(){var t=this.marker?this.marker.parentNode:this.templateElement.parentNode;return t.closest(Mavo.selectors.multiple)},addButton:function(){var n=this,i="button.mv-add-"+this.property,o=this.closestCollection||this.marker.parentNode.closest(Mavo.selectors.group);if(o)var a=e(i,o).filter(function(t){
return!n.templateElement.contains(t)})[0];return a||(a=t.create("button",{className:"mv-add",textContent:"Add "+this.name})),a.classList.add("mv-ui","mv-add"),Mavo.data(a,"collection",this),this.property&&a.classList.add("mv-add-"+this.property),a.addEventListener("click",function(t){t.preventDefault(),n.add().edit()}),a}},"static":{dragulas:[],get:function(t){var e=Mavo.data(t,"collection");if(e)return e;var n=Mavo.Node.get(t);return n&&n.collection||null},lazy:{dragula:function(){return t.include(self.dragula,"https://cdnjs.cloudflare.com/ajax/libs/dragula/3.7.2/dragula.min.js")}}}});Mavo.hooks.add("primitive-init-end",function(){var e=this;if(this.collection&&!this.attribute){var n=function(n){var i;return e.sneak(function(){var o=t.remove(t(".mv-item-controls",e.element));i=n(),t.inside(o,e.element)}),i};["textContent","innerHTML"].forEach(function(t){var i=Object.getOwnPropertyDescriptor(Node.prototype,t);Object.defineProperty(e.element,t,{get:function(){var t=this;return n(function(){
return i.get.call(t)})},set:function(t){var e=this;n(function(){return i.set.call(e,t)})}})})}}),Mavo.hooks.add("node-edit-end",function(){var n=this;this.collection&&(this.itemControls||(this.itemControls=e(".mv-item-controls",this.element).filter(function(t){return t.closest(Mavo.selectors.multiple)==n.element})[0],this.itemControls=this.itemControls||t.create({className:"mv-item-controls mv-ui"}),t.set(this.itemControls,{contents:[{tag:"button",title:"Delete this "+this.name,className:"mv-delete",events:{click:function(t){return n.collection["delete"](n)}}},{tag:"button",title:"Add new "+this.name.replace(/s$/i,"")+" "+(this.collection.bottomUp?"after":"before"),className:"mv-add",events:{click:function(t){var e=n.collection.add(null,n.index+n.collection.bottomUp);return t[Mavo.superKey]&&e.render(n.data),Mavo.inViewport(e.element)||e.element.scrollIntoView({behavior:"smooth"}),e.edit()}}},{tag:"button",title:"Drag to reorder "+this.name,className:"mv-drag-handle"}]})),this.itemControls.parentNode||(this.itemControlsComment?this.itemControlsComment.parentNode.replaceChild(this.itemControls,this.itemControlsComment):this.element.appendChild(this.itemControls)));
}),Mavo.hooks.add("node-done-end",function(){this.collection&&this.itemControls&&(this.itemControlsComment=this.itemControlsComment||document.createComment("item controls"),this.itemControls.parentNode.replaceChild(this.itemControlsComment,this.itemControls))}),Mavo.Node.prototype.getClosestCollection=function(){return this.collection||this.group.collection||(this.parentGroup?this.parentGroup.closestCollection:null)},t.lazy(Mavo.Node.prototype,"closestCollection",function(){return this.getClosestCollection()}),t.live(Mavo.Node.prototype,"deleted",function(n){var i=this;this.element.classList.toggle("mv-deleted",n),n?(this.elementContents=document.createDocumentFragment(),e(this.element.childNodes).forEach(function(t){i.elementContents.appendChild(t)}),t.contents(this.element,[{tag:"button",className:"mv-close mv-ui",textContent:"×",events:{click:function(e){t.remove(this.parentNode)}}},"Deleted "+this.name,{tag:"button",className:"mv-undo mv-ui",textContent:"Undo",events:{click:function(t){
return i.deleted=!1}}}]),this.element.classList.remove("mv-highlight")):this.deleted&&(this.element.textContent="",this.element.appendChild(this.elementContents),this._deleted=!1,this.dataChanged("undelete"))}),Mavo.Node.prototype.isDeleted=function(){this.deleted;return!!this.deleted||!!this.parentGroup&&this.parentGroup.isDeleted()},Mavo.hooks.add("node-init-end",function(t){this.collection=t.options.collection,this.collection&&(this.group=this.parentGroup=this.collection.parentGroup)})}(Bliss,Bliss.$);
