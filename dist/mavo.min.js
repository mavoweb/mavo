...
},{tag:"button",textContent:"Logout",className:"mv-logout",events:{click:function(t){return e.backend.logout()}}}])}}),this.element.addEventListener("mavo:logout.mavo",function(e){t(".mv-status",r.ui.bar).textContent=""})),t("summary [property]:not([typeof])")&&this.element.addEventListener("click",function(t){t.target!=document.activeElement&&t.preventDefault()}),this.needsEdit=!1,Mavo.hooks.run("init-tree-before",this),this.root=new Mavo.Group(this.element,this),this.treeBuilt.resolve(),Mavo.hooks.run("init-tree-after",this),this.setUnsavedChanges(!1),this.permissions.onchange(function(t){var e=t.action,n=t.value,i=r.element.getAttribute("mv-permissions")||"";i=i.trim().split(/\s+/).filter(function(t){return t!=e}),n&&i.push(e),r.element.setAttribute("mv-permissions",i.join(" "))}),this.permissions.can(["edit","add","delete"],function(){r.ui.edit=t.create("button",{className:"mv-edit",textContent:"Edit",onclick:function(t){return r.editing?r.done():r.edit()},inside:r.ui.bar}),r.autoEdit&&r.ui.edit.click();
},function(){t.remove(r.ui.edit),r.editing&&r.done()}),this.needsEdit&&this.permissions.can("save",function(){r.ui.save=t.create("button",{className:"mv-save",textContent:"Save",events:{click:function(t){return r.save()},"mouseenter focus":function(t){r.element.classList.add("mv-highlight-unsaved")},"mouseleave blur":function(t){return r.element.classList.remove("mv-highlight-unsaved")}},inside:r.ui.bar}),r.ui.revert=t.create("button",{className:"mv-revert",textContent:"Revert",disabled:!0,events:{click:function(t){return r.revert()},"mouseenter focus":function(t){r.element.classList.add("mv-highlight-unsaved")},"mouseleave blur":function(t){return r.element.classList.remove("mv-highlight-unsaved")}},inside:r.ui.bar})},function(){t.remove([r.ui.save,r.ui.revert]),r.ui.save=r.ui.revert=null}),this.permissions.can("delete",function(){r.ui.clear=t.create("button",{className:"mv-clear",textContent:"Clear",onclick:function(t){return r.clear()}}),r.ui.bar.appendChild(r.ui.clear)}),this.permissions.cannot(["delete","edit"],function(){
t.remove(r.ui.clear)}),this.storage||this.source?(this.storage||this.source.permissions.can("read",function(){return r.permissions.read=!0}),this.permissions.can("read",function(){return r.load()})):(this.permissions.on(["read","edit"]),t.fire(this.element,"mavo:load")),this.needsEdit||(this.permissions.off(["edit","add","delete"]),this.element.addEventListener("mavo:load",function(t){var e=n.debounce(function(){r.save()},1e3),i=function(t){t.node.saved&&e()};requestAnimationFrame(function(){r.permissions.can("save",function(){r.element.addEventListener("mavo:datachange",i)},function(){r.element.removeEventListener("mavo:datachange",i)})})})),Mavo.hooks.run("init-end",this)},get editing(){return this.root.editing},get data(){return this.getData()},getData:function(t){return this.root.getData(t)},toJSON:function(){var t=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0];return n.toJSON(t)},error:function i(e){for(var r,s=function(){return t.transition(i,{opacity:0}).then(t.remove);
},i=t.create("p",{className:"mv-error mv-ui",contents:[e,{tag:"button",className:"mv-close mv-ui",textContent:"×",events:{click:s}}],events:{mouseenter:function(t){return clearTimeout(r)},mouseleave:n.rr(function(t){return r=setTimeout(s,5e3)})},start:this.element}),o=arguments.length,a=Array(o>1?o-1:0),u=1;u<o;u++)a[u-1]=arguments[u];if(a.length>0){var c;(c=console).log.apply(c,["%c"+e,"color: red; font-weight: bold"].concat(a))}},render:function(t){n.hooks.run("render-start",{context:this,data:t}),t&&(this.editing?(this.done(),this.root.render(t),this.edit()):this.root.render(t)),this.unsavedChanges=!1},clear:function(){var t=this;confirm("This will delete all your data. Are you sure?")&&this.store(null).then(function(){return t.root.clear()})},edit:function(){this.root.edit(),t.events(this.element,"mouseenter.mavo:edit mouseleave.mavo:edit",function(t){if(t.target.matches(".mv-item-controls *")){var e=t.target.closest(n.selectors.item);e.classList.toggle("mv-highlight","mouseenter"==t.type);
...
e.inProgress=!1,t.fire(e.element,"mavo:load")})},store:function(){var t=this;if(this.storage)return this.inProgress="Saving",this.storage.login().then(function(){return t.storage.put()}).then(function(e){return t.inProgress=!1,e})["catch"](function(e){return e&&t.error("Problem saving data",e),t.inProgress=!1,Promise.reject(e)})},save:function(){var e=this;return this.store().then(function(n){n&&(t.fire(e.element,"mavo:save",{data:n.data,dataString:n.dataString}),e.lastSaved=Date.now(),e.root.save(),e.unsavedChanges=!1)})},revert:function(){this.root.revert()},walk:function(t){this.root.walk(t)},live:{inProgress:function(e){t.toggleAttribute(this.element,"mv-progress",e,e)},unsavedChanges:function(t){this.element.classList.toggle("mv-unsaved-changes",t),this.ui&&this.ui.save&&(this.ui.save.classList.toggle("mv-unsaved-changes",t),this.ui.revert.disabled=!t)},needsEdit:function(e){t.toggleAttribute(this.ui.bar,"hidden","",!e)}},"static":{all:[],superKey:0===navigator.platform.indexOf("Mac")?"metaKey":"ctrlKey",
init:function(t){return e(n.selectors.init,t||document).filter(function(t){return t==document.documentElement||!t.parentNode.closest(n.selectors.init)}).map(function(t){return new n(t)})},hooks:new t.Hooks,attributes:["mv-app","mv-storage","mv-init","mv-attribute","mv-default","mv-mode","mv-edit","mv-permisssions"]}});!function(){var e=n.selectors={init:".mv-app, [mv-app], [data-mv-app], [mv-storage], [data-mv-storage]",property:"[property], [itemprop]",specificProperty:function(t){return"[property="+t+"], [itemprop="+t+"]"},group:"[typeof], [itemscope], [itemtype], .mv-group",multiple:"[mv-multiple], .mv-multiple",formControl:"input, select, option, textarea",item:".mv-item",ui:".mv-ui",container:{tr:"table",option:"select"}},i=e.arr=function(t){return t.split(/\s*,\s*/g)},r=e.not=function(t){return i(t).map(function(t){return":not("+t+")"}).join("")},s=e.or=function(t,e){return t+", "+e},o=e.and=function(t,e){var n=[],r=i(e);return i(t).forEach(function(t){return n.push.apply(n,_toConsumableArray(r.map(function(e){
return t+e})))}),n.join(", ")},a=e.andNot=function(t,e){return o(t,r(e))};t.extend(n.selectors,{primitive:a(e.property,e.group),rootGroup:a(e.group,e.property),output:s(e.specificProperty("output"),".mv-output, .mv-value")})}(),Promise.all([t.ready(),t.include(Array.from&&window.Intl&&document.documentElement.closest,"https://cdn.polyfill.io/v2/polyfill.min.js?features=blissfuljs,Intl.~locale.en")])["catch"](function(t){return console.error(t)}).then(function(){return Mavo.init()}),Stretchy.selectors.filter=".mv-editor:not([property])"}(Bliss,Bliss.$);
...
n=this.regex.lastIndex,i.push(new Mavo.Expression(e[1]));return n<t.length&&i.push(t.substring(n)),i},"static":{create:function(t){if(t){var i=t.getAttribute("mv-expressions");if(i)return i=i.trim(),/\s/.test(i)?new(Function.prototype.bind.apply(e,[null].concat(_toConsumableArray(i.split(/\s+/))))):e.ESCAPE}},ESCAPE:-1}});e["default"]=new e("[","]")}(),function(){var e=Mavo.Expression.Text=t.Class({constructor:function(i){if(this.group=i.group,this.node=i.node,this.path=i.path,this.syntax=i.syntax,this.fallback=i.fallback,this.node||(this.node=this.path.reduce(function(t,e){return t.childNodes[e]},this.group.element)),this.element=this.node,this.attribute=i.attribute||null,Mavo.hooks.run("expressiontext-init-start",this),!this.expression){if(3===this.node.nodeType&&(this.element=this.node.parentNode,this.node.parentNode.children.length&&!this.attribute||(this.node=this.element,this.element.normalize())),this.attribute)this.expression=this.node.getAttribute(this.attribute).trim();else{if(this.node.normalize(),
this.node.firstChild&&1===this.node.childNodes.length&&3===this.node.firstChild.nodeType){var n=this.node.firstChild.textContent.match(/^\s*|\s*$/g);n[1]&&(this.node.firstChild.splitText(this.node.firstChild.textContent.length-n[1].length),t.after(this.node.lastChild,this.node)),n[0]&&(this.node.firstChild.splitText(n[0].length),this.node.parentNode.insertBefore(this.node.firstChild,this.node))}this.expression=this.node.textContent}this.template=i.template?i.template.template:this.syntax.tokenize(this.expression)}Mavo.hooks.run("expressiontext-init-end",this),e.elements.set(this.element,[].concat(_toConsumableArray(e.elements.get(this.element)||[]),[this]))},update:function(){var t=this,e=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0];this.data=e;var i={};Mavo.hooks.run("expressiontext-update-start",this),i.value=this.value=this.template.map(function(i){if(i instanceof Mavo.Expression){var n={context:t,expr:i};return Mavo.hooks.run("expressiontext-update-beforeeval",n),
n.value=n.expr.eval(e),Mavo.hooks.run("expressiontext-update-aftereval",n),n.value instanceof Error?void 0!==t.fallback?t.fallback:n.expr.expression:void 0===n.value||null===n.value?"":n.value}return i}),this.attribute||(i.presentational=this.value.map(function(t){return Array.isArray(t)?t.join(", "):"number"==typeof t?Mavo.Primitive.formatNumber(t):t}),i.presentational=1===i.presentational.length?i.presentational[0]:i.presentational.join("")),i.value=1===i.value.length?i.value[0]:i.value.join(""),this.primitive&&1===this.template.length&&("number"==typeof i.value?this.primitive.datatype="number":"boolean"==typeof i.value&&(this.primitive.datatype="boolean")),i.presentational===i.value&&(i=i.value),this.primitive?this.primitive.value=i:Mavo.Primitive.setValue(this.node,i,{attribute:this.attribute}),Mavo.hooks.run("expressiontext-update-end",this)},"static":{elements:new WeakMap,search:function(t,i){var n=e.elements.get(t)||[];return arguments.length>1?n.length?n.filter(function(t){return t.attribute===i;
})[0]||null:null:n}}})}(),function(){var i=Mavo.Expressions=t.Class({constructor:function(t){var e=this;if(t&&(this.group=t,this.group.expressions=this),this.all=[],Mavo.hooks.run("expressions-init-start",this),this.group){var i=this.group.template;if(i&&i.expressions){var n=!0,r=!1,s=void 0;try{for(var o,a=i.expressions.all[Symbol.iterator]();!(n=(o=a.next()).done);n=!0){var l=o.value;this.all.push(new Mavo.Expression.Text({path:l.path,syntax:l.syntax,attribute:l.attribute,group:this.group,template:l}))}}catch(u){r=!0,s=u}finally{try{!n&&a["return"]&&a["return"]()}finally{if(r)throw s}}}else{var h=Mavo.Expression.Syntax.create(this.group.element.closest("[mv-expressions]"))||Mavo.Expression.Syntax["default"];this.traverse(this.group.element,void 0,h)}}this.dependents=new Set,this.active=!0,this.group.element.addEventListener("mavo:datachange",function(t){return e.update()})},update:function(){if(this.active&&!this.group.isDeleted()&&this.all.length+this.dependents.size!==0){var t={context:this,
data:this.group.getRelativeData()};Mavo.hooks.run("expressions-update-start",t);var e=!0,i=!1,n=void 0;try{for(var r,s=this.all[Symbol.iterator]();!(e=(r=s.next()).done);e=!0){var o=r.value;o.update(t.data)}}catch(a){i=!0,n=a}finally{try{!e&&s["return"]&&s["return"]()}finally{if(i)throw n}}var l=!0,u=!1,h=void 0;try{for(var p,d=this.dependents[Symbol.iterator]();!(l=(p=d.next()).done);l=!0){var v=p.value;v.update()}}catch(a){u=!0,h=a}finally{try{!l&&d["return"]&&d["return"]()}finally{if(u)throw h}}}},extract:function(t,e,n,r){e&&"mv-expressions"==e.name||(e&&i.directives.indexOf(e.name)>-1||r.test(e?e.value:t.textContent))&&this.all.push(new Mavo.Expression.Text({node:t,syntax:r,path:(n||"").slice(1).split("/").map(function(t){return+t}),attribute:e&&e.name,group:this.group}))},traverse:function(t){var i=this,n=arguments.length<=1||void 0===arguments[1]?"":arguments[1],r=arguments[2];if(8!==t.nodeType)if(3===t.nodeType)this.extract(t,null,n,r);else if(t==this.group.element||!Mavo.is("group",t)){
if(r=Mavo.Expression.Syntax.create(t)||r,r===Mavo.Expression.Syntax.ESCAPE)return;e(t.attributes).forEach(function(e){return i.extract(t,e,n,r)}),e(t.childNodes).forEach(function(t,e){return i.traverse(t,n+"/"+e,r)})}},"static":{directives:[]}})}(),self.Proxy&&Mavo.hooks.add("node-getdata-end",function(t){var e=this;t.options.relative&&t.data&&"object"===_typeof(t.data)&&(t.data=new Proxy(t.data,{get:function(i,n,r){if(n in i||n in r&&n in i)return i[n];if("$index"==n)return e.index+1;if(n==e.mavo.id)return i;var s=e.walkUp(function(i){if(n in i.children)return i.expressions.dependents.add(e.expressions),i.children[n].getData(t.options)});return void 0!==s?s:void 0},has:function(i,n){if(n in i)return!0;if("$index"==n||n==e.mavo.id)return!0;var r=e.walkUp(function(t){if(n in t.children)return!0});return void 0!==r?r:(r=e.find(n),void 0!==r?(r=Array.isArray(r)?r.map(function(e){return e.getData(t.options)}).filter(function(t){return null!==t}):r.getData(t.options),i[n]=r,!0):void 0)},set:function(t,e,i){
throw Error("You can’t set data via expressions.")}}))}),Mavo.Node.prototype.getRelativeData=function(){return this.getData({relative:!0,store:"*","null":!0,unhandled:this.mavo.unhandled})},Mavo.hooks.add("group-init-start",function(){new Mavo.Expressions(this)}),Mavo.hooks.add("primitive-init-start",function(){this.expressionText=Mavo.Expression.Text.search(this.element,this.attribute),this.expressionText&&(this.expressionText.primitive=this,this.store=this.store||"none",this.modes="read")}),Mavo.hooks.add("group-init-end",function(){this.expressions.update()}),Mavo.hooks.add("group-render-start",function(){this.expressions.active=!1}),Mavo.hooks.add("group-render-end",function(){var t=this;requestAnimationFrame(function(){t.expressions.active=!0,t.expressions.update()})})}(Bliss,Bliss.$),Mavo.Expressions.directives.push("mv-value"),Mavo.hooks.add("expressiontext-init-start",function(){"mv-value"==this.attribute&&(this.attribute=Mavo.Primitive.getValueAttribute(this.element),this.fallback=this.fallback||Mavo.Primitive.getValue(this.element,{
attribute:this.attribute}),this.expression=this.element.getAttribute("mv-value"),this.template=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end)}),Mavo.Expressions.directives.push("mv-if"),Mavo.hooks.add("expressiontext-init-start",function(){"mv-if"==this.attribute&&(this.expression=this.element.getAttribute("mv-if"),this.template=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end,this.parentIf=Mavo.Expression.Text.search(this.element.parentNode.closest("[mv-if]"),"mv-if"),this.parentIf&&(this.parentIf.childIfs=(this.parentIf.childIfs||new Set).add(this)))}),Mavo.hooks.add("expressiontext-update-end",function(){var t=this;"mv-if"==this.attribute&&this.group.mavo.treeBuilt.then(function(){var e=t.value[0],i=t.oldValue&&t.oldValue[0];if(t.parentIf){var n=t.parentIf.value[0];t.value[0]=e=e&&n}if(e!==i){if(n!==!1&&(e?t.comment&&t.comment.parentNode&&t.comment.parentNode.replaceChild(t.element,t.comment):t.element.parentNode&&(t.comment||(t.comment=document.createComment("mv-if")),
t.element.parentNode.replaceChild(t.comment,t.element))),t.childProperties){var r=!0,s=!1,o=void 0;try{for(var a,l=t.childProperties[Symbol.iterator]();!(r=(a=l.next()).done);r=!0){var u=a.value;u.hidden=!e}}catch(h){s=!0,o=h}finally{try{!r&&l["return"]&&l["return"]()}finally{if(s)throw o}}}if(t.childIfs){var p=!0,d=!1,v=void 0;try{for(var f,c=t.childIfs[Symbol.iterator]();!(p=(f=c.next()).done);p=!0){var x=f.value;x.update()}}catch(h){d=!0,v=h}finally{try{!p&&c["return"]&&c["return"]()}finally{if(d)throw v}}}t.oldValue=t.value}})}),Mavo.hooks.add("unit-isdatanull",function(t){t.result=t.result||this.hidden&&"*"==t.options.store}),$.live(Mavo.Primitive.prototype,"hidden",function(t){this._hidden!==t&&(this._hidden=t,this.dataChanged())}),$.lazy(Mavo.Expression.Text.prototype,"childProperties",function(){var t=this;if("mv-if"==this.attribute){var e=$$(Mavo.selectors.property,this.element).filter(function(e){return e.closest("[mv-if]")==t.element}).map(function(t){return Mavo.Node.get(t)});
return e.length&&this.element.addEventListener("mavo:datachange",function(e){requestAnimationFrame(function(){t.element.parentNode||t.group.element.dispatchEvent(e)})}),e}});
