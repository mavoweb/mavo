...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,n=Array(t.length);e<t.length;e++)n[e]=t[e];return n}return Array.from(t)}!function(t,e){var n=self.Mavo=t.Class({constructor:function(i){var r=this;this.treeBuilt=Mavo.defer(),this.element=i,this.index=n.all.push(this);var s=n.attributes.map(function(t){return"[data-"+t+"]"}),o=!0,a=!1,u=void 0;try{for(var l,c=e(s.join(", "),this.element).concat(this.element)[Symbol.iterator]();!(o=(l=c.next()).done);o=!0){var v=l.value,m=!0,h=!1,d=void 0;try{for(var f,g=n.attributes[Symbol.iterator]();!(m=(f=g.next()).done);m=!0){var p=f.value,y=v.getAttribute("data-"+p);null!==y&&v.setAttribute(p,y)}}catch(b){h=!0,d=b}finally{try{!m&&g["return"]&&g["return"]()}finally{if(h)throw d}}}}catch(b){a=!0,u=b}finally{try{!o&&c["return"]&&c["return"]()}finally{if(a)throw u}}n.allIds.push(this.id=Mavo.getAttribute(this.element,"mv-app","id")||"mavo"+this.index),this.element.setAttribute("mv-app",this.id),this.unhandled=this.element.classList.contains("mv-keep-unhandled"),
