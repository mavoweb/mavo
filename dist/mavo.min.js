...
this.primitive?this.primitive.value=s:Mavo.Primitive.setValue(this.node,s,{attribute:this.attribute}),Mavo.hooks.run("expressiontext-update-end",this)},"static":{elements:new WeakMap,search:function(t,i){var s=e.elements.get(t)||[];return arguments.length>1?s.length?s.filter(function(t){return t.attribute===i})[0]||null:null:s}}});Mavo.hooks.add("primitive-init-start",function(){this.expressionText=Mavo.Expression.Text.search(this.element,this.attribute),this.expressionText&&(this.expressionText.primitive=this,this.store=this.store||"none",this.modes="read")})}(Bliss);
"use strict";function _defineProperty(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e};!function(e,t){var n=Mavo.Expressions=e.Class({constructor:function(e){var t=this;this.mavo=e,this.expressions=[];var i=Mavo.Expression.Syntax.create(this.mavo.element.closest("[mv-expressions]"))||Mavo.Expression.Syntax["default"];this.traverse(this.mavo.element,void 0,i),this.scheduled=new Set,this.mavo.treeBuilt.then(function(){var e=!0,i=!1,o=void 0;try{for(var r,s=t.expressions[Symbol.iterator]();!(e=(r=s.next()).done);e=!0){var a=r.value;a.item=Mavo.Node.get(a.element.closest(Mavo.selectors.multiple+", "+Mavo.selectors.group)),
a.item.expressions=a.item.expressions||[],a.item.expressions.push(a);var u=Mavo.Node.get(a.element,!0);u&&u instanceof Mavo.Primitive&&u.attribute==a.attribute&&(a.primitive=u,u.store=u.store||"none",u.modes="read")}}catch(l){i=!0,o=l}finally{try{!e&&s["return"]&&s["return"]()}finally{if(i)throw o}}t.mavo.element.addEventListener("mavo:datachange",function(e){"propertychange"==e.action&&e.node.closestCollection?t.scheduled.has(e.property)||(setTimeout(function(){t.scheduled["delete"](e.property),t.update(e)},n.PROPERTYCHANGE_THROTTLE),t.scheduled.add(e.property)):requestAnimationFrame(function(){return t.update(e)})}),t.update()})},update:function(t){var n,i,o=this;t instanceof Element&&(n=t.closest(Mavo.selectors.group),t=null),n=n||this.mavo.element,i=Mavo.Node.get(n);var r=i.getData({relative:!0,store:"*","null":!0,unhandled:this.mavo.unhandled});i.walk(function(n,i){if(n.expressions&&n.expressions.length&&!n.isDeleted()){var s={context:o,data:e.value.apply(e,[r].concat(_toConsumableArray(i)))
};Mavo.hooks.run("expressions-update-start",s);var a=!0,u=!1,l=void 0;try{for(var v,d=n.expressions[Symbol.iterator]();!(a=(v=d.next()).done);a=!0){var c=v.value;c.changedBy(t)&&c.update(s.data,t)}}catch(p){u=!0,l=p}finally{try{!a&&d["return"]&&d["return"]()}finally{if(u)throw l}}}})},extract:function(e,t,i,o){t&&"mv-expressions"==t.name||(t&&n.directives.indexOf(t.name)>-1||o.test(t?t.value:e.textContent))&&this.expressions.push(new Mavo.Expression.Text({node:e,syntax:o,path:i?i.slice(1).split("/").map(function(e){return+e}):[],attribute:t&&t.name,mavo:this.mavo}))},traverse:function(e){var n=this,i=arguments.length<=1||void 0===arguments[1]?"":arguments[1],o=arguments[2];if(8!==e.nodeType)if(3===e.nodeType)this.extract(e,null,i,o);else{if(e.normalize(),o=Mavo.Expression.Syntax.create(e)||o,o===Mavo.Expression.Syntax.ESCAPE)return;Mavo.is("multiple",e)&&(i=""),t(e.attributes).forEach(function(t){return n.extract(e,t,i,o)}),t(e.childNodes).forEach(function(e,t){return n.traverse(e,i+"/"+t,o);
})}},"static":{directives:[],PROPERTYCHANGE_THROTTLE:50}});self.Proxy&&Mavo.hooks.add("node-getdata-end",function(e){var t=this;if(e.options.relative&&(e.data&&"object"===_typeof(e.data)||this.collection)){var n=e.data;if(this instanceof Mavo.Primitive){var i;e.data=(i={},_defineProperty(i,Symbol.toPrimitive,function(){return n}),_defineProperty(i,this.property,n),i)}e.data=new Proxy(e.data,{get:function(e,n,i){return n in e||n in i&&n in e?e[n]:"$index"==n?t.index+1:n==t.mavo.id?e:void 0},has:function(n,i){if(i in n)return!0;if("$index"==i||i==t.mavo.id)return!0;var o=t.walkUp(function(e){if(i in e.children)return e.children[i]});return void 0===o&&(o=t.find(i)),void 0!==o&&(Array.isArray(o)?o=o.map(function(t){return t.getData(e.options)}).filter(function(e){return null!==e}):o instanceof Mavo.Node&&(o=o.getData(e.options)),n[i]=o,!0)},set:function(e,t,n){throw Error("You can’t set data via expressions.")}})}}),Mavo.hooks.add("init-tree-before",function(){this.expressions=new Mavo.Expressions(this);
}),Mavo.hooks.add("node-init-end",function(){var e=this,t=this.template;t&&t.expressions&&(this.expressions=t.expressions.map(function(t){return new Mavo.Expression.Text({template:t,item:e,mavo:e.mavo})}))}),Mavo.hooks.add("render-end",function(){this.expressions.update()}),Mavo.hooks.add("collection-add-end",function(e){this.mavo.expressions.update(e.item.element)})}(Bliss,Bliss.$),Mavo.attributes.push("mv-value"),Mavo.Expressions.directives.push("mv-value"),Mavo.hooks.add("expressiontext-init-start",function(){"mv-value"==this.attribute&&(this.attribute=Mavo.Primitive.getValueAttribute(this.element),this.fallback=this.fallback||Mavo.Primitive.getValue(this.element,{attribute:this.attribute}),this.expression=this.element.getAttribute("mv-value"),this.parsed=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end)});
"use strict";Mavo.Expressions.directives.push("mv-if"),Mavo.attributes.push("mv-if"),Mavo.hooks.add("expressiontext-init-start",function(){"mv-if"==this.attribute&&(this.expression=this.element.getAttribute("mv-if"),this.parsed=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end,this.parentIf=this.element.parentNode&&Mavo.Expression.Text.search(this.element.parentNode.closest("[mv-if]"),"mv-if"),this.parentIf&&(this.parentIf.childIfs=(this.parentIf.childIfs||new Set).add(this)))}),Mavo.hooks.add("expressiontext-update-end",function(){var e=this;if("mv-if"==this.attribute){var t=this.value[0],i=this.oldValue[0];this.item.mavo.treeBuilt.then(function(){if(e.parentIf){var n=e.parentIf.value[0];e.value[0]=t=t&&n}if(t!==i){if(n!==!1&&(t?e.comment&&e.comment.parentNode&&e.comment.parentNode.replaceChild(e.element,e.comment):e.element.parentNode&&(e.comment||(e.comment=document.createComment("mv-if")),e.element.parentNode.replaceChild(e.comment,e.element))),
e.childProperties){var r=!0,s=!1,a=void 0;try{for(var o,h=e.childProperties[Symbol.iterator]();!(r=(o=h.next()).done);r=!0){var d=o.value;d.hidden=!t}}catch(l){s=!0,a=l}finally{try{!r&&h["return"]&&h["return"]()}finally{if(s)throw a}}}if(e.childIfs){var m=!0,v=!1,f=void 0;try{for(var p,c=e.childIfs[Symbol.iterator]();!(m=(p=c.next()).done);m=!0){var u=p.value;u.update()}}catch(l){v=!0,f=l}finally{try{!m&&c["return"]&&c["return"]()}finally{if(v)throw f}}}}})}}),Mavo.hooks.add("unit-isdatanull",function(e){e.result=e.result||this.hidden&&"*"==e.options.store}),$.live(Mavo.Primitive.prototype,"hidden",function(e){this._hidden!==e&&(this._hidden=e,this.dataChanged())}),$.lazy(Mavo.Expression.Text.prototype,"childProperties",function(){var e=this;if("mv-if"==this.attribute){var t=$$(Mavo.selectors.property,this.element).filter(function(t){return t.closest("[mv-if]")==e.element}).map(function(e){return Mavo.Node.get(e)});return this.element.addEventListener("mavo:datachange",function(t){requestAnimationFrame(function(){
e.element.parentNode||e.item.element.dispatchEvent(t)})}),t}});
