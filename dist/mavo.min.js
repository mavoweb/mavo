...
},error:function i(e){for(var n=function(){return t.transition(i,{opacity:0}).then(t.remove)},i=(setTimeout(n,5e3),t.create("p",{className:"mv-error mv-ui",contents:[e,{tag:"button",className:"mv-close mv-ui",textContent:"×",events:{click:n}}],start:this.element})),s=arguments.length,r=Array(s>1?s-1:0),o=1;o<s;o++)r[o-1]=arguments[o];if(r.length>0){var a;(a=console).log.apply(a,["%c"+e,"color: red; font-weight: bold"].concat(r))}},render:function(t){n.hooks.run("render-start",{context:this,data:t}),t&&(this.editing?(this.done(),this.root.render(t),this.edit()):this.root.render(t)),this.unsavedChanges=!1},clear:function(){confirm("This will delete all your data. Are you sure?")&&(this.store(null),this.root.clear())},edit:function(){this.root.edit(),t.events(this.element,"mouseenter.mavo:edit mouseleave.mavo:edit",function(t){if(t.target.matches(".mv-item-controls *")){var e=t.target.closest(n.selectors.item);e.classList.toggle("mv-highlight","mouseenter"==t.type)}if(t.target.matches(n.selectors.item)){
t.target.classList.remove("mv-has-hovered-item");var i=t.target.parentNode.closest(n.selectors.item);i&&i.classList.toggle("mv-has-hovered-item","mouseenter"==t.type)}},!0),this.setUnsavedChanges()},setUnsavedChanges:function(t){var e=!!t;return t||this.walk(function(n){if(n.unsavedChanges)return e=!0,t===!1&&(n.unsavedChanges=!1),!1}),this.unsavedChanges=e},done:function(){this.root.done(),t.unbind(this.element,".mavo:edit"),this.unsavedChanges=!1},load:function(){var e=this;this.inProgress="Loading";var n=this.storage||this.source;return n.ready.then(function(){return n.get()})["catch"](function(t){return e.source&&n!==e.source?e.source.ready.then(function(){return e.source.get()}):Promise.reject(t)}).then(function(n){if(n&&"string"==t.type(n))try{n=JSON.parse(n)}catch(i){e.error("The data is corrupted."),e.error("The data is corrupted.",i,n),n=""}e.render(n)})["catch"](function(t){t&&(t.xhr&&404==t.xhr.status?e.render(""):(console.error(t),console.log(t.stack)))}).then(function(){e.inProgress=!1,
t.fire(e.element,"mavo:load")})},store:function(){var e=this;this.storage&&(this.inProgress="Saving",this.storage.login().then(function(){return e.storage.put()}).then(function(n){t.fire(e.element,"mavo:save",{data:n.data,dataString:n.dataString}),e.lastSaved=Date.now()})["catch"](function(t){t&&(console.error(t),console.log(t.stack))}).then(function(){e.inProgress=!1}))},save:function(){this.root.save(),this.store(),this.unsavedChanges=!1},revert:function(){this.root.revert()},walk:function(t){this.root.walk(t)},live:{inProgress:function(e){t.toggleAttribute(this.element,"mv-progress",e,e)},unsavedChanges:function(t){this.element.classList.toggle("mv-unsaved-changes",t),this.ui&&this.ui.save&&(this.ui.save.disabled=!t,this.ui.revert.disabled=!t)},needsEdit:function(e){t.toggleAttribute(this.ui.bar,"hidden","",!e)}},"static":{all:[],superKey:0===navigator.platform.indexOf("Mac")?"metaKey":"ctrlKey",init:function(t){return e(n.selectors.init,t||document).filter(function(t){return t==document.documentElement||!t.parentNode.closest(n.selectors.init);
}).map(function(t){return new n(t)})},hooks:new t.Hooks,attributes:["mv-app","mv-storage","mv-init","mv-attribute","mv-default","mv-mode","mv-edit","mv-permisssions"]}});!function(){var e=n.selectors={init:".mv-app, [mv-app], [data-mv-app], [mv-storage], [data-mv-storage]",property:"[property], [itemprop]",specificProperty:function(t){return"[property="+t+"], [itemprop="+t+"]"},group:"[typeof], [itemscope], [itemtype], .mv-group",multiple:"[mv-multiple], .mv-multiple",formControl:"input, select, option, textarea",item:".mv-item",ui:".mv-ui",container:{tr:"table",option:"select"}},i=e.arr=function(t){return t.split(/\s*,\s*/g)},s=e.not=function(t){return i(t).map(function(t){return":not("+t+")"}).join("")},r=e.or=function(t,e){return t+", "+e},o=e.and=function(t,e){var n=[],s=i(e);return i(t).forEach(function(t){return n.push.apply(n,_toConsumableArray(s.map(function(e){return t+e})))}),n.join(", ")},a=e.andNot=function(t,e){return o(t,s(e))};t.extend(n.selectors,{primitive:a(e.property,e.group),
rootGroup:a(e.group,e.property),output:r(e.specificProperty("output"),".mv-output, .mv-value")})}(),Promise.all([t.ready(),t.include(Array.from&&window.Intl&&document.documentElement.closest,"https://cdn.polyfill.io/v2/polyfill.min.js?features=blissfuljs,Intl.~locale.en")])["catch"](function(t){return console.error(t)}).then(function(){return Mavo.init()}),Stretchy.selectors.filter=".mv-editor:not([property])"}(Bliss,Bliss.$);
"use strict";!function(t,r){function e(t,e){for(t="mv-"+t+"-within",r("."+t).forEach(function(r){return r.classList.remove(t)});e&&e.classList;)e.classList.add(t),e=e.parentNode}var n=t.extend(Mavo,{toJSON:function(t){return null===t?"":"string"==typeof t?t:JSON.stringify(t,null,"\t")},readable:function(t){return t&&t.replace(/([a-z])([A-Z])(?=[a-z])/g,function(t,r,e){return r+" "+e.toLowerCase()}).replace(/([a-z])[_\/-](?=[a-z])/g,"$1 ").replace(/^[a-z]/,function(t){return t.toUpperCase()})},queryJSON:function(r,e){return e&&r?t.value.apply(t,[r].concat(e.split("/"))):r},toArray:function(t){return void 0===t?[]:Array.isArray(t)?t:[t]},"delete":function(t,r){var e=t&&t.indexOf(r);e>-1&&t.splice(e,1)},flatten:function(t){return Array.isArray(t)?t.reduce(function(t,r){return n.toArray(t).concat(n.flatten(r))},[]):[t]},is:function(t){for(var r=arguments.length,e=Array(r>1?r-1:0),i=1;i<r;i++)e[i-1]=arguments[i];var a=!0,o=!1,u=void 0;try{for(var s,c=e[Symbol.iterator]();!(a=(s=c.next()).done);a=!0){
...
var e=t();requestAnimationFrame(function(){return r.run()})}else var e=t();return e}}),defer:function(t){var r,e,n=new Promise(function(n,i){t&&t(n,i),r=n,e=i});return n.resolve=function(t){return r(t),n},n.reject=function(t){return e(t),n},n},rr:function(t){return t(),t}});t.add("toggleAttribute",function(t,r){var e=arguments.length<=2||void 0===arguments[2]?null!==r:arguments[2];e?this.setAttribute(t,r):this.removeAttribute(t)}),t.proxy=t.classProps.proxy=t.overload(function(t,r,e){return Object.defineProperty(t,r,{get:function(){return this[e][r]},set:function(t){this[e][r]=t},configurable:!0,enumerable:!0}),t}),t.classProps.propagated=function(t,r){Mavo.toArray(r).forEach(function(r){var e=t[r];t[r]=function(){var t=e&&e.apply(this,arguments);this.propagate&&t!==!1&&this.propagate(r)}})},document.addEventListener("focus",function(t){e("focus",t.target)},!0),document.addEventListener("blur",function(t){e("focus",null)},!0),addEventListener("hashchange",function(r){e("target",t(location.hash));
}),document.documentElement.addEventListener("mavo:datachange",function(r){e("target",t(location.hash))}),e("focus",document.activeElement!==document.body?document.activeElement:null)}(Bliss,Bliss.$);
