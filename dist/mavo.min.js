...
return void 0!==i?i:(i={},this.propagate(function(t){if((t.saved||"*"==!e.store)&&!(t.property in i)){var r=t.getData(e);(null!==r||e["null"])&&(i[t.property]=r)}}),e.dirty&&!e.unhandled||t.extend(i,this.unhandled),this.type&&this.type!=r.DEFAULT_TYPE&&(i["@type"]=this.type),this.vocab&&(i["@context"]=this.vocab),i)},find:function(t){if(this.property==t)return this;if(t in this.properties)return this.properties[t].find(t);for(var e in this.properties){var r=this.properties[e].find(t);if(void 0!==r)return r}},propagate:function(e){var r=arguments;t.each(this.properties,function(t,e){e.call.apply(e,r)})},save:function(){this.unsavedChanges=!1},done:function(){t.unbind(this.element,".mavo:edit")},propagated:["save","done","import","clear"],render:function(e){var r=this;e&&(Mavo.hooks.run("group-render-start",this),e=Array.isArray(e)?e[0]:e,this.unhandled=t.extend({},e,function(t){return!(t in r.properties)}),this.propagate(function(t){t.render(e[t.property])}),this.save(),Mavo.hooks.run("group-render-end",this));
},contains:function(t){return t instanceof Mavo.Unit?t.parentGroup===this:t.parentNode&&this.element===t.parentNode.closest(Mavo.selectors.group)},"static":{all:new WeakMap,DEFAULT_TYPE:"Item",normalize:function(t){if(Mavo.is("group",t)){var e=t.getAttribute("typeof")||t.getAttribute("itemtype")||r.DEFAULT_TYPE;return t.setAttribute("typeof",e),e}return null}}})}(Bliss,Bliss.$);
