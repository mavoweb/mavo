...
return void 0!==o?o:(o={},this.propagate(function(t){if((!t.computed||e.computed)&&!(t.property in o)){var i=t.getData(e);(null!==i||e["null"])&&(o[t.property]=i)}}),e.dirty&&!e.unhandled||t.extend(o,this.unhandled),this.type&&this.type!=i.DEFAULT_TYPE&&(o["@type"]=this.type),this.vocab&&(o["@context"]=this.vocab),o)},find:function(t){if(this.property==t)return this;if(t in this.properties)return this.properties[t].find(t);for(var e in this.properties){var i=this.properties[e].find(t);if(void 0!==i)return i}},propagate:function(e){var i=arguments;t.each(this.properties,function(t,e){e.call.apply(e,i)})},save:function(){return!this.placeholder&&void(this.unsavedChanges=!1)},done:function(){t.unbind(this.element,".mavo:edit")},propagated:["save","done","import","clear"],render:function(e){var i=this;e&&(Mavo.hooks.run("scope-render-start",this),e=Array.isArray(e)?e[0]:e,this.unhandled=t.extend({},e,function(t){return!(t in i.properties)}),this.propagate(function(t){t.render(e[t.property]);
}),this.save(),Mavo.hooks.run("scope-render-end",this))},contains:function(t){return t instanceof Mavo.Unit?t.parentScope===this:t.parentNode&&this.element===t.parentNode.closest(Mavo.selectors.scope)},"static":{all:new WeakMap,DEFAULT_TYPE:"Item",normalize:function(t){if(Mavo.is("scope",t)){var e=t.getAttribute("typeof")||t.getAttribute("itemtype")||i.DEFAULT_TYPE;return t.setAttribute("typeof",e),e}return null}}})}(Bliss,Bliss.$);
...
node:this,mavo:this.mavo,action:"add",item:r}))}return i.silent||(this.unsavedChanges=e.unsavedChanges=this.mavo.unsavedChanges=!0),e},propagate:function(){var e=arguments;this.items.forEach(function(t){return t.call.apply(t,e)})},"delete":function(t,i){var n=this;return i?(e.remove(t.element),void this.items.splice(this.items.indexOf(t),1)):e.transition(t.element,{opacity:0}).then(function(){t.deleted=!0,t.element.style.opacity="",t.element._.fire("mavo:datachange",{node:n,mavo:n.mavo,action:"delete",item:t}),n.unsavedChanges=t.unsavedChanges=n.mavo.unsavedChanges=!0})},edit:function(){if(0===this.length&&this.required){var t=this.add(null,null,!0);t.placeholder=!0,t.walk(function(e){return e.unsavedChanges=!1}),e.once(t.element,"mavo:datachange",function(e){t.unsavedChanges=!0,t.placeholder=!1})}this.propagate(function(e){return e[e.preEdit?"preEdit":"edit"]()})},clear:function(){this.mutable&&(this.propagate(function(e){if(e.element.remove)e.element.remove();else{var t=!0,i=!1,n=void 0;
try{for(var a,r=e.element.childNodes[Symbol.iterator]();!(t=(a=r.next()).done);t=!0){a.value}}catch(s){i=!0,n=s}finally{try{!t&&r["return"]&&r["return"]()}finally{if(i)throw n}}}}),this.items=[],this.marker._.fire("mavo:datachange",{node:this,mavo:this.mavo,action:"clear"}))},save:function(){var e=!0,t=!1,i=void 0;try{for(var n,a=this.items[Symbol.iterator]();!(e=(n=a.next()).done);e=!0){var r=n.value;r.deleted?this["delete"](r,!0):r.unsavedChanges=r.dirty=!1}}catch(s){t=!0,i=s}finally{try{!e&&a["return"]&&a["return"]()}finally{if(t)throw i}}},done:function(){var e=!0,t=!1,i=void 0;try{for(var n,a=this.items[Symbol.iterator]();!(e=(n=a.next()).done);e=!0){var r=n.value;if(r.placeholder)return void this["delete"](r,!0)}}catch(s){t=!0,i=s}finally{try{!e&&a["return"]&&a["return"]()}finally{if(t)throw i}}},propagated:["save","done"],revert:function(){var e=!0,t=!1,i=void 0;try{for(var n,a=this.items[Symbol.iterator]();!(e=(n=a.next()).done);e=!0){var r=n.value;r.unsavedChanges&&!r.placeholder?this["delete"](r,!0):(r.deleted&&(r.deleted=!1),
r.revert())}}catch(s){t=!0,i=s}finally{try{!e&&a["return"]&&a["return"]()}finally{if(t)throw i}}},render:function(e){var t=this;if(this.unhandled={before:[],after:[]},e){if(e=Mavo.toArray(e),this.mutable){this.clear();var i=document.createDocumentFragment();e.forEach(function(e,n){var a=t.createItem();a.render(e),t.items.push(a),a.index=n,i.appendChild(a.element)}),this.marker.parentNode.insertBefore(i,this.marker)}else this.items.forEach(function(t,i){return t.render(e&&e[i])}),e&&(this.unhandled.after=e.slice(this.items.length));this.save()}},find:function(e){var t=this.items.filter(function(e){return!e.deleted});if(this.property==e)return t;if(this.properties.indexOf(e)>-1){var i=t.map(function(t){return t.find(e)});return Mavo.flatten(i)}},live:{mutable:function(t){if(t&&t!==this.mutable&&(this._mutable=t,this.mavo.needsEdit=!0,this.required=this.templateElement.matches(Mavo.selectors.required),this.marker=e.create("div",{hidden:!0,className:"mv-marker",after:this.templateElement}),
this.templateElement.classList.add("mv-item"),!this.addButton.parentNode))if(this.bottomUp)this.addButton._.before(e.value(this.items[0],"element")||this.marker);else{var i=this.element.tagName.toLowerCase(),n=Mavo.selectors.container[i];if(n)var a=this.marker.closest(n);this.addButton._.after(a&&a.parentNode?a:this.marker)}}},lazy:{bottomUp:function(){if(!this.mutable)return!1;var e=this.templateElement.getAttribute("data-order");return null!==e?/^desc\b/i.test(e):!!this.addButton.parentNode&&!!(this.addButton.compareDocumentPosition(this.templateElement)&Node.DOCUMENT_POSITION_FOLLOWING)},closestCollection:function(){var e=this.marker?this.marker.parentNode:this.templateElement.parentNode;return e.closest(Mavo.selectors.item)},addButton:function(){var i=this,n="button.add-"+this.property,a=this.closestCollection||this.marker.closest(Mavo.selectors.scope);if(a)var r=t(n,a).filter(function(e){return!i.templateElement.contains(e)})[0];return r||(r=e.create("button",{className:"add",textContent:"Add "+this.name
})),r.classList.add("mv-ui","mv-add"),this.property&&r.classList.add("add-"+this.property),r.addEventListener("click",function(e){e.preventDefault(),i.add().edit()}),r}}})}(Bliss,Bliss.$);
