...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,n=Array(t.length);e<t.length;e++)n[e]=t[e];return n}return Array.from(t)}!function(t,e){var n=self.Mavo=t.Class({constructor:function(i){var s=this;this.treeBuilt=Mavo.defer(),this.element=i,this.index=n.all.push(this);var r=n.attributes.map(function(t){return"[data-"+t+"]"}),o=!0,a=!1,u=void 0;try{for(var c,l=e(r.join(", "),this.element).concat(this.element)[Symbol.iterator]();!(o=(c=l.next()).done);o=!0){var m=c.value,h=!0,v=!1,d=void 0;try{for(var f,g=n.attributes[Symbol.iterator]();!(h=(f=g.next()).done);h=!0){var p=f.value,b=m.getAttribute("data-"+p);null!==b&&m.setAttribute(p,b)}}catch(y){v=!0,d=y}finally{try{!h&&g["return"]&&g["return"]()}finally{if(v)throw d}}}}catch(y){a=!0,u=y}finally{try{!o&&l["return"]&&l["return"]()}finally{if(a)throw u}}this.id=Mavo.getAttribute(this.element,"mv-app","id")||"mavo"+this.index,this.element.setAttribute("mv-app",this.id),this.unhandled=this.element.classList.contains("mv-keep-unhandled"),
this.autoEdit=this.element.classList.contains("mv-autoedit"),1==this.index&&(this.storage=n.urlParam("store"),this.source=n.urlParam("source")),this.storage=this.storage||n.urlParam(this.id+"_store")||this.element.getAttribute("mv-storage")||null,this.source=this.source||n.urlParam(this.id+"_source")||this.element.getAttribute("mv-init")||null,this.storage&&(this.storage=this.storage.trim(),this.storage="none"==this.storage?null:n.Backend.create(this.storage,this)),this.source&&(this.source=n.Backend.create(this.source,this)),this.permissions=this.storage?this.storage.permissions:new Mavo.Permissions,this.element.addEventListener("keydown",function(t){83==t.keyCode&&t[n.superKey]&&(t.preventDefault(),s.save())}),this.element.setAttribute("typeof",""),e(n.selectors.primitive,i).forEach(function(e){var i=t(n.selectors.not(n.selectors.formControl)+", "+n.selectors.property,e);if(i){var s=Mavo.Primitive.getDefaults(e),r=Mavo.is("multiple",e);(r||!Mavo.Primitive.getValueAttribute(e,s)&&!s.hasChildren)&&e.setAttribute("typeof","");
}}),this.ui={bar:t(".mv-bar",this.element)||t.create({className:"mv-bar mv-ui",start:this.element})},this.ui.status=t(".mv-status",this.ui.bar)||t.create("span",{className:"mv-status",inside:this.ui.bar}),this.storage&&(this.authControls={},this.permissions.can("login",function(){s.loginHash="#login"+(Mavo.all[0]===s?"":"-"+s.id),s.authControls.login=t.create({tag:"a",href:s.loginHash,textContent:"Login",className:"mv-login mv-button",events:{click:function(t){t.preventDefault(),s.storage.login()}},after:t(".mv-status",s.ui.bar)});var e;(e=function(){location.hash===s.loginHash&&(history.replaceState(null,document.title,new URL("",location)+""),s.storage.login())})(),window.addEventListener("hashchange.mavo",e)},function(){t.remove(s.authControls.login),s.element._.unbind("hashchange.mavo")}),this.element.addEventListener("mavo:login.mavo",function(e){if(e.backend==s.storage){var n=t(".mv-status",s.ui.bar);n.innerHTML="",n._.contents(["Logged in to "+e.backend.id+" as ",{tag:"strong",innerHTML:e.name
},{tag:"button",textContent:"Logout",className:"mv-logout",events:{click:function(t){return e.backend.logout()}}}])}}),this.element.addEventListener("mavo:logout.mavo",function(e){t(".mv-status",s.ui.bar).textContent=""})),t("summary [property]:not([typeof])")&&this.element.addEventListener("click",function(t){t.target!=document.activeElement&&t.preventDefault()}),this.needsEdit=!1,Mavo.hooks.run("init-tree-before",this),this.root=new Mavo.Group(this.element,this),this.treeBuilt.resolve(),Mavo.hooks.run("init-tree-after",this),this.setUnsavedChanges(!1),this.permissions.onchange(function(t){var e=t.action,n=t.value,i=s.element.getAttribute("mv-permissions")||"";i=i.trim().split(/\s+/).filter(function(t){return t!=e}),n&&i.push(e),s.element.setAttribute("mv-permissions",i.join(" "))}),this.permissions.can(["edit","add","delete"],function(){s.ui.edit=t.create("button",{className:"mv-edit",textContent:"Edit",onclick:function(t){return s.editing?s.done():s.edit()},inside:s.ui.bar}),s.autoEdit&&s.ui.edit.click();
},function(){t.remove(s.ui.edit),s.editing&&s.done()}),this.needsEdit&&this.permissions.can("save",function(){s.ui.save=t.create("button",{className:"mv-save",textContent:"Save",events:{click:function(t){return s.save()},"mouseenter focus":function(t){s.element.classList.add("mv-save-hovered"),s.setUnsavedChanges()},"mouseleave blur":function(t){return s.element.classList.remove("mv-save-hovered")}},inside:s.ui.bar}),s.ui.revert=t.create("button",{className:"mv-revert",textContent:"Revert",disabled:!0,events:{click:function(t){return s.revert()},"mouseenter focus":function(t){s.unsavedChanges||(s.element.classList.add("mv-revert-hovered"),s.setUnsavedChanges())},"mouseleave blur":function(t){return s.element.classList.remove("mv-revert-hovered")}},inside:s.ui.bar})},function(){t.remove([s.ui.save,s.ui.revert]),s.ui.save=s.ui.revert=null}),this.permissions.can("delete",function(){s.ui.clear=t.create("button",{className:"mv-clear",textContent:"Clear",onclick:function(t){return s.clear()}}),
s.ui.bar.appendChild(s.ui.clear)}),this.permissions.cannot(["delete","edit"],function(){t.remove(s.ui.clear)}),this.storage||this.source?(this.storage||this.source.permissions.can("read",function(){return s.permissions.read=!0}),this.permissions.can("read",function(){return s.load()})):(this.permissions.on(["read","edit"]),t.fire(this.element,"mavo:load")),this.needsEdit||(this.permissions.off(["edit","add","delete"]),this.element.addEventListener("mavo:load",function(t){var e=n.debounce(function(){s.save()},1e3),i=function(t){t.node.saved&&e()};requestAnimationFrame(function(){s.permissions.can("save",function(){s.element.addEventListener("mavo:datachange",i)},function(){s.element.removeEventListener("mavo:datachange",i)})})})),Mavo.hooks.run("init-end",this)},get editing(){return this.root.editing},get data(){return this.getData()},getData:function(t){return this.root.getData(t)},toJSON:function(){var t=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0];return n.toJSON(t);
},render:function(t){n.hooks.run("render-start",{context:this,data:t}),t&&(this.editing?(this.done(),this.root.render(t),this.edit()):this.root.render(t)),this.unsavedChanges=!1},clear:function(){confirm("This will delete all your data. Are you sure?")&&(this.store(null),this.root.clear())},edit:function(){this.root.edit(),t.events(this.element,"mouseenter.mavo:edit mouseleave.mavo:edit",function(t){if(t.target.matches(".mv-item-controls .mv-delete")){var e=t.target.closest(n.selectors.item);e.classList.toggle("mv-delete-hover","mouseenter"==t.type)}if(t.target.matches(n.selectors.item)){t.target.classList.remove("mv-has-hovered-item");var i=t.target.parentNode.closest(n.selectors.item);i&&i.classList.toggle("mv-has-hovered-item","mouseenter"==t.type)}},!0),this.setUnsavedChanges()},setUnsavedChanges:function(t){var e=!!t;return t||this.walk(function(n){if(n.unsavedChanges)return e=!0,t===!1&&(n.unsavedChanges=!1),!1}),this.unsavedChanges=e},done:function(){this.root.done(),t.unbind(this.element,".mavo:edit"),
this.unsavedChanges=!1},load:function(){var e=this;this.inProgress="Loading";var n=this.storage||this.source;return n.ready.then(function(){return n.get()})["catch"](function(t){return e.source&&n!==e.source?e.source.ready.then(function(){return e.source.get()}):Promise.reject(t)}).then(function(n){if(n&&"string"==t.type(n))try{n=JSON.parse(n)}catch(i){console.log("%cJSON parse error","color: red; font-weight: bold",n),n=""}e.render(n)})["catch"](function(t){t&&(t.xhr&&404==t.xhr.status?e.render(""):(console.error(t),console.log(t.stack)))}).then(function(){e.inProgress=!1,t.fire(e.element,"mavo:load")})},store:function(){var e=this;this.storage&&(this.inProgress="Saving",this.storage.login().then(function(){return e.storage.put()}).then(function(n){t.fire(e.element,"mavo:save",{data:n.data,dataString:n.dataString}),e.lastSaved=Date.now()})["catch"](function(t){t&&(console.error(t),console.log(t.stack))}).then(function(){e.inProgress=!1}))},save:function(){this.root.save(),this.store(),
this.unsavedChanges=!1},revert:function(){this.root.revert()},walk:function(t){this.root.walk(t)},live:{inProgress:function(e){t.toggleAttribute(this.element,"mv-progress",e,e)},unsavedChanges:function(t){this.element.classList.toggle("mv-unsaved-changes",t),this.ui&&this.ui.save&&(this.ui.save.disabled=!t,this.ui.revert.disabled=!t)},needsEdit:function(e){t.toggleAttribute(this.ui.bar,"hidden","",!e)}},"static":{all:[],superKey:0===navigator.platform.indexOf("Mac")?"metaKey":"ctrlKey",init:function(t){return e(n.selectors.init,t||document).filter(function(t){return t==document.documentElement||!t.parentNode.closest(n.selectors.init)}).map(function(t){return new n(t)})},hooks:new t.Hooks,attributes:["mv-app","mv-storage","mv-init","mv-attribute","mv-default","mv-mode","mv-edit","mv-permisssions"]}});!function(){var e=n.selectors={init:".mv-app, [mv-app], [data-mv-app], [mv-storage], [data-mv-storage]",property:"[property], [itemprop]",specificProperty:function(t){return"[property="+t+"], [itemprop="+t+"]";
},group:"[typeof], [itemscope], [itemtype], .mv-group",multiple:"[mv-multiple], .mv-multiple",formControl:"input, select, option, textarea",item:".mv-item",ui:".mv-ui",container:{tr:"table",option:"select"}},i=e.arr=function(t){return t.split(/\s*,\s*/g)},s=e.not=function(t){return i(t).map(function(t){return":not("+t+")"}).join("")},r=e.or=function(t,e){return t+", "+e},o=e.and=function(t,e){var n=[],s=i(e);return i(t).forEach(function(t){return n.push.apply(n,_toConsumableArray(s.map(function(e){return t+e})))}),n.join(", ")},a=e.andNot=function(t,e){return o(t,s(e))};t.extend(n.selectors,{primitive:a(e.property,e.group),rootGroup:a(e.group,e.property),output:r(e.specificProperty("output"),".mv-output, .mv-value")})}(),Promise.all([t.ready(),t.include(Array.from&&window.Intl&&document.documentElement.closest,"https://cdn.polyfill.io/v2/polyfill.min.js?features=blissfuljs,Intl.~locale.en")])["catch"](function(t){return console.error(t)}).then(function(){return Mavo.init()}),Stretchy.selectors.filter=".mv-editor:not([property])";
}(Bliss,Bliss.$);
"use strict";!function(t,r){function e(t,e){for(t="mv-"+t+"-within",r("."+t).forEach(function(r){return r.classList.remove(t)});e&&(e=e.parentNode)&&e.classList;)e.classList.add(t)}var n=t.extend(Mavo,{toJSON:function(t){return null===t?"":"string"==typeof t?t:JSON.stringify(t,null,"\t")},readable:function(t){return t&&t.replace(/([a-z])([A-Z])(?=[a-z])/g,function(t,r,e){return r+" "+e.toLowerCase()}).replace(/([a-z])[_\/-](?=[a-z])/g,"$1 ").replace(/^[a-z]/,function(t){return t.toUpperCase()})},queryJSON:function(r,e){return e&&r?t.value.apply(t,[r].concat(e.split("/"))):r},toArray:function(t){return void 0===t?[]:Array.isArray(t)?t:[t]},"delete":function(t,r){var e=t&&t.indexOf(r);e>-1&&t.splice(e,1)},flatten:function(t){return Array.isArray(t)?t.reduce(function(t,r){return n.toArray(t).concat(n.flatten(r))},[]):[t]},is:function(t){for(var r=arguments.length,e=Array(r>1?r-1:0),i=1;i<r;i++)e[i-1]=arguments[i];var a=!0,o=!1,u=void 0;try{for(var s,c=e[Symbol.iterator]();!(a=(s=c.next()).done);a=!0){
var l=s.value;if(l&&l.matches&&l.matches(n.selectors[t]))return!0}}catch(f){o=!0,u=f}finally{try{!a&&c["return"]&&c["return"]()}finally{if(o)throw u}}return!1},data:function(r,e,n){return void 0===n?t.value(r,"_","data","mavo",e):(r._.data.mavo=r._.mavo||{},void(r._.data.mavo[e]=n))},pushUnique:function(t,r){t.indexOf(r)===-1&&t.push(r)},getAttribute:function(t){for(var r=arguments.length,e=Array(r>1?r-1:0),n=1;n<r;n++)e[n-1]=arguments[n];for(var i,a=0;i=e[a];a++){var o=t.getAttribute(i);if(o)return o}return null},urlParam:function(){for(var t=("searchParams"in URL.prototype?new URL(location).searchParams:null),r=null,e=arguments.length,n=Array(e),i=0;i<e;i++)n[i]=arguments[i];var a=!0,o=!1,u=void 0;try{for(var s,c=n[Symbol.iterator]();!(a=(s=c.next()).done);a=!0){var l=s.value;if(t)r=t.get(l);else{var f=location.search.match(RegExp("[?&]"+l+"(?:=([^&]+))?(?=&|$)","i"));r=f&&(f[1]||"")}if(null!==r)return r}}catch(h){o=!0,u=h}finally{try{!a&&c["return"]&&c["return"]()}finally{if(o)throw u;
}}return null},debounce:function(t,r){var e=null;return function(){var n=this,i=arguments;clearTimeout(e),e=setTimeout(function(){t.apply(n,i)},r)}},escapeRegExp:function(t){return t.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")},Observer:t.Class({constructor:function(r,e,n,i){n instanceof MutationObserver&&(this.observer=n),this.observer=this.observer||new MutationObserver(n),this.element=r,this.callback=n,this.attribute=e,this.oldValue=i,this.options={},e&&t.extend(this.options,{attributes:!0,attributeFilter:"all"==this.attribute?void 0:[this.attribute],attributeOldValue:!!this.oldValue}),this.attribute&&"all"!=this.attribute||t.extend(this.options,{characterData:!0,childList:!0,subtree:!0,characterDataOldValue:!!this.oldValue}),this.run()},stop:function(){return this.running&&(this.observer.disconnect(),this.running=!1),this},run:function(){return this.running||(this.observer.observe(this.element,this.options),this.running=!0),this},sneak:function(t){var r=this;if(this.running){this.stop();
var e=t();requestAnimationFrame(function(){return r.run()})}else var e=t();return e}}),defer:function(t){var r,e,n=new Promise(function(n,i){t&&t(n,i),r=n,e=i});return n.resolve=function(t){return r(t),n},n.reject=function(t){return e(t),n},n}});t.add("toggleAttribute",function(t,r){var e=arguments.length<=2||void 0===arguments[2]?null!==r:arguments[2];e?this.setAttribute(t,r):this.removeAttribute(t)}),t.proxy=t.classProps.proxy=t.overload(function(t,r,e){return Object.defineProperty(t,r,{get:function(){return this[e][r]},set:function(t){this[e][r]=t},configurable:!0,enumerable:!0}),t}),t.classProps.propagated=function(t,r){Mavo.toArray(r).forEach(function(r){var e=t[r];t[r]=function(){var t=e&&e.apply(this,arguments);this.propagate&&t!==!1&&this.propagate(r)}})},document.addEventListener("focus",function(t){e("focus",t.target)},!0),document.addEventListener("blur",function(t){e("focus",null)},!0),addEventListener("hashchange",function(r){e("target",t(location.hash))},!0),e("target",t(location.hash)),
e("focus",document.activeElement!==document.body?document.activeElement:null)}(Bliss,Bliss.$);
...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,o=Array(t.length);e<t.length;e++)o[e]=t[e];return o}return Array.from(t)}!function(t,e){var o=Mavo.Node=t.Class({"abstract":!0,constructor:function(t,e){var r=this,i=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];if(!t||!e)throw new Error("Mavo.Node constructor requires an element argument and a mavo object");var n={context:this,options:i};this.uid=++o.maxId,o.all.set(t,[].concat(_toConsumableArray(o.all.get(this.element)||[]),[this])),this.element=t,this.template=n.options.template,this.template?this.template.copies.push(this):this.copies=[],this.mavo=e,this.fromTemplate("property","type","modes")||(this.property=o.getProperty(t),this.type=Mavo.Group.normalize(t),this.store=this.element.getAttribute("mv-storage"),this.modes=this.element.getAttribute("mv-mode")),this.modeObserver=new Mavo.Observer(this.element,"mv-mode",function(t){console.log("%cmutation observer on","color:purple;",r.property,r.uid,r.template),
r.mode=r.element.getAttribute("mv-mode"),r["edit"==r.mode?"edit":"done"]()}),this.mode=this.modes||"read",this.group=this.parentGroup=n.options.group,Mavo.hooks.run("node-init-end",n)},get editing(){return"edit"==this.mode},get constant(){return"read"==this.modes},get isRoot(){return!this.property},get name(){return Mavo.readable(this.property||this.type).toLowerCase()},get data(){return this.getData()},get saved(){return"none"!==this.store},getData:function(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return this.isDataNull(t)?null:void this.walkUp(function(e){if(e.isDataNull(t))return null})},isDataNull:function(t){var e={context:this,options:t,result:this.deleted||!this.saved&&"*"!=t.store};return Mavo.hooks.run("unit-isdatanull",e),e.result},walk:function(t){var e=function o(e){var r=t(e);r!==!1&&e.propagate&&e.propagate(o)};e(this)},walkUp:function(t){for(var e=this;e=e.parentGroup;){var o=t(e);if(void 0!==o)return o}},edit:function(){this.mode="edit",this.propagate("edit"),
Mavo.hooks.run("node-edit-end",this)},done:function(){this.mode="read",t.unbind(this.element,".mavo:edit"),this.propagate("done"),Mavo.hooks.run("node-done-end",this)},propagate:function(t){for(var e in this.children){var o=this.children[e];o instanceof Mavo.Node&&("function"==typeof t?t.call(o,o):t in o&&o[t]())}},propagated:["save","revert"],toJSON:Mavo.prototype.toJSON,fromTemplate:function(){if(this.template){for(var t=arguments.length,e=Array(t),o=0;o<t;o++)e[o]=arguments[o];var r=!0,i=!1,n=void 0;try{for(var a,s=e[Symbol.iterator]();!(r=(a=s.next()).done);r=!0){var u=a.value;this[u]=this.template[u]}}catch(l){i=!0,n=l}finally{try{!r&&s["return"]&&s["return"]()}finally{if(i)throw n}}}return!!this.template},dataChanged:function(e){var o=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];t.fire(o.element||this.element,"mavo:datachange",t.extend({property:this.property,action:e,mavo:this.mavo,node:this},o))},toString:function(){return"#"+this.uid+": "+this.nodeType+" ("+this.property+")";
},live:{store:function(e){t.toggleAttribute(this.element,"mv-storage",e)},unsavedChanges:function(t){return!t||this.saved&&this.editing||(t=!1),this.element.classList.toggle("mv-unsaved-changes",t),t},mode:function(e){var o=this;this._mode!=e&&(this._mode=e,this.modeObserver.sneak(function(){var r=o.modes||"edit"==o.mode;t.toggleAttribute(o.element,"mv-mode",e,r)}))}},"static":{maxId:0,all:new WeakMap,create:function(t,e){var o=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];return Mavo.is("multiple",t)&&!o.collection?new Mavo.Collection(t,e,o):new(Mavo[Mavo.is("group",t)?"Group":"Primitive"])(t,e,o)},getProperty:function(t){var e=t.getAttribute("property")||t.getAttribute("itemprop");return!e&&t.hasAttribute("property")&&(e=t.name||t.id||t.classList[0]),e&&t.setAttribute("property",e),e},get:function(t,e){var r=(o.all.get(t)||[]).filter(function(t){return!(t instanceof Mavo.Collection)});return r.length<2||!e?r[0]:r[0]instanceof Mavo.Group?node[1]:void 0}}})}(Bliss,Bliss.$);
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,r=Array(t.length);e<t.length;e++)r[e]=t[e];return r}return Array.from(t)}!function(t,e){var r=Mavo.Group=t.Class({"extends":Mavo.Node,nodeType:"Group",constructor:function(t,r,a){var n=this;if(this.children={},this.group=this,Mavo.hooks.run("group-init-start",this),Mavo.Primitive.getValueAttribute(this.element)){this.children[this.property]=new Mavo.Primitive(this.element,this.mavo,{group:this})}e(Mavo.selectors.property,this.element).forEach(function(t){var e=Mavo.Node.getProperty(t);if(n.contains(t)){var r=n.children[e],a=n.template?n.template.children[e]:null,i={template:a,group:n};if(r){var o=r;r instanceof Mavo.Collection||(o=new Mavo.Collection(r.element,n.mavo,i),n.children[e]=r.collection=o,o.add(r)),!o.mutable&&Mavo.is("multiple",t)&&(o.mutable=!0),o.add(t)}else{var s=Mavo.Node.create(t,n.mavo,i);n.children[e]=s}}});var i=(this.isRoot?this.element.closest("[vocab]"):null)||this.element;this.vocab=i.getAttribute("vocab"),
Mavo.hooks.run("group-init-end",this)},get isRoot(){return!this.property},getData:function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],a={context:this,options:e,data:this["super"].getData.call(this,e)};return void 0!==a.data?a.data:(a.data={},this.propagate(function(t){if((t.saved||"*"==e.store)&&!(t.property in a.data)){var r=t.getData(e);(null!==r||a.options["null"])&&(a.data[t.property]=r)}}),a.options.unhandled&&t.extend(a.data,this.unhandled),this.type&&this.type!=r.DEFAULT_TYPE&&(a.data["@type"]=this.type),this.vocab&&(a.data["@context"]=this.vocab),a.data.summary&&(a.data.toString=function(){return this.summary}),Mavo.hooks.run("node-getdata-end",a),a.data)},find:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];if(this.property==t)return this;if(t in this.children)return this.children[t].find(t,e);var r=[];for(var a in this.children){var n=this.children[a].find(t,e);if(void 0!==n){if(!Array.isArray(n))return n;r.push.apply(r,_toConsumableArray(n));
}}return r.length?r:void 0},save:function(){this.unsavedChanges=!1},propagated:["save","import","clear"],render:function(e){var r=this;e&&(Mavo.hooks.run("group-render-start",this),e=Array.isArray(e)?e[0]:e,this.unhandled=t.extend({},e,function(t){return!(t in r.children)}),this.propagate(function(t){t.render(e[t.property])}),this.save(),Mavo.hooks.run("group-render-end",this))},contains:function(t){return t instanceof Mavo.Node?t.parentGroup===this:t.parentNode&&this.element===t.parentNode.closest(Mavo.selectors.group)},"static":{all:new WeakMap,DEFAULT_TYPE:"Item",normalize:function(t){if(Mavo.is("group",t)){var e=Mavo.getAttribute(t,"typeof","itemtype")||r.DEFAULT_TYPE;return t.setAttribute("typeof",e),e}return null}}})}(Bliss,Bliss.$);
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){var i=Mavo.Primitive=t.Class({"extends":Mavo.Node,nodeType:"Primitive",constructor:function(a,n,s){var o=this;if(this.fromTemplate("defaults","attribute","templateValue")||(this.defaults=i.getDefaults(a),this.attribute=i.getValueAttribute(this.element,this.defaults)),this.datatype=this.defaults.datatype,this.modes=this.modes||this.defaults.modes,this.mode=this.modes||"read",Mavo.hooks.run("primitive-init-start",this),this.defaults.init&&this.defaults.init.call(this,this.element),this.defaults.changeEvents&&t.events(this.element,this.defaults.changeEvents,function(t){t.target===o.element&&(o.value=o.getValue())}),this.constant||(this.mavo.needsEdit=!0),this.editor||this.attribute||(this.editor=e(this.element.children).filter(function(t){return t.matches(Mavo.selectors.formControl)&&!t.matches(Mavo.selectors.property);
})[0],this.editor&&(this.element.textContent=this.editorValue,t.remove(this.editor))),!this.editor&&this.element.hasAttribute("mv-edit")){var r=t(this.element.getAttribute("mv-edit"));r&&Mavo.is("formControl",r)&&(this.editor=r.cloneNode(!0),this.template||new Mavo.Observer(r,"all",function(t){var e=!0,i=!1,a=void 0;try{for(var n,s=o.copies[Symbol.iterator]();!(e=(n=s.next()).done);e=!0){var u=n.value;u.editor=r.cloneNode(!0),u.setValue(u.value,{force:!0,silent:!0})}}catch(l){i=!0,a=l}finally{try{!e&&s["return"]&&s["return"]()}finally{if(i)throw a}}}))}this.templateValue=this.getValue(),this["default"]=this.element.getAttribute("mv-default"),this.constant||""===this["default"]?this["default"]=this.templateValue:null===this["default"]?this["default"]=this.editor?this.editorValue:this.emptyValue:new Mavo.Observer(this.element,"mv-default",function(t){o["default"]=o.element.getAttribute("mv-default")}),this.constant||this.setValue(this.templateValue,{silent:!0}),this.setValue(this.template?this["default"]:this.templateValue,{
silent:!0}),this.observer=new Mavo.Observer(this.element,this.attribute,function(t){!o.attribute&&o.editing||(o.value=o.getValue())}),Mavo.hooks.run("primitive-init-end",this)},get editorValue(){if(this.defaults.getEditorValue)return this.defaults.getEditorValue.call(this);if(this.editor){if(this.editor.matches(Mavo.selectors.formControl))return i.getValue(this.editor,{datatype:this.datatype});var e=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);if(e)return i.getValue(e)}},set editorValue(e){if(this.defaults.setEditorValue)return this.defaults.setEditorValue.call(this,e);if(this.editor)if(this.editor.matches(Mavo.selectors.formControl))i.setValue(this.editor,e,{defaults:this.editorDefaults});else{var a=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);a&&i.setValue(a,e)}},getData:function(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],e={context:this,options:t,data:this["super"].getData.call(this,t)};return void 0!==e.data?e.data:(e.data=this.value,
""===e.data&&(e.data=null),Mavo.hooks.run("node-getdata-end",e),e.data)},save:function(){this.savedValue=this.value,this.unsavedChanges=!1},done:function(){var e=this;this["super"].done.call(this),"preEdit"in this&&t.unbind(this.element,".mavo:preedit .mavo:edit"),this.sneak(function(){return e.defaults.done?void e.defaults.done.call(e):void(e.popup?e.popup.close():!e.attribute&&e.editor&&(t.remove(e.editor),e.element.textContent=e.editorValue))}),null!==this.element._.data.prevTabindex?this.element.tabIndex=this.element._.data.prevTabindex:this.element.removeAttribute("tabindex")},revert:function(){this.unsavedChanges&&void 0!==this.savedValue&&(this.value=this.savedValue,this.unsavedChanges=!1)},sneak:function(t){this.observer?this.observer.sneak(t):t()},initEdit:function(){var a=this;if(!this.editor){var n=this.defaults.editor||Mavo.Elements["*"].editor;this.editor=t.create("function"===t.type(n)?n.call(this):n),this.editorValue=this.value}t.events(this.editor,{"input change":function(t){
a.value=a.editorValue},focus:function(t){a.editor.select&&a.editor.select()},"mavo:datachange":function(e){"output"===e.property&&(e.stopPropagation(),t.fire(a.editor,"input"))}}),"placeholder"in this.editor&&(this.editor.placeholder="("+this.label+")");var s=/^mv-edit-/i;e(this.element.attributes).forEach(function(t){s.test(t.name)&&this.editor.setAttribute(t.name.replace(s,""),t.value)},this),this.attribute&&(this.popup=new i.Popup(this)),this.popup||this.editor.classList.add("mv-editor"),this.initEdit=null},edit:function(){var e=this;if(!this.constant)return this["super"].edit.call(this),this.element._.data.prevTabindex=this.element.getAttribute("tabindex"),this.element.tabIndex=0,this.element.addEventListener("click.mavo:edit",function(t){return t.preventDefault()}),this.preEdit=Mavo.defer(function(i,a){if(e.empty&&!e.attribute)return i();var n;t.events(e.element,{"click.mavo:preedit":i,"focus.mavo:preedit":i}),e.attribute||t.events(e.element,{"mouseenter.mavo:preedit":function(t){clearTimeout(n),
n=setTimeout(i,150)},"mouseleave.mavo:preedit":function(t){clearTimeout(n)}})}),this.defaults.edit?void this.defaults.edit.call(this):void this.preEdit.then(function(){t.unbind(e.element,".mavo:preedit"),e.initEdit&&e.initEdit(),e.popup?e.popup.show():e.editor.focus(),e.attribute||e.editor.parentNode!=e.element&&(e.editorValue=e.value,e.element.textContent="",e.element.appendChild(e.editor))})},clear:function(){this.constant||(this.value=this.emptyValue)},render:function(t){Array.isArray(t)&&(t=t[0]),"object"===("undefined"==typeof t?"undefined":_typeof(t))&&(t=t[this.property]),void 0===t?this.value=this.closestCollection?this["default"]:this.templateValue:this.value=t,this.save()},find:function(t){if(this.property==t)return this},getValue:function(t){return i.getValue(this.element,{defaults:this.defaults,attribute:this.attribute,datatype:this.datatype})},lazy:{label:function(){return Mavo.readable(this.property)},emptyValue:function(){switch(this.datatype){case"boolean":return!1;case"number":
return 0}return""},editorDefaults:function(){return this.editor&&i.getDefaults(this.editor)}},setValue:function(e){var a=this,n=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return this.sneak(function(){if("object"==t.type(e)&&"value"in e){var s=e.presentational;e=e.value}return e=e||0===e?e:"",e=i.safeCast(e,a.datatype),e!=a._value||n.force?(a.editor&&document.activeElement!=a.editor&&(a.editorValue=e),a.defaults.humanReadable&&a.attribute&&(s=a.defaults.humanReadable.call(a,e)),a.editing&&!a.attribute||(a.defaults.setValue?a.defaults.setValue.call(a,a.element,e):(a.editor&&a.editor.matches("select")&&a.editor.selectedOptions[0]&&(s=a.editor.selectedOptions[0].textContent),i.setValue(a.element,{value:e,presentational:s},{defaults:a.defaults,attribute:a.attribute,datatype:a.datatype}))),a.empty=""===e,a._value=e,void(n.silent||(a.saved&&(a.unsavedChanges=a.mavo.unsavedChanges=!0),requestAnimationFrame(function(){return a.dataChanged("propertychange",{value:e})})))):e}),e},dataChanged:function(){
var t=arguments.length<=0||void 0===arguments[0]?"propertychange":arguments[0],e=arguments[1];return this["super"].dataChanged.call(this,t,e)},live:{value:function(t){return this.setValue(t)},empty:function(e){var i=e&&!this.constant&&!(this.attribute&&t(Mavo.selectors.property,this.element));this.element.classList.toggle("mv-empty",i)}},"static":{all:new WeakMap,getDefaults:function(t){var e=null;for(var i in Mavo.Elements)t.matches(i)&&(e=Mavo.Elements[i]);return e},getValueAttribute:function(t){var e=arguments.length<=1||void 0===arguments[1]?i.getDefaults(t):arguments[1],a=t.getAttribute("mv-attribute")||e.attribute;return a&&"null"!==a||(a=null),a},safeCast:function(t,e){var a=("undefined"==typeof t?"undefined":_typeof(t),i.cast(t,e));return null===t||void 0===t?t:"boolean"==e?"false"!==t&&0!==t&&""!==t&&("true"===t||t>0||t):"number"==e?/^[-+]?[0-9.e]+$/i.test(t+"")?a:t:a},cast:function(t,e){switch(e){case"number":return+t;case"boolean":return!!t;case"string":return t+""}return t},
...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,n=Array(t.length);e<t.length;e++)n[e]=t[e];return n}return Array.from(t)}!function(t,e){Mavo.attributes.push("mv-multiple","mv-order","mv-accepts");var n=Mavo.Collection=t.Class({"extends":Mavo.Node,nodeType:"Collection",constructor:function(t,n,i){if(this.templateElement=this.element,this.children=[],this.fromTemplate("properties","mutable","templateElement","accepts")||(this.properties=e(Mavo.selectors.property,this.templateElement).map(Mavo.Node.getProperty),this.mutable=this.templateElement.matches(Mavo.selectors.multiple),this.accepts=(this.templateElement.getAttribute("mv-accepts")||"").split(/\s+/),this.templateElement=this.templateElement.cloneNode(!0)),this.mutable){var a=this.createItem(this.element);this.add(a),this.itemTemplate=a.template||a}Mavo.hooks.run("collection-init-end",this)},get length(){return this.children.length},getData:function(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],e={
context:this,options:t,data:[]},n=!0,i=!1,a=void 0;try{for(var o,r=this.children[Symbol.iterator]();!(n=(o=r.next()).done);n=!0)if(item=o.value,!item.deleted){var l=item.getData(e.options);l&&e.data.push(l)}}catch(s){i=!0,a=s}finally{try{!n&&r["return"]&&r["return"]()}finally{if(i)throw a}}return this.unhandled&&e.options.unhandled&&(e.data=this.unhandled.before.concat(e.data,this.unhandled.after)),this.mutable||1!=e.data.length||(e.data=e.data[0]),Mavo.hooks.run("node-getdata-end",e),e.data},createItem:function(t){t||(t=this.templateElement.cloneNode(!0));var e=Mavo.Node.create(t,this.mavo,{collection:this,template:this.itemTemplate||(this.template?this.template.itemTemplate:null),property:this.property,type:this.type});return e},add:function(t,e){var n=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];if(t=t instanceof Node?Mavo.Node.get(t)||this.createItem(t):t||this.createItem(),t.collection!=this&&this.adopt(t),e in this.children?this.bottomUp&&e++:void 0===e&&(e=this.bottomUp?0:this.length),
this.mutable){var i=this.children[e];t.element._.before(i&&i.element||this.marker)}var a=this.splice({remove:t},{index:e,add:t});return a.forEach(function(t){n.silent||(t.dataChanged("move"),t.unsavedChanges=!0)}),n.silent||(this.unsavedChanges=this.mavo.unsavedChanges=!0),t},splice:function(){for(var t=arguments.length,e=Array(t),n=0;n<t;n++)e[n]=arguments[n];var i=!0,a=!1,o=void 0;try{for(var r,l=e[Symbol.iterator]();!(i=(r=l.next()).done);i=!0){var s=r.value;void 0===s.index&&s.remove&&isNaN(s.remove)&&(s.index=this.children.indexOf(s.remove),s.remove=1)}}catch(d){a=!0,o=d}finally{try{!i&&l["return"]&&l["return"]()}finally{if(a)throw o}}e.sort(function(t,e){return e.index-t.index});var c=!0,h=!1,m=void 0;try{for(var u,v=e[Symbol.iterator]();!(c=(u=v.next()).done);c=!0){var p=u.value;if(p.index>-1&&(p.remove||p.add)){var f;p.remove=p.remove||0,p.add=Mavo.toArray(p.add),(f=this.children).splice.apply(f,[p.index,+p.remove].concat(_toConsumableArray(p.add)))}}}catch(d){h=!0,m=d}finally{try{
!c&&v["return"]&&v["return"]()}finally{if(h)throw m}}for(var g=[],y=0;y<this.length;y++){var C=this.children[y];C&&C.index!==y&&(C.index=y,g.push(C))}return g},adopt:function(t){var e=this;t.collection&&(t.collection.splice({remove:t}),t.collection.dataChanged("delete")),this.walk(function(n){n.closestCollection===t.collection&&(n.closestCollection=e),t.mavo!=e.mavo&&(t.mavo=e.mavo)}),t.collection=this,t.template&&(Mavo["delete"](t.template.copies,t),t.template=this.itemTemplate)},"delete":function(e,n){var i=this;return n?(t.remove(e.element),void this.splice({remove:e})):t.transition(e.element,{opacity:0}).then(function(){e.deleted=!0,e.element.style.opacity="",e.dataChanged("delete"),i.unsavedChanges=e.unsavedChanges=i.mavo.unsavedChanges=!0})},edit:function(){var e=this;if(this["super"].edit.call(this),this.mutable){if(!this.addButton.parentNode)if(this.bottomUp)this.addButton._.before(t.value(this.children[0],"element")||this.marker);else{var i=this.element.tagName.toLowerCase(),a=Mavo.selectors.container[i];
if(a)var o=this.marker.parentNode.closest(a);this.addButton._.after(o&&o.parentNode?o:this.marker)}n.dragula.then(function(){e.getDragula()})}},done:function(){this["super"].done.call(this),this.mutable&&this.addButton.parentNode&&this.addButton.remove()},clear:function(){this.mutable&&(this.propagate(function(t){if(t.element.remove)t.element.remove();else{var e=!0,n=!1,i=void 0;try{for(var a,o=t.element.childNodes[Symbol.iterator]();!(e=(a=o.next()).done);e=!0){a.value}}catch(r){n=!0,i=r}finally{try{!e&&o["return"]&&o["return"]()}finally{if(n)throw i}}}}),this.children=[],this.dataChanged("clear"))},dataChanged:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return e.element=e.element||this.marker,this["super"].dataChanged.call(this,t,e)},save:function(){var t=!0,e=!1,n=void 0;try{for(var i,a=this.children[Symbol.iterator]();!(t=(i=a.next()).done);t=!0){var o=i.value;o.deleted?this["delete"](o,!0):o.unsavedChanges=!1}}catch(r){e=!0,n=r}finally{try{!t&&a["return"]&&a["return"]();
}finally{if(e)throw n}}},propagated:["save"],revert:function(){var t=!0,e=!1,n=void 0;try{for(var i,a=this.children[Symbol.iterator]();!(t=(i=a.next()).done);t=!0){var o=i.value;o.unsavedChanges?this["delete"](o,!0):(o.deleted&&(o.deleted=!1),o.revert())}}catch(r){e=!0,n=r}finally{try{!t&&a["return"]&&a["return"]()}finally{if(e)throw n}}},render:function(t){var e=this;if(this.unhandled={before:[],after:[]},t){if(t=Mavo.toArray(t),this.mutable){this.clear();var n=document.createDocumentFragment();t.forEach(function(t,i){var a=e.createItem();a.render(t),e.children.push(a),a.index=i,n.appendChild(a.element)}),this.marker.parentNode.insertBefore(n,this.marker)}else this.children.forEach(function(e,n){return e.render(t&&t[n])}),t&&(this.unhandled.after=t.slice(this.length));this.save()}},find:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],n=this.children.filter(function(t){return!t.deleted});if(this.property==t)return e.collections?this:n;if(this.properties.indexOf(t)>-1){
var i=n.map(function(n){return n.find(t,e)});return Mavo.flatten(i)}},isCompatible:function(t){return t&&this.itemTemplate.nodeType==t.itemTemplate.nodeType&&(t===this||t.template==this||this.template==t||this.template&&this.template==t.template||this.accepts.indexOf(t.property)>-1)},live:{mutable:function(e){e&&e!==this.mutable&&(this._mutable=e,this.mavo.needsEdit=!0,this.marker=document.createComment("mv-marker"),Mavo.data(this.marker,"collection",this),t.after(this.marker,this.templateElement),this.templateElement.classList.add("mv-item"))}},getDragula:function(){var t=this;if(this.dragula)return this.dragula;if(this.template)return Mavo.pushUnique(this.template.dragula.containers,this.marker.parentNode),this.dragula=this.template.dragula||this.template.getDragula();return this.dragula=dragula({containers:[this.marker.parentNode],isContainer:function(e){return!!t.accepts.length&&Mavo.flatten(t.accepts.map(function(e){return t.mavo.root.find(e,{collections:!0})})).filter(function(t){
return t&&t instanceof n}).map(function(t){return t.marker.parentNode}).indexOf(e)>-1},moves:function(t,e,n){return n.classList.contains("mv-drag-handle")&&n.closest(Mavo.selectors.item)==t},accepts:function(t,e,i,a){if(t.contains(e))return!1;var o=a?a.previousElementSibling:e.lastElementChild,r=n.get(o)||n.get(a);if(!r)return!1;var l=Mavo.Node.get(t);return l&&l.collection.isCompatible(r)}}),this.dragula.on("drop",function(e,i,a){var o=Mavo.Node.get(e),r=(o&&o.index,e.nextElementSibling),l=e.previousElementSibling,s=n.get(l)||n.get(r),d=Mavo.Node.get(l)||Mavo.Node.get(r);if(d&&d.collection!=s&&(d=null),!o.collection.isCompatible(s))return t.dragula.cancel(!0);var c=d?d.index+(d.element===l):s.length;s.add(o,c)}),n.dragulas.push(this.dragula),this.dragula},lazy:{bottomUp:function(){if(!this.mutable)return!1;var t=this.templateElement.getAttribute("mv-order");return null!==t?/^desc\b/i.test(t):!!this.addButton.parentNode&&!!(this.addButton.compareDocumentPosition(this.templateElement)&Node.DOCUMENT_POSITION_FOLLOWING);
},closestCollection:function(){var t=this.marker?this.marker.parentNode:this.templateElement.parentNode;return t.closest(Mavo.selectors.item)},addButton:function(){var n=this,i="button.mv-add-"+this.property,a=this.closestCollection||this.marker.parentNode.closest(Mavo.selectors.group);if(a)var o=e(i,a).filter(function(t){return!n.templateElement.contains(t)})[0];return o||(o=t.create("button",{className:"mv-add",textContent:"Add "+this.name})),o.classList.add("mv-ui","mv-add"),Mavo.data(o,"collection",this),this.property&&o.classList.add("mv-add-"+this.property),o.addEventListener("click",function(t){t.preventDefault(),n.add().edit()}),o}},"static":{dragulas:[],get:function(t){var e=Mavo.data(t,"collection");if(e)return e;var n=Mavo.Node.get(t);return n&&n.collection||null},lazy:{dragula:function(){return t.include(self.dragula,"https://cdnjs.cloudflare.com/ajax/libs/dragula/3.7.2/dragula.min.js")}}}});Mavo.hooks.add("primitive-init-end",function(){var e=this;if(this.collection&&!this.attribute){
var n=function(n){var i;return e.sneak(function(){var a=t.remove(t(".mv-item-controls",e.element));i=n(),t.inside(a,e.element)}),i};["textContent","innerHTML"].forEach(function(t){var i=Object.getOwnPropertyDescriptor(Node.prototype,t);Object.defineProperty(e.element,t,{get:function(){var t=this;return n(function(){return i.get.call(t)})},set:function(t){var e=this;n(function(){return i.set.call(e,t)})}})})}}),Mavo.hooks.add("node-edit-end",function(){var n=this;this.collection&&(this.itemControls||(this.itemControls=e(".mv-item-controls",this.element).filter(function(t){return t.closest(Mavo.selectors.item)==n.element})[0],this.itemControls=this.itemControls||t.create({className:"mv-item-controls mv-ui"}),t.set(this.itemControls,{contents:[{tag:"button",title:"Delete this "+this.name,className:"mv-delete",events:{click:function(t){return n.collection["delete"](n)}}},{tag:"button",title:"Add new "+this.name.replace(/s$/i,"")+" "+(this.bottomUp?"after":"before"),className:"mv-add",events:{
click:function(t){return n.collection.add(null,n.collection.children.indexOf(item)).edit()}}},{tag:"button",title:"Drag to reorder "+this.name,className:"mv-drag-handle"}]})),this.itemControls.parentNode||this.element.appendChild(this.itemControls))}),Mavo.hooks.add("node-done-end",function(){this.collection&&this.itemControls&&this.itemControls.remove()}),Mavo.Node.prototype.getClosestCollection=function(){return this.collection||this.group.collection||(this.parentGroup?this.parentGroup.closestCollection:null)},t.lazy(Mavo.Node.prototype,"closestCollection",function(){return this.getClosestCollection()}),t.live(Mavo.Node.prototype,"deleted",function(n){var i=this;this.element.classList.toggle("mv-deleted",n),n?(this.elementContents=document.createDocumentFragment(),e(this.element.childNodes).forEach(function(t){i.elementContents.appendChild(t)}),t.contents(this.element,[{tag:"button",className:"mv-close mv-ui",textContent:"×",events:{click:function(e){t.remove(this.parentNode)}}},"Deleted "+this.name,{
tag:"button",className:"mv-undo mv-ui",textContent:"Undo",events:{click:function(t){return i.deleted=!1}}}]),this.element.classList.remove("mv-delete-hover")):this.deleted&&(this.element.textContent="",this.element.appendChild(this.elementContents),this._deleted=!1,this.dataChanged("undelete"))}),Mavo.Node.prototype.isDeleted=function(){this.deleted;return!!this.deleted||!!this.parentGroup&&this.parentGroup.isDeleted()},Mavo.hooks.add("node-init-end",function(t){this.collection=t.options.collection,this.collection&&(this.group=this.parentGroup=this.collection.parentGroup)})}(Bliss,Bliss.$);
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,i=Array(t.length);e<t.length;e++)i[e]=t[e];return i}return Array.from(t)}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){Mavo.attributes.push("mv-expressions","mv-value","mv-if");var i=Mavo.Expression=t.Class({constructor:function(t){this.expression=t},eval:function(t){this.oldValue=this.value,Mavo.hooks.run("expression-eval-beforeeval",this);try{this["function"]||(this["function"]=i.compile(this.expression)),this.value=this["function"](t)}catch(e){Mavo.hooks.run("expression-eval-error",{context:this,exception:e}),this.value=e}return this.value},toString:function(){return this.expression},live:{expression:function(t){t=t.trim();this["function"]=null}},"static":{serializers:{BinaryExpression:function(t){return i.serialize(t.left)+" "+t.operator+" "+i.serialize(t.right);
},UnaryExpression:function(t){return""+t.operator+i.serialize(t.argument)},CallExpression:function(t){return i.serialize(t.callee)+"("+t.arguments.map(i.serialize).join(", ")+")"},ConditionalExpression:function(t){return i.serialize(t.test)+"? "+i.serialize(t.consequent)+" : "+i.serialize(t.alternate)},MemberExpression:function(t){return i.serialize(t.object)+'["'+(t.property.name||t.property.value)+'"]'},ArrayExpression:function(t){return"["+t.elements.map(i.serialize).join(", ")+"]"},Literal:function(t){return t.raw},Identifier:function(t){return t.name},ThisExpression:function(t){return"this"},Compound:function(t){return t.body.map(i.serialize).join(" ")}},transformations:{BinaryExpression:function(t){var e=Mavo.Script.getOperatorName(t.operator),n=(Mavo.Script.operators[e],t),r=[];do r.unshift(n.right),n=n.left;while(Mavo.Script.getOperatorName(n.operator)===e);if(r.unshift(n),r.length>1)return e+"("+r.map(i.serialize).join(", ")+")"},CallExpression:function(t){"Identifier"==t.callee.type&&"if"==t.callee.name&&(t.callee.name="iff");
...
n=this.regex.lastIndex,i.push(new Mavo.Expression(e[1]));return n<t.length&&i.push(t.substring(n)),i},"static":{create:function(t){if(t){var i=t.getAttribute("mv-expressions");if(i)return i=i.trim(),/\s/.test(i)?new(Function.prototype.bind.apply(e,[null].concat(_toConsumableArray(i.split(/\s+/))))):e.ESCAPE}},ESCAPE:-1}});e["default"]=new e("[","]")}(),function(){var e=Mavo.Expression.Text=t.Class({constructor:function(t){this.group=t.group,this.node=t.node,this.path=t.path,this.syntax=t.syntax,this.fallback=t.fallback,this.node||(this.node=this.path.reduce(function(t,e){return t.childNodes[e]},this.group.element)),this.element=this.node,this.attribute=t.attribute||null,Mavo.hooks.run("expressiontext-init-start",this),this.expression||(3===this.node.nodeType&&(this.element=this.node.parentNode,this.node.parentNode.children.length&&!this.attribute||(this.node=this.element,this.element.normalize())),this.expression=(this.attribute?this.node.getAttribute(this.attribute):this.node.textContent).trim(),
this.template=t.template?t.template.template:this.syntax.tokenize(this.expression)),Mavo.hooks.run("expressiontext-init-end",this),e.elements.set(this.element,[].concat(_toConsumableArray(e.elements.get(this.element)||[]),[this]))},update:function(){var t=this,e=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0];this.data=e;var i={};Mavo.hooks.run("expressiontext-update-start",this),i.value=this.value=this.template.map(function(i){if(i instanceof Mavo.Expression){var n={context:t,expr:i};return Mavo.hooks.run("expressiontext-update-beforeeval",n),n.value=n.expr.eval(e),Mavo.hooks.run("expressiontext-update-aftereval",n),n.value instanceof Error?void 0!==t.fallback?t.fallback:n.expr.expression:void 0===n.value||null===n.value?"":n.value}return i}),this.attribute||(i.presentational=this.value.map(function(t){return Array.isArray(t)?t.join(", "):"number"==typeof t?Mavo.Primitive.formatNumber(t):t}),i.presentational=1===i.presentational.length?i.presentational[0]:i.presentational.join("")),
i.value=1===i.value.length?i.value[0]:i.value.join(""),this.primitive&&1===this.template.length&&("number"==typeof i.value?this.primitive.datatype="number":"boolean"==typeof i.value&&(this.primitive.datatype="boolean")),i.presentational===i.value&&(i=i.value),this.primitive?this.primitive.value=i:Mavo.Primitive.setValue(this.node,i,{attribute:this.attribute}),Mavo.hooks.run("expressiontext-update-end",this)},"static":{elements:new WeakMap,search:function(t,i){var n=e.elements.get(t)||[];return arguments.length>1?n.length?n.filter(function(t){return t.attribute===i})[0]||null:null:n}}})}(),function(){var i=Mavo.Expressions=t.Class({constructor:function(t){var e=this;if(t&&(this.group=t,this.group.expressions=this),this.all=[],Mavo.hooks.run("expressions-init-start",this),this.group){var i=this.group.template;if(i&&i.expressions){var n=!0,r=!1,s=void 0;try{for(var a,o=i.expressions.all[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var u=a.value;this.all.push(new Mavo.Expression.Text({path:u.path,
syntax:u.syntax,attribute:u.attribute,group:this.group,template:u}))}}catch(l){r=!0,s=l}finally{try{!n&&o["return"]&&o["return"]()}finally{if(r)throw s}}}else{var p=Mavo.Expression.Syntax.create(this.group.element.closest("[mv-expressions]"))||Mavo.Expression.Syntax["default"];this.traverse(this.group.element,void 0,p)}}this.dependents=new Set,this.active=!0,this.group.element.addEventListener("mavo:datachange",function(t){return e.update()})},update:function(){if(this.active&&!this.group.isDeleted()&&this.all.length+this.dependents.size!==0){var t={context:this,data:this.group.getRelativeData()};Mavo.hooks.run("expressions-update-start",t);var e=!0,i=!1,n=void 0;try{for(var r,s=this.all[Symbol.iterator]();!(e=(r=s.next()).done);e=!0){var a=r.value;a.update(t.data)}}catch(o){i=!0,n=o}finally{try{!e&&s["return"]&&s["return"]()}finally{if(i)throw n}}var u=!0,l=!1,p=void 0;try{for(var h,v=this.dependents[Symbol.iterator]();!(u=(h=v.next()).done);u=!0){var d=h.value;d.update()}}catch(o){l=!0,
p=o}finally{try{!u&&v["return"]&&v["return"]()}finally{if(l)throw p}}}},extract:function(t,e,n,r){e&&"mv-expressions"==e.name||(e&&i.directives.indexOf(e.name)>-1||r.test(e?e.value:t.textContent))&&this.all.push(new Mavo.Expression.Text({node:t,syntax:r,path:(n||"").slice(1).split("/").map(function(t){return+t}),attribute:e&&e.name,group:this.group}))},traverse:function(t){var i=this,n=arguments.length<=1||void 0===arguments[1]?"":arguments[1],r=arguments[2];if(8!==t.nodeType)if(3===t.nodeType)this.extract(t,null,n,r);else if(t==this.group.element||!Mavo.is("group",t)){if(r=Mavo.Expression.Syntax.create(t)||r,r===Mavo.Expression.Syntax.ESCAPE)return;e(t.attributes).forEach(function(e){return i.extract(t,e,n,r)}),e(t.childNodes).forEach(function(t,e){return i.traverse(t,n+"/"+e,r)})}},"static":{directives:[]}})}(),self.Proxy&&Mavo.hooks.add("node-getdata-end",function(t){var e=this;t.options.relative&&t.data&&"object"===_typeof(t.data)&&(t.data=new Proxy(t.data,{get:function(i,n,r){if(n in i||n in r&&n in i)return i[n];
if("$index"==n)return e.index+1;if(n==e.mavo.id)return i;var s=e.walkUp(function(i){if(n in i.children)return i.expressions.dependents.add(e.expressions),i.children[n].getData(t.options)});return void 0!==s?s:void 0},has:function(i,n){if(n in i)return!0;if("$index"==n||n==e.mavo.id)return!0;var r=e.walkUp(function(t){if(n in t.children)return!0});return void 0!==r?r:(r=e.find(n),void 0!==r?(r=Array.isArray(r)?r.map(function(e){return e.getData(t.options)}).filter(function(t){return null!==t}):r.getData(t.options),i[n]=r,!0):void 0)},set:function(t,e,i){throw Error("You can’t set data via expressions.")}}))}),Mavo.Node.prototype.getRelativeData=function(){return this.getData({relative:!0,store:"*","null":!0,unhandled:this.mavo.unhandled})},Mavo.hooks.add("group-init-start",function(){new Mavo.Expressions(this)}),Mavo.hooks.add("primitive-init-start",function(){this.expressionText=Mavo.Expression.Text.search(this.element,this.attribute),this.expressionText&&(this.expressionText.primitive=this,
this.store=this.store||"none",this.modes="read")}),Mavo.hooks.add("group-init-end",function(){this.expressions.update()}),Mavo.hooks.add("group-render-start",function(){this.expressions.active=!1}),Mavo.hooks.add("group-render-end",function(){var t=this;requestAnimationFrame(function(){t.expressions.active=!0,t.expressions.update()})})}(Bliss,Bliss.$),Mavo.Expressions.directives.push("mv-value"),Mavo.hooks.add("expressiontext-init-start",function(){"mv-value"==this.attribute&&(this.attribute=Mavo.Primitive.getValueAttribute(this.element),this.fallback=this.fallback||Mavo.Primitive.getValue(this.element,{attribute:this.attribute}),this.expression=this.element.getAttribute("mv-value"),this.template=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end)}),Mavo.Expressions.directives.push("mv-if"),Mavo.hooks.add("expressiontext-init-start",function(){"mv-if"==this.attribute&&(this.expression=this.element.getAttribute("mv-if"),this.template=[new Mavo.Expression(this.expression)],
this.expression=this.syntax.start+this.expression+this.syntax.end,this.parentIf=Mavo.Expression.Text.search(this.element.parentNode.closest("[mv-if]"),"mv-if"),this.parentIf&&(this.parentIf.childIfs=(this.parentIf.childIfs||new Set).add(this)))}),Mavo.hooks.add("expressiontext-update-end",function(){var t=this;"mv-if"==this.attribute&&this.group.mavo.treeBuilt.then(function(){var e=t.value[0],i=t.oldValue&&t.oldValue[0];if(t.parentIf){var n=t.parentIf.value[0];t.value[0]=e=e&&n}if(e!==i){if(n!==!1&&(e?t.comment&&t.comment.parentNode&&t.comment.parentNode.replaceChild(t.element,t.comment):t.element.parentNode&&(t.comment||(t.comment=document.createComment("mv-if")),t.element.parentNode.replaceChild(t.comment,t.element))),t.childProperties){var r=!0,s=!1,a=void 0;try{for(var o,u=t.childProperties[Symbol.iterator]();!(r=(o=u.next()).done);r=!0){var l=o.value;l.hidden=!e}}catch(p){s=!0,a=p}finally{try{!r&&u["return"]&&u["return"]()}finally{if(s)throw a}}}if(t.childIfs){var h=!0,v=!1,d=void 0;
try{for(var c,f=t.childIfs[Symbol.iterator]();!(h=(c=f.next()).done);h=!0){var m=c.value;m.update()}}catch(p){v=!0,d=p}finally{try{!h&&f["return"]&&f["return"]()}finally{if(v)throw d}}}t.oldValue=t.value}})}),Mavo.hooks.add("unit-isdatanull",function(t){t.result=t.result||this.hidden&&"*"==t.options.store}),$.live(Mavo.Primitive.prototype,"hidden",function(t){this._hidden!==t&&(this._hidden=t,this.dataChanged())}),$.lazy(Mavo.Expression.Text.prototype,"childProperties",function(){var t=this;if("mv-if"==this.attribute){var e=$$(Mavo.selectors.property,this.element).filter(function(e){return e.closest("[mv-if]")==t.element}).map(function(t){return Mavo.Node.get(t)});return e.length&&this.element.addEventListener("mavo:datachange",function(e){requestAnimationFrame(function(){t.element.parentNode||t.group.element.dispatchEvent(e)})}),e}});
