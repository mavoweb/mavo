...
}}catch(l){r=!0,s=l}finally{try{!n&&o["return"]&&o["return"]()}finally{if(r)throw s}}}else{var p=Mavo.Expression.Syntax.create(this.group.element.closest("[data-expressions]"))||Mavo.Expression.Syntax["default"];this.traverse(this.group.element,void 0,p)}}this.dependents=new Set,this.active=!0,this.group.element.addEventListener("mavo:datachange",function(t){return e.update()}),this.update()},update:function(){if(this.active&&!this.group.isDeleted()&&this.all.length+this.dependents.size!==0){var t={context:this,data:this.group.getRelativeData()};Mavo.hooks.run("expressions-update-start",t);var e=!0,i=!1,n=void 0;try{for(var r,s=this.all[Symbol.iterator]();!(e=(r=s.next()).done);e=!0){var a=r.value;a.update(t.data)}}catch(o){i=!0,n=o}finally{try{!e&&s["return"]&&s["return"]()}finally{if(i)throw n}}var u=!0,l=!1,p=void 0;try{for(var h,c=this.dependents[Symbol.iterator]();!(u=(h=c.next()).done);u=!0){var f=h.value;f.update()}}catch(o){l=!0,p=o}finally{try{!u&&c["return"]&&c["return"]()}finally{
