...
"use strict";!function(t,e){var n=Mavo.Unit=t.Class({"abstract":!0,"extends":Mavo.Node,constructor:function(t,e){var n=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];this.constructor.all.set(this.element,this),this.collection=n.collection,this.dirty=n.dirty,this.collection&&(this.group=this.parentGroup=this.collection.parentGroup),this.fromTemplate("required")||(this.required=Mavo.is("required",this.element)),Mavo.hooks.run("unit-init-end",this)},isDeleted:function(){this.deleted;return!!this.deleted||!!this.parentGroup&&this.parentGroup.isDeleted()},getData:function(t){return t=t||{},n.isNull(this,t)?null:void this.walkUp(function(e){if(n.isNull(e,t))return null})},lazy:{closestCollection:function(){return this.collection||this.group.collection||(this.parentGroup?this.parentGroup.closestCollection:null)}},live:{store:function(e){t.toggleAttribute(this.element,"data-store",e)},deleted:function(n){var i=this;this.element.classList.toggle("deleted",n),n?(this.elementContents=document.createDocumentFragment(),
...
return new(Mavo[Mavo.is("group",t)?"Group":"Primitive"])(t,e,n)},isNull:function(t,e){return t.dirty&&!e.dirty||t.deleted&&e.dirty||!t.saved&&"*"!=e.store}}})}(Bliss,Bliss.$);
