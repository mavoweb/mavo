...
"use strict";!function(t,e){Mavo.Unit=t.Class({"abstract":!0,"extends":Mavo.Node,constructor:function(t,e){var n=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];this.constructor.all.set(this.element,this),this.collection=n.collection,this.collection&&(this.group=this.parentGroup=this.collection.parentGroup),this.fromTemplate("required")||(this.required=Mavo.is("required",this.element)),Mavo.hooks.run("unit-init-end",this)},isDeleted:function(){this.deleted;return!!this.deleted||!!this.parentGroup&&this.parentGroup.isDeleted()},getData:function(t){return t=t||{},this.isNull(t)?null:void this.walkUp(function(e){if(e.isNull(t))return null})},isNull:function(t){return this.deleted||!this.saved&&"*"!=t.store},lazy:{closestCollection:function(){return this.collection||this.group.collection||(this.parentGroup?this.parentGroup.closestCollection:null)}},live:{store:function(e){t.toggleAttribute(this.element,"data-store",e)},deleted:function(n){var i=this;this.element.classList.toggle("deleted",n),
...
return new(Mavo[Mavo.is("group",t)?"Group":"Primitive"])(t,e,n)}}})}(Bliss,Bliss.$);
...
Mavo.Expressions.directives.push("data-content"),Mavo.hooks.add("expressiontext-init-start",function(){"data-content"==this.attribute&&(this.attribute=Mavo.Primitive.getValueAttribute(this.element),this.fallback=this.fallback||Mavo.Primitive.getValue(this.element,this.attribute,null,{raw:!0}),this.expression=this.element.getAttribute("data-content"),this.template=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end)}),Mavo.Expressions.directives.push("data-if"),Mavo.hooks.add("expressiontext-init-start",function(){"data-if"==this.attribute&&(this.expression=this.element.getAttribute("data-if"),this.template=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end)}),Mavo.hooks.add("expressiontext-update-end",function(){if("data-if"==this.attribute){var t=this.value[0];this.group.mavo.root&&(t||Object.keys(this.group.properties).length||console.trace(),t&&this.comment&&this.comment.parentNode?this.comment.parentNode.replaceChild(this.element,this.comment):!t&&this.element.parentNode&&(this.comment||(this.comment=document.createComment("mv-if")),
...
"use strict";!function(t,e){var r=Mavo.Group=t.Class({"extends":Mavo.Unit,constructor:function(t,r,i){var o=this;if(this.properties={},this.group=this,Mavo.hooks.run("group-init-start",this),Mavo.Primitive.getValueAttribute(this.element)){this.properties[this.property]=new Mavo.Primitive(this.element,this.mavo,{group:this})}e(Mavo.selectors.property,this.element).forEach(function(t){var e=Mavo.Node.getProperty(t);if(o.contains(t)){var r=o.properties[e],i=o.template?o.template.properties[e]:null,n={template:i,group:o};if(r){var s=r;r instanceof Mavo.Collection||(s=new Mavo.Collection(r.element,o.mavo,n),o.properties[e]=r.collection=s,s.add(r)),!s.mutable&&Mavo.is("multiple",t)&&(s.mutable=!0),s.add(t)}else{var a=Mavo.Node.create(t,o.mavo,n);o.properties[e]=a}}});var n=(this.isRoot?this.element.closest("[vocab]"):null)||this.element;this.vocab=n.getAttribute("vocab"),Mavo.hooks.run("group-init-end",this)},get isRoot(){return!this.property},getData:function(e){e=e||{};var i=this["super"].getData.call(this,e);
return void 0!==i?i:(i={},this.propagate(function(t){if((t.saved||"*"==e.store)&&!(t.property in i)){var r=t.getData(e);(null!==r||e["null"])&&(i[t.property]=r)}}),e.unhandled&&t.extend(i,this.unhandled),this.type&&this.type!=r.DEFAULT_TYPE&&(i["@type"]=this.type),this.vocab&&(i["@context"]=this.vocab),i.summary&&(i.toString=function(){return this.summary}),i)},find:function(t){if(this.property==t)return this;if(t in this.properties)return this.properties[t].find(t);for(var e in this.properties){var r=this.properties[e].find(t);if(void 0!==r)return r}},propagate:function(e){var r=arguments;t.each(this.properties,function(t,e){e.call.apply(e,r)})},save:function(){this.unsavedChanges=!1},done:function(){t.unbind(this.element,".mavo:edit")},propagated:["save","done","import","clear"],render:function(e){var r=this;e&&(Mavo.hooks.run("group-render-start",this),e=Array.isArray(e)?e[0]:e,this.unhandled=t.extend({},e,function(t){return!(t in r.properties)}),this.propagate(function(t){t.render(e[t.property]);
}),this.save(),Mavo.hooks.run("group-render-end",this))},contains:function(t){return t instanceof Mavo.Unit?t.parentGroup===this:t.parentNode&&this.element===t.parentNode.closest(Mavo.selectors.group)},"static":{all:new WeakMap,DEFAULT_TYPE:"Item",normalize:function(t){if(Mavo.is("group",t)){var e=t.getAttribute("typeof")||t.getAttribute("itemtype")||r.DEFAULT_TYPE;return t.setAttribute("typeof",e),e}return null}}})}(Bliss,Bliss.$);
...
var n=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);n&&(i.all.has(n)?i.all.get(n).value=e:i.setValue(n,e))}},getData:function(t){t=t||{};var e=this["super"].getData.call(this,t);return void 0!==e?e:(e=this.value,""===e?null:e)},save:function(){this.savedValue=this.value,this.unsavedChanges=!1},done:function(){this.unobserve(),this.popup?this.popup.close():!this.attribute&&this.editing&&(t.remove(this.editor),this.element.textContent=this.editorValue),this.view="read",null!==this.element._.data.prevTabindex?this.element.tabIndex=this.element._.data.prevTabindex:this.element.removeAttribute("tabindex"),this.observe()},revert:function(){this.unsavedChanges&&void 0!==this.savedValue&&(this.value=this.savedValue,this.unsavedChanges=!1)},preEdit:function(){var t=this;if(!this.constant){if(this.empty&&!this.attribute)return void this.edit();if("preEdit"!=this.view){this.view="preEdit";var e;this.element._.events({"click.mavo:preedit":function(e){return t.edit()},"focus.mavo:preedit":function(e){
t.edit(),t.popup||t.editor.focus()},"click.mavo:edit":function(t){t.preventDefault()}}),this.attribute||this.element._.events({"mouseenter.mavo:preedit":function(i){clearTimeout(e),e=setTimeout(function(){return t.edit()},150)},"mouseleave.mavo:preedit":function(t){clearTimeout(e)}}),this.element._.data.prevTabindex=this.element.getAttribute("tabindex"),this.element.tabIndex=0}}},initEdit:function(){var n=this;if(!this.editor){var a=i.getMatch(this.element,i.editors);a.create&&t.extend(this,a,function(t){return"create"!=t});var r=a.create||a;this.editor=t.create("function"===t.type(r)?r.call(this):r),this.editorValue=this.value,this.editorType="created"}t.events(this.editor,{"input change":function(t){n.value=n.editorValue},focus:function(t){n.editor.select&&n.editor.select()},"mavo:datachange":function(e){"output"===e.property&&(e.stopPropagation(),t.fire(n.editor,"input"))}}),"placeholder"in this.editor&&(this.editor.placeholder="("+this.label+")");var o=/^data-input-/i;e(this.element.attributes).forEach(function(t){
o.test(t.name)&&this.editor.setAttribute(t.name.replace(o,""),t.value)},this),this.attribute&&(this.popup=new i.Popup(this)),this.popup||this.editor.classList.add("mv-editor"),this.initEdit=null},edit:function(){this.constant||this.editing||(this.element._.unbind(".mavo:preedit"),this.initEdit&&this.initEdit(),this.popup&&this.popup.show(),this.attribute||this.editor.parentNode!=this.element&&(this.editorValue=this.value,this.element.textContent="",this.element.appendChild(this.editor)),this.view="edit")},clear:function(){this.value=this.emptyValue},render:function(t){Array.isArray(t)&&(t=t[0]),"object"===("undefined"==typeof t?"undefined":_typeof(t))&&(t=t[this.property]),void 0===t?this.value=this.closestCollection?this["default"]:this.templateValue:this.value=t,this.save()},find:function(t){if(this.property==t)return this},observe:function(){var t=this;this.constant||(this.observer=Mavo.observe(this.element,this.attribute,this.observer||function(e){!t.attribute&&t.mavo.editing||(t.value=t.getValue());
