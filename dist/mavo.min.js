...
"use strict";!function(t,e){function r(t,r){for(t="mv-"+t+"-within",e("."+t).forEach(function(e){return e.classList.remove(t)});r&&r.classList;)r.classList.add(t),r=r.parentNode}var n=t.extend(Mavo,{toJSON:function(t){return null===t?"":"string"==typeof t?t:JSON.stringify(t,null,"\t")},readable:function(t){return t&&t.replace(/([a-z])([A-Z])(?=[a-z])/g,function(t,e,r){return e+" "+r.toLowerCase()}).replace(/([a-z])[_\/-](?=[a-z])/g,"$1 ").replace(/^[a-z]/,function(t){return t.toUpperCase()})},queryJSON:function(e,r){return r&&e?t.value.apply(t,[e].concat(r.split("/"))):e},toArray:function(t){return void 0===t?[]:Array.isArray(t)?t:[t]},"delete":function(t,e){var r=t&&t.indexOf(e);r>-1&&t.splice(r,1)},flatten:function(t){return Array.isArray(t)?t.reduce(function(t,e){return n.toArray(t).concat(n.flatten(e))},[]):[t]},is:function(t){for(var e=arguments.length,r=Array(e>1?e-1:0),i=1;i<e;i++)r[i-1]=arguments[i];var a=!0,o=!1,u=void 0;try{for(var s,c=r[Symbol.iterator]();!(a=(s=c.next()).done);a=!0){
var l=s.value;if(l&&l.matches&&l.matches(n.selectors[t]))return!0}}catch(f){o=!0,u=f}finally{try{!a&&c["return"]&&c["return"]()}finally{if(o)throw u}}return!1},data:function(e,r,n){return void 0===n?t.value(e,"_","data","mavo",r):(e._.data.mavo=e._.mavo||{},void(e._.data.mavo[r]=n))},pushUnique:function(t,e){t.indexOf(e)===-1&&t.push(e)},getAttribute:function(t){for(var e=arguments.length,r=Array(e>1?e-1:0),n=1;n<e;n++)r[n-1]=arguments[n];for(var i,a=0;i=r[a];a++){var o=t.getAttribute(i);if(o)return o}return null},urlParam:function(){for(var t=("searchParams"in URL.prototype?new URL(location).searchParams:null),e=null,r=arguments.length,n=Array(r),i=0;i<r;i++)n[i]=arguments[i];var a=!0,o=!1,u=void 0;try{for(var s,c=n[Symbol.iterator]();!(a=(s=c.next()).done);a=!0){var l=s.value;if(t)e=t.get(l);else{var f=location.search.match(RegExp("[?&]"+l+"(?:=([^&]+))?(?=&|$)","i"));e=f&&(f[1]||"")}if(null!==e)return e}}catch(h){o=!0,u=h}finally{try{!a&&c["return"]&&c["return"]()}finally{if(o)throw u;
}}return null},debounce:function(t,e){var r=null;return function(){var n=this,i=arguments;clearTimeout(r),r=setTimeout(function(){t.apply(n,i)},e)}},escapeRegExp:function(t){return t.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")},Observer:t.Class({constructor:function(e,r,n,i){n instanceof MutationObserver&&(this.observer=n),this.observer=this.observer||new MutationObserver(n),this.element=e,this.callback=n,this.attribute=r,this.oldValue=i,this.options={},r&&t.extend(this.options,{attributes:!0,attributeFilter:"all"==this.attribute?void 0:[this.attribute],attributeOldValue:!!this.oldValue}),this.attribute&&"all"!=this.attribute||t.extend(this.options,{characterData:!0,childList:!0,subtree:!0,characterDataOldValue:!!this.oldValue}),this.run()},stop:function(){return this.running&&(this.observer.disconnect(),this.running=!1),this},run:function(){return this.running||(this.observer.observe(this.element,this.options),this.running=!0),this},sneak:function(t){var e=this;if(this.running){this.stop();
var r=t();requestAnimationFrame(function(){return e.run()})}else var r=t();return r}}),defer:function(t){var e,r,n=new Promise(function(n,i){t&&t(n,i),e=n,r=i});return n.resolve=function(t){return e(t),n},n.reject=function(t){return r(t),n},n}});t.add("toggleAttribute",function(t,e){var r=arguments.length<=2||void 0===arguments[2]?null!==e:arguments[2];r?this.setAttribute(t,e):this.removeAttribute(t)}),t.proxy=t.classProps.proxy=t.overload(function(t,e,r){return Object.defineProperty(t,e,{get:function(){return this[r][e]},set:function(t){this[r][e]=t},configurable:!0,enumerable:!0}),t}),t.classProps.propagated=function(t,e){Mavo.toArray(e).forEach(function(e){var r=t[e];t[e]=function(){var t=r&&r.apply(this,arguments);this.propagate&&t!==!1&&this.propagate(e)}})},document.addEventListener("focus",function(t){r("focus",t.target)},!0),document.addEventListener("blur",function(t){r("focus",null)},!0),addEventListener("hashchange",function(e){r("target",t(location.hash))}),document.documentElement.addEventListener("mavo:datachange",function(e){
r("target",t(location.hash))}),r("focus",document.activeElement!==document.body?document.activeElement:null)}(Bliss,Bliss.$);
