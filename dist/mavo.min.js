...
},group:"[typeof], [itemscope], [itemtype], .mv-group",multiple:"[mv-multiple], .mv-multiple",formControl:"input, select, option, textarea",item:".mv-item",ui:".mv-ui",container:{li:"ul, ol",tr:"table",option:"select",dt:"dl",dd:"dl"}},i=e.arr=function(t){return t.split(/\s*,\s*/g)},s=e.not=function(t){return i(t).map(function(t){return":not("+t+")"}).join("")},r=e.or=function(t,e){return t+", "+e},o=e.and=function(t,e){var n=[],s=i(e);return i(t).forEach(function(t){return n.push.apply(n,_toConsumableArray(s.map(function(e){return t+e})))}),n.join(", ")},a=e.andNot=function(t,e){return o(t,s(e))};t.extend(n.selectors,{primitive:a(e.property,e.group),rootGroup:a(e.group,e.property),output:r(e.specificProperty("output"),".mv-output, .mv-value")})}(),Promise.all([t.ready(),t.include(Array.from&&window.Intl&&document.documentElement.closest,"https://cdn.polyfill.io/v2/polyfill.min.js?features=blissfuljs,Intl.~locale.en")])["catch"](function(t){return console.error(t)}).then(function(){return Mavo.init();
}),Stretchy.selectors.filter=".mv-editor:not([property])"}(Bliss,Bliss.$);
...
var l=s.value;if(l&&l.matches&&l.matches(n.selectors[t]))return!0}}catch(f){o=!0,u=f}finally{try{!a&&c["return"]&&c["return"]()}finally{if(o)throw u}}return!1},getAttribute:function(t){for(var r=arguments.length,e=Array(r>1?r-1:0),n=1;n<r;n++)e[n-1]=arguments[n];for(var i,a=0;i=e[a];a++){var o=t.getAttribute(i);if(o)return o}return null},urlParam:function(){for(var t=("searchParams"in URL.prototype?new URL(location).searchParams:null),r=null,e=arguments.length,n=Array(e),i=0;i<e;i++)n[i]=arguments[i];var a=!0,o=!1,u=void 0;try{for(var s,c=n[Symbol.iterator]();!(a=(s=c.next()).done);a=!0){var l=s.value;if(t)r=t.get(l);else{var f=location.search.match(RegExp("[?&]"+l+"(?:=([^&]+))?(?=&|$)","i"));r=f&&(f[1]||"")}if(null!==r)return r}}catch(h){o=!0,u=h}finally{try{!a&&c["return"]&&c["return"]()}finally{if(o)throw u}}return null},debounce:function(t,r){var e=null;return function(){var n=this,i=arguments;clearTimeout(e),e=setTimeout(function(){t.apply(n,i)},r)}},escapeRegExp:function(t){return t.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&");
},Observer:t.Class({constructor:function(r,e,n,i){n instanceof MutationObserver&&(this.observer=n),this.observer=this.observer||new MutationObserver(n),this.element=r,this.callback=n,this.attribute=e,this.oldValue=i,this.options={},e&&t.extend(this.options,{attributes:!0,attributeFilter:"all"==this.attribute?void 0:[this.attribute],attributeOldValue:!!this.oldValue}),this.attribute&&"all"!=this.attribute||t.extend(this.options,{characterData:!0,childList:!0,subtree:!0,characterDataOldValue:!!this.oldValue}),this.run()},stop:function(){return this.running&&(this.observer.disconnect(),this.running=!1),this},run:function(){return this.running||(this.observer.observe(this.element,this.options),this.running=!0),this},sneak:function(t){var r=this;if(this.running){this.stop();var e=t();requestAnimationFrame(function(){return r.run()})}else var e=t();return e}}),defer:function(t){var r,e,n=new Promise(function(n,i){t&&t(n,i),r=n,e=i});return n.resolve=function(t){return r(t),n},n.reject=function(t){
...
Mavo.hooks.run("group-init-end",this)},get isRoot(){return!this.property},getData:function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],a={context:this,options:e,data:this["super"].getData.call(this,e)};return void 0!==a.data?a.data:(a.data={},this.propagate(function(t){if((t.saved||"*"==e.store)&&!(t.property in a.data)){var r=t.getData(e);(null!==r||a.options["null"])&&(a.data[t.property]=r)}}),a.options.unhandled&&t.extend(a.data,this.unhandled),this.type&&this.type!=r.DEFAULT_TYPE&&(a.data["@type"]=this.type),this.vocab&&(a.data["@context"]=this.vocab),a.data.summary&&(a.data.toString=function(){return this.summary}),Mavo.hooks.run("node-getdata-end",a),a.data)},find:function(t){if(this.property==t)return this;if(t in this.children)return this.children[t].find(t);var e=[];for(var r in this.children){var a=this.children[r].find(t);if(void 0!==a){if(!Array.isArray(a))return a;e.push.apply(e,_toConsumableArray(a))}}return e.length?e:void 0},save:function(){this.unsavedChanges=!1;
},propagated:["save","import","clear"],render:function(e){var r=this;e&&(Mavo.hooks.run("group-render-start",this),e=Array.isArray(e)?e[0]:e,this.unhandled=t.extend({},e,function(t){return!(t in r.children)}),this.propagate(function(t){t.render(e[t.property])}),this.save(),Mavo.hooks.run("group-render-end",this))},contains:function(t){return t instanceof Mavo.Node?t.parentGroup===this:t.parentNode&&this.element===t.parentNode.closest(Mavo.selectors.group)},"static":{all:new WeakMap,DEFAULT_TYPE:"Item",normalize:function(t){if(Mavo.is("group",t)){var e=Mavo.getAttribute(t,"typeof","itemtype")||r.DEFAULT_TYPE;return t.setAttribute("typeof",e),e}return null}}})}(Bliss,Bliss.$);
...
"use strict";!function(e,t){Mavo.attributes.push("mv-multiple","mv-order","mv-accepts");var n=Mavo.Collection=e.Class({"extends":Mavo.Node,nodeType:"Collection",constructor:function(e,i,o){var a=this;if(this.templateElement=this.element,this.children=[],this.fromTemplate("properties","mutable","templateElement","accepts")||(this.properties=t(Mavo.selectors.property,this.templateElement).map(Mavo.Node.getProperty),this.mutable=this.templateElement.matches(Mavo.selectors.multiple),this.accepts=(this.templateElement.getAttribute("mv-accepts")||"").split(/\s+/),this.templateElement=this.templateElement.cloneNode(!0)),this.mutable){var r=this.createItem(this.element);this.add(r),this.itemTemplate=r.template||r,this.constant||this.mavo.permissions.can(["edit","add","delete"],function(){n.dragulaContainer(a.marker.parentNode)})}Mavo.hooks.run("collection-init-end",this)},get length(){return this.children.length},get containsTemplate(){return this.children.length&&this.children[0].element===this.element;
},getData:function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],t={context:this,options:e,data:[]},n=!0,i=!1,o=void 0;try{for(var a,r=this.children[Symbol.iterator]();!(n=(a=r.next()).done);n=!0)if(item=a.value,!item.deleted){var l=item.getData(t.options);l&&t.data.push(l)}}catch(s){i=!0,o=s}finally{try{!n&&r["return"]&&r["return"]()}finally{if(i)throw o}}return this.unhandled&&t.options.unhandled&&(t.data=this.unhandled.before.concat(t.data,this.unhandled.after)),this.mutable||1!=t.data.length||(t.data=t.data[0]),Mavo.hooks.run("node-getdata-end",t),t.data},createItem:function(e){e||(e=this.templateElement.cloneNode(!0));var t=Mavo.Node.create(e,this.mavo,{collection:this,template:this.itemTemplate||(this.template?this.template.itemTemplate:null),property:this.property,type:this.type});return t},add:function(e,t){var n=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];if(e=e instanceof Node?Mavo.Node.get(e)||this.createItem(e):e||this.createItem(),e.collection!=this&&this.adopt(e),
t in this.children?this.bottomUp&&t++:void 0===t&&(t=this.bottomUp?0:this.length),!e.element.parentNode){var i=this.children[t];e.element._.before(i&&i.element||this.marker)}var o=this.children.indexOf(e);o>-1&&this.children.splice(o,1),this.children.splice(t,0,e);for(var a=t-1;a<this.length;a++){var r=this.children[a];r&&(r.index=a,n.silent||r.dataChanged("add"))}return n.silent||(this.unsavedChanges=e.unsavedChanges=this.mavo.unsavedChanges=!0),e},adopt:function(e){var t=this;e.collection&&(e.collection.children.splice(e.collection.children.indexOf(e),1),e.collection.dataChanged("delete")),this.walk(function(n){n.closestCollection===e.collection&&(n.closestCollection=t),e.mavo!=t.mavo&&(e.mavo=t.mavo)}),e.collection=this,e.template&&(Mavo["delete"](e.template.copies,e),e.template=this.itemTemplate)},"delete":function(t,n){var i=this;return n?(e.remove(t.element),void this.children.splice(this.children.indexOf(t),1)):e.transition(t.element,{opacity:0}).then(function(){t.deleted=!0,t.element.style.opacity="",
t.dataChanged("delete"),i.unsavedChanges=t.unsavedChanges=i.mavo.unsavedChanges=!0})},edit:function(){if(this["super"].edit.call(this),this.mutable&&!this.addButton.parentNode)if(this.bottomUp)this.addButton._.before(e.value(this.children[0],"element")||this.marker);else{var t=this.element.tagName.toLowerCase(),i=Mavo.selectors.container[t];if(i)var o=this.marker.parentNode.closest(i);this.addButton._.after(o&&o.parentNode?o:this.marker),n.dragulaContainer(this.addButton.parentNode)}},done:function(){this["super"].done.call(this),this.mutable&&this.addButton.parentNode&&this.addButton.remove()},clear:function(){this.mutable&&(this.propagate(function(e){if(e.element.remove)e.element.remove();else{var t=!0,n=!1,i=void 0;try{for(var o,a=e.element.childNodes[Symbol.iterator]();!(t=(o=a.next()).done);t=!0){o.value}}catch(r){n=!0,i=r}finally{try{!t&&a["return"]&&a["return"]()}finally{if(n)throw i}}}}),this.children=[],this.dataChanged("clear"))},dataChanged:function(e){var t=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];
return t.element=t.element||this.marker,this["super"].dataChanged.call(this,e,t)},save:function(){var e=!0,t=!1,n=void 0;try{for(var i,o=this.children[Symbol.iterator]();!(e=(i=o.next()).done);e=!0){var a=i.value;a.deleted?this["delete"](a,!0):a.unsavedChanges=!1}}catch(r){t=!0,n=r}finally{try{!e&&o["return"]&&o["return"]()}finally{if(t)throw n}}},propagated:["save"],revert:function(){var e=!0,t=!1,n=void 0;try{for(var i,o=this.children[Symbol.iterator]();!(e=(i=o.next()).done);e=!0){var a=i.value;a.unsavedChanges?this["delete"](a,!0):(a.deleted&&(a.deleted=!1),a.revert())}}catch(r){t=!0,n=r}finally{try{!e&&o["return"]&&o["return"]()}finally{if(t)throw n}}},render:function(e){var t=this;if(this.unhandled={before:[],after:[]},e){if(e=Mavo.toArray(e),this.mutable){this.clear();var n=document.createDocumentFragment();e.forEach(function(e,i){var o=t.createItem();o.render(e),t.children.push(o),o.index=i,n.appendChild(o.element)}),this.marker.parentNode.insertBefore(n,this.marker)}else this.children.forEach(function(t,n){
return t.render(e&&e[n])}),e&&(this.unhandled.after=e.slice(this.children.length));this.save()}},find:function(e){var t=this.children.filter(function(e){return!e.deleted});if(this.property==e)return t;if(this.properties.indexOf(e)>-1){var n=t.map(function(t){return t.find(e)});return Mavo.flatten(n)}},isCompatible:function(e){return e===this||e.template==this||this.template==e||this.template==e.template||this.accepts.indexOf(e.property)>-1},live:{mutable:function(t){t&&t!==this.mutable&&(this._mutable=t,this.mavo.needsEdit=!0,this.marker=document.createComment("mv-marker"),this.marker._.MavoCollection=this,e.after(this.marker,this.templateElement),this.templateElement.classList.add("mv-item"))}},lazy:{bottomUp:function(){if(!this.mutable)return!1;var e=this.templateElement.getAttribute("mv-order");return null!==e?/^desc\b/i.test(e):!!this.addButton.parentNode&&!!(this.addButton.compareDocumentPosition(this.templateElement)&Node.DOCUMENT_POSITION_FOLLOWING)},closestCollection:function(){
var e=this.marker?this.marker.parentNode:this.templateElement.parentNode;return e.closest(Mavo.selectors.item)},addButton:function(){var n=this,i="button.mv-add-"+this.property,o=this.closestCollection||this.marker.parentNode.closest(Mavo.selectors.group);if(o)var a=t(i,o).filter(function(e){return!n.templateElement.contains(e)})[0];return a||(a=e.create("button",{className:"mv-add",textContent:"Add "+this.name})),a.classList.add("mv-ui","mv-add"),a._.data.MavoCollection=this,this.property&&a.classList.add("mv-add-"+this.property),a.addEventListener("click",function(e){e.preventDefault(),n.add().edit()}),a}},"static":{get:function(t){var n=e.value(t,e.property,"MavoCollection");if(n)return n;var i=Mavo.Node.get(t);return i&&i.collection||null},dragulaContainer:function(e){n.dragula.then(function(){n.drake.containers.indexOf(e)===-1&&n.drake.containers.push(e)})},lazy:{dragula:function(e){function t(){return e.apply(this,arguments)}return t.toString=function(){return e.toString()},t}(function(){
return e.include(self.dragula,"https://cdnjs.cloudflare.com/ajax/libs/dragula/3.7.2/dragula.min.js").then(function(){n.drake=n.drake||dragula({moves:function(e,t,n){return n.classList.contains("mv-drag-handle")&&n.closest(Mavo.selectors.item)===e},accepts:function(e,t,i,o){if(e.contains(t))return!1;var a=o?o.previousElementSibling:t.lastElementChild,r=n.get(a)||n.get(o);return r?Mavo.Node.get(e).collection.isCompatible(r):(console.log(o,a),!1)}}),n.drake.on("drop",function(e,t,i,o){var a=Mavo.Node.get(e),r=(a&&a.index,e.previousElementSibling),l=n.get(r)||n.get(o),s=Mavo.Node.get(r)||Mavo.Node.get(o);if(s&&s.collection!=l&&(s=null),!a.collection.isCompatible(l))return n.drake.cancel(!0);if(s)var d=s.index+(s.element===r);else var d=l.children.length;l.add(a,d)})})})}}});Mavo.hooks.add("primitive-init-end",function(){var t=this;if(this.collection&&!this.attribute){var n=function(n){var i;return t.sneak(function(){var o=e.remove(e(".mv-item-controls",t.element));i=n(),e.inside(o,t.element);
}),i};["textContent","innerHTML"].forEach(function(e){var i=Object.getOwnPropertyDescriptor(Node.prototype,e);Object.defineProperty(t.element,e,{get:function(){var e=this;return n(function(){return i.get.call(e)})},set:function(e){var t=this;n(function(){return i.set.call(t,e)})}})})}}),Mavo.hooks.add("node-edit-end",function(){var n=this;this.collection&&(this.itemControls||(this.itemControls=t(".mv-item-controls",this.element).filter(function(e){return e.closest(Mavo.selectors.item)==n.element})[0],this.itemControls=this.itemControls||e.create({className:"mv-item-controls mv-ui"}),e.set(this.itemControls,{contents:[{tag:"button",title:"Delete this "+this.name,className:"mv-delete",events:{click:function(e){return n.collection["delete"](n)}}},{tag:"button",title:"Add new "+this.name.replace(/s$/i,"")+" "+(this.bottomUp?"after":"before"),className:"mv-add",events:{click:function(e){return n.collection.add(null,n.children.indexOf(item)).edit()}}},{tag:"button",title:"Drag to reorder "+this.name,
className:"mv-drag-handle"}]})),this.itemControls.parentNode||this.element.appendChild(this.itemControls))}),Mavo.hooks.add("node-done-end",function(){this.collection&&this.itemControls&&this.itemControls.remove()}),Mavo.Node.prototype.getClosestCollection=function(){return this.collection||this.group.collection||(this.parentGroup?this.parentGroup.closestCollection:null)},e.lazy(Mavo.Node.prototype,"closestCollection",function(){return this.getClosestCollection()}),e.live(Mavo.Node.prototype,"deleted",function(n){var i=this;this.element.classList.toggle("mv-deleted",n),n?(this.elementContents=document.createDocumentFragment(),t(this.element.childNodes).forEach(function(e){i.elementContents.appendChild(e)}),e.contents(this.element,[{tag:"button",className:"mv-close mv-ui",textContent:"×",events:{click:function(t){e.remove(this.parentNode)}}},"Deleted "+this.name,{tag:"button",className:"mv-undo mv-ui",textContent:"Undo",events:{click:function(e){return i.deleted=!1}}}]),this.element.classList.remove("mv-delete-hover")):this.deleted&&(this.element.textContent="",
this.element.appendChild(this.elementContents),this._deleted=!1,this.dataChanged("undelete"))}),Mavo.Node.prototype.isDeleted=function(){this.deleted;return!!this.deleted||!!this.parentGroup&&this.parentGroup.isDeleted()},Mavo.hooks.add("node-init-end",function(e){this.collection=e.options.collection,this.collection&&(this.group=this.parentGroup=this.collection.parentGroup)})}(Bliss,Bliss.$);
