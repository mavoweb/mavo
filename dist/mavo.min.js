...
u.store=u.store||"none",u.modes="read")}}catch(v){n=!0,r=v}finally{try{!e&&i["return"]&&i["return"]()}finally{if(n)throw r}}t.mavo.element.addEventListener("mavo:datachange",function(e){"propertychange"==e.action&&e.node.closestCollection?t.scheduled.has(e.property)||(setTimeout(function(){t.scheduled["delete"](e.property),t.update(e)},o.PROPERTYCHANGE_THROTTLE),t.scheduled.add(e.property)):requestAnimationFrame(function(){return t.update(e)})}),t.update()})},update:function(t){var o=this,n=this.mavo.element;t instanceof Element&&(n=t.closest(Mavo.selectors.group),t=null);var r=Mavo.Node.get(n),s=r.getData({relative:!0,store:"*","null":!0,unhandled:this.mavo.unhandled});r.walk(function(n,i){if(n instanceof Mavo.Group&&n.expressions&&n.expressions.length&&!n.isDeleted()){var a={context:o,data:e.value.apply(e,[s].concat(_toConsumableArray(i)))};void 0===a.data&&console.log(s,i,n.property,r.property),Mavo.hooks.run("expressions-update-start",a);var u=!0,v=!1,l=void 0;try{for(var d,p=n.expressions[Symbol.iterator]();!(u=(d=p.next()).done);u=!0){
var c=d.value;c.changedBy(t)&&c.update(a.data,t)}}catch(h){v=!0,l=h}finally{try{!u&&p["return"]&&p["return"]()}finally{if(v)throw l}}}})},extract:function(e,t,n,r){t&&"mv-expressions"==t.name||(t&&o.directives.indexOf(t.name)>-1||r.test(t?t.value:e.textContent))&&this.expressions.push(new Mavo.Expression.Text({node:e,syntax:r,path:n?n.slice(1).split("/").map(function(e){return+e}):[],attribute:t&&t.name,mavo:this.mavo}))},traverse:function(e){var o=this,n=arguments.length<=1||void 0===arguments[1]?"":arguments[1],r=arguments[2];if(8!==e.nodeType)if(3===e.nodeType)this.extract(e,null,n,r);else{if(e.normalize(),r=Mavo.Expression.Syntax.create(e)||r,r===Mavo.Expression.Syntax.ESCAPE)return;Mavo.is("group",e)&&(n=""),t(e.attributes).forEach(function(t){return o.extract(e,t,n,r)}),t(e.childNodes).forEach(function(e,t){return o.traverse(e,n+"/"+t,r)})}},"static":{directives:[],PROPERTYCHANGE_THROTTLE:50}});self.Proxy&&Mavo.hooks.add("node-getdata-end",function(e){var t=this;e.options.relative&&e.data&&"object"===_typeof(e.data)&&(e.data=new Proxy(e.data,{
get:function(e,o,n){return o in e||o in n&&o in e?e[o]:"$index"==o?t.index+1:o==t.mavo.id?e:void 0},has:function(o,n){if(n in o)return!0;if("$index"==n||n==t.mavo.id)return!0;var r=t.walkUp(function(e){if(n in e.children)return e.children[n]});return void 0===r&&(r=t.find(n)),void 0!==r&&(Array.isArray(r)?r=r.map(function(t){return t.getData(e.options)}).filter(function(e){return null!==e}):r instanceof Mavo.Node&&(r=r.getData(e.options)),o[n]=r,!0)},set:function(e,t,o){throw Error("You can’t set data via expressions.")}}))}),Mavo.hooks.add("init-tree-before",function(){this.expressions=new Mavo.Expressions(this)}),Mavo.hooks.add("group-init-start",function(){var e=this,t=this.template;t&&t.expressions&&(this.expressions=t.expressions.map(function(t){return new Mavo.Expression.Text({template:t,group:e,mavo:e.mavo})}))}),Mavo.hooks.add("render-end",function(){this.expressions.update()}),Mavo.hooks.add("collection-add-end",function(e){this.mavo.expressions.update(e.item.element)})}(Bliss,Bliss.$),
Mavo.attributes.push("mv-value"),Mavo.Expressions.directives.push("mv-value"),Mavo.hooks.add("expressiontext-init-start",function(){"mv-value"==this.attribute&&(this.attribute=Mavo.Primitive.getValueAttribute(this.element),this.fallback=this.fallback||Mavo.Primitive.getValue(this.element,{attribute:this.attribute}),this.expression=this.element.getAttribute("mv-value"),this.parsed=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end)});
