...
"use strict";!function(t,e){Mavo.Unit=t.Class({"abstract":!0,"extends":Mavo.Node,constructor:function(t,e){var i=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];this.constructor.all.set(this.element,this),this.collection=i.collection,this.dirty=i.dirty,this.collection&&(this.group=this.parentGroup=this.collection.parentGroup),this.fromTemplate("required")||(this.required=Mavo.is("required",this.element)),Mavo.hooks.run("unit-init-end",this)},isDeleted:function(){this.deleted;return!!this.deleted||!!this.parentGroup&&this.parentGroup.isDeleted()},getData:function(t){return t=t||{},this.isNull(t)?null:void this.walkUp(function(e){if(e.isNull(t))return null})},isNull:function(t){return this.dirty&&!t.dirty||this.deleted&&t.dirty||!this.saved&&"*"!=t.store},lazy:{closestCollection:function(){return this.collection||this.group.collection||(this.parentGroup?this.parentGroup.closestCollection:null)}},live:{store:function(e){t.toggleAttribute(this.element,"data-store",e)},deleted:function(i){
var n=this;this.element.classList.toggle("deleted",i),i?(this.elementContents=document.createDocumentFragment(),e(this.element.childNodes).forEach(function(t){n.elementContents.appendChild(t)}),t.contents(this.element,[{tag:"button",className:"close mv-ui",textContent:"×",events:{click:function(e){t.remove(this.parentNode)}}},"Deleted "+this.name,{tag:"button",className:"undo mv-ui",textContent:"Undo",events:{click:function(t){return n.deleted=!1}}}]),this.element.classList.remove("delete-hover")):this.deleted&&(this.element.textContent="",this.element.appendChild(this.elementContents),this._deleted=!1,t.fire(this.element,"mavo:datachange",{unit:this.collection,mavo:this.mavo,action:"undelete",item:this}))},unsavedChanges:function(t){return!t||this.saved&&this.editing||(t=!1),this.element.classList.toggle("unsaved-changes",t),t}},"static":{get:function(t,e){var i=Mavo.Group.all.get(t);return e||!i?Mavo.Primitive.all.get(t):i},create:function(t,e){var i=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];
if(!t||!e)throw new TypeError("Mavo.Unit.create() requires an element argument and a mavo object");return new(Mavo[Mavo.is("group",t)?"Group":"Primitive"])(t,e,i)}}})}(Bliss,Bliss.$);
...
}),attribute:e&&e.name,all:this}))},traverse:function(t){var i=this,n=arguments.length<=1||void 0===arguments[1]?"":arguments[1],r=arguments[2];if(3===t.nodeType||8===t.nodeType)this.extract(t,null,n,r);else if(t==this.group.element||!Mavo.is("group",t)){if(r=Mavo.Expression.Syntax.create(t)||r,r===Mavo.Expression.Syntax.ESCAPE)return;e(t.attributes).forEach(function(e){return i.extract(t,e,n,r)}),e(t.childNodes).forEach(function(t,e){return i.traverse(t,n+"/"+e,r)})}},"static":{directives:["data-if"]}})}(),Mavo.Node.prototype.getRelativeData=function(){var t=this,e=arguments.length<=0||void 0===arguments[0]?{dirty:!0,store:"*","null":!0}:arguments[0];e.unhandled=this.mavo.unhandled;var i=this.getData(e);return self.Proxy&&i&&"object"===("undefined"==typeof i?"undefined":_typeof(i))&&(i=new Proxy(i,{get:function(i,n){if(n in i)return i[n];if("$index"==n)return t.index+1;var r=t.walkUp(function(i){if(n in i.properties)return i.expressions.dependents.add(t.expressions),i.properties[n].getRelativeData(e);
...
return void 0!==i?i:(i={},this.propagate(function(t){if((t.saved||"*"==e.store)&&!(t.property in i)){var r=t.getData(e);(null!==r||e["null"])&&(i[t.property]=r)}}),e.dirty&&!e.unhandled||t.extend(i,this.unhandled),this.type&&this.type!=r.DEFAULT_TYPE&&(i["@type"]=this.type),this.vocab&&(i["@context"]=this.vocab),i.summary&&(i.toString=function(){return this.summary}),i)},find:function(t){if(this.property==t)return this;if(t in this.properties)return this.properties[t].find(t);for(var e in this.properties){var r=this.properties[e].find(t);if(void 0!==r)return r}},propagate:function(e){var r=arguments;t.each(this.properties,function(t,e){e.call.apply(e,r)})},save:function(){this.unsavedChanges=!1},done:function(){t.unbind(this.element,".mavo:edit")},propagated:["save","done","import","clear"],render:function(e){var r=this;e&&(Mavo.hooks.run("group-render-start",this),e=Array.isArray(e)?e[0]:e,this.unhandled=t.extend({},e,function(t){return!(t in r.properties)}),this.propagate(function(t){
t.render(e[t.property])}),this.save(),Mavo.hooks.run("group-render-end",this))},contains:function(t){return t instanceof Mavo.Unit?t.parentGroup===this:t.parentNode&&this.element===t.parentNode.closest(Mavo.selectors.group)},"static":{all:new WeakMap,DEFAULT_TYPE:"Item",normalize:function(t){if(Mavo.is("group",t)){var e=t.getAttribute("typeof")||t.getAttribute("itemtype")||r.DEFAULT_TYPE;return t.setAttribute("typeof",e),e}return null}}})}(Bliss,Bliss.$);
...
node:this,mavo:this.mavo,action:"clear"}))},save:function(){var e=!0,t=!1,i=void 0;try{for(var n,a=this.items[Symbol.iterator]();!(e=(n=a.next()).done);e=!0){var r=n.value;r.deleted?this["delete"](r,!0):r.unsavedChanges=r.dirty=!1}}catch(s){t=!0,i=s}finally{try{!e&&a["return"]&&a["return"]()}finally{if(t)throw i}}},done:function(){},propagated:["save","done"],revert:function(){var e=!0,t=!1,i=void 0;try{for(var n,a=this.items[Symbol.iterator]();!(e=(n=a.next()).done);e=!0){var r=n.value;r.unsavedChanges?this["delete"](r,!0):(r.deleted&&(r.deleted=!1),r.revert())}}catch(s){t=!0,i=s}finally{try{!e&&a["return"]&&a["return"]()}finally{if(t)throw i}}},render:function(e){var t=this;if(this.unhandled={before:[],after:[]},e){if(e=Mavo.toArray(e),this.mutable){this.clear();var i=document.createDocumentFragment();e.forEach(function(e,n){var a=t.createItem();a.render(e),t.items.push(a),a.index=n,i.appendChild(a.element)}),this.marker.parentNode.insertBefore(i,this.marker)}else this.items.forEach(function(t,i){
