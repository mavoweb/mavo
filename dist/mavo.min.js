...
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,i=Array(e.length);t<e.length;t++)i[t]=e[t];return i}return Array.from(e)}!function(e,t){var i=self.Mavo=e.Class({constructor:function(s){var r=this;if(this.index=i.all.push(this),this.id=s.getAttribute("data-mavo")||Mavo.Node.getProperty(s)||s.id||"mavo"+this.index,this.unhandled=s.classList.contains("mv-keep-unhandled"),1==this.index&&(this.store=i.urlParam("store"),this.source=i.urlParam("source")),this.store=this.store||i.urlParam(this.id+"_store")||s.getAttribute("data-store")||null,this.source=this.source||i.urlParam(this.id+"_source")||s.getAttribute("data-source")||null,this.autoEdit=i.has("autoedit",s),this.element=i.is("scope",s)?s:e(i.selectors.rootScope,s),this.element||(s.setAttribute("typeof",s.getAttribute("property")||""),s.removeAttribute("property"),this.element=s),this.element.classList.add("mv-root"),t(i.selectors.property+", "+i.selectors.scope,s).concat([this.element]).forEach(function(e){i.is("autoMultiple",e)&&!e.hasAttribute("data-multiple")&&e.setAttribute("data-multiple","");
}),this.wrapper=s.closest(".mv-wrapper")||s,this.wrapper.addEventListener("keydown",function(e){83==e.keyCode&&e[i.superKey]&&(e.preventDefault(),r.save())}),t(i.selectors.primitive,s).forEach(function(t){var s=e(i.selectors.not(i.selectors.formControl)+", "+i.selectors.property,t)&&(Mavo.is("multiple",t)||null===Mavo.Primitive.getValueAttribute(t))||t.matches("template");s&&t.setAttribute("typeof","")}),this.wrapper===this.element&&i.is("multiple",s)){var n=this.element;this.element.matches("li, option")?n=n.parentNode:this.element.matches("td, tr, tbody, thead, tfoot")&&(n=n.closest("table")),this.wrapper=e.create({around:n})}this.wrapper.classList.add("mv-wrapper"),this.ui={bar:e(".mv-bar",this.wrapper)||e.create({className:"mv-bar mv-ui",start:this.wrapper})},this.ui.status=e(".status",this.ui.bar)||e.create("span",{className:"status",inside:this.ui.bar}),this.needsEdit=!1,this.permissions=new Mavo.Permissions(null,this),Mavo.hooks.run("init-tree-before",this),this.root=Mavo.Node.create(this.element,this),
Mavo.hooks.run("init-tree-after",this),this.setUnsavedChanges(!1),i.observe(this.wrapper,"class",function(){var e=r.permissions,t=!r.editing&&(e.login||e.edit&&!e.login&&!(e.save&&r.unsavedChanges));r.ui.bar.classList.toggle("floating",t)}),this.permissions.onchange(function(e){var t=e.action,i=e.value;r.wrapper.classList.toggle("can-"+t,i)}),this.permissions.can(["edit","add","delete"],function(){r.ui.edit=e.create("button",{className:"edit",textContent:"Edit",onclick:function(e){return r.editing?r.done():r.edit()},inside:r.ui.bar}),r.autoEdit&&requestAnimationFrame(function(){return r.ui.edit.click()})},function(){e.remove(r.ui.edit),r.editing&&r.done()}),this.needsEdit&&this.permissions.can("save",function(){r.ui.save=e.create("button",{className:"save",textContent:"Save",events:{click:function(e){return r.save()},"mouseenter focus":function(e){r.wrapper.classList.add("save-hovered"),r.setUnsavedChanges()},"mouseleave blur":function(e){return r.wrapper.classList.remove("save-hovered");
}},inside:r.ui.bar}),r.ui.revert=e.create("button",{className:"revert",textContent:"Revert",disabled:!0,events:{click:function(e){return r.revert()},"mouseenter focus":function(e){r.unsavedChanges||(r.wrapper.classList.add("revert-hovered"),r.setUnsavedChanges())},"mouseleave blur":function(e){return r.wrapper.classList.remove("revert-hovered")}},inside:r.ui.bar})},function(){e.remove([r.ui.save,r.ui.revert]),r.ui.save=r.ui.revert=null}),this.permissions.can("delete",function(){r.ui.clear=e.create("button",{className:"clear",textContent:"Clear",onclick:function(e){return r.clear()}}),r.ui.bar.appendChild(r.ui.clear)}),this.permissions.cannot(["delete","edit"],function(){e.remove(r.ui.clear)}),this.store||this.source?(this.storage=new i.Storage(this),this.permissions.can("read",function(){return r.storage.load()})):(this.permissions.on(["read","edit"]),e.fire(this.wrapper,"mavo:load")),this.needsEdit||this.permissions.off(["edit","add","delete"]),Mavo.hooks.run("init-end",this)},get data(){
return this.getData()},getData:function(e){return this.root.getData(e)},toJSON:function(){var e=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0];return i.toJSON(e)},render:function(e){i.hooks.run("render-start",{context:this,data:e}),e&&this.root.render(e),this.unsavedChanges=!1},clear:function(){confirm("This will delete all your data. Are you sure?")&&(this.storage&&this.storage.clear(),this.root.clear())},edit:function(){this.editing=!0,this.root.edit(),e.events(this.wrapper,"mouseenter.mavo:edit mouseleave.mavo:edit",function(e){if(e.target.matches(".mv-item-controls .delete")){var t=e.target.closest(i.selectors.item);t.classList.toggle("delete-hover","mouseenter"==e.type)}if(e.target.matches(i.selectors.item)){e.target.classList.remove("has-hovered-item");var s=e.target.parentNode.closest(i.selectors.item);s&&s.classList.toggle("has-hovered-item","mouseenter"==e.type)}},!0),this.setUnsavedChanges()},setUnsavedChanges:function(e){var t=!!e;return e||this.walk(function(i){
if(i.unsavedChanges)return t=!0,e===!1&&(i.unsavedChanges=!1),!1}),this.unsavedChanges=t},done:function(){this.root.done(),e.unbind(this.wrapper,".mavo:edit"),this.editing=!1,this.unsavedChanges=!1},save:function(){this.root.save(),this.storage&&this.storage.save(),this.unsavedChanges=!1},revert:function(){this.root.revert()},walk:function(e){this.root.walk(e)},live:{editing:{set:function(e){this.wrapper.classList.toggle("editing",e),e?this.wrapper.setAttribute("data-editing",""):this.wrapper.removeAttribute("data-editing")}},unsavedChanges:function(e){this.wrapper.classList.toggle("unsaved-changes",e),this.ui&&this.ui.save&&(this.ui.save.disabled=!e,this.ui.revert.disabled=!e)},needsEdit:function(e){this.ui.bar[(e?"remove":"set")+"Attribute"]("hidden","")}},"static":{all:[],superKey:0===navigator.platform.indexOf("Mac")?"metaKey":"ctrlKey",init:function(e){return t(i.selectors.init,e||document).map(function(e){return new i(e)})},hooks:new e.Hooks}});!function(){var t=i.selectors={init:".mavo, [mavo], [data-mavo], [data-store]",
property:"[property], [itemprop]",specificProperty:function(e){return"[property="+e+"], [itemprop="+e+"]"},scope:"[typeof], [itemscope], [itemtype], .mv-group",multiple:"[multiple], [data-multiple], .multiple",required:"[required], [data-required], .required",formControl:"input, select, option, textarea",computed:".computed",item:".mv-item",ui:".mv-ui",option:function(e){return"["+e+"], [data-"+e+"], [data-mv-options~='"+e+"'], ."+e},container:{li:"ul, ol",tr:"table",option:"select",dt:"dl",dd:"dl"},documentFragment:".document-fragment"},s=t.arr=function(e){return e.split(/\s*,\s*/g)},r=t.not=function(e){return s(e).map(function(e){return":not("+e+")"}).join("")},n=t.or=function(e,t){return e+", "+t},o=t.and=function(e,t){var i=[],r=s(t);return s(e).forEach(function(e){return i.push.apply(i,_toConsumableArray(r.map(function(t){return e+t})))}),i.join(", ")},a=t.andNot=function(e,t){return o(e,r(t))};e.extend(i.selectors,{primitive:a(t.property,t.scope),rootScope:a(t.scope,t.property),output:n(t.specificProperty("output"),".output, .value"),
autoMultiple:o("li, tr, option",":only-of-type")})}(),Promise.all([e.ready(),e.include(Array.from&&window.Intl&&document.documentElement.closest,"https://cdn.polyfill.io/v2/polyfill.min.js?features=blissfuljs,Intl.~locale.en")])["catch"](function(e){return console.error(e)}).then(function(){return Mavo.init()}),Stretchy.selectors.filter=".mv-editor:not([property])"}(Bliss,Bliss.$);
"use strict";!function(r,t){var e=r.extend(Mavo,{toJSON:function(r){return null===r?"":"string"==typeof r?r:JSON.stringify(r,null,"\t")},readable:function(r){return r&&r.replace(/([a-z])([A-Z])(?=[a-z])/g,function(r,t,e){return t+" "+e.toLowerCase()}).replace(/([a-z])[_\/-](?=[a-z])/g,"$1 ").replace(/^[a-z]/,function(r){return r.toUpperCase()})},identifier:function(r){return r+="",r&&r.replace(/\s+/g,"-").replace(/[^\w-]/g,"").toLowerCase()},queryJSON:function(t,e){return e&&t?r.value.apply(r,[t].concat(e.split("/"))):t},observe:function(t,e,n,a){n instanceof MutationObserver||(n=new MutationObserver(n));var o={};return e&&r.extend(o,{attributes:!0,attributeFilter:"all"==e?void 0:[e],attributeOldValue:!!a}),e&&"all"!=e||r.extend(o,{characterData:!0,childList:!0,subtree:!0,characterDataOldValue:!!a}),n.observe(t,o),n},toArray:function(r){return Array.isArray(r)?r:[r]},flatten:function(r){return Array.isArray(r)?r.reduce(function(r,t){return e.toArray(r).concat(e.flatten(t))},[]):[r]},is:function(r,t){
return t.matches&&t.matches(e.selectors[r])},has:function(r,t){return t.matches&&t.matches(e.selectors.option(r))},urlParam:function(){for(var r=("searchParams"in URL.prototype?new URL(location).searchParams:null),t=null,e=arguments.length,n=Array(e),a=0;a<e;a++)n[a]=arguments[a];var o=!0,i=!1,c=void 0;try{for(var u,s=n[Symbol.iterator]();!(o=(u=s.next()).done);o=!0){var l=u.value;if(r)t=r.get(l);else{var f=location.search.match(RegExp("[?&]"+l+"(?:=([^&]+))?(?=&|$)","i"));t=f&&(f[1]||"")}if(null!==t)return t}}catch(p){i=!0,c=p}finally{try{!o&&s["return"]&&s["return"]()}finally{if(i)throw c}}return null},escapeRegExp:function(r){return r.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}});r.proxy=r.classProps.proxy=r.overload(function(r,t,e){return Object.defineProperty(r,t,{get:function(){return this[e][t]},set:function(r){this[e][t]=r},configurable:!0,enumerable:!0}),r}),r.classProps.propagated=function(r,t){Mavo.toArray(t).forEach(function(t){var e=r[t];r[t]=function(){var r=e&&e.apply(this,arguments);
this.propagate&&r!==!1&&this.propagate(t)}})},document.addEventListener("focus",function(r){t(".focus-within").forEach(function(r){return r.classList.remove("focus-within")});for(var e=r.target;e=e.parentNode;)e.classList&&e.classList.add("focus-within")},!0)}(Bliss,Bliss.$);
...
"use strict";!function(e,t){Mavo.Unit=e.Class({"abstract":!0,"extends":Mavo.Node,constructor:function(e,t){var i=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];this.constructor.all.set(this.element,this),this.collection=i.collection,this.dirty=i.dirty,this.collection&&(this.scope=this.parentScope=this.collection.parentScope),this.fromTemplate("computed","required")||(this.computed=Mavo.is("computed",this.element),this.required=Mavo.is("required",this.element)),Mavo.hooks.run("unit-init-end",this)},isDeleted:function(){this.deleted;return!!this.deleted||!!this.parentScope&&this.parentScope.isDeleted()},getData:function(e){e=e||{};var t=function(t){return t.dirty&&!e.dirty||t.deleted&&e.dirty||t.computed&&!e.computed||t.placeholder};return t(this)?null:void this.walkUp(function(e){if(t(e))return null})},lazy:{closestCollection:function(){return this.collection?this.collection:this.walkUp(function(e){if(e.collection)return e.collection})||null}},live:{deleted:function(i){var n=this;
this.element.classList.toggle("deleted",i),i?(this.elementContents=document.createDocumentFragment(),t(this.element.childNodes).forEach(function(e){n.elementContents.appendChild(e)}),e.contents(this.element,["Deleted "+this.name,{tag:"button",textContent:"Undo",events:{click:function(e){return n.deleted=!1}}}]),this.element.classList.remove("delete-hover")):this.deleted&&(this.element.textContent="",this.element.appendChild(this.elementContents),this._deleted=!1,e.fire(this.element,"mavo:datachange",{unit:this.collection,mavo:this.mavo,action:"undelete",item:this}))},unsavedChanges:function(e){return e&&(this.placeholder||this.computed||!this.editing)&&(e=!1),this.element.classList.toggle("unsaved-changes",e),e},placeholder:function(e){this.element.classList.toggle("placeholder",e)}},"static":{get:function(e,t){var i=Mavo.Scope.all.get(e);return t||!i?Mavo.Primitive.all.get(e):i},create:function(e,t){var i=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];if(!e||!t)throw new TypeError("Mavo.Unit.create() requires an element argument and a mavo object");
return new(Mavo[Mavo.is("scope",e)?"Scope":"Primitive"])(e,t,i)}}})}(Bliss,Bliss.$);
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e};!function(e,t){var n=Mavo.Expression=e.Class({constructor:function(e){this.expression=e},eval:function(e){this.oldValue=this.value,Mavo.hooks.run("expression-eval-beforeeval",this);try{this["function"]||(this["function"]=n.compile(this.expression)),this.value=this["function"](e)}catch(t){Mavo.hooks.run("expression-eval-error",{context:this,exception:t}),this.value=n.ERROR}return this.value},toString:function(){return this.expression},live:{expression:function(e){e=e.trim();this["function"]=null}},"static":{ERROR:"N/A",serializers:{BinaryExpression:function(e){return n.serialize(e.left)+" "+e.operator+" "+n.serialize(e.right)},UnaryExpression:function(e){
return""+e.operator+n.serialize(e.argument)},CallExpression:function(e){return n.serialize(e.callee)+"("+e.arguments.map(n.serialize).join(", ")+")"},ConditionalExpression:function(e){return n.serialize(e.test)+"? "+n.serialize(e.consequent)+" : "+n.serialize(e.alternate)},MemberExpression:function(e){return n.serialize(e.object)+"["+n.serialize(e.property)+"]"},ArrayExpression:function(e){return"["+e.elements.map(n.serialize).join(", ")+"]"},Literal:function(e){return e.raw},Identifier:function(e){return e.name},ThisExpression:function(e){return"this"},Compound:function(e){return e.body.map(n.serialize).join(" ")}},transformations:{BinaryExpression:function(e){return(Mavo.Functions.operators[e.operator]||e.operator)+"("+n.serialize(e.left)+", "+n.serialize(e.right)+")"},CallExpression:function(e){"Identifier"==e.callee.type&&"if"==e.callee.name&&(e.callee.name="iff")}},serialize:function(e){if(n.transformations[e.type]){var t=n.transformations[e.type](e);if(void 0!==t)return t}return n.serializers[e.type](e);
},rewrite:function(e){try{return n.serialize(n.parse(e))}catch(t){return e}},compile:function(e){return e=n.rewrite(e),new Function("data","with(Mavo.Functions._Trap)\n\t\t\t\t\twith(data) {\n\t\t\t\t\t\treturn "+e+";\n\t\t\t\t\t}")},parse:self.jsep,lazy:{simpleOperation:function(){var e=Object.keys(Mavo.Functions.operators).map(function(e){return e.replace(/[|*+]/g,"\\$&")}).join("|"),t="\\s*(\\b[\\w.]+\\b)\\s*";return RegExp("(?:^|\\()"+t+"("+e+")"+t+"(?:$|\\))","g")}}}});self.jsep&&(jsep.addBinaryOp("and",2),jsep.addBinaryOp("or",2),jsep.addBinaryOp("=",6)),n.serializers.LogicalExpression=n.serializers.BinaryExpression,n.transformations.LogicalExpression=n.transformations.BinaryExpression,function(){var t=Mavo.Expression.Text=e.Class({constructor:function(e){this.all=e.all,this.node=e.node,this.path=e.path,this.syntax=e.syntax,this.node||(this.node=this.path.reduce(function(e,t){return e.childNodes[t]},this.all.scope.element)),this.element=this.node,this.attribute=e.attribute||null,3===this.node.nodeType&&(this.element=this.node.parentNode,
this.node.parentNode.children.length&&!this.attribute||(this.node=this.element,this.element.normalize())),this.expression=(this.attribute?this.node.getAttribute(this.attribute):this.node.textContent).trim(),this.template=e.template?e.template.template:this.tokenize(this.expression);var n=Mavo.Unit.get(this.element);n&&this.attribute===n.attribute&&(this.primitive=n,n.computed=!0),Mavo.hooks.run("expressiontext-init-end",this),t.elements.set(this.element,[].concat(_toConsumableArray(t.elements.get(this.element)||[]),[this]))},update:function(e){var t=this;this.data=e;var n={};n.value=this.value=this.template.map(function(n){if(n instanceof Mavo.Expression){var i={context:t,expr:n};return Mavo.hooks.run("expressiontext-update-beforeeval",i),i.value=i.expr.eval(e),Mavo.hooks.run("expressiontext-update-aftereval",i),void 0===i.value||null===i.value?"":i.value}return n}),this.attribute||(n.presentational=this.value.map(function(e){return Array.isArray(e)?e.join(", "):"number"==typeof e?Mavo.Primitive.formatNumber(e):e;
}),n.presentational=1===n.presentational.length?n.presentational[0]:n.presentational.join("")),n.value=1===n.value.length?n.value[0]:n.value.join(""),this.primitive&&1===this.template.length&&("number"==typeof n.value?this.primitive.datatype="number":"boolean"==typeof n.value&&(this.primitive.datatype="boolean")),n.presentational===n.value&&(n=n.value),this.primitive?this.primitive.value=n:Mavo.Primitive.setValue(this.node,n,this.attribute,{presentational:n.presentational})},tokenize:function(e){var t,n=(this.syntax,[]),i=0;for(this.syntax.lastIndex=0;null!==(t=this.syntax.exec(e));)t.index>i&&n.push(e.substring(i,t.index)),i=this.syntax.lastIndex,n.push(new Mavo.Expression(t[1]));return i<e.length&&n.push(e.substring(i)),n},proxy:{scope:"all",expressionRegex:"all"},"static":{elements:new WeakMap}})}(),function(){var n=Mavo.Expressions=e.Class({constructor:function(e){var t=this;if(e&&(this.scope=e,this.scope.expressions=this),this.all=[],Mavo.hooks.run("expressions-init-start",this),this.scope){
var i=this.scope.template;if(i&&i.expressions){var r=!0,s=!1,a=void 0;try{for(var o,l=i.expressions.all[Symbol.iterator]();!(r=(o=l.next()).done);r=!0){var u=o.value;this.all.push(new Mavo.Expression.Text({path:u.path,syntax:u.syntax,attribute:u.attribute,all:this,template:u}))}}catch(p){s=!0,a=p}finally{try{!r&&l["return"]&&l["return"]()}finally{if(s)throw a}}}else{var h=n.getSyntax(this.scope.element.closest("[data-expressions]"))||n.defaultSyntax;this.traverse(this.scope.element,void 0,h)}}this.dependents=new Set,this.active=!0,this.scope.element.addEventListener("mavo:datachange",function(e){return t.update()}),this.update()},update:function(){if(this.active&&!this.scope.isDeleted()&&this.all.length+this.dependents.size!==0){var e={context:this,data:this.scope.getRelativeData()};Mavo.hooks.run("expressions-update-start",e);var t=!0,n=!1,i=void 0;try{for(var r,s=this.all[Symbol.iterator]();!(t=(r=s.next()).done);t=!0){var a=r.value;a.update(e.data)}}catch(o){n=!0,i=o}finally{try{!t&&s["return"]&&s["return"]();
}finally{if(n)throw i}}var l=!0,u=!1,p=void 0;try{for(var h,c=this.dependents[Symbol.iterator]();!(l=(h=c.next()).done);l=!0){var f=h.value;f.update()}}catch(o){u=!0,p=o}finally{try{!l&&c["return"]&&c["return"]()}finally{if(u)throw p}}}},extract:function(e,t,n,i){i.lastIndex=0,i.test(t?t.value:e.textContent)&&this.all.push(new Mavo.Expression.Text({node:e,syntax:i,path:(n||"").slice(1).split("/").map(function(e){return+e}),attribute:t&&t.name,all:this}))},traverse:function(e){var i=this,r=arguments.length<=1||void 0===arguments[1]?"":arguments[1],s=arguments[2];3===e.nodeType||8===e.nodeType?this.extract(e,null,r,s):e!=this.scope.element&&Mavo.is("scope",e)||(s=n.getSyntax(e)||s,t(e.attributes).forEach(function(t){return i.extract(e,t,r,s)}),t(e.childNodes).forEach(function(e,t){return i.traverse(e,r+"/"+t,s)}))},"static":{defaultSyntax:/\[([\S\s]+?)\]/gi,emptySyntax:/(?!)/,getSyntax:function(e){if(e){var t=e.getAttribute("data-expressions");if(t){if(!/^\S+expression\S+$/i.test(t))return n.emptySyntax;
t=Mavo.escapeRegExp(t).replace("expression","([\\S\\s]+?)"),t=RegExp(t,"gi")}return t}}}})}(),Mavo.Node.prototype.getRelativeData=function(){var e=this,t=arguments.length<=0||void 0===arguments[0]?{dirty:!0,computed:!0,"null":!0}:arguments[0];t.unhandled=this.mavo.unhandled;var n=this.getData(t);return self.Proxy&&n&&"object"===("undefined"==typeof n?"undefined":_typeof(n))&&(n=new Proxy(n,{get:function(n,i){if(i in n)return n[i];if("$index"==i)return e.index+1;var r=e.walkUp(function(n){if(i in n.properties)return n.expressions.dependents.add(e.expressions),n.properties[i].getRelativeData(t)});return void 0!==r?r:void 0},has:function(n,i){if(i in n)return!0;if("$index"==i)return!0;var r=e.walkUp(function(e){if(i in e.properties)return!0});return void 0!==r?r:(r=e.find(i),void 0!==r?(r=Array.isArray(r)?r.map(function(e){return e.getData(t)}).filter(function(e){return null!==e}):r.getData(t),n[i]=r,!0):void 0)},set:function(e,t,n){throw Error("You can’t set data via expressions.")}})),n},
Mavo.hooks.add("scope-init-end",function(){new Mavo.Expressions(this),this.expressions.update()}),Mavo.hooks.add("scope-render-start",function(){this.expressions.active=!1}),Mavo.hooks.add("scope-render-end",function(){var e=this;requestAnimationFrame(function(){e.expressions.active=!0,e.expressions.update()})})}(Bliss,Bliss.$);
"use strict";function _toConsumableArray(n){if(Array.isArray(n)){for(var r=0,t=Array(n.length);r<n.length;r++)t[r]=n[r];return t}return Array.from(n)}!function(){function n(n,r){return n=Array.isArray(n)?n:r?$$(r):[n],n.filter(function(n){return!isNaN(n)}).map(function(n){return+n})}function r(r,e){var u=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];return e.length<2?function(n){return Array.isArray(n)?n.map(e):e(n)}:(u.symbol&&(t.operators[u.symbol]=r),t[r]=function(){for(var r=arguments.length,t=Array(r),o=0;o<r;o++)t[o]=arguments[o];return 1===t.length&&(t=[].concat(_toConsumableArray(t),[u.identity])),t.reduce(function(r,t){return Array.isArray(t)?("number"==typeof u.identity&&(t=n(t)),Array.isArray(r)?[].concat(_toConsumableArray(t.map(function(n,t){return e(void 0===r[t]?u.identity:r[t],n)})),_toConsumableArray(r.slice(t.length))):t.map(function(n){return e(r,n)})):("number"==typeof u.identity&&(t=+t),Array.isArray(r)?r.map(function(n){return e(n,t)}):e(r,t))})})}var t=Mavo.Functions={
operators:{"=":"eq"},sum:function(r){return n(r,arguments).reduce(function(n,r){return+n+(+r||0)},0)},average:function(r){return r=n(r,arguments),r.length&&t.sum(r)/r.length},min:function(r){return Math.min.apply(Math,_toConsumableArray(n(r,arguments)))},max:function(r){return Math.max.apply(Math,_toConsumableArray(n(r,arguments)))},count:function(n){return Mavo.toArray(n).filter(function(n){return null!==n&&n!==!1}).length},round:function(n,r){return n&&r&&isFinite(n)?+n.toLocaleString("en-US",{useGrouping:!1,maximumFractionDigits:r}):Math.round(n)},iff:function(n,r){var t=arguments.length<=2||void 0===arguments[2]?"":arguments[2];return n?r:t}};r("not",function(n){return function(n){return!n}}),r("multiply",function(n,r){return n*r},{identity:1,symbol:"*"}),r("divide",function(n,r){return n/r},{identity:1,symbol:"/"}),r("add",function(n,r){return+n+ +r},{symbol:"+"}),r("subtract",function(n,r){return n-r},{symbol:"-"}),r("lte",function(n,r){return n<=r},{symbol:"<="}),r("lt",function(n,r){
return n<r},{symbol:"<"}),r("gte",function(n,r){return n>=r},{symbol:">="}),r("gt",function(n,r){return n>r},{symbol:">"}),r("eq",function(n,r){return n==r},{symbol:"=="}),r("and",function(n,r){return!!n&&!!r},{identity:!0,symbol:"&&"}),r("or",function(n,r){return!!n||!!r},{identity:!1,symbol:"||"});var e={average:"avg",iff:"iff IF",subtract:"minus",multiply:"mult product",divide:"div",lt:"lessThan smaller",gt:"moreThan greater greaterThan bigger",eq:"equal equality"},u=function(n){e[n].split(/\s+/g).forEach(function(r){return t[r]=t[n]})};for(var o in e)u(o);Mavo.Functions._Trap=self.Proxy?new Proxy(t,{get:function(n,r){if(r in n)return n[r];var t=r.toLowerCase&&r.toLowerCase();return t&&n.hasOwnProperty(t)?n[t]:r in Math||t in Math?Math[r]||Math[t]:r in self?self[r]:r},has:function(n,r){return"data"!=r}}):Mavo.Functions}();
...
}}),t.dirty&&!t.unhandled||e.extend(i,this.unhandled),i)},find:function(e){if(this.property==e)return this;if(e in this.properties)return this.properties[e].find(e);for(var t in this.properties){var i=this.properties[t].find(e);if(void 0!==i)return i}},propagate:function(t){var i=arguments;e.each(this.properties,function(e,t){t.call.apply(t,i)})},save:function(){return!this.placeholder&&void(this.unsavedChanges=!1)},done:function(){e.unbind(this.element,".mavo:edit")},propagated:["save","done","import","clear"],render:function(t){var i=this;return t?(Mavo.hooks.run("scope-render-start",this),t=t.isArray?t[0]:t,this.unhandled=e.extend({},t,function(e){return!(e in i.properties)}),this.propagate(function(e){e.render(t[e.property])}),this.save(),void Mavo.hooks.run("scope-render-end",this)):void this.clear()},contains:function(e){return e instanceof Mavo.Unit?e.parentScope===this:e.parentNode&&this.element===e.parentNode.closest(Mavo.selectors.scope)},"static":{all:new WeakMap,normalize:function(e){
if(Mavo.is("scope",e)){var t=e.getAttribute("typeof")||e.getAttribute("itemtype")||"Item";return e.setAttribute("typeof",t),t}return null}}})}(Bliss,Bliss.$);
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){var i=Mavo.Primitive=t.Class({"extends":Mavo.Unit,constructor:function(n,s,a){var o=this;if(this.fromTemplate("attribute","datatype","humanReadable","computed","templateValue")||(this.attribute=i.getValueAttribute(this.element),this.attribute?this.humanReadable=this.attribute.humanReadable:this.element.normalize(),this.datatype=i.getDatatype(this.element,this.attribute),this.templateValue=this.getValue({raw:!0})),Mavo.is("formControl",this.element)&&(this.editor=this.element,this.editorType="exposed",this.edit()),this.editor||this.attribute||(this.editor=e(this.element.children).filter(function(t){return t.matches(Mavo.selectors.formControl)&&!t.matches(Mavo.selectors.property)})[0],this.editor&&(this.editorType="nested",this.element.textContent=this.editorValue,t.remove(this.editor))),
!this.editor&&this.element.hasAttribute("data-edit")){this.editorType="linked";var r=t(this.element.getAttribute("data-edit"));r&&Mavo.is("formControl",r)&&(this.editor=r.cloneNode(!0),this.template||Mavo.observe(r,"all",function(t){var e=!0,i=!1,n=void 0;try{for(var s,a=o.copies[Symbol.iterator]();!(e=(s=a.next()).done);e=!0){var u=s.value;u.editor=r.cloneNode(!0),u.setValue(u.value,{force:!0,silent:!0})}}catch(h){i=!0,n=h}finally{try{!e&&a["return"]&&a["return"]()}finally{if(i)throw n}}}))}if(this.fromTemplate("templateValue")||(this.templateValue=this.getValue()),requestAnimationFrame(function(){o.exposed||o.computed||(o.mavo.needsEdit=!0)}),this["default"]=this.element.getAttribute("data-default"),this.computed||""===this["default"]?this["default"]=this.templateValue:null===this["default"]&&(this["default"]=this.editor?this.editorValue:this.emptyValue),this.collection){var u=function(e){o.unobserve();var i=t.remove(t(Mavo.selectors.ui,o.element)),n=e();return t.inside(i,o.element),o.observe(),
n};["textContent","innerHTML"].forEach(function(t){var e=Object.getOwnPropertyDescriptor(Node.prototype,t);Object.defineProperty(o.element,t,{get:function(){var t=this;return u(function(){return e.get.call(t)})},set:function(t){var i=this;u(function(){return e.set.call(i,t)})}})})}this.computed||this.setValue(this.templateValue,{silent:!0}),this.setValue(this.template?this["default"]:this.templateValue,{silent:!0}),this.observe()},get editorValue(){if(this.editor){if(this.editor.matches(Mavo.selectors.formControl))return i.getValue(this.editor,void 0,this.datatype);var e=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);if(e)return i.all.has(e)?i.all.get(e).value:i.getValue(e)}},set editorValue(e){if(this.editor)if(this.editor.matches(Mavo.selectors.formControl))i.setValue(this.editor,e);else{var n=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);n&&(i.all.has(n)?i.all.get(n).value=e:i.setValue(n,e))}},get exposed(){return this.editor===this.element;
...
},"focus.mavo:preedit":function(e){t.edit(),t.popup||t.editor.focus()},"click.mavo:edit":function(e){t.exposed||e.preventDefault()}}),this.attribute||this.element._.events({"mouseenter.mavo:preedit":function(i){clearTimeout(e),e=setTimeout(function(){return t.edit()},150)},"mouseleave.mavo:preedit":function(t){clearTimeout(e)}}),this.element._.data.prevTabindex=this.element.getAttribute("tabindex"),this.element.tabIndex=0}},initEdit:function(){var n=this;if(!this.editor){var s=i.getMatch(this.element,i.editors);s.create&&t.extend(this,s,function(t){return"create"!=t});var a=s.create||s;this.editor=t.create("function"===t.type(a)?a.call(this):a),this.editorValue=this.value,this.editorType="created"}if(this.editor._.events({"input change":function(t){var e=n.mavo.unsavedChanges;n.value=n.editorValue,n.exposed&&!n.mavo.editing&&n.mavo.permissions.save&&(n.unsavedChanges=!1,n.mavo.unsavedChanges=e,"change"==t.type&&(n.save(),n.mavo.storage.save(),n.mavo.setUnsavedChanges()))},focus:function(t){
n.editor.select&&n.editor.select()},keyup:function(t){(n.popup&&13==t.keyCode||27==t.keyCode)&&(n.popup.contains(document.activeElement)&&n.element.focus(),t.stopPropagation(),n.hidePopup())},"mavo:datachange":function(e){"output"===e.property&&(e.stopPropagation(),t.fire(n.editor,"input"))}}),"placeholder"in this.editor&&(this.editor.placeholder="("+this.label+")"),!this.exposed){var o=/^data-input-/i;if(e(this.element.attributes).forEach(function(t){o.test(t.name)&&this.editor.setAttribute(t.name.replace(o,""),t.value)},this),this.attribute){this.element.classList.add("using-popup"),this.popup=this.popup||t.create("div",{className:"mv-popup",hidden:!0,contents:[this.label+":",this.editor]}),this.editor.matches("select")&&(this.editor.size=Math.min(10,this.editor.children.length));var r=function(t){n.popup.contains(t.target)||n.element.contains(t.target)||n.hidePopup()};this.showPopup=function(){t.unbind([this.element,this.popup],".mavo:showpopup"),this.popup._.after(this.element);var e=this.element.offsetLeft,i=this.element.offsetTop+this.element.offsetHeight;
this.popup._.style({top:i+"px",left:e+"px"}),this.popup._.removeAttribute("hidden"),t.events(document,"focus click",r,!0)},this.hidePopup=function(){var e=this;t.unbind(document,"focus click",r,!0),this.popup.setAttribute("hidden",""),setTimeout(function(){t.remove(e.popup)},400),t.events(this.element,"focus.mavo:showpopup click.mavo:showpopup",function(t){e.showPopup()},!0)}}}this.popup||this.editor.classList.add("mv-editor"),this.initEdit=null},edit:function(){this.computed||this.editing||(this.element._.unbind(".mavo:preedit"),this.initEdit&&this.initEdit(),this.popup&&this.showPopup(),this.attribute||this.editor.parentNode==this.element||this.exposed||(this.editorValue=this.value,this.element.textContent="",this.exposed||this.element.appendChild(this.editor)),this.editing=!0)},clear:function(){this.value=this.emptyValue},render:function(t){Array.isArray(t)&&(t=t[0]),"object"===("undefined"==typeof t?"undefined":_typeof(t))&&(t=t[this.property]),this.value=void 0===t?this["default"]:t,
this.save()},find:function(t){if(this.property==t)return this},observe:function(){var t=this;this.computed||(this.observer=Mavo.observe(this.element,this.attribute,this.observer||function(e){!t.attribute&&t.mavo.editing||(t.value=t.getValue())}))},unobserve:function(){this.observer&&this.observer.disconnect()},getValue:function(t){return i.getValue(this.element,this.attribute,this.datatype,t)},lazy:{label:function(){return Mavo.readable(this.property)},emptyValue:function(){switch(this.datatype){case"boolean":return!1;case"number":return 0}return""}},setValue:function(e){var n=this,s=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];if(this.unobserve(),"object"==t.type(e)&&"value"in e){var a=e.presentational;e=e.value}return e=e||0===e?e:"",e=i.safeCast(e,this.datatype),e!=this._value||s.force?(this.editor&&(this.editorValue=e),this.humanReadable&&this.attribute&&(a=this.humanReadable(e)),this.editing&&!this.attribute||(this.editor&&this.editor.matches("select")&&this.editor.selectedOptions[0]&&(a=this.editor.selectedOptions[0].textContent),
i.setValue(this.element,{value:e,presentational:a},this.attribute,this.datatype)),this.empty=""===e,this._value=e,s.silent||(this.computed||(this.unsavedChanges=this.mavo.unsavedChanges=!0),requestAnimationFrame(function(){t.fire(n.element,"mavo:datachange",{property:n.property,value:e,mavo:n.mavo,node:n,dirty:n.editing,action:"propertychange"})})),this.observe(),e):e},live:{value:function(t){return this.setValue(t)},empty:function(e){var i=e&&!this.exposed&&!(this.attribute&&t(Mavo.selectors.property,this.element));this.element.classList.toggle("empty",i)},editing:function(t){this.element.classList.toggle("editing",t)},computed:function(t){this.element.classList.toggle("computed",t)}},"static":{all:new WeakMap,getMatch:function(t,e){var i=null;for(var n in e)t.matches(n)&&(i=e[n]);return i},getValueAttribute:function(e){var n=e.getAttribute("data-attribute")||i.getMatch(e,i.attributes);return n&&n.value&&(n=t.extend(new String(n.value),n)),n&&"null"!==n||(n=null),n},getDatatype:function(t,e){
var n=t.getAttribute("datatype");if(!n)for(var s in i.datatypes)t.matches(s)&&(n=i.datatypes[s][e]);return n=n||"string"},safeCast:function(t,e){var n=("undefined"==typeof t?"undefined":_typeof(t),i.cast(t,e));return null===t||void 0===t?t:"boolean"==e?"false"!==t&&0!==t&&""!==t&&("true"===t||t>0||t):"number"==e?/^[-+]?[0-9.e]+$/i.test(t+"")?n:t:n},cast:function(t,e){switch(e){case"number":return+t;case"boolean":return!!t;case"string":return t+""}return t},getValue:function(t,e,n){var s=arguments.length<=3||void 0===arguments[3]?{}:arguments[3];e=e||null===e?e:i.getValueAttribute(t),n=n||i.getDatatype(t,e);var a;return a=e in t&&!s.raw&&i.useProperty(t,e)?t[e]:e?t.getAttribute(e):t.getAttribute("content")||t.textContent||null,i.safeCast(a,n)},setValue:function(e,n,s,a){if("object"==t.type(n)&&"value"in n){var o=n.presentational;n=n.value}if(null!==s&&(s=s||i.getValueAttribute(e)),s in e&&i.useProperty(e,s)&&e[s]!=n)try{e[s]=n}catch(r){}s?e.getAttribute(s)!=n&&(e.setAttribute(s,n),o&&(e.textContent=o)):("number"!==a||o||(o=i.formatNumber(n)),
e.textContent=o||n,o&&e.setAttribute&&e.setAttribute("content",n))},useProperty:function(t,e){return!(["href","src"].indexOf(e)>-1)&&"http://www.w3.org/2000/svg"!=t.namespaceURI},lazy:{formatNumber:function(){var t=new Intl.NumberFormat("en-US",{maximumFractionDigits:2});return function(e){return e===1/0||e===-(1/0)?e<0?"-∞":"∞":t.format(e)}}}}});i.attributes={"img, video, audio":"src","a, link":"href","select, input, textarea, meter, progress":"value","input[type=checkbox]":"checked",time:{value:"datetime",humanReadable:function(t){var e=new Date(t);if(!t||isNaN(e))return"(No "+this.label+")";var i={date:{day:"numeric",month:"short",year:"numeric"},month:{month:"long"},time:{hour:"numeric",minute:"numeric"},"datetime-local":{day:"numeric",month:"short",year:"numeric",hour:"numeric",minute:"numeric"}},n=i[this.editor&&this.editor.type]||i.date;return n.timeZone="UTC",e.toLocaleString("en-GB",n)}},meta:"content"},i.datatypes={"input[type=checkbox]":{checked:"boolean"},"input[type=range], input[type=number], meter, progress":{
value:"number"}},i.editors={"*":{tag:"input"},".number":{tag:"input",type:"number"},".boolean":{tag:"input",type:"checkbox"},"a, img, video, audio, .url":{tag:"input",type:"url",placeholder:"http://"},"p, div, li, dt, dd, h1, h2, h3, h4, h5, h6, article, section, address, .multiline":{create:function(){var e=getComputedStyle(this.element).display,i=0===e.indexOf("inline")?"input":"textarea",n=t.create(i);if("textarea"==i){var s=this.element.offsetWidth;s&&(n.width=s)}return n},get editorValue(){return this.editor&&i.safeCast(this.editor.value,this.datatype)},set editorValue(t){this.editor&&(this.editor.value=t?t.replace(/\r?\n/g,""):"")}},"meter, progress":function(){return t.create({tag:"input",type:"range",min:this.element.getAttribute("min")||0,max:this.element.getAttribute("max")||100})},"time, .date":function(){var e={date:/^[Y\d]{4}-[M\d]{2}-[D\d]{2}$/i,month:/^[Y\d]{4}-[M\d]{2}$/i,time:/^[H\d]{2}:[M\d]{2}/i,week:/[Y\d]{4}-W[W\d]{2}$/i,"datetime-local":/^[Y\d]{4}-[M\d]{2}-[D\d]{2} [H\d]{2}:[M\d]{2}/i
},i=this.element.getAttribute("datetime")||"YYYY-MM-DD";for(var n in e)if(e[n].test(i))break;return t.create("input",{type:n})}}}(Bliss,Bliss.$);
