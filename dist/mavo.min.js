...
"use strict";!function(t,e){function n(t,n){for(t="mv-"+t+"-within",e("."+t).forEach(function(e){return e.classList.remove(t)});n&&(n=n.parentNode)&&n.classList;)n.classList.add(t)}var r=t.extend(Mavo,{toJSON:function(t){return null===t?"":"string"==typeof t?t:JSON.stringify(t,null,"\t")},readable:function(t){return t&&t.replace(/([a-z])([A-Z])(?=[a-z])/g,function(t,e,n){return e+" "+n.toLowerCase()}).replace(/([a-z])[_\/-](?=[a-z])/g,"$1 ").replace(/^[a-z]/,function(t){return t.toUpperCase()})},queryJSON:function(e,n){return n&&e?t.value.apply(t,[e].concat(n.split("/"))):e},toArray:function(t){return void 0===t?[]:Array.isArray(t)?t:[t]},flatten:function(t){return Array.isArray(t)?t.reduce(function(t,e){return r.toArray(t).concat(r.flatten(e))},[]):[t]},is:function(t,e){return e.matches&&e.matches(r.selectors[t])},has:function(t,e){return e.matches&&e.matches(r.selectors.option(t))},urlParam:function(){for(var t=("searchParams"in URL.prototype?new URL(location).searchParams:null),e=null,n=arguments.length,r=Array(n),i=0;i<n;i++)r[i]=arguments[i];
var a=!0,o=!1,s=void 0;try{for(var u,c=r[Symbol.iterator]();!(a=(u=c.next()).done);a=!0){var l=u.value;if(t)e=t.get(l);else{var h=location.search.match(RegExp("[?&]"+l+"(?:=([^&]+))?(?=&|$)","i"));e=h&&(h[1]||"")}if(null!==e)return e}}catch(f){o=!0,s=f}finally{try{!a&&c["return"]&&c["return"]()}finally{if(o)throw s}}return null},debounce:function(t,e){var n=null;return function(){var r=this,i=arguments;clearTimeout(n),n=setTimeout(function(){t.apply(r,i)},e)}},escapeRegExp:function(t){return t.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")},Observer:t.Class({constructor:function(e,n,r,i){r instanceof MutationObserver&&(this.observer=r),this.observer=this.observer||new MutationObserver(r),this.element=e,this.callback=r,this.attribute=n,this.oldValue=i,this.options={},n&&t.extend(this.options,{attributes:!0,attributeFilter:"all"==this.attribute?void 0:[this.attribute],attributeOldValue:!!this.oldValue}),this.attribute&&"all"!=this.attribute||t.extend(this.options,{characterData:!0,childList:!0,
subtree:!0,characterDataOldValue:!!this.oldValue}),this.run()},stop:function(){return this.running&&(this.observer.disconnect(),this.running=!1),this},run:function(){return this.running||(this.observer.observe(this.element,this.options),this.running=!0),this},sneak:function(t){var e=this;if(this.running){this.stop();var n=t();requestAnimationFrame(function(){return e.run()})}else var n=t();return n}}),defer:function(t){var e,n,r=new Promise(function(r,i){t&&t(r,i),e=r,n=i});return r.resolve=function(t){return e(t),r},r.reject=function(t){return n(t),r},r}});t.add("toggleAttribute",function(t,e){var n=arguments.length<=2||void 0===arguments[2]?null!==e:arguments[2];n?this.setAttribute(t,e):this.removeAttribute(t)}),t.proxy=t.classProps.proxy=t.overload(function(t,e,n){return Object.defineProperty(t,e,{get:function(){return this[n][e]},set:function(t){this[n][e]=t},configurable:!0,enumerable:!0}),t}),t.classProps.propagated=function(t,e){Mavo.toArray(e).forEach(function(e){var n=t[e];t[e]=function(){
var t=n&&n.apply(this,arguments);this.propagate&&t!==!1&&this.propagate(e)}})},document.addEventListener("focus",function(t){n("focus",t.target)},!0),document.addEventListener("blur",function(t){n("focus",null)},!0),addEventListener("hashchange",function(e){n("target",t(location.hash))},!0),n("target",t(location.hash)),n("focus",document.activeElement!==document.body?document.activeElement:null)}(Bliss,Bliss.$);
...
})[0],this.editor&&(this.element.textContent=this.editorValue,t.remove(this.editor))),!this.editor&&this.element.hasAttribute("data-edit")){var r=t(this.element.getAttribute("data-edit"));r&&Mavo.is("formControl",r)&&(this.editor=r.cloneNode(!0),this.template||new Mavo.Observer(r,"all",function(t){var e=!0,i=!1,a=void 0;try{for(var n,s=o.copies[Symbol.iterator]();!(e=(n=s.next()).done);e=!0){var u=n.value;u.editor=r.cloneNode(!0),u.setValue(u.value,{force:!0,silent:!0})}}catch(l){i=!0,a=l}finally{try{!e&&s["return"]&&s["return"]()}finally{if(i)throw a}}}))}this.templateValue=this.getValue(),this["default"]=this.element.getAttribute("data-default"),this.constant||""===this["default"]?this["default"]=this.templateValue:null===this["default"]?this["default"]=this.editor?this.editorValue:this.emptyValue:new Mavo.Observer(this.element,"data-default",function(t){o["default"]=o.element.getAttribute("data-default")}),this.constant||this.setValue(this.templateValue,{silent:!0}),this.setValue(this.template?this["default"]:this.templateValue,{
...
this.element.addEventListener("mousemove.mavo:edit",function(r){var u=e.element.getBoundingClientRect().left,d=Math.max(0,(r.clientX-u)/e.element.offsetWidth),o=t+n*d,l=o%a;o+=l>a/2?a-l:-l,o=Math.max(t,Math.min(o,i)),e.sneak(function(){return e.element.setAttribute("value",o)})}),this.element.addEventListener("mouseleave.mavo:edit",function(t){e.sneak(function(){return e.element.setAttribute("value",e.value)})}),this.element.addEventListener("click.mavo:edit",function(t){e.value=e.getValue()}),this.element.addEventListener("keydown.mavo:edit",function(n){if(n.target==e.element&&(37==n.keyCode||39==n.keyCode)){var r=a*(39==n.keyCode?1:-1)*(n.shiftKey?10:1),u=e.value+r;u=Math.max(t,Math.min(u,i)),e.element.setAttribute("value",u)}})},done:function(){e.unbind(this.element,".mavo:edit")}},meta:{attribute:"content"},"p, div, li, dt, dd, h1, h2, h3, h4, h5, h6, article, section, address":{editor:function i(){var t=getComputedStyle(this.element).display,n=0===t.indexOf("inline")?"input":"textarea",i=e.create(n);
