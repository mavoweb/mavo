...
"use strict";function _defineProperty(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e};!function(e,t){var n=Mavo.Expressions=e.Class({constructor:function(e){var t=this;this.mavo=e,this.expressions=[];var o=Mavo.Expression.Syntax.create(this.mavo.element.closest("[mv-expressions]"))||Mavo.Expression.Syntax["default"];this.traverse(this.mavo.element,void 0,o),this.scheduled=new Set,this.mavo.treeBuilt.then(function(){var e=!0,o=!1,i=void 0;try{for(var r,a=t.expressions[Symbol.iterator]();!(e=(r=a.next()).done);e=!0){var s=r.value;s.item=Mavo.Node.get(s.element.closest(Mavo.selectors.multiple+", "+Mavo.selectors.group)),
s.item.expressions=s.item.expressions||[],s.item.expressions.push(s);var u=Mavo.Node.get(s.element,!0);u&&u instanceof Mavo.Primitive&&u.attribute==s.attribute&&(s.primitive=u,u.store=u.store||"none",u.modes="read")}}catch(l){o=!0,i=l}finally{try{!e&&a["return"]&&a["return"]()}finally{if(o)throw i}}t.mavo.element.addEventListener("mavo:datachange",function(e){"propertychange"==e.action&&e.node.closestCollection?t.scheduled.has(e.property)||(setTimeout(function(){t.scheduled["delete"](e.property),t.update(e)},n.PROPERTYCHANGE_THROTTLE),t.scheduled.add(e.property)):requestAnimationFrame(function(){return t.update(e)})}),t.update()})},update:function(t){var n,o,i=this;t instanceof Element&&(n=t.closest(Mavo.selectors.group),t=null),n=n||this.mavo.element,o=Mavo.Node.get(n);var r=o.getData({relative:!0,store:"*","null":!0,unhandled:this.mavo.unhandled});o.walk(function(n,o){if(n.expressions&&n.expressions.length&&!n.isDeleted()){var a={context:i,data:e.value.apply(e,[r].concat(_toConsumableArray(o)))
};Mavo.hooks.run("expressions-update-start",a);var s=!0,u=!1,l=void 0;try{for(var v,d=n.expressions[Symbol.iterator]();!(s=(v=d.next()).done);s=!0){var c=v.value;c.changedBy(t)&&c.update(a.data,t)}}catch(p){u=!0,l=p}finally{try{!s&&d["return"]&&d["return"]()}finally{if(u)throw l}}}})},extract:function(e,t,o,i){t&&"mv-expressions"==t.name||(t&&n.directives.indexOf(t.name)>-1||i.test(t?t.value:e.textContent))&&this.expressions.push(new Mavo.Expression.Text({node:e,syntax:i,path:o?o.slice(1).split("/").map(function(e){return+e}):[],attribute:t&&t.name,mavo:this.mavo}))},traverse:function(e){var n=this,o=arguments.length<=1||void 0===arguments[1]?"":arguments[1],i=arguments[2];if(8!==e.nodeType)if(3===e.nodeType)this.extract(e,null,o,i);else{if(e.normalize(),i=Mavo.Expression.Syntax.create(e)||i,i===Mavo.Expression.Syntax.ESCAPE)return;Mavo.is("multiple",e)&&(o=""),t(e.attributes).forEach(function(t){return n.extract(e,t,o,i)}),t(e.childNodes).forEach(function(e,t){return n.traverse(e,o+"/"+t,i);
})}},"static":{directives:[],PROPERTYCHANGE_THROTTLE:50}});self.Proxy&&Mavo.hooks.add("node-getdata-end",function(e){var t=this;if(e.options.relative&&(e.data&&"object"===_typeof(e.data)||this.collection)){var n=e.data;if(this instanceof Mavo.Primitive){var o;e.data=(o={},_defineProperty(o,Symbol.toPrimitive,function(){return n}),_defineProperty(o,this.property,n),o)}e.data=new Proxy(e.data,{get:function(e,t,n){if(t in e||t in n&&t in e)return e[t]},has:function(n,o){if(o in n)return!0;if("$index"==o)return n[o]=t.index+1;if(o==t.mavo.id)return n[o]=t.mavo.root.getData(e.options);if(t instanceof Mavo.Group&&o==t.property&&t.collection)return n[o]=e.data;var i=t.walkUp(function(e){if(o in e.children)return e.children[o]});return void 0===i&&(i=t.find(o)),void 0!==i&&(Array.isArray(i)?i=i.map(function(t){return t.getData(e.options)}).filter(function(e){return null!==e}):i instanceof Mavo.Node&&(i=i.getData(e.options)),n[o]=i,!0)},set:function(e,t,n){throw Error("You can’t set data via expressions.");
}})}}),Mavo.hooks.add("init-tree-before",function(){this.expressions=new Mavo.Expressions(this)}),Mavo.hooks.add("node-init-end",function(){var e=this,t=this.template;t&&t.expressions&&(this.expressions=t.expressions.map(function(t){return new Mavo.Expression.Text({template:t,item:e,mavo:e.mavo})}))}),Mavo.hooks.add("render-end",function(){this.expressions.update()}),Mavo.hooks.add("collection-add-end",function(e){this.mavo.expressions.update(e.item.element)})}(Bliss,Bliss.$),Mavo.attributes.push("mv-value"),Mavo.Expressions.directives.push("mv-value"),Mavo.hooks.add("expressiontext-init-start",function(){"mv-value"==this.attribute&&(this.attribute=Mavo.Primitive.getValueAttribute(this.element),this.fallback=this.fallback||Mavo.Primitive.getValue(this.element,{attribute:this.attribute}),this.expression=this.element.getAttribute("mv-value"),this.parsed=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end)});
