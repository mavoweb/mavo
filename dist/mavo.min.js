...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,n=Array(t.length);e<t.length;e++)n[e]=t[e];return n}return Array.from(t)}!function(t,e){var n=self.Mavo=t.Class({constructor:function(i){var s=this;this.treeBuilt=Mavo.defer(),this.element=i,this.index=n.all.push(this);var r=n.attributes.map(function(t){return"[data-"+t+"]"}),o=!0,a=!1,u=void 0;try{for(var l,c=e(r.join(", "),this.element).concat(this.element)[Symbol.iterator]();!(o=(l=c.next()).done);o=!0){var h=l.value,m=!0,v=!1,d=void 0;try{for(var f,g=n.attributes[Symbol.iterator]();!(m=(f=g.next()).done);m=!0){var p=f.value,b=h.getAttribute("data-"+p);null!==b&&h.setAttribute(p,b)}}catch(y){v=!0,d=y}finally{try{!m&&g["return"]&&g["return"]()}finally{if(v)throw d}}}}catch(y){a=!0,u=y}finally{try{!o&&c["return"]&&c["return"]()}finally{if(a)throw u}}this.id=Mavo.getAttribute(this.element,"mv-app","id")||"mavo"+this.index,this.element.setAttribute("mv-app",this.id),this.unhandled=this.element.classList.contains("mv-keep-unhandled"),
