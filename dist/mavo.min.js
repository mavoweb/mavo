...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){var i=Mavo.Primitive=t.Class({"extends":Mavo.Unit,constructor:function(n,s,o){var a=this;if(this.fromTemplate("attribute","datatype","humanReadable","templateValue")||(this.attribute=i.getValueAttribute(this.element),this.attribute&&(this.humanReadable=this.attribute.humanReadable),this.datatype=i.getDatatype(this.element,this.attribute)),this.view="read",this.computed=!1,Mavo.hooks.run("primitive-init-start",this),Mavo.is("formControl",this.element)?(this.editor=this.element,this.editorType="exposed",this.edit()):this.computed||(this.mavo.needsEdit=!0),this.editor||this.attribute||(this.editor=e(this.element.children).filter(function(t){return t.matches(Mavo.selectors.formControl)&&!t.matches(Mavo.selectors.property)})[0],this.editor&&(this.editorType="nested",this.element.textContent=this.editorValue,
t.remove(this.editor))),!this.editor&&this.element.hasAttribute("data-edit")){this.editorType="linked";var r=t(this.element.getAttribute("data-edit"));r&&Mavo.is("formControl",r)&&(this.editor=r.cloneNode(!0),this.template||Mavo.observe(r,"all",function(t){var e=!0,i=!1,n=void 0;try{for(var s,o=a.copies[Symbol.iterator]();!(e=(s=o.next()).done);e=!0){var u=s.value;u.editor=r.cloneNode(!0),u.setValue(u.value,{force:!0,silent:!0})}}catch(h){i=!0,n=h}finally{try{!e&&o["return"]&&o["return"]()}finally{if(i)throw n}}}))}if(this.templateValue=this.getValue(),this["default"]=this.element.getAttribute("data-default"),this.computed||""===this["default"]?this["default"]=this.templateValue:null===this["default"]?this["default"]=this.editor?this.editorValue:this.emptyValue:Mavo.observe(this.element,"data-default",function(t){a["default"]=a.element.getAttribute("data-default")}),this.collection){var u=function(e){a.unobserve();var i=t.remove(t(Mavo.selectors.ui,a.element)),n=e();return t.inside(i,a.element),
a.observe(),n};["textContent","innerHTML"].forEach(function(t){var e=Object.getOwnPropertyDescriptor(Node.prototype,t);Object.defineProperty(a.element,t,{get:function(){var t=this;return u(function(){return e.get.call(t)})},set:function(t){var i=this;u(function(){return e.set.call(i,t)})}})})}this.computed||this.setValue(this.templateValue,{silent:!0}),this.setValue(this.template?this["default"]:this.templateValue,{silent:!0}),this.observe()},get editing(){return"edit"==this.view},get editorValue(){if(this.getEditorValue){var e=this.getEditorValue();if(void 0!==e)return e}if(this.editor){if(this.editor.matches(Mavo.selectors.formControl))return i.getValue(this.editor,void 0,this.datatype);var n=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);if(n)return i.all.has(n)?i.all.get(n).value:i.getValue(n)}},set editorValue(e){if((!this.setEditorValue||void 0===this.setEditorValue(e))&&this.editor)if(this.editor.matches(Mavo.selectors.formControl))i.setValue(this.editor,e);else{
...
if("preEdit"!=this.view){this.view="preEdit";var e;this.element._.events({"click.mavo:preedit":function(e){return t.edit()},"focus.mavo:preedit":function(e){t.edit(),t.popup||t.editor.focus()},"click.mavo:edit":function(e){t.exposed||e.preventDefault()}}),this.attribute||this.element._.events({"mouseenter.mavo:preedit":function(i){clearTimeout(e),e=setTimeout(function(){return t.edit()},150)},"mouseleave.mavo:preedit":function(t){clearTimeout(e)}}),this.element._.data.prevTabindex=this.element.getAttribute("tabindex"),this.element.tabIndex=0}}},initEdit:function(){var n=this;if(!this.editor){var s=i.getMatch(this.element,i.editors);s.create&&t.extend(this,s,function(t){return"create"!=t});var o=s.create||s;this.editor=t.create("function"===t.type(o)?o.call(this):o),this.editorValue=this.value,this.editorType="created"}if(this.editor._.events({"input change":function(t){var e=n.mavo.unsavedChanges;n.value=n.editorValue,n.exposed&&!n.mavo.editing&&n.mavo.permissions.save&&(n.unsavedChanges=!1,
...
i.safeCast(s,n)},setValue:function(e,n,s,o){if("object"==t.type(n)&&"value"in n){var a=n.presentational;n=n.value}if(null!==s&&(s=s||i.getValueAttribute(e)),s in e&&i.useProperty(e,s)&&e[s]!=n)try{e[s]=n}catch(r){}s?e.getAttribute(s)!=n&&(e.setAttribute(s,n),a&&(e.textContent=a)):("number"!==o||a||(a=i.formatNumber(n)),e.textContent=a||n,a&&e.setAttribute&&e.setAttribute("content",n))},useProperty:function(t,e){return!(["href","src"].indexOf(e)>-1)&&"http://www.w3.org/2000/svg"!=t.namespaceURI},lazy:{formatNumber:function(){var t=new Intl.NumberFormat("en-US",{maximumFractionDigits:2});return function(e){return e===1/0||e===-(1/0)?e<0?"-∞":"∞":t.format(e)}}}}});i.attributes={"img, video, audio":"src","a, link":"href","select, input, textarea, meter, progress":"value","input[type=checkbox]":"checked",time:{value:"datetime",humanReadable:function(t){var e=new Date(t);if(!t||isNaN(e))return"(No "+this.label+")";var i={date:{day:"numeric",month:"short",year:"numeric"},month:{month:"long"},time:{
...
},show:function(){var e=this;t.unbind([this.element,this.popup],".mavo:showpopup"),this.shown=!0,this.hideCallback=function(t){e.popup.contains(t.target)||e.element.contains(t.target)||e.hide()},this.position=function(i){var n=e.element.getBoundingClientRect(),s=n.left,o=n.bottom;t.style(e.popup,{top:o+"px",left:s+"px"})},this.position(),document.body.appendChild(this.popup),requestAnimationFrame(function(t){return e.popup.removeAttribute("hidden")}),t.events(document,"focus click",this.hideCallback,!0),window.addEventListener("scroll",this.position)},hide:function(){var e=this;t.unbind(document,"focus click",this.hideCallback,!0),window.removeEventListener("scroll",this.position),this.popup.setAttribute("hidden",""),this.shown=!1,setTimeout(function(){t.remove(e.popup)},1e3*parseFloat(getComputedStyle(this.popup).transitionDuration)||400),t.events(this.element,{"click.mavo:showpopup":function(t){e.show()},"keyup.mavo:showpopup":function(t){[13,113].indexOf(t.keyCode)>-1&&(e.show(),e.editor.focus());
}})},close:function(){this.hide(),t.unbind(this.element,".mavo:edit .mavo:preedit .mavo:showpopup")},proxy:{editor:"primitive",element:"primitive"}})}(Bliss,Bliss.$);
