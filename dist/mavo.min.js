...
"use strict";!function(t,e){var i=Mavo.Scope=t.Class({"extends":Mavo.Unit,constructor:function(t,i,o){var r=this;if(this.properties={},this.scope=this,Mavo.hooks.run("scope-init-start",this),Mavo.Primitive.getValueAttribute(this.element)){this.properties[this.property]=new Mavo.Primitive(this.element,this.mavo,{scope:this})}e(Mavo.selectors.property,this.element).forEach(function(t){var e=Mavo.Node.getProperty(t);if(r.contains(t)){var i=r.properties[e],o=r.template?r.template.properties[e]:null,n={template:o,scope:r};if(i){var s=i;i instanceof Mavo.Collection||(s=new Mavo.Collection(i.element,r.mavo,n),r.properties[e]=i.collection=s,s.add(i)),!s.mutable&&Mavo.is("multiple",t)&&(s.mutable=!0),s.add(t)}else{var a=Mavo.Node.create(t,r.mavo,n);r.properties[e]=a}}});var n=(this.isRoot?this.element.closest("[vocab]"):null)||this.element;this.vocab=n.getAttribute("vocab"),Mavo.hooks.run("scope-init-end",this)},get isRoot(){return!this.property},getData:function(e){e=e||{};var o=this["super"].getData.call(this,e);
return void 0!==o?o:(o={},this.propagate(function(t){if((!t.computed||e.computed)&&!(t.property in o)){var i=t.getData(e);(null!==i||e["null"])&&(o[t.property]=i)}}),e.dirty&&!e.unhandled||t.extend(o,this.unhandled),this.type&&this.type!=i.DEFAULT_TYPE&&(o["@type"]=this.type),this.vocab&&(o["@context"]=this.vocab),o)},find:function(t){if(this.property==t)return this;if(t in this.properties)return this.properties[t].find(t);for(var e in this.properties){var i=this.properties[e].find(t);if(void 0!==i)return i}},propagate:function(e){var i=arguments;t.each(this.properties,function(t,e){e.call.apply(e,i)})},save:function(){this.unsavedChanges=!1},done:function(){t.unbind(this.element,".mavo:edit")},propagated:["save","done","import","clear"],render:function(e){var i=this;e&&(Mavo.hooks.run("scope-render-start",this),e=Array.isArray(e)?e[0]:e,this.unhandled=t.extend({},e,function(t){return!(t in i.properties)}),this.propagate(function(t){t.render(e[t.property])}),this.save(),Mavo.hooks.run("scope-render-end",this));
},contains:function(t){return t instanceof Mavo.Unit?t.parentScope===this:t.parentNode&&this.element===t.parentNode.closest(Mavo.selectors.scope)},"static":{all:new WeakMap,DEFAULT_TYPE:"Item",normalize:function(t){if(Mavo.is("scope",t)){var e=t.getAttribute("typeof")||t.getAttribute("itemtype")||i.DEFAULT_TYPE;return t.setAttribute("typeof",e),e}return null}}})}(Bliss,Bliss.$);
