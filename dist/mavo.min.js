...
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,o=Array(e.length);t<e.length;t++)o[t]=e[t];return o}return Array.from(e)}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e};!function(e,t){var o=Mavo.Expressions=e.Class({constructor:function(e){var t=this;this.mavo=e,this.expressions=[];var n=Mavo.Expression.Syntax.create(this.mavo.element.closest("[mv-expressions]"))||Mavo.Expression.Syntax["default"];this.traverse(this.mavo.element,void 0,n),this.scheduled=new Set,this.mavo.treeBuilt.then(function(){var e=!0,n=!1,s=void 0;try{for(var r,i=t.expressions[Symbol.iterator]();!(e=(r=i.next()).done);e=!0){var a=r.value;a.group=Mavo.Node.get(a.element.closest(Mavo.selectors.group)),a.group.expressions=a.group.expressions||[],a.group.expressions.push(a);var u=Mavo.Node.get(a.element,!0);u&&u instanceof Mavo.Primitive&&u.attribute==a.attribute&&(a.primitive=u,
u.store=u.store||"none",u.modes="read")}}catch(v){n=!0,s=v}finally{try{!e&&i["return"]&&i["return"]()}finally{if(n)throw s}}t.mavo.element.addEventListener("mavo:datachange",function(e){"propertychange"==e.action&&e.node.closestCollection?t.scheduled.has(e.property)||(setTimeout(function(){t.scheduled["delete"](e.property),t.update(e)},o.PROPERTYCHANGE_THROTTLE),t.scheduled.add(e.property)):requestAnimationFrame(function(){return t.update(e)})}),t.update()})},update:function(t){var o=this,n=this.mavo.element;t instanceof Element&&(n=t.closest(Mavo.selectors.group),t=null);var s=Mavo.Node.get(n),r=s.getData({relative:!0,store:"*","null":!0,unhandled:this.mavo.unhandled});s.walk(function(n,s){if(n instanceof Mavo.Group&&n.expressions&&n.expressions.length&&!n.isDeleted()){var i={context:o,data:e.value.apply(e,[r].concat(_toConsumableArray(s)))};Mavo.hooks.run("expressions-update-start",i);var a=!0,u=!1,v=void 0;try{for(var l,d=n.expressions[Symbol.iterator]();!(a=(l=d.next()).done);a=!0){
var p=l.value;p.changedBy(t)&&p.update(i.data,t)}}catch(c){u=!0,v=c}finally{try{!a&&d["return"]&&d["return"]()}finally{if(u)throw v}}}})},extract:function(e,t,n,s){t&&"mv-expressions"==t.name||(t&&o.directives.indexOf(t.name)>-1||s.test(t?t.value:e.textContent))&&this.expressions.push(new Mavo.Expression.Text({node:e,syntax:s,path:n?n.slice(1).split("/").map(function(e){return+e}):[],attribute:t&&t.name,mavo:this.mavo}))},traverse:function(e){var o=this,n=arguments.length<=1||void 0===arguments[1]?"":arguments[1],s=arguments[2];if(8!==e.nodeType)if(3===e.nodeType)this.extract(e,null,n,s);else{if(e.normalize(),s=Mavo.Expression.Syntax.create(e)||s,s===Mavo.Expression.Syntax.ESCAPE)return;Mavo.is("group",e)&&(n=""),t(e.attributes).forEach(function(t){return o.extract(e,t,n,s)}),t(e.childNodes).forEach(function(e,t){return o.traverse(e,n+"/"+t,s)})}},"static":{directives:[],PROPERTYCHANGE_THROTTLE:50}});self.Proxy&&Mavo.hooks.add("node-getdata-end",function(e){var t=this;e.options.relative&&e.data&&"object"===_typeof(e.data)&&(e.data=new Proxy(e.data,{
get:function(e,o,n){return o in e||o in n&&o in e?e[o]:"$index"==o?t.index+1:o==t.mavo.id?e:void 0},has:function(o,n){if(n in o)return!0;if("$index"==n||n==t.mavo.id)return!0;var s=t.walkUp(function(e){if(n in e.children)return e.children[n]});return void 0===s&&(s=t.find(n)),void 0!==s&&(Array.isArray(s)?s=s.map(function(t){return t.getData(e.options)}).filter(function(e){return null!==e}):s instanceof Mavo.Node&&(s=s.getData(e.options)),o[n]=s,!0)},set:function(e,t,o){throw Error("You can’t set data via expressions.")}}))}),Mavo.hooks.add("init-tree-before",function(){this.expressions=new Mavo.Expressions(this)}),Mavo.hooks.add("group-init-start",function(){var e=this,t=this.template;t&&t.expressions&&(this.expressions=t.expressions.map(function(t){return new Mavo.Expression.Text({template:t,group:e,mavo:e.mavo})}))}),Mavo.hooks.add("render-end",function(){this.expressions.update()}),Mavo.hooks.add("collection-add-end",function(e){this.mavo.expressions.update(e.item.element)})}(Bliss,Bliss.$),
