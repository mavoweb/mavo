...
this.setValue(this.initialValue,{silent:!0,dataOnly:!this.closestCollection}),this.observer=new Mavo.Observer(this.element,this.attribute,function(t){!o.attribute&&o.editing||(o.value=o.getValue())}),Mavo.hooks.run("primitive-init-end",this)},get editorValue(){if(this.defaults.getEditorValue)return this.defaults.getEditorValue.call(this);if(this.editor){if(this.editor.matches(Mavo.selectors.formControl))return i.getValue(this.editor,{datatype:this.datatype});var e=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);if(e)return i.getValue(e)}},set editorValue(e){if(this.defaults.setEditorValue)return this.defaults.setEditorValue.call(this,e);if(this.editor)if(this.editor.matches(Mavo.selectors.formControl))i.setValue(this.editor,e,{defaults:this.editorDefaults});else{var a=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);a&&i.setValue(a,e)}},getData:function(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],e={context:this,options:t,data:this["super"].getData.call(this,t)
...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){Mavo.attributes.push("mv-value","mv-if");var i=Mavo.Expressions=t.Class({constructor:function(t){var e=this;this.mavo=t,this.all=[],Mavo.hooks.run("expressions-init-start",this);var i=Mavo.Expression.Syntax.create(this.mavo.element.closest("[mv-expressions]"))||Mavo.Expression.Syntax["default"];this.traverse(this.mavo.element,void 0,i,this.mavo.root),this.active=!0,this.mavo.element.addEventListener("mavo:datachange",function(t){return e.update(t)})},update:function(t){var e=this;this.mavo.walk(function(i){if(i instanceof Mavo.Group&&i.expressions&&i.expressions.length&&!i.isDeleted()){var n={context:e,data:i.getRelativeData()};Mavo.hooks.run("expressions-update-start",n);var s=!0,o=!1,a=void 0;try{for(var r,u=i.expressions[Symbol.iterator]();!(s=(r=u.next()).done);s=!0){
var v=r.value;v.changedBy(t)&&v.update(n.data,t)}}catch(p){o=!0,a=p}finally{try{!s&&u["return"]&&u["return"]()}finally{if(o)throw a}}}})},extract:function(t,e,n,s,o){e&&"mv-expressions"==e.name||(e&&i.directives.indexOf(e.name)>-1||s.test(e?e.value:t.textContent))&&(o.expressions=o.expressions||[],o.expressions.push(new Mavo.Expression.Text({node:t,syntax:s,group:o,path:n?n.slice(1).split("/").map(function(t){return+t}):[],attribute:e&&e.name})))},traverse:function(t){var i=arguments.length<=1||void 0===arguments[1]?"":arguments[1],n=this,s=arguments[2],o=arguments[3];if(8!==t.nodeType)if(3===t.nodeType)this.extract(t,null,i,s,o);else{if(s=Mavo.Expression.Syntax.create(t)||s,s===Mavo.Expression.Syntax.ESCAPE)return;t!=o.element&&Mavo.is("group",t)&&(o=Mavo.Node.get(t),i=""),e(t.attributes).forEach(function(e){return n.extract(t,e,i,s,o)}),e(t.childNodes).forEach(function(t,e){return n.traverse(t,i+"/"+e,s,o)})}},"static":{directives:[]}});self.Proxy&&Mavo.hooks.add("node-getdata-end",function(t){
var e=this;t.options.relative&&t.data&&"object"===_typeof(t.data)&&(t.data=new Proxy(t.data,{get:function(t,i,n){return i in t||i in n&&i in t?t[i]:"$index"==i?e.index+1:i==e.mavo.id?t:void 0},has:function(i,n){if(n in i)return!0;if("$index"==n||n==e.mavo.id)return!0;var s=e.walkUp(function(t){if(n in t.children)return t.children[n]});return void 0===s&&(s=e.find(n)),void 0!==s&&(Array.isArray(s)?s=s.map(function(e){return e.getRelativeData(t.options)}).filter(function(t){return null!==t}):s instanceof Mavo.Node&&(s=s.getRelativeData(t.options)),i[n]=s,!0)},set:function(t,e,i){throw Error("You can’t set data via expressions.")}}))}),Mavo.Node.prototype.getRelativeData=function(){return this.getData({relative:!0,store:"*","null":!0,unhandled:this.mavo.unhandled})},Mavo.hooks.add("init-tree-after",function(){this.expressions=new Mavo.Expressions(this),this.expressions.update()}),Mavo.hooks.add("group-init-end",function(){var t=this,e=this.template;e&&e.expressions&&(this.expressions=e.expressions.map(function(e){
return new Mavo.Expression.Text({template:e,group:t})}))}),Mavo.hooks.add("render-end",function(){this.expressions.update()})}(Bliss,Bliss.$),Mavo.Expressions.directives.push("mv-value"),Mavo.hooks.add("expressiontext-init-start",function(){"mv-value"==this.attribute&&(this.attribute=Mavo.Primitive.getValueAttribute(this.element),this.fallback=this.fallback||Mavo.Primitive.getValue(this.element,{attribute:this.attribute}),this.expression=this.element.getAttribute("mv-value"),this.parsed=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end)});
...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(o){return typeof o}:function(o){return o&&"function"==typeof Symbol&&o.constructor===Symbol?"symbol":typeof o};!function(o,t){return;var n,r}(Bliss,Bliss.$);
