...
}},"static":{all:[],allIds:[],get:function(t){var e=!0,i=!1,r=void 0;try{for(var s,o=n.all[Symbol.iterator]();!(e=(s=o.next()).done);e=!0){var a=s.value;if(a.id===t)return a}}catch(u){i=!0,r=u}finally{try{!e&&o["return"]&&o["return"]()}finally{if(i)throw r}}return null},superKey:0===navigator.platform.indexOf("Mac")?"metaKey":"ctrlKey",init:function(t){return e(n.selectors.init,t||document).filter(function(t){return t==document.documentElement||!t.parentNode.closest(n.selectors.init)}).map(function(t){return new n(t)})},hooks:new t.Hooks,attributes:["mv-app","mv-storage","mv-init","mv-attribute","mv-default","mv-mode","mv-edit","mv-permisssions"]}});!function(){var e=n.selectors={init:".mv-app, [mv-app], [data-mv-app], [mv-storage], [data-mv-storage]",property:"[property], [itemprop]",specificProperty:function(t){return"[property="+t+"], [itemprop="+t+"]"},group:"[typeof], [itemscope], [itemtype], .mv-group",multiple:"[mv-multiple], .mv-multiple",formControl:"input, select, option, textarea",
item:".mv-item",ui:".mv-ui",container:{tr:"table",option:"select"}},i=e.arr=function(t){return t.split(/\s*,\s*/g)},r=e.not=function(t){return i(t).map(function(t){return":not("+t+")"}).join("")},s=e.or=function(t,e){return t+", "+e},o=e.and=function(t,e){var n=[],r=i(e);return i(t).forEach(function(t){return n.push.apply(n,_toConsumableArray(r.map(function(e){return t+e})))}),n.join(", ")},a=e.andNot=function(t,e){return o(t,r(e))};t.extend(n.selectors,{primitive:a(e.property,e.group),rootGroup:a(e.group,e.property),output:s(e.specificProperty("output"),".mv-output, .mv-value")})}(),Promise.all([t.ready(),t.include(Array.from&&window.Intl&&document.documentElement.closest,"https://cdn.polyfill.io/v2/polyfill.min.js?features=blissfuljs,Intl.~locale.en")])["catch"](function(t){return console.error(t)}).then(function(){return Mavo.init()}),Stretchy.selectors.filter=".mv-editor:not([property])"}(Bliss,Bliss.$);
...
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,r=Array(e.length);t<e.length;t++)r[t]=e[t];return r}return Array.from(e)}!function(e){Mavo.attributes.push("mv-expressions");var t=Mavo.Expression=e.Class({constructor:function(e){this.expression=e},eval:function(e){this.oldValue=this.value,Mavo.hooks.run("expression-eval-beforeeval",this);try{this["function"]||(this["function"]=t.compile(this.expression),this.identifiers=this.expression.match(/[$a-z][$\w]*/gi)||[]),this.value=this["function"](e)}catch(r){Mavo.hooks.run("expression-eval-error",{context:this,exception:r}),this.value=r}return this.value},toString:function(){return this.expression},changedBy:function(e){if(!this.identifiers||!e)return!0;if(this.identifiers.indexOf(e.property)>-1)return!0;if(e.node instanceof Mavo.Collection||e.node.collection){if(this.identifiers.indexOf("$index")>-1)return!0;var t=e.node.collection||e.node;if(Mavo.hasIntersection(t.properties,this.identifiers))return!0}return!!Mavo.hasIntersection(Mavo.allIds,this.identifiers);
},live:{expression:function(e){e=e;this["function"]=null}},"static":{serializers:{BinaryExpression:function(e){return t.serialize(e.left)+" "+e.operator+" "+t.serialize(e.right)},UnaryExpression:function(e){return""+e.operator+t.serialize(e.argument)},CallExpression:function(e){return t.serialize(e.callee)+"("+e.arguments.map(t.serialize).join(", ")+")"},ConditionalExpression:function(e){return t.serialize(e.test)+"? "+t.serialize(e.consequent)+" : "+t.serialize(e.alternate)},MemberExpression:function(e){return t.serialize(e.object)+'["'+(e.property.name||e.property.value)+'"]'},ArrayExpression:function(e){return"["+e.elements.map(t.serialize).join(", ")+"]"},Literal:function(e){return e.raw},Identifier:function(e){return e.name},ThisExpression:function(e){return"this"},Compound:function(e){return e.body.map(t.serialize).join(" ")}},transformations:{BinaryExpression:function(e){var r=Mavo.Script.getOperatorName(e.operator),i=(Mavo.Script.operators[r],e),n=[];do n.unshift(i.right),i=i.left;while(Mavo.Script.getOperatorName(i.operator)===r);
if(n.unshift(i),n.length>1)return r+"("+n.map(t.serialize).join(", ")+")"},CallExpression:function(e){"Identifier"==e.callee.type&&"if"==e.callee.name&&(e.callee.name="iff")}},serialize:function(e){if(t.transformations[e.type]){var r=t.transformations[e.type](e);if(void 0!==r)return r}return t.serializers[e.type](e)},rewrite:function(e){try{return t.serialize(t.parse(e))}catch(r){return e}},compile:function(e){return e=t.rewrite(e),new Function("data","with(Mavo.Functions._Trap)\n\t\t\t\t\twith(data) {\n\t\t\t\t\t\treturn "+e+";\n\t\t\t\t\t}")},parse:self.jsep}});self.jsep&&(jsep.addBinaryOp("and",2),jsep.addBinaryOp("or",2),jsep.addBinaryOp("=",6),jsep.removeBinaryOp("===")),t.serializers.LogicalExpression=t.serializers.BinaryExpression,t.transformations.LogicalExpression=t.transformations.BinaryExpression,t.Syntax=e.Class({constructor:function(e,t){this.start=e,this.end=t,this.regex=RegExp(Mavo.escapeRegExp(e)+"([\\S\\s]+?)"+Mavo.escapeRegExp(t),"gi")},test:function(e){return this.regex.lastIndex=0,
this.regex.test(e)},tokenize:function(e){var t,r=[],i=0;for(this.regex.lastIndex=0;null!==(t=this.regex.exec(e));)t.index>i&&r.push(e.substring(i,t.index)),i=this.regex.lastIndex,r.push(new Mavo.Expression(t[1]));return i<e.length&&r.push(e.substring(i)),r},"static":{create:function(e){if(e){var r=e.getAttribute("mv-expressions");if(r)return r=r.trim(),/\s/.test(r)?new(Function.prototype.bind.apply(t.Syntax,[null].concat(_toConsumableArray(r.split(/\s+/))))):t.Syntax.ESCAPE}},ESCAPE:-1}}),t.Syntax["default"]=new t.Syntax("[","]")}(Bliss);
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,i=Array(e.length);t<e.length;t++)i[t]=e[t];return i}return Array.from(e)}!function(e){var t=Mavo.Expression.Text=e.Class({constructor:function(){var i=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];this.template=i.template&&i.template.template||i.template;for(var s=["group","path","syntax","fallback","attribute"],n=0;n<s.length;n++){var a=s[n];this[a]=void 0===i[a]&&this.template?this.template[a]:i[a]}if(this.node=i.node,this.node||(this.node=this.path.reduce(function(e,t){return e.childNodes[t]},this.group.element)),this.element=this.node,this.attribute=this.attribute||null,Mavo.hooks.run("expressiontext-init-start",this),!this.expression){if(3===this.node.nodeType&&(this.element=this.node.parentNode,this.node.parentNode.children.length&&!this.attribute||(this.node=this.element,this.element.normalize())),this.attribute)this.expression=this.node.getAttribute(this.attribute).trim();else{if(this.node.normalize(),
this.node.firstChild&&1===this.node.childNodes.length&&3===this.node.firstChild.nodeType){var r=this.node.firstChild.textContent.match(/^\s*|\s*$/g);r[1]&&(this.node.firstChild.splitText(this.node.firstChild.textContent.length-r[1].length),e.after(this.node.lastChild,this.node)),r[0]&&(this.node.firstChild.splitText(r[0].length),this.node.parentNode.insertBefore(this.node.firstChild,this.node))}this.expression=this.node.textContent}this.parsed=i.template?i.template.parsed:this.syntax.tokenize(this.expression)}this.oldValue=this.value=this.parsed.map(function(e){return e instanceof Mavo.Expression?e.expression:e}),Mavo.hooks.run("expressiontext-init-end",this),t.elements.set(this.element,[].concat(_toConsumableArray(t.elements.get(this.element)||[]),[this]))},changedBy:function(e){var t=!0,i=!1,s=void 0;try{for(var n,a=this.parsed[Symbol.iterator]();!(t=(n=a.next()).done);t=!0){var r=n.value;if(r instanceof Mavo.Expression&&r.changedBy(e))return!0}}catch(o){i=!0,s=o}finally{try{!t&&a["return"]&&a["return"]();
}finally{if(i)throw s}}},update:function(){var e=this,t=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0],i=arguments[1];this.data=t;var s={};Mavo.hooks.run("expressiontext-update-start",this),this.oldValue=this.value,s.value=this.value=this.parsed.map(function(s,n){if(s instanceof Mavo.Expression){if(s.changedBy(i)){var a={context:e,expr:s};return Mavo.hooks.run("expressiontext-update-beforeeval",a),a.value=a.expr.eval(t),Mavo.hooks.run("expressiontext-update-aftereval",a),a.value instanceof Error?void 0!==e.fallback?e.fallback:a.expr.expression:void 0===a.value||null===a.value?"":a.value}return e.oldValue[n]}return s}),this.attribute||(s.presentational=this.value.map(function(e){return Array.isArray(e)?e.join(", "):"number"==typeof e?Mavo.Primitive.formatNumber(e):e}),s.presentational=1===s.presentational.length?s.presentational[0]:s.presentational.join("")),s.value=1===s.value.length?s.value[0]:s.value.join(""),this.primitive&&1===this.parsed.length&&("number"==typeof s.value?this.primitive.datatype="number":"boolean"==typeof s.value&&(this.primitive.datatype="boolean")),
s.presentational===s.value&&(s=s.value),this.primitive?this.primitive.value=s:Mavo.Primitive.setValue(this.node,s,{attribute:this.attribute}),Mavo.hooks.run("expressiontext-update-end",this)},"static":{elements:new WeakMap,search:function(e,i){var s=t.elements.get(e)||[];return arguments.length>1?s.length?s.filter(function(e){return e.attribute===i})[0]||null:null:s}}});Mavo.hooks.add("primitive-init-start",function(){this.expressionText=Mavo.Expression.Text.search(this.element,this.attribute),this.expressionText&&(this.expressionText.primitive=this,this.store=this.store||"none",this.modes="read")}),Mavo.hooks.add("collection-add-end",function(e){if(e.item instanceof Mavo.Primitive&&this.itemTemplate){var t=Mavo.Expression.Text.search(this.itemTemplate.element)[0];t&&t.group.expressions.all.push(new Mavo.Expression.Text({node:e.item.element,template:t}))}})}(Bliss);
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){Mavo.attributes.push("mv-value","mv-if");var i=Mavo.Expressions=t.Class({constructor:function(t){var e=this;if(t&&(this.group=t,this.group.expressions=this),this.all=[],Mavo.hooks.run("expressions-init-start",this),this.group){var i=this.group.template;if(i&&i.expressions){var n=!0,r=!1,s=void 0;try{for(var a,o=i.expressions.all[Symbol.iterator]();!(n=(a=o.next()).done);n=!0){var u=a.value;this.all.push(new Mavo.Expression.Text({template:u,group:this.group}))}}catch(v){r=!0,s=v}finally{try{!n&&o["return"]&&o["return"]()}finally{if(r)throw s}}}else{var l=Mavo.Expression.Syntax.create(this.group.element.closest("[mv-expressions]"))||Mavo.Expression.Syntax["default"];this.traverse(this.group.element,void 0,l)}}this.dependents=new Set,this.active=!0,this.group.element.addEventListener("mavo:datachange",function(t){
return e.update(t)})},update:function(t){if(this.active&&!this.group.isDeleted()&&this.all.length+this.dependents.size!==0){var e={context:this,data:this.group.getRelativeData()};Mavo.hooks.run("expressions-update-start",e);var i=!0,n=!1,r=void 0;try{for(var s,a=this.all[Symbol.iterator]();!(i=(s=a.next()).done);i=!0){var o=s.value;o.changedBy(t)&&o.update(e.data,t)}}catch(u){n=!0,r=u}finally{try{!i&&a["return"]&&a["return"]()}finally{if(n)throw r}}var v=!0,l=!1,h=void 0;try{for(var p,d=this.dependents[Symbol.iterator]();!(v=(p=d.next()).done);v=!0){var f=p.value;f.update()}}catch(u){l=!0,h=u}finally{try{!v&&d["return"]&&d["return"]()}finally{if(l)throw h}}}},extract:function(t,e,n,r){e&&"mv-expressions"==e.name||(e&&i.directives.indexOf(e.name)>-1||r.test(e?e.value:t.textContent))&&this.all.push(new Mavo.Expression.Text({node:t,syntax:r,path:n?n.slice(1).split("/").map(function(t){return+t}):[],attribute:e&&e.name,group:this.group}))},traverse:function(t){var i=this,n=arguments.length<=1||void 0===arguments[1]?"":arguments[1],r=arguments[2];
if(8!==t.nodeType)if(3===t.nodeType)this.extract(t,null,n,r);else if(t==this.group.element||!Mavo.is("group",t)){if(r=Mavo.Expression.Syntax.create(t)||r,r===Mavo.Expression.Syntax.ESCAPE)return;e(t.attributes).forEach(function(e){return i.extract(t,e,n,r)}),e(t.childNodes).forEach(function(t,e){return i.traverse(t,n+"/"+e,r)})}},"static":{directives:[]}});self.Proxy&&Mavo.hooks.add("node-getdata-end",function(t){var e=this;t.options.relative&&t.data&&"object"===_typeof(t.data)&&(t.data=new Proxy(t.data,{get:function(t,i,n){return i in t||i in n&&i in t?t[i]:"$index"==i?e.index+1:i==e.mavo.id?t:void 0},has:function(i,n){if(n in i)return!0;if("$index"==n||n==e.mavo.id)return!0;var r=e.walkUp(function(t){if(n in t.children)return t.children[n]});return void 0===r&&(r=e.find(n)),void 0!==r&&(Array.isArray(r)?r=r.map(function(e){return e.getRelativeData(t.options)}).filter(function(t){return null!==t}):r instanceof Mavo.Node&&(r=r.getRelativeData(t.options)),i[n]=r,!0)},set:function(t,e,i){
