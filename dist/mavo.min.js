...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){var i=Mavo.Primitive=t.Class({"extends":Mavo.Unit,constructor:function(n,s,a){var r=this;if(this.fromTemplate("attribute","datatype","humanReadable","templateValue")||(this.attribute=i.getValueAttribute(this.element),this.attribute&&(this.humanReadable=this.attribute.humanReadable),this.datatype=i.getDatatype(this.element,this.attribute),this.templateValue=this.getValue()),this.view="read",this.computed=!1,Mavo.hooks.run("primitive-init-start",this),Mavo.is("formControl",this.element)?(this.editor=this.element,this.editorType="exposed",this.edit()):this.computed||(this.mavo.needsEdit=!0),this.editor||this.attribute||(this.editor=e(this.element.children).filter(function(t){return t.matches(Mavo.selectors.formControl)&&!t.matches(Mavo.selectors.property)})[0],this.editor&&(this.editorType="nested",
...
Object.defineProperty(r.element,t,{get:function(){var t=this;return u(function(){return e.get.call(t)})},set:function(t){var i=this;u(function(){return e.set.call(i,t)})}})})}this.computed||this.setValue(this.templateValue,{silent:!0}),this.setValue(this.template?this["default"]:this.templateValue,{silent:!0}),this.observe()},get editing(){return"edit"==this.view},get editorValue(){if(this.getEditorValue){var e=this.getEditorValue();if(void 0!==e)return e}if(this.editor){if(this.editor.matches(Mavo.selectors.formControl))return i.getValue(this.editor,void 0,this.datatype);var n=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);if(n)return i.all.has(n)?i.all.get(n).value:i.getValue(n)}},set editorValue(e){if((!this.setEditorValue||void 0===this.setEditorValue(e))&&this.editor)if(this.editor.matches(Mavo.selectors.formControl))i.setValue(this.editor,e);else{var n=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);n&&(i.all.has(n)?i.all.get(n).value=e:i.setValue(n,e));
}},get exposed(){return this.editor===this.element},getData:function(t){t=t||{};var e=this["super"].getData.call(this,t);if(void 0!==e)return e;var e=t.dirty||this.exposed?this.value:this.savedValue;return t.dirty||""!==e?e:null},save:function(){return!this.placeholder&&(this.savedValue=this.value,void(this.unsavedChanges=!1))},done:function(){this.unobserve(),this.popup?this.hidePopup():this.attribute||this.exposed||!this.editing||(t.remove(this.editor),this.element.textContent=this.editorValue),this.exposed||(this.view="read"),null!==this.element._.data.prevTabindex?this.element.tabIndex=this.element._.data.prevTabindex:this.element.removeAttribute("tabindex"),this.element._.unbind(".mavo:edit .mavo:preedit .mavo:showpopup"),this.observe()},revert:function(){this.unsavedChanges&&void 0!==this.savedValue&&(this.value=this.savedValue,this.unsavedChanges=!1)},preEdit:function(){var t=this;if(!this.computed){if(this.empty&&!this.attribute)return void this.edit();if("preEdit"!=this.view){this.view="preEdit";
var e;this.element._.events({"click.mavo:preedit":function(e){return t.edit()},"focus.mavo:preedit":function(e){t.edit(),t.popup||t.editor.focus()},"click.mavo:edit":function(e){t.exposed||e.preventDefault()}}),this.attribute||this.element._.events({"mouseenter.mavo:preedit":function(i){clearTimeout(e),e=setTimeout(function(){return t.edit()},150)},"mouseleave.mavo:preedit":function(t){clearTimeout(e)}}),this.element._.data.prevTabindex=this.element.getAttribute("tabindex"),this.element.tabIndex=0}}},initEdit:function(){var n=this;if(!this.editor){var s=i.getMatch(this.element,i.editors);s.create&&t.extend(this,s,function(t){return"create"!=t});var a=s.create||s;this.editor=t.create("function"===t.type(a)?a.call(this):a),this.editorValue=this.value,this.editorType="created"}if(this.editor._.events({"input change":function(t){var e=n.mavo.unsavedChanges;n.value=n.editorValue,n.exposed&&!n.mavo.editing&&n.mavo.permissions.save&&(n.unsavedChanges=!1,n.mavo.unsavedChanges=e,"change"==t.type&&(n.save(),
n.mavo.storage.save(),n.mavo.setUnsavedChanges()))},focus:function(t){n.editor.select&&n.editor.select()},keyup:function(t){(n.popup&&13==t.keyCode||27==t.keyCode)&&(n.popup.contains(document.activeElement)&&n.element.focus(),t.stopPropagation(),n.hidePopup())},"mavo:datachange":function(e){"output"===e.property&&(e.stopPropagation(),t.fire(n.editor,"input"))}}),"placeholder"in this.editor&&(this.editor.placeholder="("+this.label+")"),!this.exposed){var r=/^data-input-/i;if(e(this.element.attributes).forEach(function(t){r.test(t.name)&&this.editor.setAttribute(t.name.replace(r,""),t.value)},this),this.attribute){this.element.classList.add("using-popup"),this.popup=this.popup||t.create("div",{className:"mv-popup",hidden:!0,contents:[this.label+":",this.editor]}),this.editor.matches("select")&&(this.editor.size=Math.min(10,this.editor.children.length));var o=function(t){n.popup.contains(t.target)||n.element.contains(t.target)||n.hidePopup()};this.showPopup=function(){t.unbind([this.element,this.popup],".mavo:showpopup"),
this.popup._.after(this.element);var e=this.element.offsetLeft,i=this.element.offsetTop+this.element.offsetHeight;this.popup._.style({top:i+"px",left:e+"px"}),this.popup._.removeAttribute("hidden"),t.events(document,"focus click",o,!0)},this.hidePopup=function(){var e=this;t.unbind(document,"focus click",o,!0),this.popup.setAttribute("hidden",""),setTimeout(function(){t.remove(e.popup)},400),t.events(this.element,"focus.mavo:showpopup click.mavo:showpopup",function(t){e.showPopup()},!0)}}}this.popup||this.editor.classList.add("mv-editor"),this.initEdit=null},edit:function(){this.computed||this.editing||(this.element._.unbind(".mavo:preedit"),this.initEdit&&this.initEdit(),this.popup&&this.showPopup(),this.attribute||this.editor.parentNode==this.element||this.exposed||(this.editorValue=this.value,this.element.textContent="",this.exposed||this.element.appendChild(this.editor)),this.view="edit")},clear:function(){this.value=this.emptyValue},render:function(t){Array.isArray(t)&&(t=t[0]),"object"===("undefined"==typeof t?"undefined":_typeof(t))&&(t=t[this.property]),
void 0===t?this.value=this.closestCollection?this["default"]:this.templateValue:this.value=t,this.save()},find:function(t){if(this.property==t)return this},observe:function(){var t=this;this.computed||(this.observer=Mavo.observe(this.element,this.attribute,this.observer||function(e){!t.attribute&&t.mavo.editing||(t.value=t.getValue())}))},unobserve:function(){this.observer&&this.observer.disconnect()},getValue:function(t){return i.getValue(this.element,this.attribute,this.datatype,t)},lazy:{label:function(){return Mavo.readable(this.property)},emptyValue:function(){switch(this.datatype){case"boolean":return!1;case"number":return 0}return""}},setValue:function(e){var n=this,s=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];if(this.unobserve(),"object"==t.type(e)&&"value"in e){var a=e.presentational;e=e.value}return e=e||0===e?e:"",e=i.safeCast(e,this.datatype),e!=this._value||s.force?(this.editor&&(this.editorValue=e),this.humanReadable&&this.attribute&&(a=this.humanReadable(e)),
this.editing&&!this.attribute||(this.editor&&this.editor.matches("select")&&this.editor.selectedOptions[0]&&(a=this.editor.selectedOptions[0].textContent),i.setValue(this.element,{value:e,presentational:a},this.attribute,this.datatype)),this.empty=""===e,this._value=e,s.silent||(this.computed||(this.unsavedChanges=this.mavo.unsavedChanges=!0),requestAnimationFrame(function(){t.fire(n.element,"mavo:datachange",{property:n.property,value:e,mavo:n.mavo,node:n,dirty:n.editing,action:"propertychange"})})),"preEdit"==this.view&&this.preEdit(),this.observe(),e):e},live:{value:function(t){return this.setValue(t)},empty:function(e){var i=e&&!this.exposed&&!(this.attribute&&t(Mavo.selectors.property,this.element));this.element.classList.toggle("empty",i)},view:function(t){this.element.classList.toggle("editing","edit"==t)},computed:function(t){this.element.classList.toggle("computed",t)}},"static":{all:new WeakMap,getMatch:function(t,e){var i=null;for(var n in e)t.matches(n)&&(i=e[n]);return i},getValueAttribute:function(e){
var n=e.getAttribute("data-attribute")||i.getMatch(e,i.attributes);return n&&n.value&&(n=t.extend(new String(n.value),n)),n&&"null"!==n||(n=null),n},getDatatype:function(t,e){var n=t.getAttribute("datatype");if(!n)for(var s in i.datatypes)t.matches(s)&&(n=i.datatypes[s][e]);return n=n||"string"},safeCast:function(t,e){var n=("undefined"==typeof t?"undefined":_typeof(t),i.cast(t,e));return null===t||void 0===t?t:"boolean"==e?"false"!==t&&0!==t&&""!==t&&("true"===t||t>0||t):"number"==e?/^[-+]?[0-9.e]+$/i.test(t+"")?n:t:n},cast:function(t,e){switch(e){case"number":return+t;case"boolean":return!!t;case"string":return t+""}return t},getValue:function(t,e,n){arguments.length<=3||void 0===arguments[3]?{}:arguments[3];e=e||null===e?e:i.getValueAttribute(t),n=n||i.getDatatype(t,e);var s;return s=e in t&&i.useProperty(t,e)?t[e]:e?t.getAttribute(e):t.getAttribute("content")||t.textContent||null,i.safeCast(s,n)},setValue:function(e,n,s,a){if("object"==t.type(n)&&"value"in n){var r=n.presentational;n=n.value;
}if(null!==s&&(s=s||i.getValueAttribute(e)),s in e&&i.useProperty(e,s)&&e[s]!=n)try{e[s]=n}catch(o){}s?e.getAttribute(s)!=n&&(e.setAttribute(s,n),r&&(e.textContent=r)):("number"!==a||r||(r=i.formatNumber(n)),e.textContent=r||n,r&&e.setAttribute&&e.setAttribute("content",n))},useProperty:function(t,e){return!(["href","src"].indexOf(e)>-1)&&"http://www.w3.org/2000/svg"!=t.namespaceURI},lazy:{formatNumber:function(){var t=new Intl.NumberFormat("en-US",{maximumFractionDigits:2});return function(e){return e===1/0||e===-(1/0)?e<0?"-∞":"∞":t.format(e)}}}}});i.attributes={"img, video, audio":"src","a, link":"href","select, input, textarea, meter, progress":"value","input[type=checkbox]":"checked",time:{value:"datetime",humanReadable:function(t){var e=new Date(t);if(!t||isNaN(e))return"(No "+this.label+")";var i={date:{day:"numeric",month:"short",year:"numeric"},month:{month:"long"},time:{hour:"numeric",minute:"numeric"},"datetime-local":{day:"numeric",month:"short",year:"numeric",hour:"numeric",
minute:"numeric"}},n=i[this.editor&&this.editor.type]||i.date;return n.timeZone="UTC",e.toLocaleString("en-GB",n)}},meta:"content"},i.datatypes={"input[type=checkbox]":{checked:"boolean"},"input[type=range], input[type=number], meter, progress":{value:"number"}},i.editors={"*":{tag:"input"},".number":{tag:"input",type:"number"},".boolean":{tag:"input",type:"checkbox"},"a, img, video, audio, .url":{tag:"input",type:"url",placeholder:"http://"},"p, div, li, dt, dd, h1, h2, h3, h4, h5, h6, article, section, address, .multiline":{create:function(){var e=getComputedStyle(this.element).display,i=0===e.indexOf("inline")?"input":"textarea",n=t.create(i);if("textarea"==i){var s=this.element.offsetWidth;s&&(n.width=s)}return n},setEditorValue:function(t){if("string"==this.datatype){var e=getComputedStyle(this.element);return t=t||"",["normal","nowrap"].indexOf(e.whiteSpace)>-1&&(t=t.replace(/\r?\n/g," ")),["normal","nowrap","pre-line"].indexOf(e.whiteSpace)>-1&&(t=t.replace(/^[ \t]+|[ \t]+$/gm,"").replace(/[ \t]+/g," ")),
this.editor.value=t,!0}}},"meter, progress":function(){return t.create({tag:"input",type:"range",min:this.element.getAttribute("min")||0,max:this.element.getAttribute("max")||100})},"time, .date":function(){var e={date:/^[Y\d]{4}-[M\d]{2}-[D\d]{2}$/i,month:/^[Y\d]{4}-[M\d]{2}$/i,time:/^[H\d]{2}:[M\d]{2}/i,week:/[Y\d]{4}-W[W\d]{2}$/i,"datetime-local":/^[Y\d]{4}-[M\d]{2}-[D\d]{2} [H\d]{2}:[M\d]{2}/i},i=this.element.getAttribute("datetime")||"YYYY-MM-DD";for(var n in e)if(e[n].test(i))break;return t.create("input",{type:n})}}}(Bliss,Bliss.$);
