...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,i=Array(t.length);e<t.length;e++)i[e]=t[e];return i}return Array.from(t)}!function(t,e){var i=self.Mavo=t.Class({constructor:function(s){var r=this;if(this.index=i.all.push(this),this.id=s.getAttribute("data-mavo")||Mavo.Node.getProperty(s)||s.id||"mavo"+this.index,this.unhandled=s.classList.contains("mv-keep-unhandled"),1==this.index&&(this.store=i.urlParam("store"),this.source=i.urlParam("source")),this.store=this.store||i.urlParam(this.id+"_store")||s.getAttribute("data-store")||null,this.source=this.source||i.urlParam(this.id+"_source")||s.getAttribute("data-source")||null,this.autoEdit=i.has("autoedit",s),this.element=i.is("scope",s)?s:t(i.selectors.rootScope,s),this.element||(s.setAttribute("typeof",s.getAttribute("property")||""),s.removeAttribute("property"),this.element=s),this.element.classList.add("mv-root"),e(i.selectors.property+", "+i.selectors.scope,s).concat([this.element]).forEach(function(t){i.is("autoMultiple",t)&&!t.hasAttribute("data-multiple")&&t.setAttribute("data-multiple","");
}),this.wrapper=s.closest(".mv-wrapper")||s,this.wrapper.addEventListener("keydown",function(t){83==t.keyCode&&t[i.superKey]&&(t.preventDefault(),r.save())}),e(i.selectors.primitive,s).forEach(function(e){var s=t(i.selectors.not(i.selectors.formControl)+", "+i.selectors.property,e)&&(Mavo.is("multiple",e)||null===Mavo.Primitive.getValueAttribute(e))||e.matches("template");s&&e.setAttribute("typeof","")}),this.wrapper===this.element&&i.is("multiple",s)){var n=this.element;this.element.matches("li, option")?n=n.parentNode:this.element.matches("td, tr, tbody, thead, tfoot")&&(n=n.closest("table")),this.wrapper=t.create({around:n})}this.wrapper.classList.add("mv-wrapper"),this.ui={bar:t(".mv-bar",this.wrapper)||t.create({className:"mv-bar mv-ui",start:this.wrapper})},this.ui.status=t(".status",this.ui.bar)||t.create("span",{className:"status",inside:this.ui.bar}),this.needsEdit=!1,this.permissions=new Mavo.Permissions(null,this),Mavo.hooks.run("init-tree-before",this),this.root=Mavo.Node.create(this.element,this),
Mavo.hooks.run("init-tree-after",this),this.setUnsavedChanges(!1),i.observe(this.wrapper,"class",function(){var t=r.permissions,e=!r.editing&&(t.login||t.edit&&!t.login&&!(t.save&&r.unsavedChanges));r.ui.bar.classList.toggle("floating",e)}),this.permissions.onchange(function(t){var e=t.action,i=t.value;r.wrapper.classList.toggle("can-"+e,i)}),this.permissions.can(["edit","add","delete"],function(){r.ui.edit=t.create("button",{className:"edit",textContent:"Edit",onclick:function(t){return r.editing?r.done():r.edit()},inside:r.ui.bar}),r.autoEdit&&r.wrapper.addEventListener("mavo:load",function(t){return r.ui.edit.click()})},function(){t.remove(r.ui.edit),r.editing&&r.done()}),this.needsEdit&&this.permissions.can("save",function(){r.ui.save=t.create("button",{className:"save",textContent:"Save",events:{click:function(t){return r.save()},"mouseenter focus":function(t){r.wrapper.classList.add("save-hovered"),r.setUnsavedChanges()},"mouseleave blur":function(t){return r.wrapper.classList.remove("save-hovered");
}},inside:r.ui.bar}),r.ui.revert=t.create("button",{className:"revert",textContent:"Revert",disabled:!0,events:{click:function(t){return r.revert()},"mouseenter focus":function(t){r.unsavedChanges||(r.wrapper.classList.add("revert-hovered"),r.setUnsavedChanges())},"mouseleave blur":function(t){return r.wrapper.classList.remove("revert-hovered")}},inside:r.ui.bar})},function(){t.remove([r.ui.save,r.ui.revert]),r.ui.save=r.ui.revert=null}),this.permissions.can("delete",function(){r.ui.clear=t.create("button",{className:"clear",textContent:"Clear",onclick:function(t){return r.clear()}}),r.ui.bar.appendChild(r.ui.clear)}),this.permissions.cannot(["delete","edit"],function(){t.remove(r.ui.clear)}),this.store||this.source?(this.storage=new i.Storage(this),this.permissions.can("read",function(){return r.storage.load()})):(this.permissions.on(["read","edit"]),t.fire(this.wrapper,"mavo:load")),this.needsEdit||this.permissions.off(["edit","add","delete"]),Mavo.hooks.run("init-end",this)},get data(){
return this.getData()},getData:function(t){return this.root.getData(t)},toJSON:function(){var t=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0];return i.toJSON(t)},render:function(t){i.hooks.run("render-start",{context:this,data:t}),t&&(this.editing?(this.done(),this.root.render(t),this.edit()):this.root.render(t)),this.unsavedChanges=!1},clear:function(){confirm("This will delete all your data. Are you sure?")&&(this.storage&&this.storage.clear(),this.root.clear())},edit:function(){this.editing=!0,this.root.edit(),t.events(this.wrapper,"mouseenter.mavo:edit mouseleave.mavo:edit",function(t){if(t.target.matches(".mv-item-controls .delete")){var e=t.target.closest(i.selectors.item);e.classList.toggle("delete-hover","mouseenter"==t.type)}if(t.target.matches(i.selectors.item)){t.target.classList.remove("has-hovered-item");var s=t.target.parentNode.closest(i.selectors.item);s&&s.classList.toggle("has-hovered-item","mouseenter"==t.type)}},!0),this.setUnsavedChanges()},setUnsavedChanges:function(t){
var e=!!t;return t||this.walk(function(i){if(i.unsavedChanges)return e=!0,t===!1&&(i.unsavedChanges=!1),!1}),this.unsavedChanges=e},done:function(){this.root.done(),t.unbind(this.wrapper,".mavo:edit"),this.editing=!1,this.unsavedChanges=!1},save:function(){this.root.save(),this.storage&&this.storage.save(),this.unsavedChanges=!1},revert:function(){this.root.revert()},walk:function(t){this.root.walk(t)},live:{editing:{set:function(t){this.wrapper.classList.toggle("editing",t),t?this.wrapper.setAttribute("data-editing",""):this.wrapper.removeAttribute("data-editing")}},unsavedChanges:function(t){this.wrapper.classList.toggle("unsaved-changes",t),this.ui&&this.ui.save&&(this.ui.save.disabled=!t,this.ui.revert.disabled=!t)},needsEdit:function(t){this.ui.bar[(t?"remove":"set")+"Attribute"]("hidden","")}},"static":{all:[],superKey:0===navigator.platform.indexOf("Mac")?"metaKey":"ctrlKey",init:function(t){return e(i.selectors.init,t||document).map(function(t){return new i(t)})},hooks:new t.Hooks
}});!function(){var e=i.selectors={init:".mavo, [mavo], [data-mavo], [data-store]",property:"[property], [itemprop]",specificProperty:function(t){return"[property="+t+"], [itemprop="+t+"]"},scope:"[typeof], [itemscope], [itemtype], .mv-group",multiple:"[multiple], [data-multiple], .multiple",required:"[required], [data-required], .required",formControl:"input, select, option, textarea",computed:".computed",item:".mv-item",ui:".mv-ui",option:function(t){return"["+t+"], [data-"+t+"], [data-mv-options~='"+t+"'], ."+t},container:{li:"ul, ol",tr:"table",option:"select",dt:"dl",dd:"dl"},documentFragment:".document-fragment"},s=e.arr=function(t){return t.split(/\s*,\s*/g)},r=e.not=function(t){return s(t).map(function(t){return":not("+t+")"}).join("")},n=e.or=function(t,e){return t+", "+e},o=e.and=function(t,e){var i=[],r=s(e);return s(t).forEach(function(t){return i.push.apply(i,_toConsumableArray(r.map(function(e){return t+e})))}),i.join(", ")},a=e.andNot=function(t,e){return o(t,r(e))};t.extend(i.selectors,{
primitive:a(e.property,e.scope),rootScope:a(e.scope,e.property),output:n(e.specificProperty("output"),".output, .value"),autoMultiple:o("li, tr, option",":only-of-type")})}(),Promise.all([t.ready(),t.include(Array.from&&window.Intl&&document.documentElement.closest,"https://cdn.polyfill.io/v2/polyfill.min.js?features=blissfuljs,Intl.~locale.en")])["catch"](function(t){return console.error(t)}).then(function(){return Mavo.init()}),Stretchy.selectors.filter=".mv-editor:not([property])"}(Bliss,Bliss.$);
