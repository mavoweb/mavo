...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){var i=Mavo.Primitive=t.Class({"extends":Mavo.Unit,constructor:function(n,s,o){var r=this;if(this.fromTemplate("attribute","datatype","humanReadable","templateValue")||(this.attribute=i.getValueAttribute(this.element),this.attribute&&(this.humanReadable=this.attribute.humanReadable),this.datatype=i.getDatatype(this.element,this.attribute)),this.view="read",this.computed=!1,Mavo.hooks.run("primitive-init-start",this),Mavo.is("formControl",this.element)?(this.editor=this.element,this.editorType="exposed",this.edit()):this.computed||(this.mavo.needsEdit=!0),this.editor||this.attribute||(this.editor=e(this.element.children).filter(function(t){return t.matches(Mavo.selectors.formControl)&&!t.matches(Mavo.selectors.property)})[0],this.editor&&(this.editorType="nested",this.element.textContent=this.editorValue,
t.remove(this.editor))),!this.editor&&this.element.hasAttribute("data-edit")){this.editorType="linked";var a=t(this.element.getAttribute("data-edit"));a&&Mavo.is("formControl",a)&&(this.editor=a.cloneNode(!0),this.template||Mavo.observe(a,"all",function(t){var e=!0,i=!1,n=void 0;try{for(var s,o=r.copies[Symbol.iterator]();!(e=(s=o.next()).done);e=!0){var u=s.value;u.editor=a.cloneNode(!0),u.setValue(u.value,{force:!0,silent:!0})}}catch(h){i=!0,n=h}finally{try{!e&&o["return"]&&o["return"]()}finally{if(i)throw n}}}))}if(this.templateValue=this.getValue(),this["default"]=this.element.getAttribute("data-default"),this.computed||""===this["default"]?this["default"]=this.templateValue:null===this["default"]&&(this["default"]=this.editor?this.editorValue:this.emptyValue),this.collection){var u=function(e){r.unobserve();var i=t.remove(t(Mavo.selectors.ui,r.element)),n=e();return t.inside(i,r.element),r.observe(),n};["textContent","innerHTML"].forEach(function(t){var e=Object.getOwnPropertyDescriptor(Node.prototype,t);
