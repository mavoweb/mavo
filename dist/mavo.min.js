...
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,i=Array(e.length);t<e.length;t++)i[t]=e[t];return i}return Array.from(e)}!function(e){var t=Mavo.Expression.Text=e.Class({constructor:function(){var i=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];this.mavo=i.mavo,this.template=i.template&&i.template.template||i.template;for(var s=["group","path","syntax","fallback","attribute"],n=0;n<s.length;n++){var a=s[n];this[a]=void 0===i[a]&&this.template?this.template[a]:i[a]}if(this.node=i.node,this.node||(this.node=this.path.reduce(function(e,t){return e.childNodes[t]},this.group.element)),this.element=this.node,this.attribute=this.attribute||null,Mavo.hooks.run("expressiontext-init-start",this),!this.expression){if(3===this.node.nodeType&&(this.element=this.node.parentNode,this.node.parentNode.children.length&&!this.attribute||(this.node=this.element,this.element.normalize())),this.attribute)this.expression=this.node.getAttribute(this.attribute).trim();else{
if(this.node.normalize(),this.node.firstChild&&1===this.node.childNodes.length&&3===this.node.firstChild.nodeType){var o=this.node.firstChild.textContent.match(/^\s*|\s*$/g);o[1]&&(this.node.firstChild.splitText(this.node.firstChild.textContent.length-o[1].length),e.after(this.node.lastChild,this.node)),o[0]&&(this.node.firstChild.splitText(o[0].length),this.node.parentNode.insertBefore(this.node.firstChild,this.node))}this.expression=this.node.textContent}this.parsed=i.template?i.template.parsed:this.syntax.tokenize(this.expression)}this.oldValue=this.value=this.parsed.map(function(e){return e instanceof Mavo.Expression?e.expression:e}),Mavo.hooks.run("expressiontext-init-end",this),t.elements.set(this.element,[].concat(_toConsumableArray(t.elements.get(this.element)||[]),[this]))},changedBy:function(e){return!this.parsed.every(function(t){return!(t instanceof Mavo.Expression&&t.changedBy(e))})},update:function(){var e=this,t=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0],i=arguments[1];
this.data=t;var s={};Mavo.hooks.run("expressiontext-update-start",this),this.oldValue=this.value,s.value=this.value=this.parsed.map(function(s,n){if(s instanceof Mavo.Expression){if(s.changedBy(i)){var a={context:e,expr:s};return Mavo.hooks.run("expressiontext-update-beforeeval",a),a.value=a.expr.eval(t),Mavo.hooks.run("expressiontext-update-aftereval",a),a.value instanceof Error?void 0!==e.fallback?e.fallback:a.expr.expression:void 0===a.value||null===a.value?"":a.value}return e.oldValue[n]}return s}),this.attribute||(s.presentational=this.value.map(function(e){return Array.isArray(e)?e.join(", "):"number"==typeof e?Mavo.Primitive.formatNumber(e):e}),s.presentational=1===s.presentational.length?s.presentational[0]:s.presentational.join("")),s.value=1===s.value.length?s.value[0]:s.value.join(""),this.primitive&&1===this.parsed.length&&("number"==typeof s.value?this.primitive.datatype="number":"boolean"==typeof s.value&&(this.primitive.datatype="boolean")),s.presentational===s.value&&(s=s.value),
this.primitive?this.primitive.value=s:Mavo.Primitive.setValue(this.node,s,{attribute:this.attribute}),Mavo.hooks.run("expressiontext-update-end",this)},"static":{elements:new WeakMap,search:function(e,i){var s=t.elements.get(e)||[];return arguments.length>1?s.length?s.filter(function(e){return e.attribute===i})[0]||null:null:s}}});Mavo.hooks.add("primitive-init-start",function(){this.expressionText=Mavo.Expression.Text.search(this.element,this.attribute),this.expressionText&&(this.expressionText.primitive=this,this.store=this.store||"none",this.modes="read")}),Mavo.hooks.add("collection-add-end",function(e){if(e.item instanceof Mavo.Primitive&&this.itemTemplate){var t=Mavo.Expression.Text.search(this.itemTemplate.element)[0];t&&t.group.expressions.push(new Mavo.Expression.Text({node:e.item.element,template:t,mavo:this.mavo}))}})}(Bliss);
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,o=Array(e.length);t<e.length;t++)o[t]=e[t];return o}return Array.from(e)}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e};!function(e,t){var o=Mavo.Expressions=e.Class({constructor:function(e){var t=this;this.mavo=e,this.expressions=[];var n=Mavo.Expression.Syntax.create(this.mavo.element.closest("[mv-expressions]"))||Mavo.Expression.Syntax["default"];this.traverse(this.mavo.element,void 0,n),this.scheduled=new Set,this.mavo.treeBuilt.then(function(){var e=!0,n=!1,r=void 0;try{for(var s,i=t.expressions[Symbol.iterator]();!(e=(s=i.next()).done);e=!0){var a=s.value;a.group=Mavo.Node.get(a.element.closest(Mavo.selectors.group)),a.group.expressions=a.group.expressions||[],a.group.expressions.push(a);var u=Mavo.Node.get(a.element,!0);u&&u instanceof Mavo.Primitive&&u.attribute==a.attribute&&(a.primitive=u,
u.store=u.store||"none",u.modes="read")}}catch(v){n=!0,r=v}finally{try{!e&&i["return"]&&i["return"]()}finally{if(n)throw r}}t.mavo.element.addEventListener("mavo:datachange",function(e){"propertychange"==e.action&&e.node.closestCollection?t.scheduled.has(e.property)||(setTimeout(function(){t.scheduled["delete"](e.property),t.update(e)},o.PROPERTYCHANGE_THROTTLE),t.scheduled.add(e.property)):requestAnimationFrame(function(){return t.update(e)})}),t.update()})},update:function(t){var o=this,n=this.mavo.root.getData({relative:!0,store:"*","null":!0,unhandled:this.mavo.unhandled});this.mavo.walk(function(r,s){if(r instanceof Mavo.Group&&r.expressions&&r.expressions.length&&!r.isDeleted()){var i={context:o,data:e.value.apply(e,[n].concat(_toConsumableArray(s)))};Mavo.hooks.run("expressions-update-start",i);var a=!0,u=!1,v=void 0;try{for(var l,p=r.expressions[Symbol.iterator]();!(a=(l=p.next()).done);a=!0){var d=l.value;d.changedBy(t)&&d.update(i.data,t)}}catch(c){u=!0,v=c}finally{try{!a&&p["return"]&&p["return"]();
}finally{if(u)throw v}}}})},extract:function(e,t,n,r){t&&"mv-expressions"==t.name||(t&&o.directives.indexOf(t.name)>-1||r.test(t?t.value:e.textContent))&&this.expressions.push(new Mavo.Expression.Text({node:e,syntax:r,path:n?n.slice(1).split("/").map(function(e){return+e}):[],attribute:t&&t.name,mavo:this.mavo}))},traverse:function(e){var o=this,n=arguments.length<=1||void 0===arguments[1]?"":arguments[1],r=arguments[2];if(8!==e.nodeType)if(3===e.nodeType)this.extract(e,null,n,r);else{if(e.normalize(),r=Mavo.Expression.Syntax.create(e)||r,r===Mavo.Expression.Syntax.ESCAPE)return;Mavo.is("group",e)&&(n=""),t(e.attributes).forEach(function(t){return o.extract(e,t,n,r)}),t(e.childNodes).forEach(function(e,t){return o.traverse(e,n+"/"+t,r)})}},"static":{directives:[],PROPERTYCHANGE_THROTTLE:50}});self.Proxy&&Mavo.hooks.add("node-getdata-end",function(e){var t=this;e.options.relative&&e.data&&"object"===_typeof(e.data)&&(e.data=new Proxy(e.data,{get:function(e,o,n){return o in e||o in n&&o in e?e[o]:"$index"==o?t.index+1:o==t.mavo.id?e:void 0;
},has:function(o,n){if(n in o)return!0;if("$index"==n||n==t.mavo.id)return!0;var r=t.walkUp(function(e){if(n in e.children)return e.children[n]});return void 0===r&&(r=t.find(n)),void 0!==r&&(Array.isArray(r)?r=r.map(function(t){return t.getData(e.options)}).filter(function(e){return null!==e}):r instanceof Mavo.Node&&(r=r.getData(e.options)),o[n]=r,!0)},set:function(e,t,o){throw Error("You can’t set data via expressions.")}}))}),Mavo.hooks.add("init-tree-before",function(){this.expressions=new Mavo.Expressions(this)}),Mavo.hooks.add("group-init-start",function(){var e=this,t=this.template;t&&t.expressions&&(this.expressions=t.expressions.map(function(t){return new Mavo.Expression.Text({template:t,group:e,mavo:e.mavo})}))}),Mavo.hooks.add("render-end",function(){this.expressions.update()})}(Bliss,Bliss.$),Mavo.attributes.push("mv-value"),Mavo.Expressions.directives.push("mv-value"),Mavo.hooks.add("expressiontext-init-start",function(){"mv-value"==this.attribute&&(this.attribute=Mavo.Primitive.getValueAttribute(this.element),
this.fallback=this.fallback||Mavo.Primitive.getValue(this.element,{attribute:this.attribute}),this.expression=this.element.getAttribute("mv-value"),this.parsed=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end)});
"use strict";Mavo.Expressions.directives.push("mv-if"),Mavo.attributes.push("mv-if"),Mavo.hooks.add("expressiontext-init-start",function(){"mv-if"==this.attribute&&(this.expression=this.element.getAttribute("mv-if"),this.parsed=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end,this.parentIf=this.element.parentNode&&Mavo.Expression.Text.search(this.element.parentNode.closest("[mv-if]"),"mv-if"),this.parentIf&&(this.parentIf.childIfs=(this.parentIf.childIfs||new Set).add(this)))}),Mavo.hooks.add("expressiontext-update-end",function(){var e=this;if("mv-if"==this.attribute){var t=this.value[0],i=this.oldValue[0];this.group.mavo.treeBuilt.then(function(){if(e.parentIf){var n=e.parentIf.value[0];e.value[0]=t=t&&n}if(t!==i){if(n!==!1&&(t?e.comment&&e.comment.parentNode&&e.comment.parentNode.replaceChild(e.element,e.comment):e.element.parentNode&&(e.comment||(e.comment=document.createComment("mv-if")),e.element.parentNode.replaceChild(e.comment,e.element))),
e.childProperties){var r=!0,o=!1,s=void 0;try{for(var a,h=e.childProperties[Symbol.iterator]();!(r=(a=h.next()).done);r=!0){var d=a.value;d.hidden=!t}}catch(l){o=!0,s=l}finally{try{!r&&h["return"]&&h["return"]()}finally{if(o)throw s}}}if(e.childIfs){var m=!0,v=!1,f=void 0;try{for(var p,u=e.childIfs[Symbol.iterator]();!(m=(p=u.next()).done);m=!0){var c=p.value;c.update()}}catch(l){v=!0,f=l}finally{try{!m&&u["return"]&&u["return"]()}finally{if(v)throw f}}}}})}}),Mavo.hooks.add("unit-isdatanull",function(e){e.result=e.result||this.hidden&&"*"==e.options.store}),$.live(Mavo.Primitive.prototype,"hidden",function(e){this._hidden!==e&&(this._hidden=e,this.dataChanged())}),$.lazy(Mavo.Expression.Text.prototype,"childProperties",function(){var e=this;if("mv-if"==this.attribute){var t=$$(Mavo.selectors.property,this.element).filter(function(t){return t.closest("[mv-if]")==e.element}).map(function(e){return Mavo.Node.get(e)});return this.element.addEventListener("mavo:datachange",function(t){requestAnimationFrame(function(){
