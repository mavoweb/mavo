...
},{tag:"button",textContent:"Logout",className:"mv-logout",events:{click:function(t){return e.backend.logout()}}}])}}),this.element.addEventListener("mavo:logout.mavo",function(e){t(".mv-status",r.ui.bar).textContent=""})),t("summary [property]:not([typeof])")&&this.element.addEventListener("click",function(t){t.target!=document.activeElement&&t.preventDefault()}),Mavo.hooks.run("init-tree-before",this),this.root=new Mavo.Group(this.element,this),this.treeBuilt.resolve(),Mavo.hooks.run("init-tree-after",this),this.needsEdit=this.some(function(t){return t!=r.root&&!t.modes&&"read"==t.mode}),this.setUnsavedChanges(!1),this.permissions.onchange(function(t){var e=t.action,n=t.value,i=r.element.getAttribute("mv-permissions")||"";i=i.trim().split(/\s+/).filter(function(t){return t!=e}),n&&i.push(e),r.element.setAttribute("mv-permissions",i.join(" "))}),this.needsEdit&&this.permissions.can(["edit","add","delete"],function(){r.ui.edit=t.create("button",{className:"mv-edit",textContent:"Edit",onclick:function(t){
return r.editing?r.done():r.edit()},inside:r.ui.bar}),r.autoEdit&&r.ui.edit.click()},function(){t.remove(r.ui.edit),r.editing&&r.done()}),this.storage&&this.permissions.can("delete",function(){r.ui.clear=t.create("button",{className:"mv-clear",textContent:"Clear",onclick:function(t){return r.clear()}}),r.ui.bar.appendChild(r.ui.clear)},function(){t.remove(r.ui.clear)}),this.storage||this.source?(this.storage||this.source.permissions.can("read",function(){return r.permissions.read=!0}),this.permissions.can("read",function(){return r.load()})):(this.permissions.on(["read","edit"]),t.fire(this.element,"mavo:load")),this.permissions.can("save",function(){r.ui.save=t.create("button",{className:"mv-save",textContent:"Save",events:{click:function(t){return r.save()},"mouseenter focus":function(t){r.element.classList.add("mv-highlight-unsaved")},"mouseleave blur":function(t){return r.element.classList.remove("mv-highlight-unsaved")}},inside:r.ui.bar}),r.autoSave?r.element.addEventListener("mavo:load.mavo:autosave",function(t){
var e=n.debounce(function(){r.save()},3e3),i=function(t){t.node.saved&&e()};requestAnimationFrame(function(){r.permissions.can("save",function(){r.element.addEventListener("mavo:datachange.mavo:autosave",i)},function(){r.element.removeEventListener("mavo:datachange.mavo:autosave",i)})})}):r.ui.revert=t.create("button",{className:"mv-revert",textContent:"Revert",disabled:!0,events:{click:function(t){return r.revert()},"mouseenter focus":function(t){r.element.classList.add("mv-highlight-unsaved")},"mouseleave blur":function(t){return r.element.classList.remove("mv-highlight-unsaved")}},inside:r.ui.bar})},function(){t.remove([r.ui.save,r.ui.revert]),r.ui.save=r.ui.revert=null,r.element.removeEventListener(".mavo:autosave")}),Mavo.hooks.run("init-end",this)},get editing(){return this.root.editing},get data(){return this.getData()},getData:function(t){return this.root.getData(t)},toJSON:function(){var t=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0];return n.toJSON(t)},error:function i(e){
for(var r,s=function(){return t.transition(i,{opacity:0}).then(t.remove)},i=t.create("p",{className:"mv-error mv-ui",contents:[e,{tag:"button",className:"mv-close mv-ui",textContent:"×",events:{click:s}}],events:{mouseenter:function(t){return clearTimeout(r)},mouseleave:n.rr(function(t){return r=setTimeout(s,5e3)})},start:this.element}),o=arguments.length,a=Array(o>1?o-1:0),u=1;u<o;u++)a[u-1]=arguments[u];if(a.length>0){var c;(c=console).log.apply(c,["%c"+e,"color: red; font-weight: bold"].concat(a))}},render:function(t){var e={context:this,data:t};n.hooks.run("render-start",e),e.data&&this.root.render(e.data),this.unsavedChanges=!1,n.hooks.run("render-end",e)},clear:function(){var t=this;confirm("This will delete all your data. Are you sure?")&&this.store(null).then(function(){return t.root.clear()})},edit:function(){this.root.edit(),t.events(this.element,"mouseenter.mavo:edit mouseleave.mavo:edit",function(t){if(t.target.matches(".mv-item-controls *")){var e=t.target.closest(n.selectors.multiple);
e.classList.toggle("mv-highlight","mouseenter"==t.type)}if(t.target.matches(n.selectors.multiple)){t.target.classList.remove("mv-has-hovered-item");var i=t.target.parentNode.closest(n.selectors.multiple);i&&i.classList.toggle("mv-has-hovered-item","mouseenter"==t.type)}},!0),this.setUnsavedChanges()},setUnsavedChanges:function(t){var e=!!t;return t||this.walk(function(n){if(n.unsavedChanges)return e=!0,t===!1&&(n.unsavedChanges=!1),!1}),this.unsavedChanges=e},done:function(){this.root.done(),t.unbind(this.element,".mavo:edit"),this.unsavedChanges=!1},load:function(){var e=this;this.inProgress="Loading";var n=this.storage||this.source;return n.ready.then(function(){return n.get()})["catch"](function(t){return e.source&&n!==e.source?e.source.ready.then(function(){return e.source.get()}):Promise.reject(t)}).then(function(n){if(n&&"string"==t.type(n))try{n=JSON.parse(n)}catch(i){e.error("The data is corrupted.",i,n),n=""}e.render(n)})["catch"](function(t){t&&(t.xhr&&404==t.xhr.status?e.render(""):e.error("The data could not be loaded.",t));
...
this.ui.revert&&(this.ui.revert.disabled=!t))},needsEdit:function(e){t.remove(this.ui.edit)}},"static":{all:[],allIds:[],get:function(t){var e=!0,i=!1,r=void 0;try{for(var s,o=n.all[Symbol.iterator]();!(e=(s=o.next()).done);e=!0){var a=s.value;if(a.id===t)return a}}catch(u){i=!0,r=u}finally{try{!e&&o["return"]&&o["return"]()}finally{if(i)throw r}}return null},superKey:0===navigator.platform.indexOf("Mac")?"metaKey":"ctrlKey",init:function(t){return e(n.selectors.init,t||document).filter(function(t){return t==document.documentElement||!t.parentNode.closest(n.selectors.init)}).map(function(t){return new n(t)})},plugin:function(e){n.hooks.add(e.hooks);for(var i in e.extend)t.Class(Mavo[i],e.extend[i])},hooks:new t.Hooks,attributes:["mv-app","mv-storage","mv-init","mv-attribute","mv-default","mv-mode","mv-edit","mv-permisssions"]}});!function(){var e=n.selectors={init:".mv-app, [mv-app], [data-mv-app], [mv-storage], [data-mv-storage]",property:"[property], [itemprop]",specificProperty:function(t){
return"[property="+t+"], [itemprop="+t+"]"},group:"[typeof], [itemscope], [itemtype], [mv-group]",multiple:"[mv-multiple]",formControl:"input, select, option, textarea",ui:".mv-ui",container:{tr:"table",option:"select"}},i=e.arr=function(t){return t.split(/\s*,\s*/g)},r=e.not=function(t){return i(t).map(function(t){return":not("+t+")"}).join("")},s=e.or=function(t,e){return t+", "+e},o=e.and=function(t,e){var n=[],r=i(e);return i(t).forEach(function(t){return n.push.apply(n,_toConsumableArray(r.map(function(e){return t+e})))}),n.join(", ")},a=e.andNot=function(t,e){return o(t,r(e))};t.extend(n.selectors,{primitive:a(e.property,e.group),rootGroup:a(e.group,e.property),output:s(e.specificProperty("output"),".mv-output, .mv-value")})}(),Promise.all([t.ready(),t.include(Array.from&&window.Intl&&document.documentElement.closest,"https://cdn.polyfill.io/v2/polyfill.min.js?features=blissfuljs,Intl.~locale.en")])["catch"](function(t){return console.error(t)}).then(function(){return Mavo.init()}),
...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,o=Array(t.length);e<t.length;e++)o[e]=t[e];return o}return Array.from(t)}!function(t,e){var o=Mavo.Node=t.Class({"abstract":!0,constructor:function(e,r){var n=this,i=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];if(!e||!r)throw new Error("Mavo.Node constructor requires an element argument and a mavo object");var s={context:this,options:i};this.uid=++o.maxId,this.nodeType=this.nodeType,this.property=null,t.extend(this,s.options),o.all.set(e,[].concat(_toConsumableArray(o.all.get(this.element)||[]),[this])),this.element=e,this.template=s.options.template,this.template?this.template.copies.push(this):this.copies=[],this.mavo=r,this.group=this.parentGroup=s.options.group,this.fromTemplate("property","type","modes")||(this.property=o.getProperty(e),this.type=Mavo.Group.normalize(e),this.store=this.element.getAttribute("mv-storage"),this.modes=this.element.getAttribute("mv-mode")),Mavo.hooks.run("node-init-start",s),
this.modeObserver=new Mavo.Observer(this.element,"mv-mode",function(t){n.mode=n.element.getAttribute("mv-mode"),n["edit"==n.mode?"edit":"done"]()}),this.mode=this.modes||"read",Mavo.hooks.run("node-init-end",s)},get editing(){return"edit"==this.mode},get constant(){return"read"==this.modes},get isRoot(){return!this.property},get name(){return Mavo.readable(this.property||this.type).toLowerCase()},get data(){return this.getData()},get saved(){return"none"!==this.store},get path(){var t=this.parentGroup?this.parentGroup.path:[];return this.property?[].concat(_toConsumableArray(t),[this.property]):t},postInit:function(){"edit"==this.modes&&this.edit()},destroy:function(){this.modeObserver.destroy()},getData:function(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];return this.isDataNull(t)?null:void this.walkUp(function(e){if(e.isDataNull(t))return null})},isDataNull:function(t){var e={context:this,options:t,result:this.deleted||!this.saved&&"*"!=t.store};return Mavo.hooks.run("unit-isdatanull",e),
e.result},walk:function(t){var e=arguments.length<=1||void 0===arguments[1]?[]:arguments[1],o=function r(e,o){var n=t(e,o);if(n!==!1)for(var i in e.children){var s=e.children[i];if(s instanceof Mavo.Node){var n=r.call(s,s,[].concat(_toConsumableArray(o),[i]));if(n===!1)return!1}}return n!==!1};return o(this,e)},walkUp:function(t){for(var e=this;e=e.parentGroup;){var o=t(e);if(void 0!==o)return o}},edit:function(){this.mode="edit",this.propagate("edit"),Mavo.hooks.run("node-edit-end",this)},done:function(){this.mode="read",t.unbind(this.element,".mavo:edit"),this.propagate("done"),Mavo.hooks.run("node-done-end",this)},propagate:function(t){for(var e in this.children){var o=this.children[e];o instanceof Mavo.Node&&("function"==typeof t?t.call(o,o):t in o&&o[t]())}},propagated:["save","revert","destroy"],toJSON:Mavo.prototype.toJSON,fromTemplate:function(){if(this.template){for(var t=arguments.length,e=Array(t),o=0;o<t;o++)e[o]=arguments[o];var r=!0,n=!1,i=void 0;try{for(var s,a=e[Symbol.iterator]();!(r=(s=a.next()).done);r=!0){
var h=s.value;this[h]=this.template[h]}}catch(u){n=!0,i=u}finally{try{!r&&a["return"]&&a["return"]()}finally{if(n)throw i}}}return!!this.template},render:function(t){Mavo.hooks.run("node-render-start",this),this.editing?(this.done(),this.dataRender(t),this.edit()):this.dataRender(t),this.save(),Mavo.hooks.run("node-render-end",this)},dataChanged:function(e){var o=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];t.fire(o.element||this.element,"mavo:datachange",t.extend({property:this.property,action:e,mavo:this.mavo,node:this},o))},toString:function(){return"#"+this.uid+": "+this.nodeType+" ("+this.property+")"},live:{store:function(e){t.toggleAttribute(this.element,"mv-storage",e)},unsavedChanges:function(t){return!t||this.saved&&this.editing||(t=!1),this.element.classList.toggle("mv-unsaved-changes",t),t},mode:function(e){var o=this;this._mode!=e&&(this._mode=e,this.modeObserver.sneak(function(){var r=o.modes||"edit"==o.mode;t.toggleAttribute(o.element,"mv-mode",e,r)}))}},"static":{
maxId:0,all:new WeakMap,create:function(t,e){var o=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];return Mavo.is("multiple",t)&&!o.collection?new Mavo.Collection(t,e,o):new(Mavo[Mavo.is("group",t)?"Group":"Primitive"])(t,e,o)},getProperty:function(t){var e=t.getAttribute("property")||t.getAttribute("itemprop");return!e&&t.hasAttribute("property")&&(e=t.name||t.id||t.classList[0]),e&&t.setAttribute("property",e),e},get:function(t,e){var r=(o.all.get(t)||[]).filter(function(t){return!(t instanceof Mavo.Collection)});return r.length<2||!e?r[0]:r[0]instanceof Mavo.Group?node[1]:void 0}}})}(Bliss,Bliss.$);
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,r=Array(t.length);e<t.length;e++)r[e]=t[e];return r}return Array.from(t)}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){var r=Mavo.Group=t.Class({"extends":Mavo.Node,nodeType:"Group",constructor:function(t,r,n){var o=this;if(this.children={},this.group=this,Mavo.hooks.run("group-init-start",this),Mavo.Primitive.getValueAttribute(this.element)){this.children[this.property]=new Mavo.Primitive(this.element,this.mavo,{group:this})}e(Mavo.selectors.property,this.element).forEach(function(t){var e=Mavo.Node.getProperty(t);if(o.contains(t)){var r=o.children[e],n=o.template?o.template.children[e]:null,i={template:n,group:o};if(r){var a=r;r instanceof Mavo.Collection||(a=new Mavo.Collection(r.element,o.mavo,i),o.children[e]=r.collection=a,a.add(r)),!a.mutable&&Mavo.is("multiple",t)&&(a.mutable=!0),
a.add(t)}else{var s=Mavo.Node.create(t,o.mavo,i);o.children[e]=s}}});var i=(this.isRoot?this.element.closest("[vocab]"):null)||this.element;this.vocab=i.getAttribute("vocab"),this.postInit(),Mavo.hooks.run("group-init-end",this)},get isRoot(){return!this.property},getData:function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],n={context:this,options:e,data:this["super"].getData.call(this,e)};return void 0!==n.data?n.data:(n.data={},this.propagate(function(t){if((t.saved||"*"==e.store)&&!(t.property in n.data)){var r=t.getData(e);(null!==r||n.options["null"])&&(n.data[t.property]=r)}}),t.extend(n.data,this.unhandled),this.type&&this.type!=r.DEFAULT_TYPE&&(n.data["@type"]=this.type),this.vocab&&(n.data["@context"]=this.vocab),n.data.summary&&(n.data.toString=function(){return this.summary}),Mavo.hooks.run("node-getdata-end",n),n.data)},find:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];if(this.property==t)return this;if(t in this.children)return this.children[t].find(t,e);
var r=[];for(var n in this.children){var o=this.children[n].find(t,e);if(void 0!==o){if(!Array.isArray(o))return o;r.push.apply(r,_toConsumableArray(o))}}return r.length?r:void 0},save:function(){this.unsavedChanges=!1},propagated:["save","import","clear"],dataRender:function(e){var r=this;if(e){e=Array.isArray(e)?e[0]:e;var n=this.unhandled;this.unhandled=t.extend({},e,function(t){return!(t in r.children)}),this.propagate(function(t){t.render(e[t.property])});for(var o in this.unhandled){var i=this.unhandled[o];"object"==("undefined"==typeof i?"undefined":_typeof(i))||n&&n[o]==i||this.dataChanged("propertychange",{property:o})}}},contains:function(t){return t instanceof Mavo.Node?t.parentGroup===this:t.parentNode&&this.element===t.parentNode.closest(Mavo.selectors.group)},"static":{all:new WeakMap,DEFAULT_TYPE:"Item",normalize:function(t){if(Mavo.is("group",t)){var e=Mavo.getAttribute(t,"typeof","itemtype")||r.DEFAULT_TYPE;return t.setAttribute("typeof",e),e}return null}}})}(Bliss,Bliss.$);
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){var i=Mavo.Primitive=t.Class({"extends":Mavo.Node,nodeType:"Primitive",constructor:function(a,s,n){var o=this;if(this.fromTemplate("defaults","attribute","templateValue")||(this.defaults=i.getDefaults(a),this.attribute=i.getValueAttribute(this.element,this.defaults)),this.datatype=this.defaults.datatype,this.modes=this.modes||this.defaults.modes,this.mode=this.modes||"read",Mavo.hooks.run("primitive-init-start",this),this.defaults.init&&this.defaults.init.call(this,this.element),this.defaults.changeEvents&&t.events(this.element,this.defaults.changeEvents,function(t){t.target===o.element&&(o.value=o.getValue())}),this.editor||this.attribute||(this.editor=e(this.element.children).filter(function(t){return t.matches(Mavo.selectors.formControl)&&!t.matches(Mavo.selectors.property);
})[0],this.editor&&(this.element.textContent=this.editorValue,t.remove(this.editor))),!this.editor&&this.element.hasAttribute("mv-edit")){var r=t(this.element.getAttribute("mv-edit"));r&&Mavo.is("formControl",r)&&(this.editor=r.cloneNode(!0),this.template||new Mavo.Observer(r,"all",function(t){var e=!0,i=!1,a=void 0;try{for(var s,n=o.copies[Symbol.iterator]();!(e=(s=n.next()).done);e=!0){var u=s.value;u.editor=r.cloneNode(!0),u.setValue(u.value,{force:!0,silent:!0})}}catch(l){i=!0,a=l}finally{try{!e&&n["return"]&&n["return"]()}finally{if(i)throw a}}}))}this.templateValue=this.getValue(),this._default=this.element.getAttribute("mv-default"),null===this["default"]?this._default=this.constant?this.templateValue:this.editor?this.editorValue:void 0:""===this["default"]?this._default=this.templateValue:this.defaultObserver=new Mavo.Observer(this.element,"mv-default",function(t){o["default"]=o.element.getAttribute("mv-default")}),this.initialValue=(this.template||void 0!==this["default"]?this["default"]:this.templateValue)||this.emptyValue,
this.setValue(this.initialValue,{silent:!0}),this.observer=new Mavo.Observer(this.element,this.attribute,function(t){!o.attribute&&o.editing||(o.value=o.getValue())}),this.postInit(),Mavo.hooks.run("primitive-init-end",this)},get editorValue(){if(this.defaults.getEditorValue)return this.defaults.getEditorValue.call(this);if(this.editor){if(this.editor.matches(Mavo.selectors.formControl))return i.getValue(this.editor,{datatype:this.datatype});var e=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);if(e)return i.getValue(e)}},set editorValue(e){if(this.defaults.setEditorValue)return this.defaults.setEditorValue.call(this,e);if(this.editor)if(this.editor.matches(Mavo.selectors.formControl))i.setValue(this.editor,e,{defaults:this.editorDefaults});else{var a=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);a&&i.setValue(a,e)}},destroy:function(){this["super"].destroy.call(this),this.defaultObserver&&this.defaultObserver.destroy(),this.observer&&this.observer.destroy();
},getData:function(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],e={context:this,options:t,data:this["super"].getData.call(this,t)};return void 0!==e.data?e.data:(e.data=this.value,""===e.data&&(e.data=null),Mavo.hooks.run("node-getdata-end",e),e.data)},save:function(){this.savedValue=this.value,this.unsavedChanges=!1},done:function(){var e=this;"edit"!=this.modes&&(this["super"].done.call(this),"preEdit"in this&&t.unbind(this.element,".mavo:preedit .mavo:edit"),this.sneak(function(){return e.defaults.done?void e.defaults.done.call(e):void(e.popup?e.popup.close():!e.attribute&&e.editor&&(t.remove(e.editor),e.element.textContent=e.editorValue))}),null!==this.element._.data.prevTabindex?this.element.tabIndex=this.element._.data.prevTabindex:this.element.removeAttribute("tabindex"))},revert:function(){this.unsavedChanges&&void 0!==this.savedValue&&(this.value=this.savedValue,this.unsavedChanges=!1)},sneak:function(t){this.observer?this.observer.sneak(t):t()},initEdit:function(){
var a=this;if(!this.editor){var s=this.defaults.editor||Mavo.Elements["*"].editor;this.editor=t.create("function"===t.type(s)?s.call(this):s),this.editorValue=this.value}t.events(this.editor,{"input change":function(t){a.value=a.editorValue},focus:function(t){a.editor.select&&a.editor.select()},"mavo:datachange":function(e){"output"===e.property&&(e.stopPropagation(),t.fire(a.editor,"input"))}}),"placeholder"in this.editor&&(this.editor.placeholder="("+this.label+")");var n=/^mv-edit-/i;e(this.element.attributes).forEach(function(t){n.test(t.name)&&this.editor.setAttribute(t.name.replace(n,""),t.value)},this),this.attribute&&(this.popup=new i.Popup(this)),this.popup||this.editor.classList.add("mv-editor"),this.initEdit=null},edit:function(){var e=this;if("read"!=this.modes)return this["super"].edit.call(this),this.element._.data.prevTabindex=this.element.getAttribute("tabindex"),this.element.tabIndex=0,this.element.addEventListener("click.mavo:edit",function(t){return t.preventDefault();
}),this.preEdit=Mavo.defer(function(i,a){if(e.empty&&!e.attribute)return i();var s;t.events(e.element,{"click.mavo:preedit":i,"focus.mavo:preedit":i}),e.attribute||t.events(e.element,{"mouseenter.mavo:preedit":function(t){clearTimeout(s),s=setTimeout(i,150)},"mouseleave.mavo:preedit":function(t){clearTimeout(s)}})}),this.defaults.edit?void this.defaults.edit.call(this):void this.preEdit.then(function(){t.unbind(e.element,".mavo:preedit"),e.initEdit&&e.initEdit(),e.popup?e.popup.show():e.editor.focus(),e.attribute||e.editor.parentNode!=e.element&&(e.editorValue=e.value,e.element.textContent="",e.element.appendChild(e.editor))})},clear:function(){this.constant||(this.value=this.emptyValue)},dataRender:function(t){Array.isArray(t)&&(t=t[0]),"object"===("undefined"==typeof t?"undefined":_typeof(t))&&(t=Symbol.toPrimitive in t?t[Symbol.toPrimitive]():t[this.property]),void 0===t?this.value=this.closestCollection?this["default"]:this.templateValue:this.value=t},find:function(t){if(this.property==t)return this;
},getValue:function(t){return i.getValue(this.element,{defaults:this.defaults,attribute:this.attribute,datatype:this.datatype})},lazy:{label:function(){return Mavo.readable(this.property)},emptyValue:function(){switch(this.datatype){case"boolean":return!1;case"number":return 0}return""},editorDefaults:function(){return this.editor&&i.getDefaults(this.editor)}},setValue:function(e){var a=this,s=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return this.sneak(function(){if("object"==t.type(e)&&"value"in e){var n=e.presentational;e=e.value}return e=e||0===e?e:"",e=i.safeCast(e,a.datatype),e!=a._value||s.force?(a.editor&&document.activeElement!=a.editor&&(a.editorValue=e),a.defaults.humanReadable&&a.attribute&&(n=a.defaults.humanReadable.call(a,e)),a.editing&&!a.attribute&&a.editor||(a.defaults.setValue?a.defaults.setValue.call(a,a.element,e):(a.editor&&a.editor.matches("select")&&a.editor.selectedOptions[0]&&(n=a.editor.selectedOptions[0].textContent),s.dataOnly||i.setValue(a.element,{
value:e,presentational:n},{defaults:a.defaults,attribute:a.attribute,datatype:a.datatype}))),a.empty=""===e,a._value=e,void(s.silent||(a.saved&&(a.unsavedChanges=a.mavo.unsavedChanges=!0),a.dataChanged("propertychange",{value:e})))):e}),e},dataChanged:function(){var t=arguments.length<=0||void 0===arguments[0]?"propertychange":arguments[0],e=arguments[1];return this["super"].dataChanged.call(this,t,e)},live:{"default":function(t){this.value==this._default&&(this.value=t)},value:function(t){return this.setValue(t)},empty:function(e){var i=e&&!this.constant&&!(this.attribute&&t(Mavo.selectors.property,this.element));this.element.classList.toggle("mv-empty",i)}},"static":{all:new WeakMap,getDefaults:function(t){var e=null;for(var i in Mavo.Elements)t.matches(i)&&(e=Mavo.Elements[i]);return e},getValueAttribute:function(t){var e=arguments.length<=1||void 0===arguments[1]?i.getDefaults(t):arguments[1],a=t.getAttribute("mv-attribute")||e.attribute;return a&&"null"!==a||(a=null),a},safeCast:function(t,e){
var a=("undefined"==typeof t?"undefined":_typeof(t),i.cast(t,e));return null===t||void 0===t?t:"boolean"==e?"false"!==t&&0!==t&&""!==t&&("true"===t||t>0||t):"number"==e?/^[-+]?[0-9.e]+$/i.test(t+"")?a:t:a},cast:function(t,e){switch(e){case"number":return+t;case"boolean":return!!t;case"string":return t+""}return t},getValue:function(t,e){var a=e.defaults,s=void 0===a?i.getDefaults(t):a,n=e.attribute,o=void 0===n?i.getValueAttribute(t,s):n,r=e.datatype,u=void 0===r?s.datatype:r;if(s.getValue&&o==s.attribute)return s.getValue(t);var l;return l=o in t&&i.useProperty(t,o)?t[o]:o?t.getAttribute(o):t.getAttribute("content")||t.textContent||null,i.safeCast(l,u)},setValue:function(e,a,s){var n=s.defaults,o=s.attribute,r=s.datatype;if("object"==t.type(a)&&"value"in a){var u=a.presentational;a=a.value}if(1===e.nodeType&&(n=n||i.getDefaults(e),o=void 0!==o?o:i.getValueAttribute(e,n),r=void 0!==r?r:n.datatype,n.setValue&&o==n.attribute))return n.setValue(e,a);if(o){if(o in e&&i.useProperty(e,o)&&e[o]!==a)try{
e[o]=a}catch(l){}"boolean"==r?a!=e.hasAttribute(o)&&t.toggleAttribute(e,o,a,a):e.getAttribute(o)!=a&&(e.setAttribute(o,a),u&&(e.textContent=u))}else"number"!==r||u||(u=i.formatNumber(a)),e.textContent=u||a,u&&e.setAttribute&&e.setAttribute("content",a)},useProperty:function(t,e){return!(["href","src"].indexOf(e)>-1)&&"http://www.w3.org/2000/svg"!=t.namespaceURI},lazy:{formatNumber:function(){var t=new Intl.NumberFormat("en-US",{maximumFractionDigits:2});return function(e){return e===1/0||e===-(1/0)?e<0?"-∞":"∞":t.format(e)}}}}});i.Popup=t.Class({constructor:function(e){var i=this;this.primitive=e,this.popup=t.create("div",{className:"mv-popup",hidden:!0,contents:[this.primitive.label+":",this.editor],events:{keyup:function(t){13!=t.keyCode&&27!=t.keyCode||(i.popup.contains(document.activeElement)&&i.element.focus(),t.stopPropagation(),i.hide())}}}),this.editor.matches("select")&&(this.editor.size=Math.min(10,this.editor.children.length))},show:function(){var e=this;t.unbind([this.element,this.popup],".mavo:showpopup"),
this.shown=!0,this.hideCallback=function(t){e.popup.contains(t.target)||e.element.contains(t.target)||e.hide()},this.position=function(i){var a=e.element.getBoundingClientRect(),s=a.left,n=a.bottom;t.style(e.popup,{top:n+"px",left:s+"px"})},this.position(),document.body.appendChild(this.popup),requestAnimationFrame(function(t){return e.popup.removeAttribute("hidden")}),t.events(document,"focus click",this.hideCallback,!0),window.addEventListener("scroll",this.position)},hide:function(){var e=this;t.unbind(document,"focus click",this.hideCallback,!0),window.removeEventListener("scroll",this.position),this.popup.setAttribute("hidden",""),this.shown=!1,setTimeout(function(){t.remove(e.popup)},1e3*parseFloat(getComputedStyle(this.popup).transitionDuration)||400),t.events(this.element,{"click.mavo:showpopup":function(t){e.show()},"keyup.mavo:showpopup":function(t){[13,113].indexOf(t.keyCode)>-1&&(e.show(),e.editor.focus())}})},close:function(){this.hide(),t.unbind(this.element,".mavo:edit .mavo:preedit .mavo:showpopup");
},proxy:{editor:"primitive",element:"primitive"}})}(Bliss,Bliss.$);
...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,n=Array(t.length);e<t.length;e++)n[e]=t[e];return n}return Array.from(t)}!function(t,e){Mavo.attributes.push("mv-multiple","mv-order","mv-accepts");var n=Mavo.Collection=t.Class({"extends":Mavo.Node,nodeType:"Collection",constructor:function(t,n,i){if(this.templateElement=this.element,this.children=[],this.fromTemplate("properties","mutable","templateElement","accepts")||(this.properties=e(Mavo.selectors.property,this.templateElement).map(Mavo.Node.getProperty),this.mutable=this.templateElement.matches(Mavo.selectors.multiple),this.accepts=(this.templateElement.getAttribute("mv-accepts")||"").split(/\s+/),this.templateElement=this.templateElement.cloneNode(!0)),this.mutable){var o=this.createItem(this.element);this.add(o),this.itemTemplate=o.template||o}this.postInit(),Mavo.hooks.run("collection-init-end",this)},get length(){return this.children.length},getData:function(){var t=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],e={
context:this,options:t,data:[]},n=!0,i=!1,o=void 0;try{for(var a,r=this.children[Symbol.iterator]();!(n=(a=r.next()).done);n=!0)if(item=a.value,!item.deleted||t["null"]){var l=item.getData(e.options);(l||t["null"])&&e.data.push(l)}}catch(s){i=!0,o=s}finally{try{!n&&r["return"]&&r["return"]()}finally{if(i)throw o}}return this.unhandled&&(e.data=this.unhandled.before.concat(e.data,this.unhandled.after)),this.mutable||1!=e.data.length||(e.data=e.data[0]),Mavo.hooks.run("node-getdata-end",e),e.data},createItem:function(t){t||(t=this.templateElement.cloneNode(!0));var e=Mavo.Node.create(t,this.mavo,{collection:this,template:this.itemTemplate||(this.template?this.template.itemTemplate:null),property:this.property,type:this.type});return e},add:function(e,n){var i=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];if(e=e instanceof Node?Mavo.Node.get(e)||this.createItem(e):e||this.createItem(),e.collection!=this&&this.adopt(e),this.mutable){var o=void 0===n?this.marker:this.children[n];
t[this.bottomUp?"after":"before"](e.element,o),void 0===n&&(n=this.bottomUp?0:this.length)}var a={context:this,item:e};return a.previousIndex=e.index,a.changed=this.splice({remove:a.item},{index:n,add:a.item}),i.silent||(a.changed.forEach(function(t){t.dataChanged(t==a.item&&void 0===a.previousIndex?"add":"move"),t.unsavedChanges=!0}),this.unsavedChanges=this.mavo.unsavedChanges=!0),Mavo.hooks.run("collection-add-end",a),a.item},splice:function(){for(var t=arguments.length,e=Array(t),n=0;n<t;n++)e[n]=arguments[n];var i=!0,o=!1,a=void 0;try{for(var r,l=e[Symbol.iterator]();!(i=(r=l.next()).done);i=!0){var s=r.value;void 0===s.index&&s.remove&&isNaN(s.remove)&&(s.index=this.children.indexOf(s.remove),s.remove=1)}}catch(d){o=!0,a=d}finally{try{!i&&l["return"]&&l["return"]()}finally{if(o)throw a}}e.sort(function(t,e){return e.index-t.index});var h=!0,c=!1,m=void 0;try{for(var u,v=e[Symbol.iterator]();!(h=(u=v.next()).done);h=!0){var p=u.value;if(p.index>-1&&(p.remove||p.add)){var f;p.remove=p.remove||0,
p.add=Mavo.toArray(p.add),(f=this.children).splice.apply(f,[p.index,+p.remove].concat(_toConsumableArray(p.add)))}}}catch(d){c=!0,m=d}finally{try{!h&&v["return"]&&v["return"]()}finally{if(c)throw m}}for(var g=[],C=0;C<this.length;C++){var y=this.children[C];y&&y.index!==C&&(y.index=C,g.push(y))}return g},adopt:function(t){var e=this;t.collection&&(t.collection.splice({remove:t}),t.collection.dataChanged("delete")),this.walk(function(n){n.closestCollection===t.collection&&(n.closestCollection=e),t.mavo!=e.mavo&&(t.mavo=e.mavo)}),t.collection=this,t.template&&(Mavo["delete"](t.template.copies,t),t.template=this.itemTemplate)},"delete":function(e,n){var i=this;return n?(t.remove(e.element),this.splice({remove:e}),void e.destroy()):t.transition(e.element,{opacity:0}).then(function(){e.deleted=!0,e.element.style.opacity="",e.dataChanged("delete"),i.unsavedChanges=e.unsavedChanges=i.mavo.unsavedChanges=!0})},edit:function(){var e=this;if("read"!=this.modes&&(this["super"].edit.call(this),this.mutable)){
if(!this.addButton.parentNode){var i=this.element.tagName.toLowerCase(),o=Mavo.selectors.container[i],a=o?this.marker.parentNode.closest(o):this.marker;t[this.bottomUp?"before":"after"](this.addButton,a)}n.dragula.then(function(){e.getDragula()})}},done:function(){"edit"!=this.modes&&(this["super"].done.call(this),this.mutable&&this.addButton.parentNode&&this.addButton.remove())},clear:function(){this.mutable&&(this.propagate(function(t){t.element.remove(),t.destroy()}),this.children=[],this.dataChanged("clear"))},dataChanged:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];return e.element=e.element||this.marker,this["super"].dataChanged.call(this,t,e)},save:function(){var t=!0,e=!1,n=void 0;try{for(var i,o=this.children[Symbol.iterator]();!(t=(i=o.next()).done);t=!0){var a=i.value;a.deleted?this["delete"](a,!0):a.unsavedChanges=!1}}catch(r){e=!0,n=r}finally{try{!t&&o["return"]&&o["return"]()}finally{if(e)throw n}}},propagated:["save"],revert:function(){var t=!0,e=!1,n=void 0;
try{for(var i,o=this.children[Symbol.iterator]();!(t=(i=o.next()).done);t=!0){var a=i.value;a.unsavedChanges?this["delete"](a,!0):(a.deleted&&(a.deleted=!1),a.revert())}}catch(r){e=!0,n=r}finally{try{!t&&o["return"]&&o["return"]()}finally{if(e)throw n}}},dataRender:function(e){if(this.unhandled={before:[],after:[]},e)if(e=Mavo.toArray(e),this.mutable){for(var n=0;n<this.children.length;n++)n<e.length?this.children[n].render(e[n]):this["delete"](this.children[n],!0);if(e.length>n){for(var i=document.createDocumentFragment(),o=n;o<e.length;o++){var a=this.createItem();a.render(e[o]),this.children.push(a),a.index=o,i.appendChild(a.element);var r={context:this,item:a};Mavo.hooks.run("collection-add-end",r)}t[this.bottomUp?"after":"before"](i,this.marker)}}else this.children.forEach(function(t,n){return t.render(e&&e[n])}),e&&(this.unhandled.after=e.slice(this.length))},find:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1],n=this.children.filter(function(t){return!t.deleted;
});if(this.property==t)return e.collections?this:n;if(this.properties.indexOf(t)>-1){var i=n.map(function(n){return n.find(t,e)});return Mavo.flatten(i)}},isCompatible:function(t){return t&&this.itemTemplate.nodeType==t.itemTemplate.nodeType&&(t===this||t.template==this||this.template==t||this.template&&this.template==t.template||this.accepts.indexOf(t.property)>-1)},live:{mutable:function(e){e&&e!==this.mutable&&(this._mutable=e,this.marker=document.createComment("mv-marker"),Mavo.data(this.marker,"collection",this),t.after(this.marker,this.templateElement))}},getDragula:function(){var t=this;if(this.dragula)return this.dragula;if(this.template)return Mavo.pushUnique(this.template.getDragula().containers,this.marker.parentNode),this.dragula=this.template.dragula||this.template.getDragula();return this.dragula=dragula({containers:[this.marker.parentNode],isContainer:function(e){return!!t.accepts.length&&Mavo.flatten(t.accepts.map(function(e){return t.mavo.root.find(e,{collections:!0})})).filter(function(t){
return t&&t instanceof n}).map(function(t){return t.marker.parentNode}).indexOf(e)>-1},moves:function(t,e,n){return n.classList.contains("mv-drag-handle")&&n.closest(Mavo.selectors.multiple)==t},accepts:function(t,e,i,o){if(t.contains(e))return!1;var a=o?o.previousElementSibling:e.lastElementChild,r=n.get(a)||n.get(o);if(!r)return!1;var l=Mavo.Node.get(t);return l&&l.collection.isCompatible(r)}}),this.dragula.on("drop",function(e,i,o){var a=Mavo.Node.get(e),r=(a&&a.index,e.nextElementSibling),l=e.previousElementSibling,s=n.get(l)||n.get(r),d=Mavo.Node.get(l)||Mavo.Node.get(r);if(d&&d.collection!=s&&(d=null),!a.collection.isCompatible(s))return t.dragula.cancel(!0);var h=d?d.index+(d.element===l):s.length;s.add(a,h)}),n.dragulas.push(this.dragula),this.dragula},lazy:{bottomUp:function(){if(!this.mutable)return!1;var t=this.templateElement.getAttribute("mv-order");return null!==t?/^desc\b/i.test(t):!!this.addButton.parentNode&&!!(this.addButton.compareDocumentPosition(this.templateElement)&Node.DOCUMENT_POSITION_FOLLOWING);
},closestCollection:function(){var t=this.marker?this.marker.parentNode:this.templateElement.parentNode;return t.closest(Mavo.selectors.multiple)},addButton:function(){var n=this,i="button.mv-add-"+this.property,o=this.closestCollection||this.marker.parentNode.closest(Mavo.selectors.group);if(o)var a=e(i,o).filter(function(t){return!n.templateElement.contains(t)})[0];return a||(a=t.create("button",{className:"mv-add",textContent:"Add "+this.name})),a.classList.add("mv-ui","mv-add"),Mavo.data(a,"collection",this),this.property&&a.classList.add("mv-add-"+this.property),a.addEventListener("click",function(t){t.preventDefault(),n.add().edit()}),a}},"static":{dragulas:[],get:function(t){var e=Mavo.data(t,"collection");if(e)return e;var n=Mavo.Node.get(t);return n&&n.collection||null},lazy:{dragula:function(){return t.include(self.dragula,"https://cdnjs.cloudflare.com/ajax/libs/dragula/3.7.2/dragula.min.js")}}}});Mavo.hooks.add({"primitive-init-end":function(){var e=this;if(this.collection&&!this.attribute){
var n=function(n){var i;return e.sneak(function(){var o=t.remove(t(".mv-item-controls",e.element));i=n(),t.inside(o,e.element)}),i};["textContent","innerHTML"].forEach(function(t){var i=Object.getOwnPropertyDescriptor(Node.prototype,t);Object.defineProperty(e.element,t,{get:function(){var t=this;return n(function(){return i.get.call(t)})},set:function(t){var e=this;n(function(){return i.set.call(e,t)})}})})}},"node-edit-end":function(){var n=this;this.collection&&(this.itemControls||(this.itemControls=e(".mv-item-controls",this.element).filter(function(t){return t.closest(Mavo.selectors.multiple)==n.element})[0],this.itemControls=this.itemControls||t.create({className:"mv-item-controls mv-ui"}),t.set(this.itemControls,{contents:[{tag:"button",title:"Delete this "+this.name,className:"mv-delete",events:{click:function(t){return n.collection["delete"](n)}}},{tag:"button",title:"Add new "+this.name.replace(/s$/i,"")+" "+(this.collection.bottomUp?"after":"before"),className:"mv-add",events:{
click:function(t){var e=n.collection.add(null,n.index+n.collection.bottomUp);return t[Mavo.superKey]&&e.render(n.data),Mavo.inViewport(e.element)||e.element.scrollIntoView({behavior:"smooth"}),e.edit()}}},{tag:"button",title:"Drag to reorder "+this.name,className:"mv-drag-handle"}]})),this.itemControls.parentNode||(t.value(this,"itemControlsComment","parentNode")?this.itemControlsComment.parentNode.replaceChild(this.itemControls,this.itemControlsComment):this.element.appendChild(this.itemControls)))},"node-done-end":function(){this.collection&&this.itemControls&&(this.itemControlsComment=this.itemControlsComment||document.createComment("item controls"),this.itemControls.parentNode&&this.itemControls.parentNode.replaceChild(this.itemControlsComment,this.itemControls))}}),Mavo.Node.prototype.getClosestCollection=function(){return this.collection||this.group.collection||(this.parentGroup?this.parentGroup.closestCollection:null)},t.lazy(Mavo.Node.prototype,"closestCollection",function(){return this.getClosestCollection();
}),t.live(Mavo.Node.prototype,"deleted",function(n){var i=this;this.element.classList.toggle("mv-deleted",n),n?(this.elementContents=document.createDocumentFragment(),e(this.element.childNodes).forEach(function(t){i.elementContents.appendChild(t)}),t.contents(this.element,[{tag:"button",className:"mv-close mv-ui",textContent:"×",events:{click:function(e){t.remove(this.parentNode)}}},"Deleted "+this.name,{tag:"button",className:"mv-undo mv-ui",textContent:"Undo",events:{click:function(t){return i.deleted=!1}}}]),this.element.classList.remove("mv-highlight")):this.deleted&&(this.element.textContent="",this.element.appendChild(this.elementContents),this._deleted=!1,this.dataChanged("undelete"))}),Mavo.Node.prototype.isDeleted=function(){this.deleted;return!!this.deleted||!!this.parentGroup&&this.parentGroup.isDeleted()},Mavo.hooks.add("node-init-end",function(t){this.collection=t.options.collection,this.collection&&(this.group=this.parentGroup=this.collection.parentGroup)})}(Bliss,Bliss.$);
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,r=Array(e.length);t<e.length;t++)r[t]=e[t];return r}return Array.from(e)}!function(e){Mavo.attributes.push("mv-expressions");var t=Mavo.Expression=e.Class({constructor:function(e){this.expression=e},eval:function(e){this.oldValue=this.value,Mavo.hooks.run("expression-eval-beforeeval",this);try{this["function"]||(this["function"]=t.compile(this.expression),this.identifiers=this.expression.match(/[$a-z][$\w]*/gi)||[]),this.value=this["function"](e)}catch(r){Mavo.hooks.run("expression-eval-error",{context:this,exception:r}),this.value=r}return this.value},toString:function(){return this.expression},changedBy:function(e){if(!e)return!0;if(!this.identifiers)return!1;if(this.identifiers.indexOf(e.property)>-1)return!0;if(Mavo.hasIntersection(e.properties,this.identifiers))return!0;if("propertychange"!=e.action){if(Mavo.hasIntersection(["$index","$all","$previous","$next"],this.identifiers))return!0;var t=e.node.collection||e.node;
if(Mavo.hasIntersection(t.properties,this.identifiers))return!0}return!!Mavo.hasIntersection(Mavo.allIds,this.identifiers)},live:{expression:function(e){e=e;this["function"]=null}},"static":{serializers:{BinaryExpression:function(e){return t.serialize(e.left)+" "+e.operator+" "+t.serialize(e.right)},UnaryExpression:function(e){return""+e.operator+t.serialize(e.argument)},CallExpression:function(e){return t.serialize(e.callee)+"("+e.arguments.map(t.serialize).join(", ")+")"},ConditionalExpression:function(e){return t.serialize(e.test)+"? "+t.serialize(e.consequent)+" : "+t.serialize(e.alternate)},MemberExpression:function(e){return"get("+t.serialize(e.object)+', "'+(e.property.name||e.property.value)+'")'},ArrayExpression:function(e){return"["+e.elements.map(t.serialize).join(", ")+"]"},Literal:function(e){return e.raw},Identifier:function(e){return e.name},ThisExpression:function(e){return"this"},Compound:function(e){return e.body.map(t.serialize).join(" ")}},transformations:{BinaryExpression:function(e){
var r=Mavo.Script.getOperatorName(e.operator),i=(Mavo.Script.operators[r],e),n=[];do n.unshift(i.right),i=i.left;while(Mavo.Script.getOperatorName(i.operator)===r);if(n.unshift(i),n.length>1)return r+"("+n.map(t.serialize).join(", ")+")"},CallExpression:function(e){"Identifier"==e.callee.type&&"if"==e.callee.name&&(e.callee.name="iff")}},serialize:function(e){if(t.transformations[e.type]){var r=t.transformations[e.type](e);if(void 0!==r)return r}return t.serializers[e.type](e)},rewrite:function(e){try{return t.serialize(t.parse(e))}catch(r){return e}},compile:function(e){return e=t.rewrite(e),new Function("data","with(Mavo.Functions._Trap)\n\t\t\t\t\twith(data) {\n\t\t\t\t\t\treturn "+e+";\n\t\t\t\t\t}")},parse:self.jsep}});self.jsep&&(jsep.addBinaryOp("and",2),jsep.addBinaryOp("or",2),jsep.addBinaryOp("=",6),jsep.addBinaryOp("mod",10),jsep.removeBinaryOp("===")),t.serializers.LogicalExpression=t.serializers.BinaryExpression,t.transformations.LogicalExpression=t.transformations.BinaryExpression,
...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,i=Array(t.length);e<t.length;e++)i[e]=t[e];return i}return Array.from(t)}!function(t){var e=Mavo.ExpressionText=t.Class({constructor:function(){var i=this,n=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];this.mavo=n.mavo,this.template=n.template&&n.template.template||n.template;for(var s=["item","path","syntax","fallback","attribute"],r=0;r<s.length;r++){var a=s[r];this[a]=void 0===n[a]&&this.template?this.template[a]:n[a]}if(this.node=n.node,this.node||(this.node=this.path.reduce(function(t,e){return t.childNodes[e]},this.item.element)),this.element=this.node,this.attribute=this.attribute||null,Mavo.hooks.run("expressiontext-init-start",this),!this.expression){if(3===this.node.nodeType&&(this.element=this.node.parentNode,this.node.parentNode.children.length&&!this.attribute||(this.node=this.element,this.element.normalize())),this.attribute)this.expression=this.node.getAttribute(this.attribute).trim();else{
if(this.node.normalize(),this.node.firstChild&&1===this.node.childNodes.length&&3===this.node.firstChild.nodeType){var o=this.node.firstChild.textContent.match(/^\s*|\s*$/g);o[1]&&(this.node.firstChild.splitText(this.node.firstChild.textContent.length-o[1].length),t.after(this.node.lastChild,this.node)),o[0]&&(this.node.firstChild.splitText(o[0].length),this.node.parentNode.insertBefore(this.node.firstChild,this.node))}this.expression=this.node.textContent}this.parsed=n.template?n.template.parsed:this.syntax.tokenize(this.expression)}this.oldValue=this.value=this.parsed.map(function(t){return t instanceof Mavo.Expression?t.expression:t}),this.mavo.treeBuilt.then(function(){i.template||(i.item=Mavo.Node.get(i.element.closest(Mavo.selectors.multiple+", "+Mavo.selectors.group)),i.item.expressions=[].concat(_toConsumableArray(i.item.expressions||[]),[i])),Mavo.hooks.run("expressiontext-init-treebuilt",i)}),Mavo.hooks.run("expressiontext-init-end",this),e.elements.set(this.element,[].concat(_toConsumableArray(e.elements.get(this.element)||[]),[this]));
},changedBy:function(t){return!this.parsed.every(function(e){return!(e instanceof Mavo.Expression&&e.changedBy(t))})},update:function(){var t=this,e=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0],i=arguments[1],n={context:this,ret:{},event:i},s=n;this.data=e,n.ret={},Mavo.hooks.run("expressiontext-update-start",n),this.oldValue=this.value,n.ret.value=this.value=this.parsed.map(function(i,n){if(i instanceof Mavo.Expression){if(i.changedBy(s.event)){var r={context:t,expr:i,parentEnv:s};return Mavo.hooks.run("expressiontext-update-beforeeval",r),r.value=r.expr.eval(e),Mavo.hooks.run("expressiontext-update-aftereval",r),r.value instanceof Error?void 0!==t.fallback?t.fallback:r.expr.expression:void 0===r.value||null===r.value?"":r.value}return t.oldValue[n]}return i}),this.attribute||(n.ret.presentational=this.value.map(function(t){return Array.isArray(t)?t.join(", "):"number"==typeof t?Mavo.Primitive.formatNumber(t):t}),n.ret.presentational=1===n.ret.presentational.length?n.ret.presentational[0]:n.ret.presentational.join("")),
n.ret.value=1===n.ret.value.length?n.ret.value[0]:n.ret.value.join(""),this.primitive&&1===this.parsed.length&&("number"==typeof n.ret.value?this.primitive.datatype="number":"boolean"==typeof n.ret.value&&(this.primitive.datatype="boolean")),n.ret.presentational===n.ret.value&&(ret=n.ret.value),this.output(n.ret),Mavo.hooks.run("expressiontext-update-end",n)},output:function(t){this.primitive?this.primitive.value=t:(t=t.presentational||t,Mavo.Primitive.setValue(this.node,t,{attribute:this.attribute}))},"static":{elements:new WeakMap,search:function(t,i){var n=e.elements.get(t)||[];return arguments.length>1?n.length?n.filter(function(t){return t.attribute===i})[0]||null:null:n}}});Mavo.hooks.add("primitive-init-start",function(){var t=Mavo.ExpressionText.search(this.element,this.attribute);t&&!t.mavoNode&&(t.primitive=this,this.storage=this.storage||"none",this.modes="read")})}(Bliss);
"use strict";function _defineProperty(e,t,n){return t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,n=Array(e.length);t<e.length;t++)n[t]=e[t];return n}return Array.from(e)}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol?"symbol":typeof e};!function(e,t){var n=Mavo.Expressions=e.Class({constructor:function(e){var t=this;this.mavo=e,this.active=!0,this.expressions=[];var o=Mavo.Expression.Syntax.create(this.mavo.element.closest("[mv-expressions]"))||Mavo.Expression.Syntax["default"];this.traverse(this.mavo.element,void 0,o),this.scheduled=new Set,this.mavo.treeBuilt.then(function(){t.expressions=[],t.mavo.element.addEventListener("mavo:datachange",function(e){t.active&&("propertychange"==e.action&&e.node.closestCollection?t.scheduled.has(e.property)||(setTimeout(function(){
t.scheduled["delete"](e.property),t.update(e)},n.PROPERTYCHANGE_THROTTLE),t.scheduled.add(e.property)):requestAnimationFrame(function(){return t.update(e)}))}),t.update()})},update:function(t){var n,o,i=this;t instanceof Element&&(n=t.closest(Mavo.selectors.group),t=null),n=n||this.mavo.element,o=Mavo.Node.get(n);var r=o.getData({relative:!0,store:"*","null":!0});o.walk(function(n,o){if(n.expressions&&n.expressions.length&&!n.isDeleted()){var a={context:i,data:e.value.apply(e,[r].concat(_toConsumableArray(o)))};Mavo.hooks.run("expressions-update-start",a);var s=!0,u=!1,c=void 0;try{for(var l,p=n.expressions[Symbol.iterator]();!(s=(l=p.next()).done);s=!0){var f=l.value;f.changedBy(t)&&f.update(a.data,t)}}catch(v){u=!0,c=v}finally{try{!s&&p["return"]&&p["return"]()}finally{if(u)throw c}}}})},extract:function(e,t,o,i){t&&"mv-expressions"==t.name||(t&&n.directives.indexOf(t.name)>-1||i.test(t?t.value:e.textContent))&&this.expressions.push(new Mavo.ExpressionText({node:e,syntax:i,path:o?o.slice(1).split("/").map(function(e){
return+e}):[],attribute:t&&t.name,mavo:this.mavo}))},traverse:function(e){var n=this,o=arguments.length<=1||void 0===arguments[1]?"":arguments[1],i=arguments[2];if(8!==e.nodeType)if(3===e.nodeType)this.extract(e,null,o,i);else{if(e.normalize(),i=Mavo.Expression.Syntax.create(e)||i,i===Mavo.Expression.Syntax.ESCAPE)return;Mavo.is("multiple",e)&&(o=""),t(e.attributes).forEach(function(t){return n.extract(e,t,o,i)}),t(e.childNodes).forEach(function(e,t){return n.traverse(e,o+"/"+t,i)})}},"static":{directives:[],PROPERTYCHANGE_THROTTLE:50,directive:function(e,t){n.directives.push(e),Mavo.attributes.push(e),Mavo.plugin(t)}}});Mavo.hooks.add({"init-tree-before":function(){this.expressions=new Mavo.Expressions(this)},"node-init-end":function(){var e=this,t=this.template;t&&t.expressions&&(this.expressions=t.expressions.map(function(t){return new Mavo.ExpressionText({template:t,item:e,mavo:e.mavo})}))},"render-start":function(){this.expressions.active=!1},"render-end":function(){this.expressions.active=!0,
this.expressions.update()},"collection-add-end":function(e){var t=this;this.mavo.treeBuilt.then(function(){return t.mavo.expressions.update(e.item.element)})},"node-getdata-end":self.Proxy&&function(e){var t=this;if(e.options.relative&&(e.data&&"object"===_typeof(e.data)||this.collection)){var n=e.data;if(this instanceof Mavo.Primitive){var o;e.data=(o={},_defineProperty(o,Symbol.toPrimitive,function(){return n}),_defineProperty(o,this.property,n),o)}e.data=new Proxy(e.data,{get:function(e,t,n){if(t in e||t in n&&t in e)return e[t]},has:function(n,o){if(o in n)return!0;if("$index"==o)return n[o]=(t.index||0)+1;if("$all"==o)return n[o]=t.closestCollection?t.closestCollection.getData(e.options):[e.data];if("$next"==o||"$previous"==o)return t.closestCollection?n[o]=t.closestCollection.getData(e.options)[t.index+("$next"==o?1:-1)]:n[o]=null;if(o==t.mavo.id)return n[o]=t.mavo.root.getData(e.options);if(t instanceof Mavo.Group&&o==t.property&&t.collection)return n[o]=e.data;var i=t.walkUp(function(e){
...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var e=0,i=Array(t.length);e<t.length;e++)i[e]=t[e];return i}return Array.from(t)}Mavo.Expressions.directive("mv-value",{hooks:{"node-init-start":function(){if(this instanceof Mavo.Group||this.collection){var t=Mavo.ExpressionText.search(this.element).filter(function(t){return"mv-value"==t.originalAttribute})[0];t&&(t.mavoNode=this,this.storage=this.storage||"none",this.modes="read",this.collection&&(this.collection.expressions=[].concat(_toConsumableArray(this.collection.expressions||[]),[t]),t.mavoNode=this.collection,this.collection.storage=this.collection.storage||"none",this.collection.modes="read"))}},"expressiontext-init-start":function(){"mv-value"==this.attribute&&(this.originalAttribute="mv-value",this.attribute=Mavo.Primitive.getValueAttribute(this.element),this.fallback=this.fallback||Mavo.Primitive.getValue(this.element,{attribute:this.attribute}),this.expression=this.element.getAttribute("mv-value"),this.element.removeAttribute("mv-value"),
this.parsed=[new Mavo.Expression(this.expression)],this.expression=this.syntax.start+this.expression+this.syntax.end)},"expressiontext-init-treebuilt":function(){"mv-value"!=this.originalAttribute||!this.mavoNode||this.mavoNode!=this.item&&this.mavoNode!=this.item.collection||(this.mavoNode==this.item.collection&&Mavo["delete"](this.item.expressions,this),this.output=function(t){t=t.value||t,this.mavoNode.render(t)},this.changedBy=function(t){return!0})},"expressiontext-update-start":function(){"mv-value"!=this.originalAttribute||this.mavoNode!=this.item}}});
