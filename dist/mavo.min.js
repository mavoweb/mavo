...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){var i=Mavo.Primitive=t.Class({"extends":Mavo.Unit,constructor:function(n,r,a){var s=this;if(this.fromTemplate("attribute","datatype","humanReadable","templateValue","constant")||(this.attribute=i.getValueAttribute(this.element),this.attribute&&(this.humanReadable=this.attribute.humanReadable),this.datatype=i.getDatatype(this.element,this.attribute),this.constant=this.element.classList.contains("mv-constant")),this.view="read",Mavo.hooks.run("primitive-init-start",this),Mavo.is("formControl",this.element)?(this.editor=this.element,this.editorType="exposed",this.edit()):this.needsEdit&&(this.mavo.needsEdit=!0),this.editor||this.attribute||(this.editor=e(this.element.children).filter(function(t){return t.matches(Mavo.selectors.formControl)&&!t.matches(Mavo.selectors.property);
})[0],this.editor&&(this.editorType="nested",this.element.textContent=this.editorValue,t.remove(this.editor))),!this.editor&&this.element.hasAttribute("data-edit")){this.editorType="linked";var o=t(this.element.getAttribute("data-edit"));o&&Mavo.is("formControl",o)&&(this.editor=o.cloneNode(!0),this.template||Mavo.observe(o,"all",function(t){var e=!0,i=!1,n=void 0;try{for(var r,a=s.copies[Symbol.iterator]();!(e=(r=a.next()).done);e=!0){var u=r.value;u.editor=o.cloneNode(!0),u.setValue(u.value,{force:!0,silent:!0})}}catch(l){i=!0,n=l}finally{try{!e&&a["return"]&&a["return"]()}finally{if(i)throw n}}}))}if(this.templateValue=this.getValue(),this["default"]=this.element.getAttribute("data-default"),this.constant||""===this["default"]?this["default"]=this.templateValue:null===this["default"]?this["default"]=this.editor?this.editorValue:this.emptyValue:Mavo.observe(this.element,"data-default",function(t){s["default"]=s.element.getAttribute("data-default")}),this.collection){var u=function(e){
s.unobserve();var i=t.remove(t(".mv-item-controls",s.element)),n=e();return t.inside(i,s.element),s.observe(),n};["textContent","innerHTML"].forEach(function(t){var e=Object.getOwnPropertyDescriptor(Node.prototype,t);Object.defineProperty(s.element,t,{get:function(){var t=this;return u(function(){return e.get.call(t)})},set:function(t){var i=this;u(function(){return e.set.call(i,t)})}})})}this.needsEdit&&this.setValue(this.templateValue,{silent:!0}),this.setValue(this.template?this["default"]:this.templateValue,{silent:!0}),this.observe()},get editing(){return"edit"==this.view},get editorValue(){if(this.getEditorValue){var e=this.getEditorValue();if(void 0!==e)return e}if(this.editor){if(this.editor.matches(Mavo.selectors.formControl))return i.getValue(this.editor,void 0,this.datatype);var n=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);if(n)return i.all.has(n)?i.all.get(n).value:i.getValue(n)}},set editorValue(e){if((!this.setEditorValue||void 0===this.setEditorValue(e))&&this.editor)if(this.editor.matches(Mavo.selectors.formControl))i.setValue(this.editor,e);else{
var n=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);n&&(i.all.has(n)?i.all.get(n).value=e:i.setValue(n,e))}},get exposed(){return this.editor===this.element},get needsEdit(){return!(this.exposed||this.constant)},getData:function(t){t=t||{};var e=this["super"].getData.call(this,t);if(void 0!==e)return e;var e=t.dirty||this.exposed?this.value:this.savedValue;return t.dirty||""!==e?e:null},save:function(){this.savedValue=this.value,this.unsavedChanges=!1},done:function(){this.unobserve(),this.popup?this.popup.close():this.attribute||this.exposed||!this.editing||(t.remove(this.editor),this.element.textContent=this.editorValue),this.exposed||(this.view="read"),null!==this.element._.data.prevTabindex?this.element.tabIndex=this.element._.data.prevTabindex:this.element.removeAttribute("tabindex"),this.observe()},revert:function(){this.unsavedChanges&&void 0!==this.savedValue&&(this.value=this.savedValue,this.unsavedChanges=!1)},preEdit:function(){var t=this;if(!this.constant){
if(this.empty&&!this.attribute)return void this.edit();if("preEdit"!=this.view){this.view="preEdit";var e;this.element._.events({"click.mavo:preedit":function(e){return t.edit()},"focus.mavo:preedit":function(e){t.edit(),t.popup||t.editor.focus()},"click.mavo:edit":function(e){t.exposed||e.preventDefault()}}),this.attribute||this.element._.events({"mouseenter.mavo:preedit":function(i){clearTimeout(e),e=setTimeout(function(){return t.edit()},150)},"mouseleave.mavo:preedit":function(t){clearTimeout(e)}}),this.element._.data.prevTabindex=this.element.getAttribute("tabindex"),this.element.tabIndex=0}}},initEdit:function(){var n=this;if(!this.editor){var r=i.getMatch(this.element,i.editors);r.create&&t.extend(this,r,function(t){return"create"!=t});var a=r.create||r;this.editor=t.create("function"===t.type(a)?a.call(this):a),this.editorValue=this.value,this.editorType="created"}if(t.events(this.editor,{"input change":function(t){n.value=n.editorValue},focus:function(t){n.editor.select&&n.editor.select();
},"mavo:datachange":function(e){"output"===e.property&&(e.stopPropagation(),t.fire(n.editor,"input"))}}),"placeholder"in this.editor&&(this.editor.placeholder="("+this.label+")"),!this.exposed){var s=/^data-input-/i;e(this.element.attributes).forEach(function(t){s.test(t.name)&&this.editor.setAttribute(t.name.replace(s,""),t.value)},this),this.attribute&&(this.popup=new i.Popup(this))}this.popup||this.editor.classList.add("mv-editor"),this.initEdit=null},edit:function(){this.constant||this.editing||(this.element._.unbind(".mavo:preedit"),this.initEdit&&this.initEdit(),this.popup&&this.popup.show(),this.attribute||this.editor.parentNode==this.element||this.exposed||(this.editorValue=this.value,this.element.textContent="",this.exposed||this.element.appendChild(this.editor)),this.view="edit")},clear:function(){this.value=this.emptyValue},render:function(t){Array.isArray(t)&&(t=t[0]),"object"===("undefined"==typeof t?"undefined":_typeof(t))&&(t=t[this.property]),void 0===t?this.value=this.closestCollection?this["default"]:this.templateValue:this.value=t,
this.save()},find:function(t){if(this.property==t)return this},observe:function(){var t=this;this.constant||(this.observer=Mavo.observe(this.element,this.attribute,this.observer||function(e){!t.attribute&&t.mavo.editing||(t.value=t.getValue())}))},unobserve:function(){this.observer&&this.observer.disconnect()},getValue:function(t){return i.getValue(this.element,this.attribute,this.datatype,t)},lazy:{label:function(){return Mavo.readable(this.property)},emptyValue:function(){switch(this.datatype){case"boolean":return!1;case"number":return 0}return""}},setValue:function(e){var n=this,r=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];if(this.unobserve(),"object"==t.type(e)&&"value"in e){var a=e.presentational;e=e.value}return e=e||0===e?e:"",e=i.safeCast(e,this.datatype),e!=this._value||r.force?(this.editor&&document.activeElement!=this.editor&&(this.editorValue=e),this.humanReadable&&this.attribute&&(a=this.humanReadable(e)),this.editing&&!this.attribute||(this.editor&&this.editor.matches("select")&&!this.exposed&&this.editor.selectedOptions[0]&&(a=this.editor.selectedOptions[0].textContent),
i.setValue(this.element,{value:e,presentational:a},this.attribute,this.datatype)),this.empty=""===e,this._value=e,r.silent||(this.saved&&(this.unsavedChanges=this.mavo.unsavedChanges=!0),requestAnimationFrame(function(){t.fire(n.element,"mavo:datachange",{property:n.property,value:e,mavo:n.mavo,node:n,dirty:n.editing,action:"propertychange"})})),"preEdit"==this.view&&this.preEdit(),this.observe(),e):e},live:{value:function(t){return this.setValue(t)},empty:function(e){var i=e&&!this.exposed&&!(this.attribute&&t(Mavo.selectors.property,this.element));this.element.classList.toggle("empty",i)},view:function(t){this.element.classList.toggle("editing","edit"==t)},constant:function(t){this.element.classList.toggle("mv-constant",t)}},"static":{all:new WeakMap,getMatch:function(t,e){var i=null;for(var n in e)t.matches(n)&&(i=e[n]);return i},getValueAttribute:function(e){var n=e.getAttribute("data-attribute")||i.getMatch(e,i.attributes);return n&&n.value&&(n=t.extend(new String(n.value),n)),n&&"null"!==n||(n=null),
n},getDatatype:function(t,e){var n=t.getAttribute("datatype");if(!n)for(var r in i.datatypes)t.matches(r)&&(n=i.datatypes[r][e]);return n=n||"string"},safeCast:function(t,e){var n=("undefined"==typeof t?"undefined":_typeof(t),i.cast(t,e));return null===t||void 0===t?t:"boolean"==e?"false"!==t&&0!==t&&""!==t&&("true"===t||t>0||t):"number"==e?/^[-+]?[0-9.e]+$/i.test(t+"")?n:t:n},cast:function(t,e){switch(e){case"number":return+t;case"boolean":return!!t;case"string":return t+""}return t},getValue:function(t,e,n){arguments.length<=3||void 0===arguments[3]?{}:arguments[3];e=e||null===e?e:i.getValueAttribute(t),n=n||i.getDatatype(t,e);var r;return r=e in t&&i.useProperty(t,e)?t[e]:e?t.getAttribute(e):t.getAttribute("content")||t.textContent||null,i.safeCast(r,n)},setValue:function(e,n,r,a){if("object"==t.type(n)&&"value"in n){var s=n.presentational;n=n.value}if(null!==r&&(r=r||i.getValueAttribute(e)),r in e&&i.useProperty(e,r)&&e[r]!=n)try{e[r]=n}catch(o){}r?e.getAttribute(r)!=n&&(e.setAttribute(r,n),
s&&(e.textContent=s)):("number"!==a||s||(s=i.formatNumber(n)),e.textContent=s||n,s&&e.setAttribute&&e.setAttribute("content",n))},useProperty:function(t,e){return!(["href","src"].indexOf(e)>-1)&&"http://www.w3.org/2000/svg"!=t.namespaceURI},register:function(t){var e=arguments.length<=1||void 0===arguments[1]?{}:arguments[1];e.attribute&&(Mavo.Primitive.attributes[t]=e.attribute),e.datatype&&(Mavo.Primitive.datatypes[t]=e.datatype),e.editor&&(Mavo.Primitive.editors[t]=e.editor),e.init&&Mavo.hooks.add("primitive-init-start",function(){this.element.matches(t)&&e.init.call(this,this.element)});var i=!0,n=!1,r=void 0;try{for(var a,s=Mavo.toArray(e.is)[Symbol.iterator]();!(i=(a=s.next()).done);i=!0){var o=a.value;Mavo.selectors[o]+=", "+t}}catch(u){n=!0,r=u}finally{try{!i&&s["return"]&&s["return"]()}finally{if(n)throw r}}},lazy:{formatNumber:function(){var t=new Intl.NumberFormat("en-US",{maximumFractionDigits:2});return function(e){return e===1/0||e===-(1/0)?e<0?"-∞":"∞":t.format(e)}}}}});i.attributes={
