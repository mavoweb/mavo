...
"use strict";function _toConsumableArray(e){if(Array.isArray(e)){for(var t=0,i=Array(e.length);t<e.length;t++)i[t]=e[t];return i}return Array.from(e)}!function(e){var t=Mavo.Expression.Text=e.Class({constructor:function(){var i=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];this.template=i.template&&i.template.template||i.template;for(var s=["group","path","syntax","fallback","attribute"],n=0;n<s.length;n++){var r=s[n];this[r]=void 0===i[r]&&this.template?this.template[r]:i[r]}if(this.node=i.node,this.node||(this.node=this.path.reduce(function(e,t){return e.childNodes[t]},this.group.element)),this.element=this.node,this.attribute=this.attribute||null,Mavo.hooks.run("expressiontext-init-start",this),!this.expression){if(3===this.node.nodeType&&(this.element=this.node.parentNode,this.node.parentNode.children.length&&!this.attribute||(this.node=this.element,this.element.normalize())),this.attribute)this.expression=this.node.getAttribute(this.attribute).trim();else{if(this.node.normalize(),
this.node.firstChild&&1===this.node.childNodes.length&&3===this.node.firstChild.nodeType){var a=this.node.firstChild.textContent.match(/^\s*|\s*$/g);a[1]&&(this.node.firstChild.splitText(this.node.firstChild.textContent.length-a[1].length),e.after(this.node.lastChild,this.node)),a[0]&&(this.node.firstChild.splitText(a[0].length),this.node.parentNode.insertBefore(this.node.firstChild,this.node))}this.expression=this.node.textContent}this.parsed=i.template?i.template.parsed:this.syntax.tokenize(this.expression)}Mavo.hooks.run("expressiontext-init-end",this),t.elements.set(this.element,[].concat(_toConsumableArray(t.elements.get(this.element)||[]),[this]))},dependsOn:function(){var e=!0,t=!1,i=void 0;try{for(var s,n=this.parsed[Symbol.iterator]();!(e=(s=n.next()).done);e=!0){s.value}}catch(r){t=!0,i=r}finally{try{!e&&n["return"]&&n["return"]()}finally{if(t)throw i}}},update:function(){var e=this,t=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0],i=arguments[1];this.data=t;var s={};
Mavo.hooks.run("expressiontext-update-start",this),"[if(absolute, uppercase(type), type)] [arcFlags] [x] [y]"==this.expression&&console.log(t,this.element.getAttribute("content"),this.group.element),s.value=this.value=this.parsed.map(function(s){if(s instanceof Mavo.Expression){if(s.changedBy(i)){var n={context:e,expr:s};return Mavo.hooks.run("expressiontext-update-beforeeval",n),n.value=n.expr.eval(t),Mavo.hooks.run("expressiontext-update-aftereval",n),n.value instanceof Error?void 0!==e.fallback?e.fallback:n.expr.expression:void 0===n.value||null===n.value?"":n.value}return s.value}return s}),this.attribute||(s.presentational=this.value.map(function(e){return Array.isArray(e)?e.join(", "):"number"==typeof e?Mavo.Primitive.formatNumber(e):e}),s.presentational=1===s.presentational.length?s.presentational[0]:s.presentational.join("")),s.value=1===s.value.length?s.value[0]:s.value.join(""),this.primitive&&1===this.parsed.length&&("number"==typeof s.value?this.primitive.datatype="number":"boolean"==typeof s.value&&(this.primitive.datatype="boolean")),
...
return e.update(t)})},update:function(t){if(this.active&&!this.group.isDeleted()&&this.all.length+this.dependents.size!==0){var e={context:this,data:this.group.getRelativeData()};Mavo.hooks.run("expressions-update-start",e);var i=!0,n=!1,r=void 0;try{for(var s,o=this.all[Symbol.iterator]();!(i=(s=o.next()).done);i=!0){var a=s.value;a.update(e.data,t)}}catch(u){n=!0,r=u}finally{try{!i&&o["return"]&&o["return"]()}finally{if(n)throw r}}var v=!0,l=!1,h=void 0;try{for(var p,d=this.dependents[Symbol.iterator]();!(v=(p=d.next()).done);v=!0){var f=p.value;f.update()}}catch(u){l=!0,h=u}finally{try{!v&&d["return"]&&d["return"]()}finally{if(l)throw h}}}},extract:function(t,e,n,r){e&&"mv-expressions"==e.name||(e&&i.directives.indexOf(e.name)>-1||r.test(e?e.value:t.textContent))&&this.all.push(new Mavo.Expression.Text({node:t,syntax:r,path:n?n.slice(1).split("/").map(function(t){return+t}):[],attribute:e&&e.name,group:this.group}))},traverse:function(t){var i=this,n=arguments.length<=1||void 0===arguments[1]?"":arguments[1],r=arguments[2];
