...
specificProperty:function(t){return"[property="+t+"], [itemprop="+t+"]"},scope:"[typeof], [itemscope], [itemtype], .mv-group",multiple:"[multiple], [data-multiple], .multiple",required:"[required], [data-required], .required",formControl:"input, select, option, textarea",computed:".computed",item:".mv-item",ui:".mv-ui",option:function(t){return"["+t+"], [data-"+t+"], [data-mv-options~='"+t+"'], ."+t},container:{li:"ul, ol",tr:"table",option:"select",dt:"dl",dd:"dl"},documentFragment:".document-fragment"},i=e.arr=function(t){return t.split(/\s*,\s*/g)},s=e.not=function(t){return i(t).map(function(t){return":not("+t+")"}).join("")},n=e.or=function(t,e){return t+", "+e},o=e.and=function(t,e){var r=[],s=i(e);return i(t).forEach(function(t){return r.push.apply(r,_toConsumableArray(s.map(function(e){return t+e})))}),r.join(", ")},a=e.andNot=function(t,e){return o(t,s(e))};t.extend(r.selectors,{primitive:a(e.property,e.scope),rootScope:a(e.scope,e.property),output:n(e.specificProperty("output"),".output, .value"),
autoMultiple:o("li, tr, option",":only-of-type")})}(),Promise.all([t.ready(),t.include(Array.from&&window.Intl&&document.documentElement.closest,"https://cdn.polyfill.io/v2/polyfill.min.js?features=blissfuljs,Intl.~locale.en")])["catch"](function(t){return console.error(t)}).then(function(){return Mavo.init()}),Stretchy.selectors.filter=".mv-editor:not([property])"}(Bliss,Bliss.$);
