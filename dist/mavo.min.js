...
"use strict";!function(e,t){Mavo.attributes.push("mv-multiple","mv-order");Mavo.Collection=e.Class({"extends":Mavo.Node,nodeType:"Collection",constructor:function(e,n,i){if(this.templateElement=this.element,this.children=[],this.fromTemplate("properties","mutable","templateElement")||(this.properties=t(Mavo.selectors.property,this.templateElement).map(Mavo.Node.getProperty),this.mutable=this.templateElement.matches(Mavo.selectors.multiple),this.templateElement=this.templateElement.cloneNode(!0)),this.mutable){var o=this.createItem(this.element);this.add(o),this.itemTemplate=o.template||o}Mavo.hooks.run("collection-init-end",this)},get length(){return this.children.length},get containsTemplate(){return this.children.length&&this.children[0].element===this.element},getData:function(){var e=arguments.length<=0||void 0===arguments[0]?{}:arguments[0],t={context:this,options:e,data:[]},n=!0,i=!1,o=void 0;try{for(var r,a=this.children[Symbol.iterator]();!(n=(r=a.next()).done);n=!0)if(item=r.value,
!item.deleted){var s=item.getData(t.options);s&&t.data.push(s)}}catch(l){i=!0,o=l}finally{try{!n&&a["return"]&&a["return"]()}finally{if(i)throw o}}return this.unhandled&&t.options.unhandled&&(t.data=this.unhandled.before.concat(t.data,this.unhandled.after)),this.mutable||1!=t.data.length||(t.data=t.data[0]),Mavo.hooks.run("collection-getdata-end",t),t.data},createItem:function(e){e||(e=this.templateElement.cloneNode(!0));var t=Mavo.Node.create(e,this.mavo,{collection:this,template:this.itemTemplate||(this.template?this.template.itemTemplate:null),property:this.property,type:this.type});return t},add:function(e,t){var n=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];if(e=e instanceof Node?Mavo.Node.get(e)||this.createItem(e):e||this.createItem(),t in this.children?this.bottomUp&&t++:t=this.bottomUp?0:this.length,!e.element.parentNode){var i=this.children[t];e.element._.before(i&&i.element||this.marker)}this.children.splice(t,0,e);for(var o=t-1;o<this.length;o++){var r=this.children[o];
r&&(r.index=o,n.silent||r.element._.fire("mavo:datachange",{node:this,mavo:this.mavo,action:"add",item:r}))}return n.silent||(this.unsavedChanges=e.unsavedChanges=this.mavo.unsavedChanges=!0),e},"delete":function(t,n){var i=this;return n?(e.remove(t.element),void this.children.splice(this.children.indexOf(t),1)):e.transition(t.element,{opacity:0}).then(function(){t.deleted=!0,t.element.style.opacity="",t.element._.fire("mavo:datachange",{node:i,mavo:i.mavo,action:"delete",item:t}),i.unsavedChanges=t.unsavedChanges=i.mavo.unsavedChanges=!0})},edit:function(){if(this["super"].edit.call(this),this.mutable&&!this.addButton.parentNode)if(this.bottomUp)this.addButton._.before(e.value(this.children[0],"element")||this.marker);else{var t=this.element.tagName.toLowerCase(),n=Mavo.selectors.container[t];if(n)var i=this.marker.closest(n);this.addButton._.after(i&&i.parentNode?i:this.marker)}},done:function(){this["super"].done.call(this),this.mutable&&this.addButton.parentNode&&this.addButton.remove();
},clear:function(){this.mutable&&(this.propagate(function(e){if(e.element.remove)e.element.remove();else{var t=!0,n=!1,i=void 0;try{for(var o,r=e.element.childNodes[Symbol.iterator]();!(t=(o=r.next()).done);t=!0){o.value}}catch(a){n=!0,i=a}finally{try{!t&&r["return"]&&r["return"]()}finally{if(n)throw i}}}}),this.children=[],this.marker._.fire("mavo:datachange",{node:this,mavo:this.mavo,action:"clear"}))},save:function(){var e=!0,t=!1,n=void 0;try{for(var i,o=this.children[Symbol.iterator]();!(e=(i=o.next()).done);e=!0){var r=i.value;r.deleted?this["delete"](r,!0):r.unsavedChanges=!1}}catch(a){t=!0,n=a}finally{try{!e&&o["return"]&&o["return"]()}finally{if(t)throw n}}},propagated:["save"],revert:function(){var e=!0,t=!1,n=void 0;try{for(var i,o=this.children[Symbol.iterator]();!(e=(i=o.next()).done);e=!0){var r=i.value;r.unsavedChanges?this["delete"](r,!0):(r.deleted&&(r.deleted=!1),r.revert())}}catch(a){t=!0,n=a}finally{try{!e&&o["return"]&&o["return"]()}finally{if(t)throw n}}},render:function(e){
