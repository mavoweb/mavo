...
},"mouseleave blur":function(t){return s.wrapper.classList.remove("save-hovered")}},inside:s.ui.bar}),s.ui.revert=t.create("button",{className:"revert",textContent:"Revert",disabled:!0,events:{click:function(t){return s.revert()},"mouseenter focus":function(t){s.unsavedChanges||(s.wrapper.classList.add("revert-hovered"),s.setUnsavedChanges())},"mouseleave blur":function(t){return s.wrapper.classList.remove("revert-hovered")}},inside:s.ui.bar})},function(){t.remove([s.ui.save,s.ui.revert]),s.ui.save=s.ui.revert=null}),this.permissions.can("delete",function(){s.ui.clear=t.create("button",{className:"clear",textContent:"Clear",onclick:function(t){return s.clear()}}),s.ui.bar.appendChild(s.ui.clear)}),this.permissions.cannot(["delete","edit"],function(){t.remove(s.ui.clear)}),this.storage||this.source?this.permissions.can("read",function(){return s.load()}):(this.permissions.on(["read","edit"]),t.fire(this.wrapper,"mavo:load")),this.needsEdit||this.permissions.off(["edit","add","delete"]),Mavo.hooks.run("init-end",this);
},get data(){return this.getData()},getData:function(t){return this.root.getData(t)},toJSON:function(){var t=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0];return r.toJSON(t)},render:function(t){r.hooks.run("render-start",{context:this,data:t}),t&&(this.editing?(this.done(),this.root.render(t),this.edit()):this.root.render(t)),this.unsavedChanges=!1},clear:function(){confirm("This will delete all your data. Are you sure?")&&(this.store(null),this.root.clear())},edit:function(){this.editing=!0,this.root.edit(),t.events(this.wrapper,"mouseenter.mavo:edit mouseleave.mavo:edit",function(t){if(t.target.matches(".mv-item-controls .delete")){var e=t.target.closest(r.selectors.item);e.classList.toggle("delete-hover","mouseenter"==t.type)}if(t.target.matches(r.selectors.item)){t.target.classList.remove("has-hovered-item");var i=t.target.parentNode.closest(r.selectors.item);i&&i.classList.toggle("has-hovered-item","mouseenter"==t.type)}},!0),this.setUnsavedChanges()},setUnsavedChanges:function(t){
var e=!!t;return t||this.walk(function(r){if(r.unsavedChanges)return e=!0,t===!1&&(r.unsavedChanges=!1),!1}),this.unsavedChanges=e},done:function(){this.root.done(),t.unbind(this.wrapper,".mavo:edit"),this.editing=!1,this.unsavedChanges=!1},load:function(){var e=this;this.inProgress="Loading";var r=this.storage||this.source;return r.ready.then(function(){return r.get()})["catch"](function(t){return e.source&&r!==e.source?e.source.ready.then(function(){return e.source.get()}):Promise.reject(t)}).then(function(r){r&&"string"==t.type(r)&&(r=JSON.parse(r)),e.render(r)})["catch"](function(t){t&&(t.xhr&&404==t.xhr.status?e.render(""):(console.error(t),console.log(t.stack)))}).then(function(){e.inProgress=!1,t.fire(e.wrapper,"mavo:load")})},store:function(){var e=this;this.storage&&(this.inProgress="Saving",this.storage.login().then(function(){return e.storage.put()}).then(function(r){t.fire(e.wrapper,"mavo:save",{data:r.data,dataString:r.dataString})})["catch"](function(t){t&&(console.error(t),
console.log(t.stack))}).then(function(){e.inProgress=!1}))},save:function(){this.root.save(),this.store(),this.unsavedChanges=!1},revert:function(){this.root.revert()},walk:function(t){this.root.walk(t)},live:{inProgress:function(e){t.toggleAttribute(this.wrapper,"data-mv-progress",e,e)},editing:{set:function(t){this.wrapper.classList.toggle("editing",t),t?this.wrapper.setAttribute("data-editing",""):this.wrapper.removeAttribute("data-editing")}},unsavedChanges:function(t){this.wrapper.classList.toggle("unsaved-changes",t),this.ui&&this.ui.save&&(this.ui.save.disabled=!t,this.ui.revert.disabled=!t)},needsEdit:function(e){t.toggleAttribute(this.ui.bar,"hidden","",!e)}},"static":{all:[],superKey:0===navigator.platform.indexOf("Mac")?"metaKey":"ctrlKey",init:function(t){return e(r.selectors.init,t||document).filter(function(t){return!t.parentNode.closest(r.selectors.init)}).map(function(t){return new r(t)})},hooks:new t.Hooks}});!function(){var e=r.selectors={init:".mavo, [mavo], [data-mavo], [data-store]",
property:"[property], [itemprop]",specificProperty:function(t){return"[property="+t+"], [itemprop="+t+"]"},group:"[typeof], [itemscope], [itemtype], .mv-group",multiple:"[multiple], [data-multiple], .multiple",required:"[required], [data-required], .required",formControl:"input, select, option, textarea",item:".mv-item",ui:".mv-ui",option:function(t){return"["+t+"], [data-"+t+"], ."+t},container:{li:"ul, ol",tr:"table",option:"select",dt:"dl",dd:"dl"}},i=e.arr=function(t){return t.split(/\s*,\s*/g)},s=e.not=function(t){return i(t).map(function(t){return":not("+t+")"}).join("")},n=e.or=function(t,e){return t+", "+e},o=e.and=function(t,e){var r=[],s=i(e);return i(t).forEach(function(t){return r.push.apply(r,_toConsumableArray(s.map(function(e){return t+e})))}),r.join(", ")},a=e.andNot=function(t,e){return o(t,s(e))};t.extend(r.selectors,{primitive:a(e.property,e.group),rootGroup:a(e.group,e.property),output:n(e.specificProperty("output"),".output, .value"),autoMultiple:o("li, tr, option",":only-of-type")
...
return n.toArray(t).concat(n.flatten(e))},[]):[t]},is:function(t,e){return e.matches&&e.matches(n.selectors[t])},has:function(t,e){return e.matches&&e.matches(n.selectors.option(t))},urlParam:function(){for(var t=("searchParams"in URL.prototype?new URL(location).searchParams:null),e=null,r=arguments.length,n=Array(r),a=0;a<r;a++)n[a]=arguments[a];var o=!0,i=!1,u=void 0;try{for(var c,s=n[Symbol.iterator]();!(o=(c=s.next()).done);o=!0){var l=c.value;if(t)e=t.get(l);else{var f=location.search.match(RegExp("[?&]"+l+"(?:=([^&]+))?(?=&|$)","i"));e=f&&(f[1]||"")}if(null!==e)return e}}catch(d){i=!0,u=d}finally{try{!o&&s["return"]&&s["return"]()}finally{if(i)throw u}}return null},escapeRegExp:function(t){return t.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")}});t.add("toggleAttribute",function(t,e){var r=arguments.length<=2||void 0===arguments[2]?null!==e:arguments[2];r?this.setAttribute(t,e):this.removeAttribute(t)}),t.proxy=t.classProps.proxy=t.overload(function(t,e,r){return Object.defineProperty(t,e,{
get:function(){return this[r][e]},set:function(t){this[r][e]=t},configurable:!0,enumerable:!0}),t}),t.classProps.propagated=function(t,e){Mavo.toArray(e).forEach(function(e){var r=t[e];t[e]=function(){var t=r&&r.apply(this,arguments);this.propagate&&t!==!1&&this.propagate(e)}})},document.addEventListener("focus",function(t){r("focus",t.target)},!0),document.addEventListener("blur",function(t){r("focus",null)},!0),addEventListener("hashchange",function(e){r("target",t(location.hash))},!0),r("target",t(location.hash)),r("focus",document.activeElement!==document.body?document.activeElement:null)}(Bliss,Bliss.$);
...
"use strict";function _toConsumableArray(t){if(Array.isArray(t)){for(var r=0,e=Array(t.length);r<t.length;r++)e[r]=t[r];return e}return Array.from(t)}!function(t,r){var e=Mavo.Node=t.Class({"abstract":!0,constructor:function(t,r){var o=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];if(!t||!r)throw new Error("Mavo.Node constructor requires an element argument and a mavo object");this.element=t,this.template=o.template,this.template?this.template.copies.push(this):this.copies=[],this.mavo=r,this.fromTemplate("property","type")||(this.property=e.getProperty(t),this.type=Mavo.Group.normalize(t)),this.group=this.parentGroup=o.group,Mavo.hooks.run("node-init-end",this)},get isRoot(){return!this.property},get name(){return Mavo.readable(this.property||this.type).toLowerCase()},get data(){return this.getData()},walk:function(t){var r=function e(r){var o=t(r);o!==!1&&r.propagate&&r.propagate(e)};r(this)},walkUp:function(t){for(var r=this;r=r.parentGroup;){var e=t(r);if(void 0!==e)return e;
}},call:function(t){for(var r=arguments.length,e=Array(r>1?r-1:0),o=1;o<r;o++)e[o-1]=arguments[o];return e=e||[],"string"==typeof t?this[t].apply(this,_toConsumableArray(e)):t.apply(this,[this].concat(_toConsumableArray(e)))},edit:function(){this.propagate(function(t){return t[t.preEdit?"preEdit":"edit"]()})},propagated:["save","revert","done","import"],toJSON:Mavo.prototype.toJSON,fromTemplate:function(){if(this.template){for(var t=arguments.length,r=Array(t),e=0;e<t;e++)r[e]=arguments[e];var o=!0,a=!1,i=void 0;try{for(var n,p=r[Symbol.iterator]();!(o=(n=p.next()).done);o=!0){var s=n.value;this[s]=this.template[s]}}catch(u){a=!0,i=u}finally{try{!o&&p["return"]&&p["return"]()}finally{if(a)throw i}}}return!!this.template},"static":{create:function(t,r){var e,o=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];return Mavo.is("multiple",t)&&!o.collection?new Mavo.Collection(t,r,o):(e=Mavo.Unit).create.apply(e,arguments)},getProperty:function(t){var r=t.getAttribute("property")||t.getAttribute("itemprop");
return!r&&t.hasAttribute("property")&&(r=t.name||t.id||t.classList[0]),r&&t.setAttribute("property",r),r}}})}(Bliss,Bliss.$);
"use strict";!function(t,e){Mavo.Unit=t.Class({"abstract":!0,"extends":Mavo.Node,constructor:function(t,e){var n=arguments.length<=2||void 0===arguments[2]?{}:arguments[2];this.constructor.all.set(this.element,this),this.collection=n.collection,this.dirty=n.dirty,this.collection&&(this.group=this.parentGroup=this.collection.parentGroup),this.fromTemplate("required","store")||(this.required=Mavo.is("required",this.element),this.store=this.element.getAttribute("data-store")),Mavo.hooks.run("unit-init-end",this)},get saved(){return"none"!==this.store},isDeleted:function(){this.deleted;return!!this.deleted||!!this.parentGroup&&this.parentGroup.isDeleted()},getData:function(t){t=t||{};var e=function(e){return e.dirty&&!t.dirty||e.deleted&&t.dirty||!e.saved&&"*"!=t.store};return e(this)?null:void this.walkUp(function(t){if(e(t))return null})},lazy:{closestCollection:function(){return this.collection||this.group.collection||(this.parentGroup?this.parentGroup.closestCollection:null)}},live:{store:function(e){
...
return void 0!==i?i:(i={},this.propagate(function(t){if((t.saved||"*"==!e.store)&&!(t.property in i)){var r=t.getData(e);(null!==r||e["null"])&&(i[t.property]=r)}}),e.dirty&&!e.unhandled||t.extend(i,this.unhandled),this.type&&this.type!=r.DEFAULT_TYPE&&(i["@type"]=this.type),this.vocab&&(i["@context"]=this.vocab),this.properties.summary&&(i.toString=function(){return this.summary}),i)},find:function(t){if(this.property==t)return this;if(t in this.properties)return this.properties[t].find(t);for(var e in this.properties){var r=this.properties[e].find(t);if(void 0!==r)return r}},propagate:function(e){var r=arguments;t.each(this.properties,function(t,e){e.call.apply(e,r)})},save:function(){this.unsavedChanges=!1},done:function(){t.unbind(this.element,".mavo:edit")},propagated:["save","done","import","clear"],render:function(e){var r=this;e&&(Mavo.hooks.run("group-render-start",this),e=Array.isArray(e)?e[0]:e,this.unhandled=t.extend({},e,function(t){return!(t in r.properties)}),this.propagate(function(t){
...
"use strict";var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol?"symbol":typeof t};!function(t,e){var i=Mavo.Primitive=t.Class({"extends":Mavo.Unit,constructor:function(n,a,s){var r=this;if(this.fromTemplate("attribute","datatype","humanReadable","templateValue","constant")||(this.attribute=i.getValueAttribute(this.element),this.attribute&&(this.humanReadable=this.attribute.humanReadable),this.datatype=i.getDatatype(this.element,this.attribute),this.constant=this.element.classList.contains("mv-constant")),this.view="read",Mavo.hooks.run("primitive-init-start",this),Mavo.is("formControl",this.element)?(this.editor=this.element,this.editorType="exposed",this.edit()):this.needsEdit&&(this.mavo.needsEdit=!0),this.editor||this.attribute||(this.editor=e(this.element.children).filter(function(t){return t.matches(Mavo.selectors.formControl)&&!t.matches(Mavo.selectors.property);
})[0],this.editor&&(this.editorType="nested",this.element.textContent=this.editorValue,t.remove(this.editor))),!this.editor&&this.element.hasAttribute("data-edit")){this.editorType="linked";var o=t(this.element.getAttribute("data-edit"));o&&Mavo.is("formControl",o)&&(this.editor=o.cloneNode(!0),this.template||Mavo.observe(o,"all",function(t){var e=!0,i=!1,n=void 0;try{for(var a,s=r.copies[Symbol.iterator]();!(e=(a=s.next()).done);e=!0){var u=a.value;u.editor=o.cloneNode(!0),u.setValue(u.value,{force:!0,silent:!0})}}catch(h){i=!0,n=h}finally{try{!e&&s["return"]&&s["return"]()}finally{if(i)throw n}}}))}if(this.templateValue=this.getValue(),this["default"]=this.element.getAttribute("data-default"),this.constant||""===this["default"]?this["default"]=this.templateValue:null===this["default"]?this["default"]=this.editor?this.editorValue:this.emptyValue:Mavo.observe(this.element,"data-default",function(t){r["default"]=r.element.getAttribute("data-default")}),this.collection){var u=function(e){
r.unobserve();var i=t.remove(t(".mv-item-controls",r.element)),n=e();return t.inside(i,r.element),r.observe(),n};["textContent","innerHTML"].forEach(function(t){var e=Object.getOwnPropertyDescriptor(Node.prototype,t);Object.defineProperty(r.element,t,{get:function(){var t=this;return u(function(){return e.get.call(t)})},set:function(t){var i=this;u(function(){return e.set.call(i,t)})}})})}this.needsEdit&&this.setValue(this.templateValue,{silent:!0}),this.setValue(this.template?this["default"]:this.templateValue,{silent:!0}),this.observe()},get editing(){return"edit"==this.view},get editorValue(){if(this.getEditorValue){var e=this.getEditorValue();if(void 0!==e)return e}if(this.editor){if(this.editor.matches(Mavo.selectors.formControl))return i.getValue(this.editor,void 0,this.datatype);var n=t(Mavo.selectors.output+", "+Mavo.selectors.formControl,this.editor);if(n)return i.all.has(n)?i.all.get(n).value:i.getValue(n)}},set editorValue(e){if((!this.setEditorValue||void 0===this.setEditorValue(e))&&this.editor)if(this.editor.matches(Mavo.selectors.formControl))i.setValue(this.editor,e);else{
