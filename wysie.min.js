...
return Object.defineProperty(e,t,{get:function(){return this[i][t]},configurable:!0,enumerable:!0}),e}),e.classProps.propagated=function(e,t){Wysie.toArray(t).forEach(function(t){var i=e[t];e[t]=function(){var e=i&&i.apply(this,arguments);this.propagate&&e!==!1&&this.propagate(t)}})},document.addEventListener("focus",function(e){t(".focus-within").forEach(function(e){return e.classList.remove("focus-within")});for(var i=e.target;i=i.parentNode;)i.classList&&i.classList.add("focus-within")},!0),e.ready().then(function(e){t("[data-store]").forEach(function(e){new Wysie(e)})}),Stretchy.selectors.filter=".wysie-editor:not([property])"}(Bliss,Bliss.$),function(e){var t=Wysie.Permissions=e.Class({constructor:function(e,t){this.triggers=[],this.wysie=t,this.set(e)},set:function(e){for(var t in e)this[t]=e[t]},on:function(e){var t=this;return Wysie.toArray(e).forEach(function(e){return t[e]=!0}),this},off:function(e){var t=this;return e=Array.isArray(e)?e:[e],e.forEach(function(e){return t[e]=!1;
...
var t=this.items.filter(function(e){return!e.deleted});if(this.property==e)return t;if(this.properties.indexOf(e)>-1){var i=t.map(function(t){return t.find(e)});return Wysie.flatten(i)}},live:{mutable:function(t){if(t&&t!==this.mutable){if(this.wysie.needsEdit=!0,this.required=this.template.matches(Wysie.selectors.required),this.marker=e.create("div",{hidden:!0,className:"wysie-marker",after:this.template}),this.template.classList.add("wysie-item"),this.template.remove(),!this.addButton.parentNode)if(this.bottomUp)this.addButton._.before(e.value(this.items[0],"element")||this.marker);else{var i=this.element.tagName.toLowerCase(),n=Wysie.selectors.container[i];if(n)var r=this.marker.closest(n);this.addButton._.after(r&&r.parentNode?r:this.marker)}this.template=this.element.cloneNode(!0)}}},lazy:{bottomUp:function(){return this.mutable?this.template.hasAttribute("data-bottomup")?!0:this.addButton.parentNode?!!(this.addButton.compareDocumentPosition(this.template)&Node.DOCUMENT_POSITION_FOLLOWING):!1:!1;
