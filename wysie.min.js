...
events:{click:function(e){return r.revert()},"mouseenter focus":function(e){r.everSaved&&(r.wrapper.classList.add("revert-hovered"),r.unsavedChanges=r.calculateUnsavedChanges())},"mouseleave blur":function(e){return r.wrapper.classList.remove("revert-hovered")}}}),r.ui.editButtons=[r.ui.edit,r.ui.save,r.ui.revert],e.contents(r.ui.bar,r.ui.editButtons),r.autoEdit&&requestAnimationFrame(function(){return r.ui.edit.click()})},function(){e.remove(r.ui.editButtons)}),this.permissions.can(["delete"],function(){r.ui.clear=e.create("button",{className:"clear",textContent:"Clear",onclick:function(e){return r.clear()}}),r.ui.editButtons.push(r.ui.clear),r.ui.bar.appendChild(r.ui.clear)},function(){e.remove(r.ui.clear)}),this.store?(this.storage=new i.Storage(this),this.permissions.can("read",function(){return r.storage.load()})):(this.permissions.on(["read","edit"]),this.root["import"](),e.fire(this.wrapper,"wysie:load")),this.needsEdit||this.permissions.off(["edit","add","delete"]),Wysie.hooks.run("init-end",this);
},get data(){return this.getData()},getData:function(e){return this.root.getData(e)},toJSON:function(){var e=arguments.length<=0||void 0===arguments[0]?this.data:arguments[0];return i.toJSON(e)},render:function(e){i.hooks.run("render-start",{context:this,data:e}),e?(this.everSaved=!0,this.root.render(e.data||e)):this.root["import"](),this.unsavedChanges=!1},clear:function(){confirm("This will delete all your data. Are you sure?")&&(this.storage&&this.storage.clear(),this.root.clear())},edit:function(){this.editing=!0,this.root.edit(),e.events(this.wrapper,"mouseenter.wysie:edit mouseleave.wysie:edit",function(e){if(e.target.matches(".wysie-item-controls .delete")){var t=e.target.closest(i.selectors.item);t.classList.toggle("delete-hover","mouseenter"==e.type)}if(e.target.matches(i.selectors.item)){e.target.classList.remove("has-hovered-item");var n=e.target.parentNode.closest(i.selectors.item);n&&n.classList.toggle("has-hovered-item","mouseenter"==e.type)}},!0),this.unsavedChanges=this.calculateUnsavedChanges();
},calculateUnsavedChanges:function(){var e=!1;return this.walk(function(t){return t.unsavedChanges?(e=!0,!1):void 0}),e},done:function(){this.root.done(),e.unbind(this.wrapper,".wysie:edit"),this.editing=!1,this.unsavedChanges=!1},save:function(){this.root.save(),this.storage&&this.storage.save(),this.everSaved=!0,this.unsavedChanges=!1},revert:function(){this.root.revert()},walk:function(e){this.root.walk(e)},live:{editing:{set:function(e){this.wrapper.classList.toggle("editing",e),e?this.wrapper.setAttribute("data-editing",""):this.wrapper.removeAttribute("data-editing")}},unsavedChanges:function(e){this.wrapper.classList.toggle("unsaved-changes",e),this.ui&&this.ui.save&&(this.ui.save.disabled=!e,this.ui.revert.disabled=!this.everSaved||!e)},everSaved:function(e){this.ui&&this.ui.revert&&(this.ui.revert.disabled=!e)}},"static":{all:[],toJSON:function(e){return null===e?"":"string"==typeof e?e:JSON.stringify(e,null,"	")},readable:function(e){return e&&e.replace(/([a-z])([A-Z])(?=[a-z])/g,function(e,t,i){
