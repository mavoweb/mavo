...
if(n)var r=this.marker.closest(n);this.addButton._.after(r||this.marker)}this.template=this.element.cloneNode(!0)}}},lazy:{bottomUp:function(){return this.mutable?this.template.hasAttribute("data-bottomup")?!0:this.addButton.parentNode?!!(this.addButton.compareDocumentPosition(this.template)&Node.DOCUMENT_POSITION_FOLLOWING):!1:!1},closestCollection:function(){var e=this.marker?this.marker.parentNode:this.template.parentNode;return e.closest(Wysie.selectors.item)},addButton:function(){var i=this,n="button.add-"+this.property,r=this.closestCollection||this.marker.closest(Wysie.selectors.scope);if(r)var s=t(n,r).filter(function(e){return!i.template.contains(e)})[0];return s||(s=e.create("button",{className:"add",textContent:"Add "+this.name})),s.classList.add("wysie-ui","wysie-add"),this.property&&s.classList.add("add-"+this.property),s.addEventListener("click",function(e){e.preventDefault(),i.add().edit()}),s}}})}(Bliss,Bliss.$);var prettyPrint=function(){var e={txt:function(e){return e+="",
document.createTextNode(e)},row:function(t,i,n){n=n||"td";var r,s=e.count(t,null)+1,o=$.create("tr"),a={colSpan:s};return $$(t).forEach(function(t){null!==t&&(r=$.create(n,a),t.nodeType?r.appendChild(t):r.innerHTML=e.shorten(t.toString()),o.appendChild(r))}),o},hRow:function(t,i){return e.row(t,i,"th")},table:function(t,i){t=t||[];var n=$.create("table"),r=$.create("thead"),s=$.create("tbody");return n.classList.add(i),t.length&&(n.appendChild(r),r.appendChild(e.hRow(t,i))),n.appendChild(s),{node:n,tbody:s,thead:r,appendChild:function(e){this.tbody.appendChild(e)},addRow:function(t,n,r){return this.appendChild(e.row(t,n||i,r)),this}}},shorten:function(e){var t=40;return e=e.replace(/^\s\s*|\s\s*$|\n/g,""),e.length>t?e.substring(0,t-1)+"...":e},htmlentities:function(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")},count:function i(e,t){for(var i=0,n=0,r=e.length;r>n;n++)e[n]===t&&i++;return i},thead:function(e){return e.getElementsByTagName("thead")[0]},within:function(e){
return{is:function(t){for(var i in e)if(e[i]===t)return i;return""}}},common:{circRef:function(i,n,r){return e.expander("[POINTS BACK TO <strong>"+n+"</strong>]","Click to show this item anyway",function(){this.parentNode.appendChild(t(i,{maxDepth:1}))})},depthReached:function(i,n){return e.expander("[DEPTH REACHED]","Click to show this item anyway",function(){try{this.parentNode.appendChild(t(i,{maxDepth:1}))}catch(n){this.parentNode.appendChild(e.table(["ERROR OCCURED DURING OBJECT RETRIEVAL"],"error").addRow([n.message]).node)}})}},expander:function(t,i,n){return $.create("a",{innerHTML:e.shorten(t)+' <b style="visibility:hidden;">[+]</b>',title:i,onmouseover:function(){this.getElementsByTagName("b")[0].style.visibility="visible"},onmouseout:function(){this.getElementsByTagName("b")[0].style.visibility="hidden"},onclick:function(){return this.style.display="none",n.call(this),!1},style:{cursor:"pointer"}})}},t=function n(t,i){i=i||{};var r=$.extend({},n.config,i),s=$.create("div"),o=(n.config,
