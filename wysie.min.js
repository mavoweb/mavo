...
t()})})},Class:function s(e){var t=["constructor","extends","abstract","static"].concat(Object.keys(i.classProps)),n=e.hasOwnProperty("constructor")?e.constructor:i.noop,s=function a(){if(e["abstract"]&&this.constructor===a)throw new Error("Abstract classes cannot be directly instantiated.");a["super"]&&a["super"].apply(this,arguments),n.apply(this,arguments)};s["super"]=e["extends"]||null,s.prototype=i.extend(Object.create(s["super"]?s["super"].prototype:Object),{constructor:s});var r=function(e){return this.hasOwnProperty(e)&&-1===t.indexOf(e)};if(e["static"]){i.extend(s,e["static"],r);for(var o in i.classProps)o in e["static"]&&i.classProps[o](s,e["static"][o])}i.extend(s.prototype,e,r);for(var o in i.classProps)o in e&&i.classProps[o](s.prototype,e[o]);return s.prototype["super"]=s["super"]?s["super"].prototype:null,s},classProps:{lazy:e(function(e,t,i){return Object.defineProperty(e,t,{get:function(){var e=i.call(this);return Object.defineProperty(this,t,{value:e,configurable:!0,enumerable:!0,
...
this.observer=Wysie.observe(this.element,this.attribute,function(e){if(o.attribute){var t=o.value;e[e.length-1].oldValue!=t&&o.update(t)}else(!o.wysie.editing||o.computed)&&o.oldValue!=o.value&&o.update(o.value)},!0),this.computed||""===this["default"]?this["default"]=this.templateValue:(null===this["default"]&&(this["default"]=this.editor?this.editorValue:this.emptyValue),this.value=this["default"]),this.update(this.value),this.collection){var c=function(t){o.unobserve();var i=e.remove(e(Wysie.selectors.ui,o.element)),n=t();return e.inside(i,o.element),o.observe(),n};["textContent","innerHTML"].forEach(function(e){var t=Object.getOwnPropertyDescriptor(Node.prototype,e);Object.defineProperty(o.element,e,{get:function(){var e=this;return c(function(){return t.get.call(e)})},set:function(e){var i=this;c(function(){return t.set.call(i,e)})}})})}this.initialized=!0},get value(){if(this.editing){var e=this.editorValue;return""===e?null:e}return n.getValue(this.element,this.attribute,this.datatype);
},set value(e){this.editing&&document.activeElement!=this.editor&&(this.editorValue=e),this.oldValue=this.value,(!this.editing||this.attribute)&&("number"!=this.datatype||this.attribute?this.editor&&this.editor.matches("select")?(this.editorValue=e,n.setValue(this.element,e,"content",this.datatype),n.setValue(this.element,this.editor.selectedOptions[0]?this.editor.selectedOptions[0].textContent:e,this.attribute,this.datatype)):n.setValue(this.element,e,this.attribute,this.datatype):(n.setValue(this.element,e,"content",this.datatype),n.setValue(this.element,Wysie.Expression.Text.formatNumber(e),null,this.datatype))),(Wysie.is("formControl",this.element)||!this.attribute)&&this.update(e),this.unsavedChanges=this.wysie.unsavedChanges=!0},get editorValue(){if(this.editor){if(this.editor.matches(Wysie.selectors.formControl))return n.getValue(this.editor,void 0,this.datatype);var t=e(Wysie.selectors.output+", "+Wysie.selectors.formControl,this.editor);if(t)return n.all.has(t)?n.all.get(t).value:n.getValue(t);
}},set editorValue(t){if(this.editor)if(this.editor.matches(Wysie.selectors.formControl))n.setValue(this.editor,t);else{var i=e(Wysie.selectors.output+", "+Wysie.selectors.formControl,this.editor);i&&(n.all.has(i)?n.all.get(i).value=t:n.setValue(i,t))}},get exposed(){return this.editor===this.element},getData:function(e){e=e||{};var t=this["super"].getData.call(this,e);if(void 0!==t)return t;var t=e.dirty||this.exposed?this.value:this.savedValue;return e.dirty||""!==t?t:null},update:function(t){t=t||0===t?t:"",this.empty=""===t,this.humanReadable&&this.attribute&&(this.element.textContent=this.humanReadable(t)),this.initialized&&(this.oldValue=this.value,e.fire(this.element,"wysie:datachange",{property:this.property,value:t,wysie:this.wysie,node:this,dirty:this.editing,action:"propertychange"}))},save:function(){return this.placeholder?!1:(this.savedValue=this.value,this.everSaved=!0,void(this.unsavedChanges=!1))},done:function(){this.unobserve(),this.popup?this.hidePopup():this.attribute||this.exposed||!this.editing||(e.remove(this.editor),
